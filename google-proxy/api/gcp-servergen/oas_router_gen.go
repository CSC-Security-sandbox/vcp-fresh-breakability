					...
					case '/': // Prefix: "/batch/"
						...
						case 'h': // Prefix: "hostGroups"
							...
							if len(elem) == 0 {
								...
								switch r.Method {
								case "POST":
									s.handleV1betaBatchListHostGroupsRequest([1]string{
										args[0],
									}, elemIsEscaped, w, r)
								default:
									s.notAllowed(w, r, "POST")
						...
						case 'k': // Prefix: "kmsConfigs"

							if l := len("kmsConfigs"); len(elem) >= l && elem[0:l] == "kmsConfigs" {
								elem = elem[l:]
							} else {
								break
							}
							...
							if len(elem) == 0 {
								...
								switch r.Method {
								case "POST":
									s.handleV1betaBatchListKmsConfigsRequest([1]string{
										args[0],
									}, elemIsEscaped, w, r)
								default:
									s.notAllowed(w, r, "POST")
						...
						case 's': // Prefix: "snapshots"
							...
							if len(elem) == 0 {
								...
								switch r.Method {
								case "POST":
									s.handleV1betaBatchListSnapshotsRequest([1]string{
										args[0],
									}, elemIsEscaped, w, r)
								default:
									s.notAllowed(w, r, "POST")
											...
											case 'p': // Prefix: "plitst"
												...
												case 'o': // Prefix: "op"
													...
													if len(elem) == 0 {
														...
														switch r.Method {
														case "POST":
															s.handleV1betaSplitStopVolumeRequest([3]string{
																args[0],
																args[1],
																args[2],
															}, elemIsEscaped, w, r)
					...
					case '/': // Prefix: "/batch/"
						...
						case 'h': // Prefix: "hostGroups"
							...
							if len(elem) == 0 {
								...
								switch method {
								case "POST":
									r.name = V1betaBatchListHostGroupsOperation
									r.summary = "Batch lists all host groups with the given UUIDs"
									r.operationID = "v1beta_batchListHostGroups"
									r.pathPattern = "/v1beta/locations/{locationId}/batch/hostGroups"
									r.args = args
									r.count = 1
									return r, true
								default:
						...
						case 'k': // Prefix: "kmsConfigs"
							...
							if len(elem) == 0 {
								...
								switch method {
								case "POST":
									r.name = V1betaBatchListKmsConfigsOperation
									r.summary = "Batch lists all KMS configurations with the given UUIDs"
									r.operationID = "v1beta_batchListKmsConfigs"
									r.pathPattern = "/v1beta/locations/{locationId}/batch/kmsConfigs"
									r.args = args
									r.count = 1
									return r, true
								default:
						...
						case 's': // Prefix: "snapshots"
							...
							if len(elem) == 0 {
								...
								switch method {
								case "POST":
									r.name = V1betaBatchListSnapshotsOperation
											...
											case 'p': // Prefix: "plitst"
												...
												case 'o': // Prefix: "op"
													...
													if len(elem) == 0 {
														...
														switch method {
														case "POST":
															r.name = V1betaSplitStopVolumeOperation
															r.summary = "Stop an in-progress split of a thin clone volume"
															r.operationID = "v1beta_splitStopVolume"
															r.pathPattern = "/v1beta/projects/{projectNumber}/locations/{locationId}/volumes/{volumeId}/splitstop"
															r.args = args
															r.count = 3
															return r, true
														default:
