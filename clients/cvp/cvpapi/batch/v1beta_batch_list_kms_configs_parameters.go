...
func (o *V1betaBatchListKmsConfigsParams) WithTimeout(timeout time.Duration) *V1betaBatchListKmsConfigsParams {
	o.SetTimeout(timeout)
	return o
}

// SetTimeout adds the timeout to the v1beta batch list kms configs params
func (o *V1betaBatchListKmsConfigsParams) SetTimeout(timeout time.Duration) {
	o.timeout = timeout
}

// WithContext adds the context to the v1beta batch list kms configs params
func (o *V1betaBatchListKmsConfigsParams) WithContext(ctx context.Context) *V1betaBatchListKmsConfigsParams {
	o.SetContext(ctx)
	return o
}

// SetContext adds the context to the v1beta batch list kms configs params
func (o *V1betaBatchListKmsConfigsParams) SetContext(ctx context.Context) {
	o.Context = ctx
}

// WithHTTPClient adds the HTTPClient to the v1beta batch list kms configs params
func (o *V1betaBatchListKmsConfigsParams) WithHTTPClient(client *http.Client) *V1betaBatchListKmsConfigsParams {
	o.SetHTTPClient(client)
	return o
}

// SetHTTPClient adds the HTTPClient to the v1beta batch list kms configs params
func (o *V1betaBatchListKmsConfigsParams) SetHTTPClient(client *http.Client) {
	o.HTTPClient = client
}
...
// WithFields adds the fields to the v1beta batch list kms configs params
func (o *V1betaBatchListKmsConfigsParams) WithFields(fields []string) *V1betaBatchListKmsConfigsParams {
	o.SetFields(fields)
	return o
}

// SetFields adds the fields to the v1beta batch list kms configs params
func (o *V1betaBatchListKmsConfigsParams) SetFields(fields []string) {
	o.Fields = fields
}

// WithLocationID adds the locationID to the v1beta batch list kms configs params
func (o *V1betaBatchListKmsConfigsParams) WithLocationID(locationID string) *V1betaBatchListKmsConfigsParams {
	o.SetLocationID(locationID)
	return o
}

// SetLocationID adds the locationId to the v1beta batch list kms configs params
func (o *V1betaBatchListKmsConfigsParams) SetLocationID(locationID string) {
	o.LocationID = locationID
}

// WithXCorrelationID adds the xCorrelationID to the v1beta batch list kms configs params
func (o *V1betaBatchListKmsConfigsParams) WithXCorrelationID(xCorrelationID *string) *V1betaBatchListKmsConfigsParams {
	o.SetXCorrelationID(xCorrelationID)
	return o
}

// SetXCorrelationID adds the xCorrelationId to the v1beta batch list kms configs params
func (o *V1betaBatchListKmsConfigsParams) SetXCorrelationID(xCorrelationID *string) {
	o.XCorrelationID = xCorrelationID
}

// WriteToRequest writes these params to a swagger request
func (o *V1betaBatchListKmsConfigsParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
