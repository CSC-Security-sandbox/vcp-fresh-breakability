...
// GetHealth provides a mock function with given fields: params
func (_m *MockClientService) GetHealth(params *GetHealthParams) (*GetHealthOK, error) {
	...
	var r0 *GetHealthOK
	var r1 error
	if rf, ok := ret.Get(0).(func(*GetHealthParams) (*GetHealthOK, error)); ok {
		return rf(params)
	}
	if rf, ok := ret.Get(0).(func(*GetHealthParams) *GetHealthOK); ok {
		r0 = rf(params)
	} else {
		if ret.Get(0) != nil {
	...
	if rf, ok := ret.Get(1).(func(*GetHealthParams) error); ok {
		r1 = rf(params)
	} else {
		r1 = ret.Error(1)
	}
...
func (_e *MockClientService_Expecter) GetHealth(params interface{}) *MockClientService_GetHealth_Call {
	return &MockClientService_GetHealth_Call{Call: _e.mock.On("GetHealth", params)}
}

func (_c *MockClientService_GetHealth_Call) Run(run func(params *GetHealthParams)) *MockClientService_GetHealth_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(*GetHealthParams))
	})
	return _c
}
...
func (_c *MockClientService_GetHealth_Call) RunAndReturn(run func(*GetHealthParams) (*GetHealthOK, error)) *MockClientService_GetHealth_Call {
	_c.Call.Return(run)
	return _c
}
