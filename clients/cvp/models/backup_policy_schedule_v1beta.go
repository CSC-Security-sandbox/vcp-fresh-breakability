...
// ContextValidate validates this backup policy schedule v1beta based on context it is used
func (m *BackupPolicyScheduleV1beta) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
