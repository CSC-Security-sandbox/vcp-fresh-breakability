...
// BatchBackupPolicyScheduleV1beta Request object for backup policy schedules
//
// swagger:model BatchBackupPolicySchedule_v1beta
type BatchBackupPolicyScheduleV1beta struct {
...
// Validate validates this batch backup policy schedule v1beta
func (m *BatchBackupPolicyScheduleV1beta) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *BatchBackupPolicyScheduleV1beta) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *BatchBackupPolicyScheduleV1beta) UnmarshalBinary(b []byte) error {
	var res BatchBackupPolicyScheduleV1beta
