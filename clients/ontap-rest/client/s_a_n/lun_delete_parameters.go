...
func (o *LunDeleteParams) SetDefaults() {
	var (
		...
		bypassRecoveryQueueDefault = string("\"False\"")
...
func (o *LunDeleteParams) WithAllowDeleteWhileMapped(allowDeleteWhileMapped *string) *LunDeleteParams {
...
func (o *LunDeleteParams) SetAllowDeleteWhileMapped(allowDeleteWhileMapped *string) {
...
func (o *LunDeleteParams) WithBypassRecoveryQueue(bypassRecoveryQueue *string) *LunDeleteParams {
	o.SetBypassRecoveryQueue(bypassRecoveryQueue)
	return o
}

// SetBypassRecoveryQueue adds the bypassRecoveryQueue to the lun delete params
func (o *LunDeleteParams) SetBypassRecoveryQueue(bypassRecoveryQueue *string) {
	o.BypassRecoveryQueue = bypassRecoveryQueue
}

// WithReturnTimeout adds the returnTimeout to the lun delete params
func (o *LunDeleteParams) WithReturnTimeout(returnTimeout *string) *LunDeleteParams {
	o.SetReturnTimeout(returnTimeout)
	return o
}

// SetReturnTimeout adds the returnTimeout to the lun delete params
func (o *LunDeleteParams) SetReturnTimeout(returnTimeout *string) {
...
func (o *LunDeleteParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
	...
	if o.BypassRecoveryQueue != nil {
		...
		var qrBypassRecoveryQueue string

		if o.BypassRecoveryQueue != nil {
			qrBypassRecoveryQueue = *o.BypassRecoveryQueue
		}
		qBypassRecoveryQueue := qrBypassRecoveryQueue
