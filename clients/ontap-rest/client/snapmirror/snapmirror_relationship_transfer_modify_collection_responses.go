...
func (o *SnapmirrorRelationshipTransferModifyCollectionDefault) Error() string {
	return fmt.Sprintf("[PATCH /snapmirror/relationships/{relationship.uuid}/transfers][%d] snapmirror_relationship_transfer_modify_collection default  %+v", o._statusCode, o.Payload)
}
...
type SnapmirrorRelationshipTransferModifyCollectionBody struct {
	...
	// Percent of bytes transferred. This is only supported for full volume transfers on object store restore relationships.
	// Read Only: true
	BytesTransferredPercent *int64 `json:"bytes_transferred_percent,omitempty"`
	...
	SnapmirrorTransferInlineOptions []*SnapmirrorTransferInlineOptionsInlineArrayItem `json:"options,omitempty"`
	...
	// Specifies the duration for which the snapshot specified in the 'source_snapshot' property is locked in the object store. The retention period value represents a duration and must be specified in the ISO-8601 duration format. The retention period can be in years, months, or days. A period specified for years, months, or days is represented in the ISO-8601 format as "P<num>Y", "P<num>M", or "P<num>D" respectively. For example, "P10Y" represents a duration of 10 years. The period string must contain only a single time element, that is, either years, months, or days. A duration which combines different periods is not supported, for example "P1Y10M" is not supported. Years, if specified, must be less than or equal to 100. Months, if specified, must be less than or equal to 1200. Days, if specified, must be between and including 30 and 36500. This property is valid only if the 'source_snapshot' property is specified and when the property 'snapshot_lock_mode' in the policy associated with the SnapMirror relationship is set to enterprise or compliance. If this property is not specified and the source snapshot being transferred does not match a policy rule, then a default retention period of "P30D" is set. This property is supported only for non-restore transfers and for object store SnapMirror relationships.
	// Example: P30D
	SnapshotRetentionPeriod *string `json:"snapshot_retention_period,omitempty"`
	...
	// Specifies the snapshot UUID on the object store source to be restored to the destination.
	// Format: uuid
...
func (o *SnapmirrorRelationshipTransferModifyCollectionBody) Validate(formats strfmt.Registry) error {
	...
	if err := o.validateArchiveRetrievalPriority(formats); err != nil {
		res = append(res, err)
	}
	...
	if err := o.validateSnapmirrorTransferInlineOptions(formats); err != nil {
		res = append(res, err)
	}
	...
	if err := o.validateSourceSnapshotUUID(formats); err != nil {
		res = append(res, err)
	}
...
var snapmirrorRelationshipTransferModifyCollectionBodyTypeArchiveRetrievalPriorityPropEnum []interface{}
...
func init() {
	...
	for _, v := range res {
		snapmirrorRelationshipTransferModifyCollectionBodyTypeArchiveRetrievalPriorityPropEnum = append(snapmirrorRelationshipTransferModifyCollectionBodyTypeArchiveRetrievalPriorityPropEnum, v)
	}
}

const (

	// SnapmirrorRelationshipTransferModifyCollectionBodyArchiveRetrievalPriorityStandard captures enum value "standard"
	SnapmirrorRelationshipTransferModifyCollectionBodyArchiveRetrievalPriorityStandard string = "standard"

	// SnapmirrorRelationshipTransferModifyCollectionBodyArchiveRetrievalPriorityHigh captures enum value "high"
	SnapmirrorRelationshipTransferModifyCollectionBodyArchiveRetrievalPriorityHigh string = "high"

	// SnapmirrorRelationshipTransferModifyCollectionBodyArchiveRetrievalPriorityLow captures enum value "low"
	SnapmirrorRelationshipTransferModifyCollectionBodyArchiveRetrievalPriorityLow string = "low"
)

// prop value enum
func (o *SnapmirrorRelationshipTransferModifyCollectionBody) validateArchiveRetrievalPriorityEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, snapmirrorRelationshipTransferModifyCollectionBodyTypeArchiveRetrievalPriorityPropEnum, true); err != nil {
		return err
	}
	return nil
}

func (o *SnapmirrorRelationshipTransferModifyCollectionBody) validateArchiveRetrievalPriority(formats strfmt.Registry) error {
	if swag.IsZero(o.ArchiveRetrievalPriority) { // not required
		return nil
	}

	// value enum
	if err := o.validateArchiveRetrievalPriorityEnum("info"+"."+"archive_retrieval_priority", "body", *o.ArchiveRetrievalPriority); err != nil {
		return err
	}
	...
	if o.ErrorInfo != nil {
		if err := o.ErrorInfo.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("info" + "." + "error_info")
			}
			return err
		}
	}
	...
	if o.Relationship != nil {
		if err := o.Relationship.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("info" + "." + "relationship")
			}
			return err
		}
	}
		...
		if o.SnapmirrorTransferInlineFiles[i] != nil {
			if err := o.SnapmirrorTransferInlineFiles[i].Validate(formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					...
					return ce.ValidateName("info" + "." + "files" + "." + strconv.Itoa(i))
				}
				return err
			}
		}
...
func (o *SnapmirrorRelationshipTransferModifyCollectionBody) validateSnapmirrorTransferInlineOptions(formats strfmt.Registry) error {
	if swag.IsZero(o.SnapmirrorTransferInlineOptions) { // not required
		return nil
	}

	for i := 0; i < len(o.SnapmirrorTransferInlineOptions); i++ {
		if swag.IsZero(o.SnapmirrorTransferInlineOptions[i]) { // not required
			continue
		}

		if o.SnapmirrorTransferInlineOptions[i] != nil {
			if err := o.SnapmirrorTransferInlineOptions[i].Validate(formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					return ve.ValidateName("info" + "." + "options" + "." + strconv.Itoa(i))
				} else if ce, ok := err.(*errors.CompositeError); ok {
					return ce.ValidateName("info" + "." + "options" + "." + strconv.Itoa(i))
				}
				return err
			}
		}
...
func (o *SnapmirrorRelationshipTransferModifyCollectionBody) validateSourceSnapshotUUID(formats strfmt.Registry) error {
	if swag.IsZero(o.SourceSnapshotUUID) { // not required
		return nil
	}

	if err := validate.FormatOf("info"+"."+"source_snapshot_uuid", "body", "uuid", o.SourceSnapshotUUID.String(), formats); err != nil {
		return err
	}
...
func (o *SnapmirrorRelationshipTransferModifyCollectionBody) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	...
	if err := o.contextValidateBytesTransferredPercent(ctx, formats); err != nil {
		res = append(res, err)
	}
	...
	if err := o.contextValidateSnapmirrorTransferInlineOptions(ctx, formats); err != nil {
		res = append(res, err)
	}
...
func (o *SnapmirrorRelationshipTransferModifyCollectionBody) contextValidateBytesTransferredPercent(ctx context.Context, formats strfmt.Registry) error {

	if err := validate.ReadOnly(ctx, "info"+"."+"bytes_transferred_percent", "body", o.BytesTransferredPercent); err != nil {
		return err
	}
...
func (o *SnapmirrorRelationshipTransferModifyCollectionBody) contextValidateSnapmirrorTransferInlineOptions(ctx context.Context, formats strfmt.Registry) error {

	for i := 0; i < len(o.SnapmirrorTransferInlineOptions); i++ {

		if o.SnapmirrorTransferInlineOptions[i] != nil {
			if err := o.SnapmirrorTransferInlineOptions[i].ContextValidate(ctx, formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					return ve.ValidateName("info" + "." + "options" + "." + strconv.Itoa(i))
				} else if ce, ok := err.(*errors.CompositeError); ok {
					return ce.ValidateName("info" + "." + "options" + "." + strconv.Itoa(i))
...
/*
SnapmirrorTransferInlineOptionsInlineArrayItem snapmirror transfer inline options inline array item
swagger:model snapmirror_transfer_inline_options_inline_array_item
*/
type SnapmirrorTransferInlineOptionsInlineArrayItem struct {
	...
	// Specifies whether or not deduplication savings of a backed up snapshot will be preserved during restore from an object store. This parameter is only supported for restoring an entire volume from an object store. Valid values are 'true' or 'false'. This parameter enables cost-optimized restore, although it may affect the duration of the restore operation. This parameter is not supported for file restores from an object store.
	// Example: true
	PreserveDedupSavings *bool `json:"preserve_dedup_savings,omitempty"`
}

// Validate validates this snapmirror transfer inline options inline array item
func (o *SnapmirrorTransferInlineOptionsInlineArrayItem) Validate(formats strfmt.Registry) error {
	return nil
}

// ContextValidate validates this snapmirror transfer inline options inline array item based on context it is used
func (o *SnapmirrorTransferInlineOptionsInlineArrayItem) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (o *SnapmirrorTransferInlineOptionsInlineArrayItem) MarshalBinary() ([]byte, error) {
	if o == nil {
		return nil, nil
	}
	return swag.WriteJSON(o)
...
// UnmarshalBinary interface implementation
func (o *SnapmirrorTransferInlineOptionsInlineArrayItem) UnmarshalBinary(b []byte) error {
	var res SnapmirrorTransferInlineOptionsInlineArrayItem
	if err := swag.ReadJSON(b, &res); err != nil {
		return err
	}
	*o = res
	...
	if o.Destination != nil {
		if err := o.Destination.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("info" + "." + "relationship" + "." + "destination")
			}
			return err
		}
	}
