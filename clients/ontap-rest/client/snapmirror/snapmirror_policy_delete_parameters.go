...
func (o *SnapmirrorPolicyDeleteParams) WithReturnTimeout(returnTimeout *string) *SnapmirrorPolicyDeleteParams {
	o.SetReturnTimeout(returnTimeout)
	return o
}

// SetReturnTimeout adds the returnTimeout to the snapmirror policy delete params
func (o *SnapmirrorPolicyDeleteParams) SetReturnTimeout(returnTimeout *string) {
