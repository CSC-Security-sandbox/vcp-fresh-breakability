...
| 13304093    | Property specified is not supported for specified relationships. |
| 13304094    | The property snapshot_retention_period is not supported for this relationship because the policy associated with it does not have the snapshot_lock_mode set to compliance or enterprise. |
| 13304134    | The overwrite property specified does not match the value specified in the previous request. |
| 6684973     | The snapshot does not exist. |
| 6621810     | Failed to get object store endpoint information. ||
*/
