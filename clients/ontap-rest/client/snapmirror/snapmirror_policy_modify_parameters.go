...
func (o *SnapmirrorPolicyModifyParams) WithReturnTimeout(returnTimeout *string) *SnapmirrorPolicyModifyParams {
	o.SetReturnTimeout(returnTimeout)
	return o
}

// SetReturnTimeout adds the returnTimeout to the snapmirror policy modify params
func (o *SnapmirrorPolicyModifyParams) SetReturnTimeout(returnTimeout *string) {
