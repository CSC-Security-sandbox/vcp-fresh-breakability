...
func (o *SnapmirrorPolicyModifyCollectionOK) Error() string {
	return fmt.Sprintf("[PATCH /snapmirror/policies][%d] snapmirrorPolicyModifyCollectionOK  %+v", 200, o.Payload)
}
...
func (o *SnapmirrorPolicyModifyCollectionAccepted) Error() string {
	return fmt.Sprintf("[PATCH /snapmirror/policies][%d] snapmirrorPolicyModifyCollectionAccepted  %+v", 202, o.Payload)
}
...
| 13303932    | Invalid input property |
| 13303947    | The specified property needs another property to be specified |
| 13303948    | The specified properties cannot be set to the specified values. |
| 13304047    | An additional property is required with the specified policy property. |
| 6621102     | Failed to modify the property from zero because the policy is currently associated with a SnapMirror relationship. |
| 6621104     | Failed to modify the property because the policy is currently associated with a relationship which does not support the property. |
| 13304090    | The property snapshot_lock_mode cannot be specified for this operation. |
| 13304096    | Property archive is not supported when property snapshot_lock_mode is set to compliance or enterprise. |
...
func (o *SnapmirrorPolicyModifyCollectionDefault) Error() string {
	return fmt.Sprintf("[PATCH /snapmirror/policies][%d] snapmirror_policy_modify_collection default  %+v", o._statusCode, o.Payload)
}
...
type SnapmirrorPolicyModifyCollectionBody struct {
	...
	// archive
	Archive *SnapmirrorPolicyInlineArchive `json:"archive,omitempty"`
...
func (o *SnapmirrorPolicyModifyCollectionBody) Validate(formats strfmt.Registry) error {
	...
	if err := o.validateArchive(formats); err != nil {
		res = append(res, err)
	}
	...
	if err := o.validateSnapshotLockMode(formats); err != nil {
		res = append(res, err)
	}
...
func (o *SnapmirrorPolicyModifyCollectionBody) validateArchive(formats strfmt.Registry) error {
	if swag.IsZero(o.Archive) { // not required
		return nil
	}

	if o.Archive != nil {
		if err := o.Archive.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("info" + "." + "archive")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("info" + "." + "archive")
			}
			return err
		}
	}
		...
		if o.SnapmirrorPolicyInlineRetention[i] != nil {
			if err := o.SnapmirrorPolicyInlineRetention[i].Validate(formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					...
					return ce.ValidateName("info" + "." + "retention" + "." + strconv.Itoa(i))
				}
				return err
			}
		}
...
var snapmirrorPolicyModifyCollectionBodyTypeSnapshotLockModePropEnum []interface{}
...
func init() {
	...
	for _, v := range res {
		snapmirrorPolicyModifyCollectionBodyTypeSnapshotLockModePropEnum = append(snapmirrorPolicyModifyCollectionBodyTypeSnapshotLockModePropEnum, v)
	}
}

const (

	// SnapmirrorPolicyModifyCollectionBodySnapshotLockModeNone captures enum value "none"
	SnapmirrorPolicyModifyCollectionBodySnapshotLockModeNone string = "none"

	// SnapmirrorPolicyModifyCollectionBodySnapshotLockModeCompliance captures enum value "compliance"
	SnapmirrorPolicyModifyCollectionBodySnapshotLockModeCompliance string = "compliance"

	// SnapmirrorPolicyModifyCollectionBodySnapshotLockModeEnterprise captures enum value "enterprise"
	SnapmirrorPolicyModifyCollectionBodySnapshotLockModeEnterprise string = "enterprise"
)

// prop value enum
func (o *SnapmirrorPolicyModifyCollectionBody) validateSnapshotLockModeEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, snapmirrorPolicyModifyCollectionBodyTypeSnapshotLockModePropEnum, true); err != nil {
		return err
	}
	return nil
}

func (o *SnapmirrorPolicyModifyCollectionBody) validateSnapshotLockMode(formats strfmt.Registry) error {
	if swag.IsZero(o.SnapshotLockMode) { // not required
		return nil
	}

	// value enum
	if err := o.validateSnapshotLockModeEnum("info"+"."+"snapshot_lock_mode", "body", *o.SnapshotLockMode); err != nil {
		return err
	}
	...
	if o.SyncCommonSnapshotSchedule != nil {
		if err := o.SyncCommonSnapshotSchedule.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("info" + "." + "sync_common_snapshot_schedule")
			}
			return err
		}
	}
...
func (o *SnapmirrorPolicyModifyCollectionBody) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	...
	if err := o.contextValidateArchive(ctx, formats); err != nil {
		res = append(res, err)
	}
...
func (o *SnapmirrorPolicyModifyCollectionBody) contextValidateArchive(ctx context.Context, formats strfmt.Registry) error {

	if o.Archive != nil {
		if err := o.Archive.ContextValidate(ctx, formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("info" + "." + "archive")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("info" + "." + "archive")
...
/*
SnapmirrorPolicyInlineArchive Archive information for the objects in an object store SnapMirror relationship. This property is applicable only for "async" policies with "create_snapshot_on_source" set to "false".
swagger:model snapmirror_policy_inline_archive
*/
type SnapmirrorPolicyInlineArchive struct {
...
// Validate validates this snapmirror policy inline archive
func (o *SnapmirrorPolicyInlineArchive) Validate(formats strfmt.Registry) error {
	return nil
}

// ContextValidate validates this snapmirror policy inline archive based on context it is used
func (o *SnapmirrorPolicyInlineArchive) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (o *SnapmirrorPolicyInlineArchive) MarshalBinary() ([]byte, error) {
	if o == nil {
		return nil, nil
	}
	return swag.WriteJSON(o)
...
// UnmarshalBinary interface implementation
func (o *SnapmirrorPolicyInlineArchive) UnmarshalBinary(b []byte) error {
	var res SnapmirrorPolicyInlineArchive
	if err := swag.ReadJSON(b, &res); err != nil {
		return err
	}
	*o = res
	...
	if o.Links != nil {
		if err := o.Links.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("info" + "." + "sync_common_snapshot_schedule" + "." + "_links")
			}
			return err
		}
	}
	...
	if o.Self != nil {
		if err := o.Self.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("info" + "." + "sync_common_snapshot_schedule" + "." + "_links" + "." + "self")
			}
			return err
		}
	}
