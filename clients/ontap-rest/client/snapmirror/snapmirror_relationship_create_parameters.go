...
// WithXNetappAuthorization adds the xNetappAuthorization to the snapmirror relationship create params
func (o *SnapmirrorRelationshipCreateParams) WithXNetappAuthorization(xNetappAuthorization *string) *SnapmirrorRelationshipCreateParams {
	o.SetXNetappAuthorization(xNetappAuthorization)
	return o
}

// SetXNetappAuthorization adds the xNetappAuthorization to the snapmirror relationship create params
func (o *SnapmirrorRelationshipCreateParams) SetXNetappAuthorization(xNetappAuthorization *string) {
...
func (o *SnapmirrorRelationshipCreateParams) WithReturnRecords(returnRecords *string) *SnapmirrorRelationshipCreateParams {
	o.SetReturnRecords(returnRecords)
	return o
}

// SetReturnRecords adds the returnRecords to the snapmirror relationship create params
func (o *SnapmirrorRelationshipCreateParams) SetReturnRecords(returnRecords *string) {
	o.ReturnRecords = returnRecords
}

// WithReturnTimeout adds the returnTimeout to the snapmirror relationship create params
func (o *SnapmirrorRelationshipCreateParams) WithReturnTimeout(returnTimeout *string) *SnapmirrorRelationshipCreateParams {
	o.SetReturnTimeout(returnTimeout)
	return o
}

// SetReturnTimeout adds the returnTimeout to the snapmirror relationship create params
func (o *SnapmirrorRelationshipCreateParams) SetReturnTimeout(returnTimeout *string) {
	o.ReturnTimeout = returnTimeout
}

// WithValidateOnly adds the validateOnly to the snapmirror relationship create params
func (o *SnapmirrorRelationshipCreateParams) WithValidateOnly(validateOnly *string) *SnapmirrorRelationshipCreateParams {
	o.SetValidateOnly(validateOnly)
	return o
}

// SetValidateOnly adds the validateOnly to the snapmirror relationship create params
func (o *SnapmirrorRelationshipCreateParams) SetValidateOnly(validateOnly *string) {
