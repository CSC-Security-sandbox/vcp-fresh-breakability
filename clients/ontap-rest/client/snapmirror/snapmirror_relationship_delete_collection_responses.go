...
func (o *SnapmirrorRelationshipDeleteCollectionOK) Error() string {
	return fmt.Sprintf("[DELETE /snapmirror/relationships][%d] snapmirrorRelationshipDeleteCollectionOK  %+v", 200, o.Payload)
}
...
func (o *SnapmirrorRelationshipDeleteCollectionAccepted) Error() string {
	return fmt.Sprintf("[DELETE /snapmirror/relationships][%d] snapmirrorRelationshipDeleteCollectionAccepted  %+v", 202, o.Payload)
}
...
func (o *SnapmirrorRelationshipDeleteCollectionDefault) Error() string {
	return fmt.Sprintf("[DELETE /snapmirror/relationships][%d] snapmirror_relationship_delete_collection default  %+v", o._statusCode, o.Payload)
}
