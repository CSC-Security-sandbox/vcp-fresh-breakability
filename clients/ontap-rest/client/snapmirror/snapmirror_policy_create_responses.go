...
func (o *SnapmirrorPolicyCreateCreated) Error() string {
	return fmt.Sprintf("[POST /snapmirror/policies][%d] snapmirrorPolicyCreateCreated  %+v", 201, o.Payload)
}
...
| 13304051    | The property only supports values from 0 to 999. |
| 13303872    | Property specified requires an effective cluster version of ONTAP specified or later. |
| 13303850    | Input parameter specified is not valid for SnapMirror policy type specified. |
