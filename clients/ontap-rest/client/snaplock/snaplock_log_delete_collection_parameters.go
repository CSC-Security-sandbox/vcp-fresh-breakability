...
func (o *SnaplockLogDeleteCollectionParams) WithContinueOnFailure(continueOnFailure *string) *SnaplockLogDeleteCollectionParams {
	o.SetContinueOnFailure(continueOnFailure)
	return o
}

// SetContinueOnFailure adds the continueOnFailure to the snaplock log delete collection params
func (o *SnaplockLogDeleteCollectionParams) SetContinueOnFailure(continueOnFailure *string) {
...
func (o *SnaplockLogDeleteCollectionParams) WithLogFilesSize(logFilesSize *string) *SnaplockLogDeleteCollectionParams {
	o.SetLogFilesSize(logFilesSize)
	return o
}

// SetLogFilesSize adds the logFilesSize to the snaplock log delete collection params
func (o *SnaplockLogDeleteCollectionParams) SetLogFilesSize(logFilesSize *string) {
...
func (o *SnaplockLogDeleteCollectionParams) WithLogVolumeMaxLogSize(logVolumeMaxLogSize *string) *SnaplockLogDeleteCollectionParams {
...
func (o *SnaplockLogDeleteCollectionParams) SetLogVolumeMaxLogSize(logVolumeMaxLogSize *string) {
...
func (o *SnaplockLogDeleteCollectionParams) WithReturnRecords(returnRecords *string) *SnaplockLogDeleteCollectionParams {
	o.SetReturnRecords(returnRecords)
	return o
}

// SetReturnRecords adds the returnRecords to the snaplock log delete collection params
func (o *SnaplockLogDeleteCollectionParams) SetReturnRecords(returnRecords *string) {
	o.ReturnRecords = returnRecords
}

// WithReturnTimeout adds the returnTimeout to the snaplock log delete collection params
func (o *SnaplockLogDeleteCollectionParams) WithReturnTimeout(returnTimeout *string) *SnaplockLogDeleteCollectionParams {
	o.SetReturnTimeout(returnTimeout)
	return o
}

// SetReturnTimeout adds the returnTimeout to the snaplock log delete collection params
func (o *SnaplockLogDeleteCollectionParams) SetReturnTimeout(returnTimeout *string) {
	o.ReturnTimeout = returnTimeout
}

// WithSerialRecords adds the serialRecords to the snaplock log delete collection params
func (o *SnaplockLogDeleteCollectionParams) WithSerialRecords(serialRecords *string) *SnaplockLogDeleteCollectionParams {
	o.SetSerialRecords(serialRecords)
	return o
}

// SetSerialRecords adds the serialRecords to the snaplock log delete collection params
func (o *SnaplockLogDeleteCollectionParams) SetSerialRecords(serialRecords *string) {
...
func (o *SnaplockLogDeleteCollectionParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
	...
	if o.LogFilesSize != nil {
		...
		var qrLogFilesSize string

		if o.LogFilesSize != nil {
			qrLogFilesSize = *o.LogFilesSize
		}
		qLogFilesSize := qrLogFilesSize
		if qLogFilesSize != "" {
	...
	if o.LogVolumeMaxLogSize != nil {
		...
		var qrLogVolumeMaxLogSize string

		if o.LogVolumeMaxLogSize != nil {
			qrLogVolumeMaxLogSize = *o.LogVolumeMaxLogSize
		}
		qLogVolumeMaxLogSize := qrLogVolumeMaxLogSize
