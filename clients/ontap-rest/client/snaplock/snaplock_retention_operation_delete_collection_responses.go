...
func (o *SnaplockRetentionOperationDeleteCollectionDefault) Error() string {
	return fmt.Sprintf("[DELETE /storage/snaplock/event-retention/operations][%d] snaplock_retention_operation_delete_collection default  %+v", o._statusCode, o.Payload)
}
