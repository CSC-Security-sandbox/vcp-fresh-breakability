...
func (o *SnaplockFingerprintOperationCreateParams) WithReturnRecords(returnRecords *string) *SnaplockFingerprintOperationCreateParams {
	o.SetReturnRecords(returnRecords)
	return o
}

// SetReturnRecords adds the returnRecords to the snaplock fingerprint operation create params
func (o *SnaplockFingerprintOperationCreateParams) SetReturnRecords(returnRecords *string) {
