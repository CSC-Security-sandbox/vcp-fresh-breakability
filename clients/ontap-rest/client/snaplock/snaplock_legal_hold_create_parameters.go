...
func (o *SnaplockLegalHoldCreateParams) WithReturnRecords(returnRecords *string) *SnaplockLegalHoldCreateParams {
	o.SetReturnRecords(returnRecords)
	return o
}

// SetReturnRecords adds the returnRecords to the snaplock legal hold create params
func (o *SnaplockLegalHoldCreateParams) SetReturnRecords(returnRecords *string) {
