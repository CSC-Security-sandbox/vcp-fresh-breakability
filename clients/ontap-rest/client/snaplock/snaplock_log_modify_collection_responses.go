...
func (o *SnaplockLogModifyCollectionOK) Error() string {
	return fmt.Sprintf("[PATCH /storage/snaplock/audit-logs][%d] snaplockLogModifyCollectionOK  %+v", 200, o.Payload)
}
...
func (o *SnaplockLogModifyCollectionAccepted) Error() string {
	return fmt.Sprintf("[PATCH /storage/snaplock/audit-logs][%d] snaplockLogModifyCollectionAccepted  %+v", 202, o.Payload)
}
...
func (o *SnaplockLogModifyCollectionDefault) Error() string {
	return fmt.Sprintf("[PATCH /storage/snaplock/audit-logs][%d] snaplock_log_modify_collection default  %+v", o._statusCode, o.Payload)
}
	...
	if o.LogArchive != nil {
		if err := o.LogArchive.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("info" + "." + "log_archive")
			}
			return err
		}
	}
	...
	if o.LogVolume != nil {
		if err := o.LogVolume.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("info" + "." + "log_volume")
			}
			return err
		}
	}
		...
		if o.SnaplockLogInlineLogFiles[i] != nil {
			if err := o.SnaplockLogInlineLogFiles[i].Validate(formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					...
					return ce.ValidateName("info" + "." + "log_files" + "." + strconv.Itoa(i))
				}
				return err
			}
		}
	...
	if o.Links != nil {
		if err := o.Links.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("info" + "." + "log_archive" + "." + "_links")
			}
			return err
		}
	}
	...
	if o.Self != nil {
		if err := o.Self.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("info" + "." + "log_archive" + "." + "_links" + "." + "self")
			}
			return err
		}
	}
