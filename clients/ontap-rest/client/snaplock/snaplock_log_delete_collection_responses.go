...
func (o *SnaplockLogDeleteCollectionOK) Error() string {
	return fmt.Sprintf("[DELETE /storage/snaplock/audit-logs][%d] snaplockLogDeleteCollectionOK  %+v", 200, o.Payload)
}
...
func (o *SnaplockLogDeleteCollectionAccepted) Error() string {
	return fmt.Sprintf("[DELETE /storage/snaplock/audit-logs][%d] snaplockLogDeleteCollectionAccepted  %+v", 202, o.Payload)
}
...
func (o *SnaplockLogDeleteCollectionDefault) Error() string {
	return fmt.Sprintf("[DELETE /storage/snaplock/audit-logs][%d] snaplock_log_delete_collection default  %+v", o._statusCode, o.Payload)
}
