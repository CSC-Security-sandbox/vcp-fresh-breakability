...
func (o *SnaplockRetentionOperationCreateParams) WithReturnRecords(returnRecords *string) *SnaplockRetentionOperationCreateParams {
	o.SetReturnRecords(returnRecords)
	return o
}

// SetReturnRecords adds the returnRecords to the snaplock retention operation create params
func (o *SnaplockRetentionOperationCreateParams) SetReturnRecords(returnRecords *string) {
