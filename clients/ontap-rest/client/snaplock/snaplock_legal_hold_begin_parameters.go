...
func (o *SnaplockLegalHoldBeginParams) WithReturnRecords(returnRecords *string) *SnaplockLegalHoldBeginParams {
	o.SetReturnRecords(returnRecords)
	return o
}

// SetReturnRecords adds the returnRecords to the snaplock legal hold begin params
func (o *SnaplockLegalHoldBeginParams) SetReturnRecords(returnRecords *string) {
