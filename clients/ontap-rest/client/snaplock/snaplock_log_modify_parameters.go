...
func (o *SnaplockLogModifyParams) WithReturnTimeout(returnTimeout *string) *SnaplockLogModifyParams {
	o.SetReturnTimeout(returnTimeout)
	return o
}

// SetReturnTimeout adds the returnTimeout to the snaplock log modify params
func (o *SnaplockLogModifyParams) SetReturnTimeout(returnTimeout *string) {
