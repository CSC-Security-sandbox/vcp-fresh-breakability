...
func (o *SnaplockComplianceClockCreateParams) WithReturnRecords(returnRecords *string) *SnaplockComplianceClockCreateParams {
	o.SetReturnRecords(returnRecords)
	return o
}

// SetReturnRecords adds the returnRecords to the snaplock compliance clock create params
func (o *SnaplockComplianceClockCreateParams) SetReturnRecords(returnRecords *string) {
