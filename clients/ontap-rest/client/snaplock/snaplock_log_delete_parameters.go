...
func (o *SnaplockLogDeleteParams) WithReturnTimeout(returnTimeout *string) *SnaplockLogDeleteParams {
	o.SetReturnTimeout(returnTimeout)
	return o
}

// SetReturnTimeout adds the returnTimeout to the snaplock log delete params
func (o *SnaplockLogDeleteParams) SetReturnTimeout(returnTimeout *string) {
