...
func (o *SnaplockRetentionPolicyCreateParams) WithReturnRecords(returnRecords *string) *SnaplockRetentionPolicyCreateParams {
	o.SetReturnRecords(returnRecords)
	return o
}

// SetReturnRecords adds the returnRecords to the snaplock retention policy create params
func (o *SnaplockRetentionPolicyCreateParams) SetReturnRecords(returnRecords *string) {
