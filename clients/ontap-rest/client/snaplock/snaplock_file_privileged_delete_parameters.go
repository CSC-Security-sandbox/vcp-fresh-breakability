...
func (o *SnaplockFilePrivilegedDeleteParams) WithReturnTimeout(returnTimeout *string) *SnaplockFilePrivilegedDeleteParams {
	o.SetReturnTimeout(returnTimeout)
	return o
}

// SetReturnTimeout adds the returnTimeout to the snaplock file privileged delete params
func (o *SnaplockFilePrivilegedDeleteParams) SetReturnTimeout(returnTimeout *string) {
