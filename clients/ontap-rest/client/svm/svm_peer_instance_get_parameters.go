...
func (o *SvmPeerInstanceGetParams) WithReturnTimeout(returnTimeout *string) *SvmPeerInstanceGetParams {
	o.SetReturnTimeout(returnTimeout)
	return o
}

// SetReturnTimeout adds the returnTimeout to the svm peer instance get params
func (o *SvmPeerInstanceGetParams) SetReturnTimeout(returnTimeout *string) {
