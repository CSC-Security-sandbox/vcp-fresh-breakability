...
func (o *SvmPeerPermissionCreateParams) WithReturnRecords(returnRecords *string) *SvmPeerPermissionCreateParams {
	o.SetReturnRecords(returnRecords)
	return o
}

// SetReturnRecords adds the returnRecords to the svm peer permission create params
func (o *SvmPeerPermissionCreateParams) SetReturnRecords(returnRecords *string) {
