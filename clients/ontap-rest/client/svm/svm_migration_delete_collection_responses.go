...
func (o *SvmMigrationDeleteCollectionOK) Error() string {
	return fmt.Sprintf("[DELETE /svm/migrations][%d] svmMigrationDeleteCollectionOK  %+v", 200, o.Payload)
}
...
func (o *SvmMigrationDeleteCollectionAccepted) Error() string {
	return fmt.Sprintf("[DELETE /svm/migrations][%d] svmMigrationDeleteCollectionAccepted  %+v", 202, o.Payload)
}
...
func (o *SvmMigrationDeleteCollectionDefault) Error() string {
	return fmt.Sprintf("[DELETE /svm/migrations][%d] svm_migration_delete_collection default  %+v", o._statusCode, o.Payload)
}
