...
func (o *SvmPeerPermissionModifyCollectionOK) Error() string {
	return fmt.Sprintf("[PATCH /svm/peer-permissions][%d] svmPeerPermissionModifyCollectionOK  %+v", 200, o.Payload)
}
...
func (o *SvmPeerPermissionModifyCollectionDefault) Error() string {
	return fmt.Sprintf("[PATCH /svm/peer-permissions][%d] svm_peer_permission_modify_collection default  %+v", o._statusCode, o.Payload)
}
	...
	if o.ClusterPeer != nil {
		if err := o.ClusterPeer.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("info" + "." + "cluster_peer")
			}
			return err
		}
	}
	...
	if o.Links != nil {
		if err := o.Links.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("info" + "." + "cluster_peer" + "." + "_links")
			}
			return err
		}
	}
	...
	if o.Self != nil {
		if err := o.Self.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("info" + "." + "cluster_peer" + "." + "_links" + "." + "self")
			}
			return err
		}
	}
