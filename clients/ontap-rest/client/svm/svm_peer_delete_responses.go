...
func (o *SvmPeerDeleteOK) Error() string {
	return fmt.Sprintf("[DELETE /svm/peers/{uuid}][%d] svmPeerDeleteOK  %+v", 200, o.Payload)
}
...
func (o *SvmPeerDeleteAccepted) Error() string {
	return fmt.Sprintf("[DELETE /svm/peers/{uuid}][%d] svmPeerDeleteAccepted  %+v", 202, o.Payload)
}
