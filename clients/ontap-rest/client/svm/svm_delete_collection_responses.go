...
func (o *SvmDeleteCollectionOK) Error() string {
	return fmt.Sprintf("[DELETE /svm/svms][%d] svmDeleteCollectionOK  %+v", 200, o.Payload)
}
...
func (o *SvmDeleteCollectionAccepted) Error() string {
	return fmt.Sprintf("[DELETE /svm/svms][%d] svmDeleteCollectionAccepted  %+v", 202, o.Payload)
}
...
func (o *SvmDeleteCollectionDefault) Error() string {
	return fmt.Sprintf("[DELETE /svm/svms][%d] svm_delete_collection default  %+v", o._statusCode, o.Payload)
}
