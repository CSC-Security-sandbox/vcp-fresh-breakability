...
func (o *SvmPeerPermissionInstanceGetParams) WithReturnTimeout(returnTimeout *string) *SvmPeerPermissionInstanceGetParams {
	o.SetReturnTimeout(returnTimeout)
	return o
}

// SetReturnTimeout adds the returnTimeout to the svm peer permission instance get params
func (o *SvmPeerPermissionInstanceGetParams) SetReturnTimeout(returnTimeout *string) {
