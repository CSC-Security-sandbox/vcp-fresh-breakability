...
func (o *SvmMigrationDeleteParams) WithReturnTimeout(returnTimeout *string) *SvmMigrationDeleteParams {
	o.SetReturnTimeout(returnTimeout)
	return o
}

// SetReturnTimeout adds the returnTimeout to the svm migration delete params
func (o *SvmMigrationDeleteParams) SetReturnTimeout(returnTimeout *string) {
