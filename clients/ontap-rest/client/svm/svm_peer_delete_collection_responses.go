...
func (o *SvmPeerDeleteCollectionOK) Error() string {
	return fmt.Sprintf("[DELETE /svm/peers][%d] svmPeerDeleteCollectionOK  %+v", 200, o.Payload)
}
...
func (o *SvmPeerDeleteCollectionAccepted) Error() string {
	return fmt.Sprintf("[DELETE /svm/peers][%d] svmPeerDeleteCollectionAccepted  %+v", 202, o.Payload)
}
...
func (o *SvmPeerDeleteCollectionDefault) Error() string {
	return fmt.Sprintf("[DELETE /svm/peers][%d] svm_peer_delete_collection default  %+v", o._statusCode, o.Payload)
}
