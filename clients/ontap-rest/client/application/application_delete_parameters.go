...
func (o *ApplicationDeleteParams) WithDeleteData(deleteData *string) *ApplicationDeleteParams {
	o.SetDeleteData(deleteData)
	return o
}

// SetDeleteData adds the deleteData to the application delete params
func (o *ApplicationDeleteParams) SetDeleteData(deleteData *string) {
	o.DeleteData = deleteData
}

// WithReturnTimeout adds the returnTimeout to the application delete params
func (o *ApplicationDeleteParams) WithReturnTimeout(returnTimeout *string) *ApplicationDeleteParams {
	o.SetReturnTimeout(returnTimeout)
	return o
}

// SetReturnTimeout adds the returnTimeout to the application delete params
func (o *ApplicationDeleteParams) SetReturnTimeout(returnTimeout *string) {
