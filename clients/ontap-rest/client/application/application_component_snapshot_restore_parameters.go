...
func (o *ApplicationComponentSnapshotRestoreParams) WithReturnRecords(returnRecords *string) *ApplicationComponentSnapshotRestoreParams {
	o.SetReturnRecords(returnRecords)
	return o
}

// SetReturnRecords adds the returnRecords to the application component snapshot restore params
func (o *ApplicationComponentSnapshotRestoreParams) SetReturnRecords(returnRecords *string) {
	o.ReturnRecords = returnRecords
}

// WithReturnTimeout adds the returnTimeout to the application component snapshot restore params
func (o *ApplicationComponentSnapshotRestoreParams) WithReturnTimeout(returnTimeout *string) *ApplicationComponentSnapshotRestoreParams {
	o.SetReturnTimeout(returnTimeout)
	return o
}

// SetReturnTimeout adds the returnTimeout to the application component snapshot restore params
func (o *ApplicationComponentSnapshotRestoreParams) SetReturnTimeout(returnTimeout *string) {
