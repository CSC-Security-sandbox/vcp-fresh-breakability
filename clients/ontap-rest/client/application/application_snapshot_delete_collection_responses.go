...
func (o *ApplicationSnapshotDeleteCollectionOK) Error() string {
	return fmt.Sprintf("[DELETE /application/applications/{application.uuid}/snapshots][%d] applicationSnapshotDeleteCollectionOK  %+v", 200, o.Payload)
}
...
func (o *ApplicationSnapshotDeleteCollectionAccepted) Error() string {
	return fmt.Sprintf("[DELETE /application/applications/{application.uuid}/snapshots][%d] applicationSnapshotDeleteCollectionAccepted  %+v", 202, o.Payload)
}
...
func (o *ApplicationSnapshotDeleteCollectionDefault) Error() string {
	return fmt.Sprintf("[DELETE /application/applications/{application.uuid}/snapshots][%d] application_snapshot_delete_collection default  %+v", o._statusCode, o.Payload)
}
