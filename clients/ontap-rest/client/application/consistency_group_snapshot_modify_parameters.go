...
type ConsistencyGroupSnapshotModifyParams struct {
	...
	*/
	...
	/* SnaplockExpiryTime.
	   ...
	   SnapLock expiry time to be modified.
...
func (o *ConsistencyGroupSnapshotModifyParams) WithReturnTimeout(returnTimeout *string) *ConsistencyGroupSnapshotModifyParams {
	o.SetReturnTimeout(returnTimeout)
	return o
}

// SetReturnTimeout adds the returnTimeout to the consistency group snapshot modify params
func (o *ConsistencyGroupSnapshotModifyParams) SetReturnTimeout(returnTimeout *string) {
	o.ReturnTimeout = returnTimeout
}

// WithSnaplockExpiryTime adds the snaplockExpiryTime to the consistency group snapshot modify params
func (o *ConsistencyGroupSnapshotModifyParams) WithSnaplockExpiryTime(snaplockExpiryTime *string) *ConsistencyGroupSnapshotModifyParams {
	o.SetSnaplockExpiryTime(snaplockExpiryTime)
	return o
}

// SetSnaplockExpiryTime adds the snaplockExpiryTime to the consistency group snapshot modify params
func (o *ConsistencyGroupSnapshotModifyParams) SetSnaplockExpiryTime(snaplockExpiryTime *string) {
