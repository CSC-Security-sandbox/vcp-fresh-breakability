...
func (o *ConsistencyGroupSnapshotModifyCollectionDefault) Error() string {
	return fmt.Sprintf("[PATCH /application/consistency-groups/{consistency_group.uuid}/snapshots][%d] consistency_group_snapshot_modify_collection default  %+v", o._statusCode, o.Payload)
}
		...
		if o.MissingLuns[i] != nil {
			if err := o.MissingLuns[i].Validate(formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					...
					return ce.ValidateName("info" + "." + "missing_luns" + "." + strconv.Itoa(i))
				}
				return err
			}
		}
		...
		if o.MissingNamespaces[i] != nil {
			if err := o.MissingNamespaces[i].Validate(formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					...
					return ce.ValidateName("info" + "." + "missing_namespaces" + "." + strconv.Itoa(i))
				}
				return err
			}
		}
		...
		if o.MissingVolumes[i] != nil {
			if err := o.MissingVolumes[i].Validate(formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					...
					return ce.ValidateName("info" + "." + "missing_volumes" + "." + strconv.Itoa(i))
				}
				return err
			}
		}
		...
		if o.SnapshotVolumes[i] != nil {
			if err := o.SnapshotVolumes[i].Validate(formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					...
					return ce.ValidateName("info" + "." + "snapshot_volumes" + "." + strconv.Itoa(i))
				}
				return err
			}
		}
...
func (o *ConsistencyGroupSnapshotModifyCollectionBody) validateSvmDr(formats strfmt.Registry) error {
	...
	if o.SvmDr != nil {
		if err := o.SvmDr.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("info" + "." + "svm_dr")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("info" + "." + "svm_dr")
			}
			return err
		}
	}
...
func (o *ConsistencyGroupSnapshotModifyCollectionBody) contextValidateSize(ctx context.Context, formats strfmt.Registry) error {
...
func (o *ConsistencyGroupSnapshotModifyCollectionBody) contextValidateSvmDr(ctx context.Context, formats strfmt.Registry) error {
