...
func (o *ConsistencyGroupSnapshotDeleteParams) WithReturnTimeout(returnTimeout *string) *ConsistencyGroupSnapshotDeleteParams {
	o.SetReturnTimeout(returnTimeout)
	return o
}

// SetReturnTimeout adds the returnTimeout to the consistency group snapshot delete params
func (o *ConsistencyGroupSnapshotDeleteParams) SetReturnTimeout(returnTimeout *string) {
