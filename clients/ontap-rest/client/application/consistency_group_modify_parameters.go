...
func (o *ConsistencyGroupModifyParams) WithReturnTimeout(returnTimeout *string) *ConsistencyGroupModifyParams {
	o.SetReturnTimeout(returnTimeout)
	return o
}

// SetReturnTimeout adds the returnTimeout to the consistency group modify params
func (o *ConsistencyGroupModifyParams) SetReturnTimeout(returnTimeout *string) {
