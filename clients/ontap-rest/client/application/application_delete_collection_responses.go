...
func (o *ApplicationDeleteCollectionOK) Error() string {
	return fmt.Sprintf("[DELETE /application/applications][%d] applicationDeleteCollectionOK  %+v", 200, o.Payload)
}
...
func (o *ApplicationDeleteCollectionAccepted) Error() string {
	return fmt.Sprintf("[DELETE /application/applications][%d] applicationDeleteCollectionAccepted  %+v", 202, o.Payload)
}
...
func (o *ApplicationDeleteCollectionDefault) Error() string {
	return fmt.Sprintf("[DELETE /application/applications][%d] application_delete_collection default  %+v", o._statusCode, o.Payload)
}
