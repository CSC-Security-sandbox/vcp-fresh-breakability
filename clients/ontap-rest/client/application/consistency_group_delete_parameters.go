...
func (o *ConsistencyGroupDeleteParams) WithDeleteData(deleteData *string) *ConsistencyGroupDeleteParams {
	o.SetDeleteData(deleteData)
	return o
}

// SetDeleteData adds the deleteData to the consistency group delete params
func (o *ConsistencyGroupDeleteParams) SetDeleteData(deleteData *string) {
	o.DeleteData = deleteData
}

// WithReturnTimeout adds the returnTimeout to the consistency group delete params
func (o *ConsistencyGroupDeleteParams) WithReturnTimeout(returnTimeout *string) *ConsistencyGroupDeleteParams {
	o.SetReturnTimeout(returnTimeout)
	return o
}

// SetReturnTimeout adds the returnTimeout to the consistency group delete params
func (o *ConsistencyGroupDeleteParams) SetReturnTimeout(returnTimeout *string) {
