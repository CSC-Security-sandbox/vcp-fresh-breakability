...
func (o *ConsistencyGroupSnapshotGetParams) WithIsPartial(isPartial *string) *ConsistencyGroupSnapshotGetParams {
	o.SetIsPartial(isPartial)
	return o
}

// SetIsPartial adds the isPartial to the consistency group snapshot get params
func (o *ConsistencyGroupSnapshotGetParams) SetIsPartial(isPartial *string) {
...
func (o *ConsistencyGroupSnapshotGetParams) WithMaxRecords(maxRecords *string) *ConsistencyGroupSnapshotGetParams {
	o.SetMaxRecords(maxRecords)
	return o
}

// SetMaxRecords adds the maxRecords to the consistency group snapshot get params
func (o *ConsistencyGroupSnapshotGetParams) SetMaxRecords(maxRecords *string) {
...
func (o *ConsistencyGroupSnapshotGetParams) WithReclaimableSpace(reclaimableSpace *string) *ConsistencyGroupSnapshotGetParams {
...
func (o *ConsistencyGroupSnapshotGetParams) SetReclaimableSpace(reclaimableSpace *string) {
	o.ReclaimableSpace = reclaimableSpace
}

// WithRestoreSize adds the restoreSize to the consistency group snapshot get params
func (o *ConsistencyGroupSnapshotGetParams) WithRestoreSize(restoreSize *string) *ConsistencyGroupSnapshotGetParams {
	o.SetRestoreSize(restoreSize)
	return o
}

// SetRestoreSize adds the restoreSize to the consistency group snapshot get params
func (o *ConsistencyGroupSnapshotGetParams) SetRestoreSize(restoreSize *string) {
	o.RestoreSize = restoreSize
}

// WithReturnRecords adds the returnRecords to the consistency group snapshot get params
func (o *ConsistencyGroupSnapshotGetParams) WithReturnRecords(returnRecords *string) *ConsistencyGroupSnapshotGetParams {
	o.SetReturnRecords(returnRecords)
	return o
}

// SetReturnRecords adds the returnRecords to the consistency group snapshot get params
func (o *ConsistencyGroupSnapshotGetParams) SetReturnRecords(returnRecords *string) {
	o.ReturnRecords = returnRecords
}

// WithReturnTimeout adds the returnTimeout to the consistency group snapshot get params
func (o *ConsistencyGroupSnapshotGetParams) WithReturnTimeout(returnTimeout *string) *ConsistencyGroupSnapshotGetParams {
	o.SetReturnTimeout(returnTimeout)
	return o
}

// SetReturnTimeout adds the returnTimeout to the consistency group snapshot get params
func (o *ConsistencyGroupSnapshotGetParams) SetReturnTimeout(returnTimeout *string) {
	o.ReturnTimeout = returnTimeout
}

// WithSize adds the size to the consistency group snapshot get params
func (o *ConsistencyGroupSnapshotGetParams) WithSize(size *string) *ConsistencyGroupSnapshotGetParams {
	o.SetSize(size)
	return o
}

// SetSize adds the size to the consistency group snapshot get params
func (o *ConsistencyGroupSnapshotGetParams) SetSize(size *string) {
	o.Size = size
}

// WithSnaplockExpired adds the snaplockExpired to the consistency group snapshot get params
func (o *ConsistencyGroupSnapshotGetParams) WithSnaplockExpired(snaplockExpired *string) *ConsistencyGroupSnapshotGetParams {
...
func (o *ConsistencyGroupSnapshotGetParams) SetSnaplockExpired(snaplockExpired *string) {
...
func (o *ConsistencyGroupSnapshotGetParams) WithWriteFence(writeFence *string) *ConsistencyGroupSnapshotGetParams {
	o.SetWriteFence(writeFence)
	return o
}

// SetWriteFence adds the writeFence to the consistency group snapshot get params
func (o *ConsistencyGroupSnapshotGetParams) SetWriteFence(writeFence *string) {
