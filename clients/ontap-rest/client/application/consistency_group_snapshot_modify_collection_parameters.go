...
func (o *ConsistencyGroupSnapshotModifyCollectionParams) WithContinueOnFailure(continueOnFailure *string) *ConsistencyGroupSnapshotModifyCollectionParams {
	o.SetContinueOnFailure(continueOnFailure)
	return o
}

// SetContinueOnFailure adds the continueOnFailure to the consistency group snapshot modify collection params
func (o *ConsistencyGroupSnapshotModifyCollectionParams) SetContinueOnFailure(continueOnFailure *string) {
...
func (o *ConsistencyGroupSnapshotModifyCollectionParams) WithIsPartial(isPartial *string) *ConsistencyGroupSnapshotModifyCollectionParams {
	o.SetIsPartial(isPartial)
	return o
}

// SetIsPartial adds the isPartial to the consistency group snapshot modify collection params
func (o *ConsistencyGroupSnapshotModifyCollectionParams) SetIsPartial(isPartial *string) {
...
func (o *ConsistencyGroupSnapshotModifyCollectionParams) WithReclaimableSpace(reclaimableSpace *string) *ConsistencyGroupSnapshotModifyCollectionParams {
...
func (o *ConsistencyGroupSnapshotModifyCollectionParams) SetReclaimableSpace(reclaimableSpace *string) {
...
func (o *ConsistencyGroupSnapshotModifyCollectionParams) WithRestoreSize(restoreSize *string) *ConsistencyGroupSnapshotModifyCollectionParams {
...
func (o *ConsistencyGroupSnapshotModifyCollectionParams) SetRestoreSize(restoreSize *string) {
...
func (o *ConsistencyGroupSnapshotModifyCollectionParams) WithReturnRecords(returnRecords *string) *ConsistencyGroupSnapshotModifyCollectionParams {
	o.SetReturnRecords(returnRecords)
	return o
}

// SetReturnRecords adds the returnRecords to the consistency group snapshot modify collection params
func (o *ConsistencyGroupSnapshotModifyCollectionParams) SetReturnRecords(returnRecords *string) {
	o.ReturnRecords = returnRecords
}

// WithReturnTimeout adds the returnTimeout to the consistency group snapshot modify collection params
func (o *ConsistencyGroupSnapshotModifyCollectionParams) WithReturnTimeout(returnTimeout *string) *ConsistencyGroupSnapshotModifyCollectionParams {
	o.SetReturnTimeout(returnTimeout)
	return o
}

// SetReturnTimeout adds the returnTimeout to the consistency group snapshot modify collection params
func (o *ConsistencyGroupSnapshotModifyCollectionParams) SetReturnTimeout(returnTimeout *string) {
	o.ReturnTimeout = returnTimeout
}

// WithSerialRecords adds the serialRecords to the consistency group snapshot modify collection params
func (o *ConsistencyGroupSnapshotModifyCollectionParams) WithSerialRecords(serialRecords *string) *ConsistencyGroupSnapshotModifyCollectionParams {
	o.SetSerialRecords(serialRecords)
	return o
}

// SetSerialRecords adds the serialRecords to the consistency group snapshot modify collection params
func (o *ConsistencyGroupSnapshotModifyCollectionParams) SetSerialRecords(serialRecords *string) {
	o.SerialRecords = serialRecords
}

// WithSize adds the size to the consistency group snapshot modify collection params
func (o *ConsistencyGroupSnapshotModifyCollectionParams) WithSize(size *string) *ConsistencyGroupSnapshotModifyCollectionParams {
	o.SetSize(size)
	return o
}

// SetSize adds the size to the consistency group snapshot modify collection params
func (o *ConsistencyGroupSnapshotModifyCollectionParams) SetSize(size *string) {
	o.Size = size
}

// WithSnaplockExpired adds the snaplockExpired to the consistency group snapshot modify collection params
func (o *ConsistencyGroupSnapshotModifyCollectionParams) WithSnaplockExpired(snaplockExpired *string) *ConsistencyGroupSnapshotModifyCollectionParams {
...
func (o *ConsistencyGroupSnapshotModifyCollectionParams) SetSnaplockExpired(snaplockExpired *string) {
...
func (o *ConsistencyGroupSnapshotModifyCollectionParams) WithWriteFence(writeFence *string) *ConsistencyGroupSnapshotModifyCollectionParams {
	o.SetWriteFence(writeFence)
	return o
}

// SetWriteFence adds the writeFence to the consistency group snapshot modify collection params
func (o *ConsistencyGroupSnapshotModifyCollectionParams) SetWriteFence(writeFence *string) {
...
func (o *ConsistencyGroupSnapshotModifyCollectionParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
	...
	if o.RestoreSize != nil {
		...
		var qrRestoreSize string

		if o.RestoreSize != nil {
			qrRestoreSize = *o.RestoreSize
		}
		qRestoreSize := qrRestoreSize
		if qRestoreSize != "" {
	...
	if o.WriteFence != nil {
		...
		var qrWriteFence string

		if o.WriteFence != nil {
			qrWriteFence = *o.WriteFence
		}
		qWriteFence := qrWriteFence
		if qWriteFence != "" {
