...
func (o *ConsistencyGroupModifyCollectionAccepted) Error() string {
	return fmt.Sprintf("[PATCH /application/consistency-groups][%d] consistencyGroupModifyCollectionAccepted  %+v", 202, o.Payload)
}
...
| 53412058 | Failed to map or unmap because consistency group consists of both 'luns' and 'namespaces'. |
...
func (o *ConsistencyGroupModifyCollectionDefault) Error() string {
	return fmt.Sprintf("[PATCH /application/consistency-groups][%d] consistency_group_modify_collection default  %+v", o._statusCode, o.Payload)
}
	...
	if o.Application != nil {
		if err := o.Application.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("info" + "." + "application")
			}
			return err
		}
	}
		...
		if o.ConsistencyGroups[i] != nil {
			if err := o.ConsistencyGroups[i].Validate(formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					...
					return ce.ValidateName("info" + "." + "consistency_groups" + "." + strconv.Itoa(i))
				}
				return err
			}
		}
		...
		if o.Luns[i] != nil {
			if err := o.Luns[i].Validate(formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					...
					return ce.ValidateName("info" + "." + "luns" + "." + strconv.Itoa(i))
				}
				return err
			}
		}
	...
	if o.MapTo != nil {
		if err := o.MapTo.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("info" + "." + "map_to")
			}
			return err
		}
	}
		...
		if o.Namespaces[i] != nil {
			if err := o.Namespaces[i].Validate(formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					...
					return ce.ValidateName("info" + "." + "namespaces" + "." + strconv.Itoa(i))
				}
				return err
			}
		}
	...
	if o.ParentConsistencyGroup != nil {
		if err := o.ParentConsistencyGroup.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("info" + "." + "parent_consistency_group")
			}
			return err
		}
	}
	...
	if o.Qos != nil {
		if err := o.Qos.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("info" + "." + "qos")
			}
			return err
		}
	}
		...
		if o.ReplicationRelationships[i] != nil {
			if err := o.ReplicationRelationships[i].Validate(formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					...
					return ce.ValidateName("info" + "." + "replication_relationships" + "." + strconv.Itoa(i))
				}
				return err
			}
		}
	...
	if o.RestoreTo != nil {
		if err := o.RestoreTo.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("info" + "." + "restore_to")
			}
			return err
		}
	}
	...
	if o.Snaplock != nil {
		if err := o.Snaplock.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("info" + "." + "snaplock")
			}
			return err
		}
	}
	...
	if o.SnapshotPolicy != nil {
		if err := o.SnapshotPolicy.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("info" + "." + "snapshot_policy")
			}
			return err
		}
	}
...
func (o *ConsistencyGroupModifyCollectionBody) validateStorageAvailabilityZones(formats strfmt.Registry) error {
		...
		if o.StorageAvailabilityZones[i] != nil {
			if err := o.StorageAvailabilityZones[i].Validate(formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					...
					return ce.ValidateName("info" + "." + "storage_availability_zones" + "." + strconv.Itoa(i))
				}
				return err
			}
		}
	...
	if o.Tiering != nil {
		if err := o.Tiering.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("info" + "." + "tiering")
			}
			return err
		}
	}
	...
	if o.UnmapFrom != nil {
		if err := o.UnmapFrom.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("info" + "." + "unmap_from")
			}
			return err
		}
	}
		...
		if o.Volumes[i] != nil {
			if err := o.Volumes[i].Validate(formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					...
					return ce.ValidateName("info" + "." + "volumes" + "." + strconv.Itoa(i))
				}
				return err
			}
		}
...
func (o *ConsistencyGroupModifyCollectionBody) contextValidateStorageAvailabilityZones(ctx context.Context, formats strfmt.Registry) error {
...
func (o *ConsistencyGroupModifyCollectionParamsBodyConsistencyGroupsItems0ProvisioningOptions) validateStorageAvailabilityZones(formats strfmt.Registry) error {
	if swag.IsZero(o.StorageAvailabilityZones) { // not required
		return nil
	}
...
func (o *ConsistencyGroupModifyCollectionParamsBodyConsistencyGroupsItems0ProvisioningOptions) contextValidateStorageAvailabilityZones(ctx context.Context, formats strfmt.Registry) error {
...
type ConsistencyGroupModifyCollectionParamsBodyConsistencyGroupsItems0RestoreToSnapshot struct {
	...
	// lun
	Lun *ConsistencyGroupModifyCollectionParamsBodyConsistencyGroupsItems0RestoreToSnapshotLun `json:"lun,omitempty"`

	// The name of the consistency group's snapshot to restore to.
	Name *string `json:"name,omitempty"`

	// namespace
	Namespace *ConsistencyGroupModifyCollectionParamsBodyConsistencyGroupsItems0RestoreToSnapshotNamespace `json:"namespace,omitempty"`
...
func (o *ConsistencyGroupModifyCollectionParamsBodyConsistencyGroupsItems0RestoreToSnapshot) validateLun(formats strfmt.Registry) error {
...
func (o *ConsistencyGroupModifyCollectionParamsBodyConsistencyGroupsItems0RestoreToSnapshot) validateNamespace(formats strfmt.Registry) error {
...
// ContextValidate validate this consistency group modify collection params body consistency groups items0 restore to snapshot based on the context it is used
...
func (o *ConsistencyGroupModifyCollectionParamsBodyConsistencyGroupsItems0RestoreToSnapshot) contextValidateLun(ctx context.Context, formats strfmt.Registry) error {
...
func (o *ConsistencyGroupModifyCollectionParamsBodyConsistencyGroupsItems0RestoreToSnapshot) contextValidateNamespace(ctx context.Context, formats strfmt.Registry) error {
...
/*
ConsistencyGroupModifyCollectionParamsBodyConsistencyGroupsItems0RestoreToSnapshotLun consistency group modify collection params body consistency groups items0 restore to snapshot lun
swagger:model ConsistencyGroupModifyCollectionParamsBodyConsistencyGroupsItems0RestoreToSnapshotLun
*/
type ConsistencyGroupModifyCollectionParamsBodyConsistencyGroupsItems0RestoreToSnapshotLun struct {
...
// Validate validates this consistency group modify collection params body consistency groups items0 restore to snapshot lun
func (o *ConsistencyGroupModifyCollectionParamsBodyConsistencyGroupsItems0RestoreToSnapshotLun) Validate(formats strfmt.Registry) error {
	return nil
}

// ContextValidate validates this consistency group modify collection params body consistency groups items0 restore to snapshot lun based on context it is used
func (o *ConsistencyGroupModifyCollectionParamsBodyConsistencyGroupsItems0RestoreToSnapshotLun) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (o *ConsistencyGroupModifyCollectionParamsBodyConsistencyGroupsItems0RestoreToSnapshotLun) MarshalBinary() ([]byte, error) {
	if o == nil {
		return nil, nil
	}
	return swag.WriteJSON(o)
...
// UnmarshalBinary interface implementation
func (o *ConsistencyGroupModifyCollectionParamsBodyConsistencyGroupsItems0RestoreToSnapshotLun) UnmarshalBinary(b []byte) error {
	var res ConsistencyGroupModifyCollectionParamsBodyConsistencyGroupsItems0RestoreToSnapshotLun
	if err := swag.ReadJSON(b, &res); err != nil {
		return err
	}
	*o = res
...
/*
ConsistencyGroupModifyCollectionParamsBodyConsistencyGroupsItems0RestoreToSnapshotNamespace consistency group modify collection params body consistency groups items0 restore to snapshot namespace
swagger:model ConsistencyGroupModifyCollectionParamsBodyConsistencyGroupsItems0RestoreToSnapshotNamespace
*/
type ConsistencyGroupModifyCollectionParamsBodyConsistencyGroupsItems0RestoreToSnapshotNamespace struct {
...
// Validate validates this consistency group modify collection params body consistency groups items0 restore to snapshot namespace
func (o *ConsistencyGroupModifyCollectionParamsBodyConsistencyGroupsItems0RestoreToSnapshotNamespace) Validate(formats strfmt.Registry) error {
	return nil
}

// ContextValidate validates this consistency group modify collection params body consistency groups items0 restore to snapshot namespace based on context it is used
func (o *ConsistencyGroupModifyCollectionParamsBodyConsistencyGroupsItems0RestoreToSnapshotNamespace) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (o *ConsistencyGroupModifyCollectionParamsBodyConsistencyGroupsItems0RestoreToSnapshotNamespace) MarshalBinary() ([]byte, error) {
	if o == nil {
		return nil, nil
	}
	return swag.WriteJSON(o)
...
// UnmarshalBinary interface implementation
func (o *ConsistencyGroupModifyCollectionParamsBodyConsistencyGroupsItems0RestoreToSnapshotNamespace) UnmarshalBinary(b []byte) error {
	var res ConsistencyGroupModifyCollectionParamsBodyConsistencyGroupsItems0RestoreToSnapshotNamespace
	if err := swag.ReadJSON(b, &res); err != nil {
		return err
	}
	*o = res
...
func (o *ConsistencyGroupModifyCollectionParamsBodyRecordsItems0ConsistencyGroupsItems0ProvisioningOptions) validateStorageAvailabilityZones(formats strfmt.Registry) error {
	if swag.IsZero(o.StorageAvailabilityZones) { // not required
		return nil
	}
...
func (o *ConsistencyGroupModifyCollectionParamsBodyRecordsItems0ConsistencyGroupsItems0ProvisioningOptions) contextValidateStorageAvailabilityZones(ctx context.Context, formats strfmt.Registry) error {
...
type ConsistencyGroupModifyCollectionParamsBodyRecordsItems0ConsistencyGroupsItems0RestoreToSnapshot struct {
	...
	// lun
	Lun *ConsistencyGroupModifyCollectionParamsBodyRecordsItems0ConsistencyGroupsItems0RestoreToSnapshotLun `json:"lun,omitempty"`

	// The name of the consistency group's snapshot to restore to.
	Name *string `json:"name,omitempty"`

	// namespace
	Namespace *ConsistencyGroupModifyCollectionParamsBodyRecordsItems0ConsistencyGroupsItems0RestoreToSnapshotNamespace `json:"namespace,omitempty"`
...
func (o *ConsistencyGroupModifyCollectionParamsBodyRecordsItems0ConsistencyGroupsItems0RestoreToSnapshot) validateLun(formats strfmt.Registry) error {
	if swag.IsZero(o.Lun) { // not required
		return nil
	}
...
func (o *ConsistencyGroupModifyCollectionParamsBodyRecordsItems0ConsistencyGroupsItems0RestoreToSnapshot) validateNamespace(formats strfmt.Registry) error {
	if swag.IsZero(o.Namespace) { // not required
		return nil
	}
...
// ContextValidate validate this consistency group modify collection params body records items0 consistency groups items0 restore to snapshot based on the context it is used
...
func (o *ConsistencyGroupModifyCollectionParamsBodyRecordsItems0ConsistencyGroupsItems0RestoreToSnapshot) contextValidateLun(ctx context.Context, formats strfmt.Registry) error {
...
func (o *ConsistencyGroupModifyCollectionParamsBodyRecordsItems0ConsistencyGroupsItems0RestoreToSnapshot) contextValidateNamespace(ctx context.Context, formats strfmt.Registry) error {
...
/*
ConsistencyGroupModifyCollectionParamsBodyRecordsItems0ConsistencyGroupsItems0RestoreToSnapshotLun consistency group modify collection params body records items0 consistency groups items0 restore to snapshot lun
swagger:model ConsistencyGroupModifyCollectionParamsBodyRecordsItems0ConsistencyGroupsItems0RestoreToSnapshotLun
*/
type ConsistencyGroupModifyCollectionParamsBodyRecordsItems0ConsistencyGroupsItems0RestoreToSnapshotLun struct {
...
// Validate validates this consistency group modify collection params body records items0 consistency groups items0 restore to snapshot lun
func (o *ConsistencyGroupModifyCollectionParamsBodyRecordsItems0ConsistencyGroupsItems0RestoreToSnapshotLun) Validate(formats strfmt.Registry) error {
	return nil
}

// ContextValidate validates this consistency group modify collection params body records items0 consistency groups items0 restore to snapshot lun based on context it is used
func (o *ConsistencyGroupModifyCollectionParamsBodyRecordsItems0ConsistencyGroupsItems0RestoreToSnapshotLun) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (o *ConsistencyGroupModifyCollectionParamsBodyRecordsItems0ConsistencyGroupsItems0RestoreToSnapshotLun) MarshalBinary() ([]byte, error) {
	if o == nil {
		return nil, nil
	}
	return swag.WriteJSON(o)
...
// UnmarshalBinary interface implementation
func (o *ConsistencyGroupModifyCollectionParamsBodyRecordsItems0ConsistencyGroupsItems0RestoreToSnapshotLun) UnmarshalBinary(b []byte) error {
	var res ConsistencyGroupModifyCollectionParamsBodyRecordsItems0ConsistencyGroupsItems0RestoreToSnapshotLun
	if err := swag.ReadJSON(b, &res); err != nil {
		return err
	}
	*o = res
...
/*
ConsistencyGroupModifyCollectionParamsBodyRecordsItems0ConsistencyGroupsItems0RestoreToSnapshotNamespace consistency group modify collection params body records items0 consistency groups items0 restore to snapshot namespace
swagger:model ConsistencyGroupModifyCollectionParamsBodyRecordsItems0ConsistencyGroupsItems0RestoreToSnapshotNamespace
*/
type ConsistencyGroupModifyCollectionParamsBodyRecordsItems0ConsistencyGroupsItems0RestoreToSnapshotNamespace struct {
...
// Validate validates this consistency group modify collection params body records items0 consistency groups items0 restore to snapshot namespace
func (o *ConsistencyGroupModifyCollectionParamsBodyRecordsItems0ConsistencyGroupsItems0RestoreToSnapshotNamespace) Validate(formats strfmt.Registry) error {
	return nil
}

// ContextValidate validates this consistency group modify collection params body records items0 consistency groups items0 restore to snapshot namespace based on context it is used
func (o *ConsistencyGroupModifyCollectionParamsBodyRecordsItems0ConsistencyGroupsItems0RestoreToSnapshotNamespace) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (o *ConsistencyGroupModifyCollectionParamsBodyRecordsItems0ConsistencyGroupsItems0RestoreToSnapshotNamespace) MarshalBinary() ([]byte, error) {
	if o == nil {
		return nil, nil
	}
	return swag.WriteJSON(o)
...
// UnmarshalBinary interface implementation
func (o *ConsistencyGroupModifyCollectionParamsBodyRecordsItems0ConsistencyGroupsItems0RestoreToSnapshotNamespace) UnmarshalBinary(b []byte) error {
	var res ConsistencyGroupModifyCollectionParamsBodyRecordsItems0ConsistencyGroupsItems0RestoreToSnapshotNamespace
	if err := swag.ReadJSON(b, &res); err != nil {
		return err
	}
	*o = res
