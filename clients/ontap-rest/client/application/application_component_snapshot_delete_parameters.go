...
func (o *ApplicationComponentSnapshotDeleteParams) WithReturnTimeout(returnTimeout *string) *ApplicationComponentSnapshotDeleteParams {
	o.SetReturnTimeout(returnTimeout)
	return o
}

// SetReturnTimeout adds the returnTimeout to the application component snapshot delete params
func (o *ApplicationComponentSnapshotDeleteParams) SetReturnTimeout(returnTimeout *string) {
