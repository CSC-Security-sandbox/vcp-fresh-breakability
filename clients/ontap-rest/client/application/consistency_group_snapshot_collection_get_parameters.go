...
func (o *ConsistencyGroupSnapshotCollectionGetParams) WithIsPartial(isPartial *string) *ConsistencyGroupSnapshotCollectionGetParams {
	o.SetIsPartial(isPartial)
	return o
}

// SetIsPartial adds the isPartial to the consistency group snapshot collection get params
func (o *ConsistencyGroupSnapshotCollectionGetParams) SetIsPartial(isPartial *string) {
...
func (o *ConsistencyGroupSnapshotCollectionGetParams) WithMaxRecords(maxRecords *string) *ConsistencyGroupSnapshotCollectionGetParams {
	o.SetMaxRecords(maxRecords)
	return o
}

// SetMaxRecords adds the maxRecords to the consistency group snapshot collection get params
func (o *ConsistencyGroupSnapshotCollectionGetParams) SetMaxRecords(maxRecords *string) {
...
func (o *ConsistencyGroupSnapshotCollectionGetParams) WithReclaimableSpace(reclaimableSpace *string) *ConsistencyGroupSnapshotCollectionGetParams {
...
func (o *ConsistencyGroupSnapshotCollectionGetParams) SetReclaimableSpace(reclaimableSpace *string) {
...
func (o *ConsistencyGroupSnapshotCollectionGetParams) WithRestoreSize(restoreSize *string) *ConsistencyGroupSnapshotCollectionGetParams {
	o.SetRestoreSize(restoreSize)
	return o
}

// SetRestoreSize adds the restoreSize to the consistency group snapshot collection get params
func (o *ConsistencyGroupSnapshotCollectionGetParams) SetRestoreSize(restoreSize *string) {
...
func (o *ConsistencyGroupSnapshotCollectionGetParams) WithReturnRecords(returnRecords *string) *ConsistencyGroupSnapshotCollectionGetParams {
	o.SetReturnRecords(returnRecords)
	return o
}

// SetReturnRecords adds the returnRecords to the consistency group snapshot collection get params
func (o *ConsistencyGroupSnapshotCollectionGetParams) SetReturnRecords(returnRecords *string) {
	o.ReturnRecords = returnRecords
}

// WithReturnTimeout adds the returnTimeout to the consistency group snapshot collection get params
func (o *ConsistencyGroupSnapshotCollectionGetParams) WithReturnTimeout(returnTimeout *string) *ConsistencyGroupSnapshotCollectionGetParams {
	o.SetReturnTimeout(returnTimeout)
	return o
}

// SetReturnTimeout adds the returnTimeout to the consistency group snapshot collection get params
func (o *ConsistencyGroupSnapshotCollectionGetParams) SetReturnTimeout(returnTimeout *string) {
	o.ReturnTimeout = returnTimeout
}

// WithSize adds the size to the consistency group snapshot collection get params
func (o *ConsistencyGroupSnapshotCollectionGetParams) WithSize(size *string) *ConsistencyGroupSnapshotCollectionGetParams {
	o.SetSize(size)
	return o
}

// SetSize adds the size to the consistency group snapshot collection get params
func (o *ConsistencyGroupSnapshotCollectionGetParams) SetSize(size *string) {
	o.Size = size
}

// WithSnaplockExpired adds the snaplockExpired to the consistency group snapshot collection get params
func (o *ConsistencyGroupSnapshotCollectionGetParams) WithSnaplockExpired(snaplockExpired *string) *ConsistencyGroupSnapshotCollectionGetParams {
...
func (o *ConsistencyGroupSnapshotCollectionGetParams) SetSnaplockExpired(snaplockExpired *string) {
...
func (o *ConsistencyGroupSnapshotCollectionGetParams) WithWriteFence(writeFence *string) *ConsistencyGroupSnapshotCollectionGetParams {
	o.SetWriteFence(writeFence)
	return o
}

// SetWriteFence adds the writeFence to the consistency group snapshot collection get params
func (o *ConsistencyGroupSnapshotCollectionGetParams) SetWriteFence(writeFence *string) {
