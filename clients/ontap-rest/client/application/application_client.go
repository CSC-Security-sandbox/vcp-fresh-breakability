...
type ClientService interface {
	...
	CrossClusterSvmApplicationCollectionGet(params *CrossClusterSvmApplicationCollectionGetParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*CrossClusterSvmApplicationCollectionGetOK, error)
...
* POST is not supported for ASA r2.
</personalities>
<personalities supports=aiml>
* Tiering is not supported on OAM clusters. Therefore, S3 bucket applications cannot be created with the capacity_tier value as true.
* S3 bucket applications cannot be created with the field exclude_aggregates set. To set exclude_aggregates, capacity_tier must be set to true which is unsupported on OAM clusters.
</personalities>
...
### Platform Specifics
* **Unified ONTAP**: Mapping or unmapping a consistency group from igroups or subsystems is not supported.
...
/*
	ContainerCreate Creates one or more of the following:
...
/*
CrossClusterSvmApplicationCollectionGet Cross cluster GET applications
*/
func (a *Client) CrossClusterSvmApplicationCollectionGet(params *CrossClusterSvmApplicationCollectionGetParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*CrossClusterSvmApplicationCollectionGetOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
		params = NewCrossClusterSvmApplicationCollectionGetParams()
	}
	op := &runtime.ClientOperation{
		ID:                 "cross_cluster_svm_application_collection_get",
		Method:             "GET",
		PathPattern:        "/svm/peers/{peer.uuid}/application/applications",
		ProducesMediaTypes: []string{"application/hal+json", "application/json"},
		ConsumesMediaTypes: []string{"application/hal+json", "application/json"},
		Schemes:            []string{"https"},
		Params:             params,
		Reader:             &CrossClusterSvmApplicationCollectionGetReader{formats: a.formats},
		AuthInfo:           authInfo,
		Context:            params.Context,
		Client:             params.HTTPClient,
	}
	...
	success, ok := result.(*CrossClusterSvmApplicationCollectionGetOK)
	if ok {
		return success, nil
	}
	// unexpected success response
	unexpectedSuccess := result.(*CrossClusterSvmApplicationCollectionGetDefault)
	return nil, runtime.NewAPIError("unexpected success response: content available as default response in error", unexpectedSuccess, unexpectedSuccess.Code())
}
