...
func (o *ApplicationComponentSnapshotDeleteCollectionOK) Error() string {
	return fmt.Sprintf("[DELETE /application/applications/{application.uuid}/components/{component.uuid}/snapshots][%d] applicationComponentSnapshotDeleteCollectionOK  %+v", 200, o.Payload)
}
...
func (o *ApplicationComponentSnapshotDeleteCollectionAccepted) Error() string {
	return fmt.Sprintf("[DELETE /application/applications/{application.uuid}/components/{component.uuid}/snapshots][%d] applicationComponentSnapshotDeleteCollectionAccepted  %+v", 202, o.Payload)
}
...
func (o *ApplicationComponentSnapshotDeleteCollectionDefault) Error() string {
	return fmt.Sprintf("[DELETE /application/applications/{application.uuid}/components/{component.uuid}/snapshots][%d] application_component_snapshot_delete_collection default  %+v", o._statusCode, o.Payload)
}
