...
func (o *ApplicationComponentSnapshotDeleteOK) Error() string {
	return fmt.Sprintf("[DELETE /application/applications/{application.uuid}/components/{component.uuid}/snapshots/{uuid}][%d] applicationComponentSnapshotDeleteOK  %+v", 200, o.Payload)
}
