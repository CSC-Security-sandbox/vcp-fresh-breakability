...
func (o *ConsistencyGroupMetricsCollectionGetOK) Error() string {
	return fmt.Sprintf("[GET /application/consistency-groups/{consistency_group.uuid}/metrics][%d] consistencyGroupMetricsCollectionGetOK  %+v", 200, o.Payload)
}
...
func (o *ConsistencyGroupMetricsCollectionGetDefault) Error() string {
	return fmt.Sprintf("[GET /application/consistency-groups/{consistency_group.uuid}/metrics][%d] consistency_group_metrics_collection_get default  %+v", o._statusCode, o.Payload)
}
