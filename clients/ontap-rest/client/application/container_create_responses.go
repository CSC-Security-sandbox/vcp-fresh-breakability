...
func (o *ContainerCreateCreated) Error() string {
	return fmt.Sprintf("[POST /application/containers][%d] containerCreateCreated  %+v", 201, o.Payload)
}
...
func (o *ContainerCreateAccepted) Error() string {
	return fmt.Sprintf("[POST /application/containers][%d] containerCreateAccepted  %+v", 202, o.Payload)
}
