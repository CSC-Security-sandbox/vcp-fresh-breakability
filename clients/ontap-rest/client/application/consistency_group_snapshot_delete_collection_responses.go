...
func (o *ConsistencyGroupSnapshotDeleteCollectionDefault) Error() string {
	return fmt.Sprintf("[DELETE /application/consistency-groups/{consistency_group.uuid}/snapshots][%d] consistency_group_snapshot_delete_collection default  %+v", o._statusCode, o.Payload)
}
...
type ConsistencyGroupSnapshotResponseInlineRecordsInlineArrayItem struct {
	...
	// svm dr
	SvmDr *ConsistencyGroupSnapshotResponseInlineRecordsInlineArrayItemInlineSvmDr `json:"svm_dr,omitempty"`
...
func (o *ConsistencyGroupSnapshotResponseInlineRecordsInlineArrayItem) Validate(formats strfmt.Registry) error {
	...
	if err := o.validateSvmDr(formats); err != nil {
		res = append(res, err)
	}
...
func (o *ConsistencyGroupSnapshotResponseInlineRecordsInlineArrayItem) validateSvmDr(formats strfmt.Registry) error {
	if swag.IsZero(o.SvmDr) { // not required
		return nil
	}

	if o.SvmDr != nil {
		if err := o.SvmDr.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
...
func (o *ConsistencyGroupSnapshotResponseInlineRecordsInlineArrayItem) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	...
	if err := o.contextValidateSvmDr(ctx, formats); err != nil {
		res = append(res, err)
	}
...
func (o *ConsistencyGroupSnapshotResponseInlineRecordsInlineArrayItem) contextValidateSize(ctx context.Context, formats strfmt.Registry) error {

	if err := validate.ReadOnly(ctx, "size", "body", o.Size); err != nil {
		return err
	}
...
func (o *ConsistencyGroupSnapshotResponseInlineRecordsInlineArrayItem) contextValidateSvmDr(ctx context.Context, formats strfmt.Registry) error {

	if o.SvmDr != nil {
		if err := o.SvmDr.ContextValidate(ctx, formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("svm_dr")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("svm_dr")
...
/*
ConsistencyGroupSnapshotResponseInlineRecordsInlineArrayItemInlineSvmDr SVM DR attributes.
swagger:model consistency_group_snapshot_response_inline_records_inline_array_item_inline_svm_dr
*/
type ConsistencyGroupSnapshotResponseInlineRecordsInlineArrayItemInlineSvmDr struct {

	// label
	Label *ConsistencyGroupSnapshotResponseInlineRecordsInlineArrayItemInlineSvmDrInlineLabel `json:"label,omitempty"`
}

// Validate validates this consistency group snapshot response inline records inline array item inline svm dr
func (o *ConsistencyGroupSnapshotResponseInlineRecordsInlineArrayItemInlineSvmDr) Validate(formats strfmt.Registry) error {
	var res []error
...
func (o *ConsistencyGroupSnapshotResponseInlineRecordsInlineArrayItemInlineSvmDr) validateLabel(formats strfmt.Registry) error {
	if swag.IsZero(o.Label) { // not required
		return nil
	}

	if o.Label != nil {
		if err := o.Label.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
...
// ContextValidate validate this consistency group snapshot response inline records inline array item inline svm dr based on the context it is used
func (o *ConsistencyGroupSnapshotResponseInlineRecordsInlineArrayItemInlineSvmDr) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error

	if err := o.contextValidateLabel(ctx, formats); err != nil {
		res = append(res, err)
	}
...
func (o *ConsistencyGroupSnapshotResponseInlineRecordsInlineArrayItemInlineSvmDr) contextValidateLabel(ctx context.Context, formats strfmt.Registry) error {

	if o.Label != nil {
		if err := o.Label.ContextValidate(ctx, formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("svm_dr" + "." + "label")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("svm_dr" + "." + "label")
...
// MarshalBinary interface implementation
func (o *ConsistencyGroupSnapshotResponseInlineRecordsInlineArrayItemInlineSvmDr) MarshalBinary() ([]byte, error) {
	if o == nil {
		return nil, nil
	}
	return swag.WriteJSON(o)
...
// UnmarshalBinary interface implementation
func (o *ConsistencyGroupSnapshotResponseInlineRecordsInlineArrayItemInlineSvmDr) UnmarshalBinary(b []byte) error {
	var res ConsistencyGroupSnapshotResponseInlineRecordsInlineArrayItemInlineSvmDr
	if err := swag.ReadJSON(b, &res); err != nil {
		return err
	}
	*o = res
...
/*
ConsistencyGroupSnapshotResponseInlineRecordsInlineArrayItemInlineSvmDrInlineLabel SVM DR label and attributes for the snapshot.
swagger:model consistency_group_snapshot_response_inline_records_inline_array_item_inline_svm_dr_inline_label
*/
type ConsistencyGroupSnapshotResponseInlineRecordsInlineArrayItemInlineSvmDrInlineLabel struct {
...
// Validate validates this consistency group snapshot response inline records inline array item inline svm dr inline label
func (o *ConsistencyGroupSnapshotResponseInlineRecordsInlineArrayItemInlineSvmDrInlineLabel) Validate(formats strfmt.Registry) error {
	return nil
}

// ContextValidate validates this consistency group snapshot response inline records inline array item inline svm dr inline label based on context it is used
func (o *ConsistencyGroupSnapshotResponseInlineRecordsInlineArrayItemInlineSvmDrInlineLabel) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (o *ConsistencyGroupSnapshotResponseInlineRecordsInlineArrayItemInlineSvmDrInlineLabel) MarshalBinary() ([]byte, error) {
	if o == nil {
		return nil, nil
	}
	return swag.WriteJSON(o)
...
// UnmarshalBinary interface implementation
func (o *ConsistencyGroupSnapshotResponseInlineRecordsInlineArrayItemInlineSvmDrInlineLabel) UnmarshalBinary(b []byte) error {
	var res ConsistencyGroupSnapshotResponseInlineRecordsInlineArrayItemInlineSvmDrInlineLabel
	if err := swag.ReadJSON(b, &res); err != nil {
		return err
	}
	*o = res
