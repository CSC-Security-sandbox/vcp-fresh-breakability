...
func (o *ConsistencyGroupSnapshotCreateParams) WithActionTimeout(actionTimeout *string) *ConsistencyGroupSnapshotCreateParams {
	o.SetActionTimeout(actionTimeout)
	return o
}

// SetActionTimeout adds the actionTimeout to the consistency group snapshot create params
func (o *ConsistencyGroupSnapshotCreateParams) SetActionTimeout(actionTimeout *string) {
...
func (o *ConsistencyGroupSnapshotCreateParams) WithReturnRecords(returnRecords *string) *ConsistencyGroupSnapshotCreateParams {
	o.SetReturnRecords(returnRecords)
	return o
}

// SetReturnRecords adds the returnRecords to the consistency group snapshot create params
func (o *ConsistencyGroupSnapshotCreateParams) SetReturnRecords(returnRecords *string) {
	o.ReturnRecords = returnRecords
}

// WithReturnTimeout adds the returnTimeout to the consistency group snapshot create params
func (o *ConsistencyGroupSnapshotCreateParams) WithReturnTimeout(returnTimeout *string) *ConsistencyGroupSnapshotCreateParams {
	o.SetReturnTimeout(returnTimeout)
	return o
}

// SetReturnTimeout adds the returnTimeout to the consistency group snapshot create params
func (o *ConsistencyGroupSnapshotCreateParams) SetReturnTimeout(returnTimeout *string) {
...
func (o *ConsistencyGroupSnapshotCreateParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
	...
	if o.ActionTimeout != nil {
		...
		var qrActionTimeout string

		if o.ActionTimeout != nil {
			qrActionTimeout = *o.ActionTimeout
		}
		qActionTimeout := qrActionTimeout
		if qActionTimeout != "" {
