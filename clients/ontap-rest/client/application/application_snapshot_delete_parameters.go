...
func (o *ApplicationSnapshotDeleteParams) WithReturnTimeout(returnTimeout *string) *ApplicationSnapshotDeleteParams {
	o.SetReturnTimeout(returnTimeout)
	return o
}

// SetReturnTimeout adds the returnTimeout to the application snapshot delete params
func (o *ApplicationSnapshotDeleteParams) SetReturnTimeout(returnTimeout *string) {
