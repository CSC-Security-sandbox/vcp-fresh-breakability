...
func (o *ApplicationModifyParams) WithReturnTimeout(returnTimeout *string) *ApplicationModifyParams {
	o.SetReturnTimeout(returnTimeout)
	return o
}

// SetReturnTimeout adds the returnTimeout to the application modify params
func (o *ApplicationModifyParams) SetReturnTimeout(returnTimeout *string) {
