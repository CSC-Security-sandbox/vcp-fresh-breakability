...
func (o *PortCollectionGetParams) WithEnabled(enabled *string) *PortCollectionGetParams {
	o.SetEnabled(enabled)
	return o
}

// SetEnabled adds the enabled to the port collection get params
func (o *PortCollectionGetParams) SetEnabled(enabled *string) {
	o.Enabled = enabled
}
...
func (o *PortCollectionGetParams) WithInUse(inUse *string) *PortCollectionGetParams {
	o.SetInUse(inUse)
	return o
}

// SetInUse adds the inUse to the port collection get params
func (o *PortCollectionGetParams) SetInUse(inUse *string) {
	o.InUse = inUse
}
...
func (o *PortCollectionGetParams) WithMaxRecords(maxRecords *string) *PortCollectionGetParams {
	o.SetMaxRecords(maxRecords)
	return o
}

// SetMaxRecords adds the maxRecords to the port collection get params
func (o *PortCollectionGetParams) SetMaxRecords(maxRecords *string) {
...
func (o *PortCollectionGetParams) WithRedundant(redundant *string) *PortCollectionGetParams {
	o.SetRedundant(redundant)
	return o
}

// SetRedundant adds the redundant to the port collection get params
func (o *PortCollectionGetParams) SetRedundant(redundant *string) {
	o.Redundant = redundant
}

// WithReturnRecords adds the returnRecords to the port collection get params
func (o *PortCollectionGetParams) WithReturnRecords(returnRecords *string) *PortCollectionGetParams {
	o.SetReturnRecords(returnRecords)
	return o
}

// SetReturnRecords adds the returnRecords to the port collection get params
func (o *PortCollectionGetParams) SetReturnRecords(returnRecords *string) {
	o.ReturnRecords = returnRecords
}

// WithReturnTimeout adds the returnTimeout to the port collection get params
func (o *PortCollectionGetParams) WithReturnTimeout(returnTimeout *string) *PortCollectionGetParams {
	o.SetReturnTimeout(returnTimeout)
	return o
}

// SetReturnTimeout adds the returnTimeout to the port collection get params
func (o *PortCollectionGetParams) SetReturnTimeout(returnTimeout *string) {
...
func (o *PortCollectionGetParams) WithSpeed(speed *string) *PortCollectionGetParams {
	o.SetSpeed(speed)
	return o
}

// SetSpeed adds the speed to the port collection get params
func (o *PortCollectionGetParams) SetSpeed(speed *string) {
	o.Speed = speed
}
