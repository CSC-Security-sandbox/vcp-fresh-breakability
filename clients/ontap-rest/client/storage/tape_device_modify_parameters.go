...
func (o *TapeDeviceModifyParams) WithReturnTimeout(returnTimeout *string) *TapeDeviceModifyParams {
	o.SetReturnTimeout(returnTimeout)
	return o
}

// SetReturnTimeout adds the returnTimeout to the tape device modify params
func (o *TapeDeviceModifyParams) SetReturnTimeout(returnTimeout *string) {
