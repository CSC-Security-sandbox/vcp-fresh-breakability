...
func (o *QosOptionGetParams) WithBackgroundTaskReserve(backgroundTaskReserve *string) *QosOptionGetParams {
...
func (o *QosOptionGetParams) SetBackgroundTaskReserve(backgroundTaskReserve *string) {
...
func (o *QosOptionGetParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
	...
	if o.BackgroundTaskReserve != nil {
		...
		var qrBackgroundTaskReserve string

		if o.BackgroundTaskReserve != nil {
			qrBackgroundTaskReserve = *o.BackgroundTaskReserve
		}
		qBackgroundTaskReserve := qrBackgroundTaskReserve
