...
func (o *QosPolicyModifyParams) WithReturnTimeout(returnTimeout *string) *QosPolicyModifyParams {
	o.SetReturnTimeout(returnTimeout)
	return o
}

// SetReturnTimeout adds the returnTimeout to the qos policy modify params
func (o *QosPolicyModifyParams) SetReturnTimeout(returnTimeout *string) {
