...
func (o *SnapshotDeleteCollectionOK) Error() string {
	return fmt.Sprintf("[DELETE /storage/volumes/{volume.uuid}/snapshots][%d] snapshotDeleteCollectionOK  %+v", 200, o.Payload)
}
...
func (o *SnapshotDeleteCollectionAccepted) Error() string {
	return fmt.Sprintf("[DELETE /storage/volumes/{volume.uuid}/snapshots][%d] snapshotDeleteCollectionAccepted  %+v", 202, o.Payload)
}
...
func (o *SnapshotDeleteCollectionDefault) Error() string {
	return fmt.Sprintf("[DELETE /storage/volumes/{volume.uuid}/snapshots][%d] snapshot_delete_collection default  %+v", o._statusCode, o.Payload)
}
