...
func (o *FlexcacheOriginModifyParams) WithReturnTimeout(returnTimeout *string) *FlexcacheOriginModifyParams {
	o.SetReturnTimeout(returnTimeout)
	return o
}

// SetReturnTimeout adds the returnTimeout to the flexcache origin modify params
func (o *FlexcacheOriginModifyParams) SetReturnTimeout(returnTimeout *string) {
