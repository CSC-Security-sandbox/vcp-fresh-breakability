...
func (o *QtreeDeleteCollectionOK) Error() string {
	return fmt.Sprintf("[DELETE /storage/qtrees][%d] qtreeDeleteCollectionOK  %+v", 200, o.Payload)
}
...
func (o *QtreeDeleteCollectionAccepted) Error() string {
	return fmt.Sprintf("[DELETE /storage/qtrees][%d] qtreeDeleteCollectionAccepted  %+v", 202, o.Payload)
}
...
func (o *QtreeDeleteCollectionDefault) Error() string {
	return fmt.Sprintf("[DELETE /storage/qtrees][%d] qtree_delete_collection default  %+v", o._statusCode, o.Payload)
}
