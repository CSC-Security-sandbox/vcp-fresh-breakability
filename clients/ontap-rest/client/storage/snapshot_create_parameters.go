...
func (o *SnapshotCreateParams) WithReturnRecords(returnRecords *string) *SnapshotCreateParams {
	o.SetReturnRecords(returnRecords)
	return o
}

// SetReturnRecords adds the returnRecords to the snapshot create params
func (o *SnapshotCreateParams) SetReturnRecords(returnRecords *string) {
	o.ReturnRecords = returnRecords
}

// WithReturnTimeout adds the returnTimeout to the snapshot create params
func (o *SnapshotCreateParams) WithReturnTimeout(returnTimeout *string) *SnapshotCreateParams {
	o.SetReturnTimeout(returnTimeout)
	return o
}

// SetReturnTimeout adds the returnTimeout to the snapshot create params
func (o *SnapshotCreateParams) SetReturnTimeout(returnTimeout *string) {
	o.ReturnTimeout = returnTimeout
}

// WithVolumeUUID adds the volumeUUID to the snapshot create params
func (o *SnapshotCreateParams) WithVolumeUUID(volumeUUID string) *SnapshotCreateParams {
	o.SetVolumeUUID(volumeUUID)
	return o
}

// SetVolumeUUID adds the volumeUuid to the snapshot create params
func (o *SnapshotCreateParams) SetVolumeUUID(volumeUUID string) {
