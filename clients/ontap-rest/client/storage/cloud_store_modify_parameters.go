...
func (o *CloudStoreModifyParams) WithReturnTimeout(returnTimeout *string) *CloudStoreModifyParams {
	o.SetReturnTimeout(returnTimeout)
	return o
}

// SetReturnTimeout adds the returnTimeout to the cloud store modify params
func (o *CloudStoreModifyParams) SetReturnTimeout(returnTimeout *string) {
