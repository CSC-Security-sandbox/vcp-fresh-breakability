...
func (o *CloudStoreModifyCollectionOK) Error() string {
	return fmt.Sprintf("[PATCH /storage/aggregates/{aggregate.uuid}/cloud-stores][%d] cloudStoreModifyCollectionOK  %+v", 200, o.Payload)
}
...
func (o *CloudStoreModifyCollectionAccepted) Error() string {
	return fmt.Sprintf("[PATCH /storage/aggregates/{aggregate.uuid}/cloud-stores][%d] cloudStoreModifyCollectionAccepted  %+v", 202, o.Payload)
}
...
func (o *CloudStoreModifyCollectionDefault) Error() string {
	return fmt.Sprintf("[PATCH /storage/aggregates/{aggregate.uuid}/cloud-stores][%d] cloud_store_modify_collection default  %+v", o._statusCode, o.Payload)
}
	...
	if o.Aggregate != nil {
		if err := o.Aggregate.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("info" + "." + "aggregate")
			}
			return err
		}
	}
	...
	if o.UnavailableReason != nil {
		if err := o.UnavailableReason.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("info" + "." + "unavailable_reason")
			}
			return err
		}
	}
	...
	if o.Links != nil {
		if err := o.Links.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("info" + "." + "target" + "." + "_links")
			}
			return err
		}
	}
	...
	if o.Self != nil {
		if err := o.Self.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("info" + "." + "target" + "." + "_links" + "." + "self")
			}
			return err
		}
	}
