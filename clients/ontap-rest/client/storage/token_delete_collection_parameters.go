...
func (o *TokenDeleteCollectionParams) WithContinueOnFailure(continueOnFailure *string) *TokenDeleteCollectionParams {
	o.SetContinueOnFailure(continueOnFailure)
	return o
}

// SetContinueOnFailure adds the continueOnFailure to the token delete collection params
func (o *TokenDeleteCollectionParams) SetContinueOnFailure(continueOnFailure *string) {
...
func (o *TokenDeleteCollectionParams) WithReserveSize(reserveSize *string) *TokenDeleteCollectionParams {
	o.SetReserveSize(reserveSize)
	return o
}

// SetReserveSize adds the reserveSize to the token delete collection params
func (o *TokenDeleteCollectionParams) SetReserveSize(reserveSize *string) {
	o.ReserveSize = reserveSize
}

// WithReturnRecords adds the returnRecords to the token delete collection params
func (o *TokenDeleteCollectionParams) WithReturnRecords(returnRecords *string) *TokenDeleteCollectionParams {
	o.SetReturnRecords(returnRecords)
	return o
}

// SetReturnRecords adds the returnRecords to the token delete collection params
func (o *TokenDeleteCollectionParams) SetReturnRecords(returnRecords *string) {
	o.ReturnRecords = returnRecords
}

// WithReturnTimeout adds the returnTimeout to the token delete collection params
func (o *TokenDeleteCollectionParams) WithReturnTimeout(returnTimeout *string) *TokenDeleteCollectionParams {
	o.SetReturnTimeout(returnTimeout)
	return o
}

// SetReturnTimeout adds the returnTimeout to the token delete collection params
func (o *TokenDeleteCollectionParams) SetReturnTimeout(returnTimeout *string) {
	o.ReturnTimeout = returnTimeout
}

// WithSerialRecords adds the serialRecords to the token delete collection params
func (o *TokenDeleteCollectionParams) WithSerialRecords(serialRecords *string) *TokenDeleteCollectionParams {
	o.SetSerialRecords(serialRecords)
	return o
}

// SetSerialRecords adds the serialRecords to the token delete collection params
func (o *TokenDeleteCollectionParams) SetSerialRecords(serialRecords *string) {
...
func (o *TokenDeleteCollectionParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
	...
	if o.ReserveSize != nil {
		...
		var qrReserveSize string

		if o.ReserveSize != nil {
			qrReserveSize = *o.ReserveSize
		}
		qReserveSize := qrReserveSize
		if qReserveSize != "" {
