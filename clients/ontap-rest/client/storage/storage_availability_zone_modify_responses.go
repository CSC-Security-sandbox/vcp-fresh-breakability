...
func (o *StorageAvailabilityZoneModifyOK) Error() string {
	return fmt.Sprintf("[PATCH /storage/availability-zones/{uuid}][%d] storageAvailabilityZoneModifyOK  %+v", 200, o.Payload)
}
...
func (o *StorageAvailabilityZoneModifyAccepted) Error() string {
	return fmt.Sprintf("[PATCH /storage/availability-zones/{uuid}][%d] storageAvailabilityZoneModifyAccepted  %+v", 202, o.Payload)
}
...
func (o *StorageAvailabilityZoneModifyDefault) Error() string {
	return fmt.Sprintf("[PATCH /storage/availability-zones/{uuid}][%d] storage_availability_zone_modify default  %+v", o._statusCode, o.Payload)
}
