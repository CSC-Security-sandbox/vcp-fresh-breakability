...
func (o *CloudStoreDeleteCollectionOK) Error() string {
	return fmt.Sprintf("[DELETE /storage/aggregates/{aggregate.uuid}/cloud-stores][%d] cloudStoreDeleteCollectionOK  %+v", 200, o.Payload)
}
...
func (o *CloudStoreDeleteCollectionAccepted) Error() string {
	return fmt.Sprintf("[DELETE /storage/aggregates/{aggregate.uuid}/cloud-stores][%d] cloudStoreDeleteCollectionAccepted  %+v", 202, o.Payload)
}
...
func (o *CloudStoreDeleteCollectionDefault) Error() string {
	return fmt.Sprintf("[DELETE /storage/aggregates/{aggregate.uuid}/cloud-stores][%d] cloud_store_delete_collection default  %+v", o._statusCode, o.Payload)
}
