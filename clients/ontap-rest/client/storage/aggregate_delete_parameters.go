...
func (o *AggregateDeleteParams) WithReturnTimeout(returnTimeout *string) *AggregateDeleteParams {
	o.SetReturnTimeout(returnTimeout)
	return o
}

// SetReturnTimeout adds the returnTimeout to the aggregate delete params
func (o *AggregateDeleteParams) SetReturnTimeout(returnTimeout *string) {
