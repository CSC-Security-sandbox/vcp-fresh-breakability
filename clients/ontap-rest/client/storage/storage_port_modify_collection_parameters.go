...
func (o *StoragePortModifyCollectionParams) WithContinueOnFailure(continueOnFailure *string) *StoragePortModifyCollectionParams {
	o.SetContinueOnFailure(continueOnFailure)
	return o
}

// SetContinueOnFailure adds the continueOnFailure to the storage port modify collection params
func (o *StoragePortModifyCollectionParams) SetContinueOnFailure(continueOnFailure *string) {
...
func (o *StoragePortModifyCollectionParams) WithEnabled(enabled *string) *StoragePortModifyCollectionParams {
	o.SetEnabled(enabled)
	return o
}

// SetEnabled adds the enabled to the storage port modify collection params
func (o *StoragePortModifyCollectionParams) SetEnabled(enabled *string) {
	o.Enabled = enabled
}
...
func (o *StoragePortModifyCollectionParams) WithInUse(inUse *string) *StoragePortModifyCollectionParams {
	o.SetInUse(inUse)
	return o
}

// SetInUse adds the inUse to the storage port modify collection params
func (o *StoragePortModifyCollectionParams) SetInUse(inUse *string) {
	o.InUse = inUse
}
...
func (o *StoragePortModifyCollectionParams) WithRedundant(redundant *string) *StoragePortModifyCollectionParams {
	o.SetRedundant(redundant)
	return o
}

// SetRedundant adds the redundant to the storage port modify collection params
func (o *StoragePortModifyCollectionParams) SetRedundant(redundant *string) {
	o.Redundant = redundant
}

// WithReturnRecords adds the returnRecords to the storage port modify collection params
func (o *StoragePortModifyCollectionParams) WithReturnRecords(returnRecords *string) *StoragePortModifyCollectionParams {
	o.SetReturnRecords(returnRecords)
	return o
}

// SetReturnRecords adds the returnRecords to the storage port modify collection params
func (o *StoragePortModifyCollectionParams) SetReturnRecords(returnRecords *string) {
	o.ReturnRecords = returnRecords
}

// WithReturnTimeout adds the returnTimeout to the storage port modify collection params
func (o *StoragePortModifyCollectionParams) WithReturnTimeout(returnTimeout *string) *StoragePortModifyCollectionParams {
	o.SetReturnTimeout(returnTimeout)
	return o
}

// SetReturnTimeout adds the returnTimeout to the storage port modify collection params
func (o *StoragePortModifyCollectionParams) SetReturnTimeout(returnTimeout *string) {
...
func (o *StoragePortModifyCollectionParams) WithSerialRecords(serialRecords *string) *StoragePortModifyCollectionParams {
	o.SetSerialRecords(serialRecords)
	return o
}

// SetSerialRecords adds the serialRecords to the storage port modify collection params
func (o *StoragePortModifyCollectionParams) SetSerialRecords(serialRecords *string) {
	o.SerialRecords = serialRecords
}

// WithSpeed adds the speed to the storage port modify collection params
func (o *StoragePortModifyCollectionParams) WithSpeed(speed *string) *StoragePortModifyCollectionParams {
	o.SetSpeed(speed)
	return o
}

// SetSpeed adds the speed to the storage port modify collection params
func (o *StoragePortModifyCollectionParams) SetSpeed(speed *string) {
	o.Speed = speed
}
...
func (o *StoragePortModifyCollectionParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
	...
	if o.Redundant != nil {
		...
		var qrRedundant string

		if o.Redundant != nil {
			qrRedundant = *o.Redundant
		}
		qRedundant := qrRedundant
		if qRedundant != "" {
