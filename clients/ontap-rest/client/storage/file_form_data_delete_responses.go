...
func (o *FileFormDataDeleteAccepted) Error() string {
	return fmt.Sprintf("[DELETE //storage/volumes/{volume.uuid}/files/{path}][%d] fileFormDataDeleteAccepted  %+v", 202, o.Payload)
}
...
func (o *FileFormDataDeleteDefault) Error() string {
	return fmt.Sprintf("[DELETE //storage/volumes/{volume.uuid}/files/{path}][%d] file_form_data_delete default  %+v", o._statusCode, o.Payload)
}
