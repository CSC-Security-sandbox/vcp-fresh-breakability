...
func (o *QuotaRuleDeleteParams) WithReturnTimeout(returnTimeout *string) *QuotaRuleDeleteParams {
	o.SetReturnTimeout(returnTimeout)
	return o
}

// SetReturnTimeout adds the returnTimeout to the quota rule delete params
func (o *QuotaRuleDeleteParams) SetReturnTimeout(returnTimeout *string) {
	o.ReturnTimeout = returnTimeout
}

// WithUUID adds the uuid to the quota rule delete params
func (o *QuotaRuleDeleteParams) WithUUID(uuid string) *QuotaRuleDeleteParams {
	o.SetUUID(uuid)
	return o
}

// SetUUID adds the uuid to the quota rule delete params
func (o *QuotaRuleDeleteParams) SetUUID(uuid string) {
	o.UUID = uuid
}
