...
type QosPolicyModifyCollectionParams struct {
	...
	/* AdaptiveAbsoluteMinIops.
	   ...
	   Format: integer
	*/
	AdaptiveAbsoluteMinIops *string
...
func (o *QosPolicyModifyCollectionParams) WithAdaptiveAbsoluteMinIops(adaptiveAbsoluteMinIops *string) *QosPolicyModifyCollectionParams {
...
func (o *QosPolicyModifyCollectionParams) SetAdaptiveAbsoluteMinIops(adaptiveAbsoluteMinIops *string) {
...
func (o *QosPolicyModifyCollectionParams) WithAdaptiveExpectedIops(adaptiveExpectedIops *string) *QosPolicyModifyCollectionParams {
...
func (o *QosPolicyModifyCollectionParams) SetAdaptiveExpectedIops(adaptiveExpectedIops *string) {
...
func (o *QosPolicyModifyCollectionParams) WithAdaptivePeakIops(adaptivePeakIops *string) *QosPolicyModifyCollectionParams {
...
func (o *QosPolicyModifyCollectionParams) SetAdaptivePeakIops(adaptivePeakIops *string) {
...
func (o *QosPolicyModifyCollectionParams) WithContinueOnFailure(continueOnFailure *string) *QosPolicyModifyCollectionParams {
	o.SetContinueOnFailure(continueOnFailure)
	return o
}

// SetContinueOnFailure adds the continueOnFailure to the qos policy modify collection params
func (o *QosPolicyModifyCollectionParams) SetContinueOnFailure(continueOnFailure *string) {
	o.ContinueOnFailure = continueOnFailure
}

// WithFixedCapacityShared adds the fixedCapacityShared to the qos policy modify collection params
func (o *QosPolicyModifyCollectionParams) WithFixedCapacityShared(fixedCapacityShared *string) *QosPolicyModifyCollectionParams {
...
func (o *QosPolicyModifyCollectionParams) SetFixedCapacityShared(fixedCapacityShared *string) {
...
func (o *QosPolicyModifyCollectionParams) WithFixedMaxThroughputIops(fixedMaxThroughputIops *string) *QosPolicyModifyCollectionParams {
...
func (o *QosPolicyModifyCollectionParams) SetFixedMaxThroughputIops(fixedMaxThroughputIops *string) {
...
func (o *QosPolicyModifyCollectionParams) WithFixedMaxThroughputMbps(fixedMaxThroughputMbps *string) *QosPolicyModifyCollectionParams {
...
func (o *QosPolicyModifyCollectionParams) SetFixedMaxThroughputMbps(fixedMaxThroughputMbps *string) {
...
func (o *QosPolicyModifyCollectionParams) WithFixedMinThroughputIops(fixedMinThroughputIops *string) *QosPolicyModifyCollectionParams {
...
func (o *QosPolicyModifyCollectionParams) SetFixedMinThroughputIops(fixedMinThroughputIops *string) {
...
func (o *QosPolicyModifyCollectionParams) WithFixedMinThroughputMbps(fixedMinThroughputMbps *string) *QosPolicyModifyCollectionParams {
...
func (o *QosPolicyModifyCollectionParams) SetFixedMinThroughputMbps(fixedMinThroughputMbps *string) {
...
func (o *QosPolicyModifyCollectionParams) WithObjectCount(objectCount *string) *QosPolicyModifyCollectionParams {
	o.SetObjectCount(objectCount)
	return o
}

// SetObjectCount adds the objectCount to the qos policy modify collection params
func (o *QosPolicyModifyCollectionParams) SetObjectCount(objectCount *string) {
	o.ObjectCount = objectCount
}

// WithPgid adds the pgid to the qos policy modify collection params
func (o *QosPolicyModifyCollectionParams) WithPgid(pgid *string) *QosPolicyModifyCollectionParams {
	o.SetPgid(pgid)
	return o
}

// SetPgid adds the pgid to the qos policy modify collection params
func (o *QosPolicyModifyCollectionParams) SetPgid(pgid *string) {
	o.Pgid = pgid
}
...
func (o *QosPolicyModifyCollectionParams) WithReturnRecords(returnRecords *string) *QosPolicyModifyCollectionParams {
	o.SetReturnRecords(returnRecords)
	return o
}

// SetReturnRecords adds the returnRecords to the qos policy modify collection params
func (o *QosPolicyModifyCollectionParams) SetReturnRecords(returnRecords *string) {
	o.ReturnRecords = returnRecords
}

// WithReturnTimeout adds the returnTimeout to the qos policy modify collection params
func (o *QosPolicyModifyCollectionParams) WithReturnTimeout(returnTimeout *string) *QosPolicyModifyCollectionParams {
	o.SetReturnTimeout(returnTimeout)
	return o
}

// SetReturnTimeout adds the returnTimeout to the qos policy modify collection params
func (o *QosPolicyModifyCollectionParams) SetReturnTimeout(returnTimeout *string) {
...
func (o *QosPolicyModifyCollectionParams) WithSerialRecords(serialRecords *string) *QosPolicyModifyCollectionParams {
	o.SetSerialRecords(serialRecords)
	return o
}

// SetSerialRecords adds the serialRecords to the qos policy modify collection params
func (o *QosPolicyModifyCollectionParams) SetSerialRecords(serialRecords *string) {
...
func (o *QosPolicyModifyCollectionParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
	...
	if o.AdaptiveAbsoluteMinIops != nil {
		...
		var qrAdaptiveAbsoluteMinIops string

		if o.AdaptiveAbsoluteMinIops != nil {
			qrAdaptiveAbsoluteMinIops = *o.AdaptiveAbsoluteMinIops
		}
		qAdaptiveAbsoluteMinIops := qrAdaptiveAbsoluteMinIops
	...
	if o.AdaptiveExpectedIops != nil {
		...
		var qrAdaptiveExpectedIops string

		if o.AdaptiveExpectedIops != nil {
			qrAdaptiveExpectedIops = *o.AdaptiveExpectedIops
		}
		qAdaptiveExpectedIops := qrAdaptiveExpectedIops
	...
	if o.AdaptivePeakIops != nil {
		...
		var qrAdaptivePeakIops string

		if o.AdaptivePeakIops != nil {
			qrAdaptivePeakIops = *o.AdaptivePeakIops
		}
		qAdaptivePeakIops := qrAdaptivePeakIops
	...
	if o.FixedCapacityShared != nil {
		...
		var qrFixedCapacityShared string

		if o.FixedCapacityShared != nil {
			qrFixedCapacityShared = *o.FixedCapacityShared
		}
		qFixedCapacityShared := qrFixedCapacityShared
	...
	if o.FixedMaxThroughputIops != nil {
		...
		var qrFixedMaxThroughputIops string

		if o.FixedMaxThroughputIops != nil {
			qrFixedMaxThroughputIops = *o.FixedMaxThroughputIops
		}
		qFixedMaxThroughputIops := qrFixedMaxThroughputIops
	...
	if o.FixedMaxThroughputMbps != nil {
		...
		var qrFixedMaxThroughputMbps string

		if o.FixedMaxThroughputMbps != nil {
			qrFixedMaxThroughputMbps = *o.FixedMaxThroughputMbps
		}
		qFixedMaxThroughputMbps := qrFixedMaxThroughputMbps
	...
	if o.FixedMinThroughputIops != nil {
		...
		var qrFixedMinThroughputIops string

		if o.FixedMinThroughputIops != nil {
			qrFixedMinThroughputIops = *o.FixedMinThroughputIops
		}
		qFixedMinThroughputIops := qrFixedMinThroughputIops
	...
	if o.FixedMinThroughputMbps != nil {
		...
		var qrFixedMinThroughputMbps string

		if o.FixedMinThroughputMbps != nil {
			qrFixedMinThroughputMbps = *o.FixedMinThroughputMbps
		}
		qFixedMinThroughputMbps := qrFixedMinThroughputMbps
	...
	if o.ObjectCount != nil {
		...
		var qrObjectCount string

		if o.ObjectCount != nil {
			qrObjectCount = *o.ObjectCount
		}
		qObjectCount := qrObjectCount
		if qObjectCount != "" {
