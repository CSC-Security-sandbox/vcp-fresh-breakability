...
func (o *CloudStoreDeleteParams) WithReturnTimeout(returnTimeout *string) *CloudStoreDeleteParams {
	o.SetReturnTimeout(returnTimeout)
	return o
}

// SetReturnTimeout adds the returnTimeout to the cloud store delete params
func (o *CloudStoreDeleteParams) SetReturnTimeout(returnTimeout *string) {
