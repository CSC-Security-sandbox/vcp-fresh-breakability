...
func (o *StartDirectoryRestoreCreated) Error() string {
	return fmt.Sprintf("[POST /storage/directory-restore][%d] startDirectoryRestoreCreated  %+v", 201, o.Payload)
}
...
func (o *StartDirectoryRestoreAccepted) Error() string {
	return fmt.Sprintf("[POST /storage/directory-restore][%d] startDirectoryRestoreAccepted  %+v", 202, o.Payload)
}
...
func (o *StartDirectoryRestoreDefault) Error() string {
	return fmt.Sprintf("[POST /storage/directory-restore][%d] start_directory_restore default  %+v", o._statusCode, o.Payload)
}
