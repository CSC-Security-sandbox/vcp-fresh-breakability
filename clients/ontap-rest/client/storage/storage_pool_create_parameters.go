...
func (o *StoragePoolCreateParams) WithDiskSize(diskSize *string) *StoragePoolCreateParams {
	o.SetDiskSize(diskSize)
	return o
}

// SetDiskSize adds the diskSize to the storage pool create params
func (o *StoragePoolCreateParams) SetDiskSize(diskSize *string) {
	o.DiskSize = diskSize
}
...
func (o *StoragePoolCreateParams) WithReturnRecords(returnRecords *string) *StoragePoolCreateParams {
	o.SetReturnRecords(returnRecords)
	return o
}

// SetReturnRecords adds the returnRecords to the storage pool create params
func (o *StoragePoolCreateParams) SetReturnRecords(returnRecords *string) {
	o.ReturnRecords = returnRecords
}

// WithReturnTimeout adds the returnTimeout to the storage pool create params
func (o *StoragePoolCreateParams) WithReturnTimeout(returnTimeout *string) *StoragePoolCreateParams {
	o.SetReturnTimeout(returnTimeout)
	return o
}

// SetReturnTimeout adds the returnTimeout to the storage pool create params
func (o *StoragePoolCreateParams) SetReturnTimeout(returnTimeout *string) {
	o.ReturnTimeout = returnTimeout
}

// WithSimulate adds the simulate to the storage pool create params
func (o *StoragePoolCreateParams) WithSimulate(simulate *string) *StoragePoolCreateParams {
	o.SetSimulate(simulate)
	return o
}

// SetSimulate adds the simulate to the storage pool create params
func (o *StoragePoolCreateParams) SetSimulate(simulate *string) {
	o.Simulate = simulate
}
