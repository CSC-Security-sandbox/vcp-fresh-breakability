...
func (o *SplitStatusCollectionGetParams) WithMaxRecords(maxRecords *string) *SplitStatusCollectionGetParams {
	o.SetMaxRecords(maxRecords)
	return o
}

// SetMaxRecords adds the maxRecords to the split status collection get params
func (o *SplitStatusCollectionGetParams) SetMaxRecords(maxRecords *string) {
...
func (o *SplitStatusCollectionGetParams) WithPendingSplits(pendingSplits *string) *SplitStatusCollectionGetParams {
	o.SetPendingSplits(pendingSplits)
	return o
}

// SetPendingSplits adds the pendingSplits to the split status collection get params
func (o *SplitStatusCollectionGetParams) SetPendingSplits(pendingSplits *string) {
	o.PendingSplits = pendingSplits
}

// WithReturnRecords adds the returnRecords to the split status collection get params
func (o *SplitStatusCollectionGetParams) WithReturnRecords(returnRecords *string) *SplitStatusCollectionGetParams {
	o.SetReturnRecords(returnRecords)
	return o
}

// SetReturnRecords adds the returnRecords to the split status collection get params
func (o *SplitStatusCollectionGetParams) SetReturnRecords(returnRecords *string) {
	o.ReturnRecords = returnRecords
}

// WithReturnTimeout adds the returnTimeout to the split status collection get params
func (o *SplitStatusCollectionGetParams) WithReturnTimeout(returnTimeout *string) *SplitStatusCollectionGetParams {
	o.SetReturnTimeout(returnTimeout)
	return o
}

// SetReturnTimeout adds the returnTimeout to the split status collection get params
func (o *SplitStatusCollectionGetParams) SetReturnTimeout(returnTimeout *string) {
...
func (o *SplitStatusCollectionGetParams) WithUnsplitSize(unsplitSize *string) *SplitStatusCollectionGetParams {
	o.SetUnsplitSize(unsplitSize)
	return o
}

// SetUnsplitSize adds the unsplitSize to the split status collection get params
func (o *SplitStatusCollectionGetParams) SetUnsplitSize(unsplitSize *string) {
...
func (o *SplitStatusCollectionGetParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
	...
	if o.PendingSplits != nil {
		...
		var qrPendingSplits string

		if o.PendingSplits != nil {
			qrPendingSplits = *o.PendingSplits
		}
		qPendingSplits := qrPendingSplits
		if qPendingSplits != "" {
	...
	if o.UnsplitSize != nil {
		...
		var qrUnsplitSize string

		if o.UnsplitSize != nil {
			qrUnsplitSize = *o.UnsplitSize
		}
		qUnsplitSize := qrUnsplitSize
		if qUnsplitSize != "" {
