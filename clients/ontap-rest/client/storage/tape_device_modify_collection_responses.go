...
func (o *TapeDeviceModifyCollectionAccepted) Error() string {
	return fmt.Sprintf("[PATCH /storage/tape-devices][%d] tapeDeviceModifyCollectionAccepted  %+v", 202, o.Payload)
}
...
func (o *TapeDeviceModifyCollectionDefault) Error() string {
	return fmt.Sprintf("[PATCH /storage/tape-devices][%d] tape_device_modify_collection default  %+v", o._statusCode, o.Payload)
}
	...
	if o.Alias != nil {
		if err := o.Alias.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("info" + "." + "alias")
			}
			return err
		}
	}
	...
	if o.Position != nil {
		if err := o.Position.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("info" + "." + "position")
			}
			return err
		}
	}
	...
	if o.StoragePort != nil {
		if err := o.StoragePort.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("info" + "." + "storage_port")
			}
			return err
		}
	}
		...
		if o.TapeDeviceInlineAliases[i] != nil {
			if err := o.TapeDeviceInlineAliases[i].Validate(formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					...
					return ce.ValidateName("info" + "." + "aliases" + "." + strconv.Itoa(i))
				}
				return err
			}
		}
		...
		if o.TapeDeviceInlineDeviceNames[i] != nil {
			if err := o.TapeDeviceInlineDeviceNames[i].Validate(formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					...
					return ce.ValidateName("info" + "." + "device_names" + "." + strconv.Itoa(i))
				}
				return err
			}
		}
...
func (o *TapeDeviceModifyCollectionBody) contextValidateTapeDeviceInlineDeviceNames(ctx context.Context, formats strfmt.Registry) error {
	...
	if err := validate.ReadOnly(ctx, "info"+"."+"device_names", "body", []*TapeDeviceInlineDeviceNamesInlineArrayItem(o.TapeDeviceInlineDeviceNames)); err != nil {
		return err
	}
