...
func (o *AggregateDeleteCollectionOK) Error() string {
	return fmt.Sprintf("[DELETE /storage/aggregates][%d] aggregateDeleteCollectionOK  %+v", 200, o.Payload)
}
...
func (o *AggregateDeleteCollectionAccepted) Error() string {
	return fmt.Sprintf("[DELETE /storage/aggregates][%d] aggregateDeleteCollectionAccepted  %+v", 202, o.Payload)
}
...
func (o *AggregateDeleteCollectionDefault) Error() string {
	return fmt.Sprintf("[DELETE /storage/aggregates][%d] aggregate_delete_collection default  %+v", o._statusCode, o.Payload)
}
