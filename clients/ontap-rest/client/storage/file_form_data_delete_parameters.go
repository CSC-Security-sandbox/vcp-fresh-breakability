...
func (o *FileFormDataDeleteParams) WithRecurse(recurse *string) *FileFormDataDeleteParams {
	o.SetRecurse(recurse)
	return o
}

// SetRecurse adds the recurse to the file form data delete params
func (o *FileFormDataDeleteParams) SetRecurse(recurse *string) {
	o.Recurse = recurse
}

// WithReturnRecords adds the returnRecords to the file form data delete params
func (o *FileFormDataDeleteParams) WithReturnRecords(returnRecords *string) *FileFormDataDeleteParams {
	o.SetReturnRecords(returnRecords)
	return o
}

// SetReturnRecords adds the returnRecords to the file form data delete params
func (o *FileFormDataDeleteParams) SetReturnRecords(returnRecords *string) {
	o.ReturnRecords = returnRecords
}

// WithReturnTimeout adds the returnTimeout to the file form data delete params
func (o *FileFormDataDeleteParams) WithReturnTimeout(returnTimeout *string) *FileFormDataDeleteParams {
	o.SetReturnTimeout(returnTimeout)
	return o
}

// SetReturnTimeout adds the returnTimeout to the file form data delete params
func (o *FileFormDataDeleteParams) SetReturnTimeout(returnTimeout *string) {
	o.ReturnTimeout = returnTimeout
}

// WithThrottleDeletion adds the throttleDeletion to the file form data delete params
func (o *FileFormDataDeleteParams) WithThrottleDeletion(throttleDeletion *string) *FileFormDataDeleteParams {
	o.SetThrottleDeletion(throttleDeletion)
	return o
}

// SetThrottleDeletion adds the throttleDeletion to the file form data delete params
func (o *FileFormDataDeleteParams) SetThrottleDeletion(throttleDeletion *string) {
...
func (o *FileFormDataDeleteParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
	...
	if o.ThrottleDeletion != nil {
		...
		var qrThrottleDeletion string

		if o.ThrottleDeletion != nil {
			qrThrottleDeletion = *o.ThrottleDeletion
		}
		qThrottleDeletion := qrThrottleDeletion
