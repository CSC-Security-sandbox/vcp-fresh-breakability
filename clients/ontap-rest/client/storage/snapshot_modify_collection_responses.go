...
func (o *SnapshotModifyCollectionOK) Error() string {
	return fmt.Sprintf("[PATCH /storage/volumes/{volume.uuid}/snapshots][%d] snapshotModifyCollectionOK  %+v", 200, o.Payload)
}
...
func (o *SnapshotModifyCollectionAccepted) Error() string {
	return fmt.Sprintf("[PATCH /storage/volumes/{volume.uuid}/snapshots][%d] snapshotModifyCollectionAccepted  %+v", 202, o.Payload)
}
...
func (o *SnapshotModifyCollectionDefault) Error() string {
	return fmt.Sprintf("[PATCH /storage/volumes/{volume.uuid}/snapshots][%d] snapshot_modify_collection default  %+v", o._statusCode, o.Payload)
}
	...
	if o.ProvenanceVolume != nil {
		if err := o.ProvenanceVolume.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("info" + "." + "provenance_volume")
			}
			return err
		}
	}
