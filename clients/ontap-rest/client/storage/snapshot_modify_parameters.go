...
func (o *SnapshotModifyParams) WithReturnTimeout(returnTimeout *string) *SnapshotModifyParams {
	o.SetReturnTimeout(returnTimeout)
	return o
}

// SetReturnTimeout adds the returnTimeout to the snapshot modify params
func (o *SnapshotModifyParams) SetReturnTimeout(returnTimeout *string) {
