...
func (o *FlexcacheOriginModifyCollectionOK) Error() string {
	return fmt.Sprintf("[PATCH /storage/flexcache/origins][%d] flexcacheOriginModifyCollectionOK  %+v", 200, o.Payload)
}
...
func (o *FlexcacheOriginModifyCollectionAccepted) Error() string {
	return fmt.Sprintf("[PATCH /storage/flexcache/origins][%d] flexcacheOriginModifyCollectionAccepted  %+v", 202, o.Payload)
}
...
func (o *FlexcacheOriginModifyCollectionDefault) Error() string {
	return fmt.Sprintf("[PATCH /storage/flexcache/origins][%d] flexcache_origin_modify_collection default  %+v", o._statusCode, o.Payload)
}
		...
		if o.FlexcacheOriginInlineFlexcaches[i] != nil {
			if err := o.FlexcacheOriginInlineFlexcaches[i].Validate(formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					...
					return ce.ValidateName("info" + "." + "flexcaches" + "." + strconv.Itoa(i))
				}
				return err
			}
		}
