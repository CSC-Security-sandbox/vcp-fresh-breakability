...
func (o *PerformanceQtreeMetricCollectionGetOK) Error() string {
	return fmt.Sprintf("[GET /storage/qtrees/{volume.uuid}/{qtree.id}/metrics][%d] performanceQtreeMetricCollectionGetOK  %+v", 200, o.Payload)
}
...
func (o *PerformanceQtreeMetricCollectionGetDefault) Error() string {
	return fmt.Sprintf("[GET /storage/qtrees/{volume.uuid}/{qtree.id}/metrics][%d] performance_qtree_metric_collection_get default  %+v", o._statusCode, o.Payload)
}
