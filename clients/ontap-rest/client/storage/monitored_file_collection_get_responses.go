...
// IsSuccess returns true when this monitored file collection get o k response has a 2xx status code
func (o *MonitoredFileCollectionGetOK) IsSuccess() bool {
	return true
}

// IsRedirect returns true when this monitored file collection get o k response has a 3xx status code
func (o *MonitoredFileCollectionGetOK) IsRedirect() bool {
	return false
}

// IsClientError returns true when this monitored file collection get o k response has a 4xx status code
func (o *MonitoredFileCollectionGetOK) IsClientError() bool {
	return false
}

// IsServerError returns true when this monitored file collection get o k response has a 5xx status code
func (o *MonitoredFileCollectionGetOK) IsServerError() bool {
	return false
}

// IsCode returns true when this monitored file collection get o k response a status code equal to that given
func (o *MonitoredFileCollectionGetOK) IsCode(code int) bool {
	return code == 200
}

// Code gets the status code for the monitored file collection get o k response
func (o *MonitoredFileCollectionGetOK) Code() int {
	return 200
}
...
func (o *MonitoredFileCollectionGetOK) String() string {
	return fmt.Sprintf("[GET /storage/monitored-files][%d] monitoredFileCollectionGetOK  %+v", 200, o.Payload)
}
...
// IsSuccess returns true when this monitored file collection get default response has a 2xx status code
func (o *MonitoredFileCollectionGetDefault) IsSuccess() bool {
	return o._statusCode/100 == 2
}

// IsRedirect returns true when this monitored file collection get default response has a 3xx status code
func (o *MonitoredFileCollectionGetDefault) IsRedirect() bool {
	return o._statusCode/100 == 3
}

// IsClientError returns true when this monitored file collection get default response has a 4xx status code
func (o *MonitoredFileCollectionGetDefault) IsClientError() bool {
	return o._statusCode/100 == 4
}

// IsServerError returns true when this monitored file collection get default response has a 5xx status code
func (o *MonitoredFileCollectionGetDefault) IsServerError() bool {
	return o._statusCode/100 == 5
}

// IsCode returns true when this monitored file collection get default response a status code equal to that given
func (o *MonitoredFileCollectionGetDefault) IsCode(code int) bool {
...
func (o *MonitoredFileCollectionGetDefault) String() string {
	return fmt.Sprintf("[GET /storage/monitored-files][%d] monitored_file_collection_get default  %+v", o._statusCode, o.Payload)
}
