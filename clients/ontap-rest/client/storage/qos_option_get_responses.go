...
func (o *QosOptionGetOK) Error() string {
	return fmt.Sprintf("[GET /storage/qos/qos-options][%d] qosOptionGetOK  %+v", 200, o.Payload)
}
...
func (o *QosOptionGetDefault) Error() string {
	return fmt.Sprintf("[GET /storage/qos/qos-options][%d] qos_option_get default  %+v", o._statusCode, o.Payload)
}
