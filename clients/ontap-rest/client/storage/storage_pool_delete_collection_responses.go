...
func (o *StoragePoolDeleteCollectionOK) Error() string {
	return fmt.Sprintf("[DELETE /storage/pools][%d] storagePoolDeleteCollectionOK  %+v", 200, o.Payload)
}
...
func (o *StoragePoolDeleteCollectionAccepted) Error() string {
	return fmt.Sprintf("[DELETE /storage/pools][%d] storagePoolDeleteCollectionAccepted  %+v", 202, o.Payload)
}
...
func (o *StoragePoolDeleteCollectionDefault) Error() string {
	return fmt.Sprintf("[DELETE /storage/pools][%d] storage_pool_delete_collection default  %+v", o._statusCode, o.Payload)
}
