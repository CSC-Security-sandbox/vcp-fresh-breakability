...
func (o *FileMoveCollectionGetParams) WithCutoverTime(cutoverTime *string) *FileMoveCollectionGetParams {
	o.SetCutoverTime(cutoverTime)
	return o
}

// SetCutoverTime adds the cutoverTime to the file move collection get params
func (o *FileMoveCollectionGetParams) SetCutoverTime(cutoverTime *string) {
...
func (o *FileMoveCollectionGetParams) WithElapsedTime(elapsedTime *string) *FileMoveCollectionGetParams {
	o.SetElapsedTime(elapsedTime)
	return o
}

// SetElapsedTime adds the elapsedTime to the file move collection get params
func (o *FileMoveCollectionGetParams) SetElapsedTime(elapsedTime *string) {
...
func (o *FileMoveCollectionGetParams) WithIndex(index *string) *FileMoveCollectionGetParams {
	o.SetIndex(index)
	return o
}

// SetIndex adds the index to the file move collection get params
func (o *FileMoveCollectionGetParams) SetIndex(index *string) {
	o.Index = index
}

// WithIsDestinationReady adds the isDestinationReady to the file move collection get params
func (o *FileMoveCollectionGetParams) WithIsDestinationReady(isDestinationReady *string) *FileMoveCollectionGetParams {
...
func (o *FileMoveCollectionGetParams) SetIsDestinationReady(isDestinationReady *string) {
	o.IsDestinationReady = isDestinationReady
}

// WithIsFlexgroup adds the isFlexgroup to the file move collection get params
func (o *FileMoveCollectionGetParams) WithIsFlexgroup(isFlexgroup *string) *FileMoveCollectionGetParams {
	o.SetIsFlexgroup(isFlexgroup)
	return o
}

// SetIsFlexgroup adds the isFlexgroup to the file move collection get params
func (o *FileMoveCollectionGetParams) SetIsFlexgroup(isFlexgroup *string) {
	o.IsFlexgroup = isFlexgroup
}

// WithIsSnapshotFenced adds the isSnapshotFenced to the file move collection get params
func (o *FileMoveCollectionGetParams) WithIsSnapshotFenced(isSnapshotFenced *string) *FileMoveCollectionGetParams {
...
func (o *FileMoveCollectionGetParams) WithReturnRecords(returnRecords *string) *FileMoveCollectionGetParams {
	o.SetReturnRecords(returnRecords)
	return o
}

// SetReturnRecords adds the returnRecords to the file move collection get params
func (o *FileMoveCollectionGetParams) SetReturnRecords(returnRecords *string) {
	o.ReturnRecords = returnRecords
}

// WithReturnTimeout adds the returnTimeout to the file move collection get params
func (o *FileMoveCollectionGetParams) WithReturnTimeout(returnTimeout *string) *FileMoveCollectionGetParams {
	o.SetReturnTimeout(returnTimeout)
	return o
}

// SetReturnTimeout adds the returnTimeout to the file move collection get params
func (o *FileMoveCollectionGetParams) SetReturnTimeout(returnTimeout *string) {
	o.ReturnTimeout = returnTimeout
}

// WithScannerPercent adds the scannerPercent to the file move collection get params
func (o *FileMoveCollectionGetParams) WithScannerPercent(scannerPercent *string) *FileMoveCollectionGetParams {
	o.SetScannerPercent(scannerPercent)
	return o
}

// SetScannerPercent adds the scannerPercent to the file move collection get params
func (o *FileMoveCollectionGetParams) SetScannerPercent(scannerPercent *string) {
	o.ScannerPercent = scannerPercent
}

// WithScannerProgress adds the scannerProgress to the file move collection get params
func (o *FileMoveCollectionGetParams) WithScannerProgress(scannerProgress *string) *FileMoveCollectionGetParams {
	o.SetScannerProgress(scannerProgress)
	return o
}

// SetScannerProgress adds the scannerProgress to the file move collection get params
func (o *FileMoveCollectionGetParams) SetScannerProgress(scannerProgress *string) {
...
func (o *FileMoveCollectionGetParams) WithScannerTotal(scannerTotal *string) *FileMoveCollectionGetParams {
	o.SetScannerTotal(scannerTotal)
	return o
}

// SetScannerTotal adds the scannerTotal to the file move collection get params
func (o *FileMoveCollectionGetParams) SetScannerTotal(scannerTotal *string) {
...
func (o *FileMoveCollectionGetParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
	...
	if o.CutoverTime != nil {
		...
		var qrCutoverTime string

		if o.CutoverTime != nil {
			qrCutoverTime = *o.CutoverTime
		}
		qCutoverTime := qrCutoverTime
		if qCutoverTime != "" {
	...
	if o.ElapsedTime != nil {
		...
		var qrElapsedTime string

		if o.ElapsedTime != nil {
			qrElapsedTime = *o.ElapsedTime
		}
		qElapsedTime := qrElapsedTime
		if qElapsedTime != "" {
	...
	if o.IsDestinationReady != nil {
		...
		var qrIsDestinationReady string

		if o.IsDestinationReady != nil {
			qrIsDestinationReady = *o.IsDestinationReady
		}
		qIsDestinationReady := qrIsDestinationReady
	...
	if o.IsFlexgroup != nil {
		...
		var qrIsFlexgroup string

		if o.IsFlexgroup != nil {
			qrIsFlexgroup = *o.IsFlexgroup
		}
		qIsFlexgroup := qrIsFlexgroup
		if qIsFlexgroup != "" {
	...
	if o.IsSnapshotFenced != nil {
		...
		var qrIsSnapshotFenced string

		if o.IsSnapshotFenced != nil {
			qrIsSnapshotFenced = *o.IsSnapshotFenced
		}
		qIsSnapshotFenced := qrIsSnapshotFenced
	...
	if o.MaxCutoverTime != nil {
		...
		var qrMaxCutoverTime string

		if o.MaxCutoverTime != nil {
			qrMaxCutoverTime = *o.MaxCutoverTime
		}
		qMaxCutoverTime := qrMaxCutoverTime
		if qMaxCutoverTime != "" {
	...
	if o.ScannerPercent != nil {
		...
		var qrScannerPercent string

		if o.ScannerPercent != nil {
			qrScannerPercent = *o.ScannerPercent
		}
		qScannerPercent := qrScannerPercent
		if qScannerPercent != "" {
	...
	if o.ScannerProgress != nil {
		...
		var qrScannerProgress string

		if o.ScannerProgress != nil {
			qrScannerProgress = *o.ScannerProgress
		}
		qScannerProgress := qrScannerProgress
		if qScannerProgress != "" {
	...
	if o.ScannerTotal != nil {
		...
		var qrScannerTotal string

		if o.ScannerTotal != nil {
			qrScannerTotal = *o.ScannerTotal
		}
		qScannerTotal := qrScannerTotal
		if qScannerTotal != "" {
