...
func (o *SnapshotPolicyScheduleDeleteCollectionDefault) Error() string {
	return fmt.Sprintf("[DELETE /storage/snapshot-policies/{snapshot_policy.uuid}/schedules][%d] snapshot_policy_schedule_delete_collection default  %+v", o._statusCode, o.Payload)
}
