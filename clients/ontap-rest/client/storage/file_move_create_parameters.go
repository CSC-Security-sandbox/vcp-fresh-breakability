...
func (o *FileMoveCreateParams) SetDefaults() {
	var (
		automaticDefault = string("\"False\"")

		disruptiveDefault = string("\"False\"")
...
func (o *FileMoveCreateParams) WithAutomatic(automatic *string) *FileMoveCreateParams {
	o.SetAutomatic(automatic)
	return o
}

// SetAutomatic adds the automatic to the file move create params
func (o *FileMoveCreateParams) SetAutomatic(automatic *string) {
	o.Automatic = automatic
}

// WithDisruptive adds the disruptive to the file move create params
func (o *FileMoveCreateParams) WithDisruptive(disruptive *string) *FileMoveCreateParams {
	o.SetDisruptive(disruptive)
	return o
}

// SetDisruptive adds the disruptive to the file move create params
func (o *FileMoveCreateParams) SetDisruptive(disruptive *string) {
	o.Disruptive = disruptive
}

// WithForce adds the force to the file move create params
func (o *FileMoveCreateParams) WithForce(force *string) *FileMoveCreateParams {
	o.SetForce(force)
	return o
}

// SetForce adds the force to the file move create params
func (o *FileMoveCreateParams) SetForce(force *string) {
	o.Force = force
}
...
func (o *FileMoveCreateParams) WithReturnRecords(returnRecords *string) *FileMoveCreateParams {
	o.SetReturnRecords(returnRecords)
	return o
}

// SetReturnRecords adds the returnRecords to the file move create params
func (o *FileMoveCreateParams) SetReturnRecords(returnRecords *string) {
...
func (o *FileMoveCreateParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
	...
	if o.Automatic != nil {
		...
		var qrAutomatic string

		if o.Automatic != nil {
			qrAutomatic = *o.Automatic
		}
		qAutomatic := qrAutomatic
		if qAutomatic != "" {
	...
	if o.Disruptive != nil {
		...
		var qrDisruptive string

		if o.Disruptive != nil {
			qrDisruptive = *o.Disruptive
		}
		qDisruptive := qrDisruptive
		if qDisruptive != "" {
