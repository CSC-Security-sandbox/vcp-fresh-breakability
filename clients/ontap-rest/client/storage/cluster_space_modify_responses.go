...
func (o *ClusterSpaceModifyOK) Error() string {
	return fmt.Sprintf("[PATCH /storage/cluster][%d] clusterSpaceModifyOK  %+v", 200, o.Payload)
}
...
func (o *ClusterSpaceModifyAccepted) Error() string {
	return fmt.Sprintf("[PATCH /storage/cluster][%d] clusterSpaceModifyAccepted  %+v", 202, o.Payload)
}
...
func (o *ClusterSpaceModifyDefault) Error() string {
	return fmt.Sprintf("[PATCH /storage/cluster][%d] cluster_space_modify default  %+v", o._statusCode, o.Payload)
}
