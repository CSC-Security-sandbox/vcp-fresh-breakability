...
func (o *SnapshotPolicyScheduleCreateParams) WithReturnRecords(returnRecords *string) *SnapshotPolicyScheduleCreateParams {
	o.SetReturnRecords(returnRecords)
	return o
}

// SetReturnRecords adds the returnRecords to the snapshot policy schedule create params
func (o *SnapshotPolicyScheduleCreateParams) SetReturnRecords(returnRecords *string) {
