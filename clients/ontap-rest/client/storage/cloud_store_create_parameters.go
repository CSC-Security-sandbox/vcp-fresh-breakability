...
func (o *CloudStoreCreateParams) WithAllowFlexgroups(allowFlexgroups *string) *CloudStoreCreateParams {
	o.SetAllowFlexgroups(allowFlexgroups)
	return o
}

// SetAllowFlexgroups adds the allowFlexgroups to the cloud store create params
func (o *CloudStoreCreateParams) SetAllowFlexgroups(allowFlexgroups *string) {
	o.AllowFlexgroups = allowFlexgroups
}

// WithCheckOnly adds the checkOnly to the cloud store create params
func (o *CloudStoreCreateParams) WithCheckOnly(checkOnly *string) *CloudStoreCreateParams {
	o.SetCheckOnly(checkOnly)
	return o
}

// SetCheckOnly adds the checkOnly to the cloud store create params
func (o *CloudStoreCreateParams) SetCheckOnly(checkOnly *string) {
...
func (o *CloudStoreCreateParams) WithReturnRecords(returnRecords *string) *CloudStoreCreateParams {
	o.SetReturnRecords(returnRecords)
	return o
}

// SetReturnRecords adds the returnRecords to the cloud store create params
func (o *CloudStoreCreateParams) SetReturnRecords(returnRecords *string) {
	o.ReturnRecords = returnRecords
}

// WithReturnTimeout adds the returnTimeout to the cloud store create params
func (o *CloudStoreCreateParams) WithReturnTimeout(returnTimeout *string) *CloudStoreCreateParams {
	o.SetReturnTimeout(returnTimeout)
	return o
}

// SetReturnTimeout adds the returnTimeout to the cloud store create params
func (o *CloudStoreCreateParams) SetReturnTimeout(returnTimeout *string) {
...
func (o *CloudStoreCreateParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
	...
	if o.AllowFlexgroups != nil {
		...
		var qrAllowFlexgroups string

		if o.AllowFlexgroups != nil {
			qrAllowFlexgroups = *o.AllowFlexgroups
		}
		qAllowFlexgroups := qrAllowFlexgroups
		if qAllowFlexgroups != "" {
