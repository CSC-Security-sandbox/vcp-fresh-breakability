...
func (o *AggregateModifyCollectionOK) Error() string {
	return fmt.Sprintf("[PATCH /storage/aggregates][%d] aggregateModifyCollectionOK  %+v", 200, o.Payload)
}
...
func (o *AggregateModifyCollectionAccepted) Error() string {
	return fmt.Sprintf("[PATCH /storage/aggregates][%d] aggregateModifyCollectionAccepted  %+v", 202, o.Payload)
}
...
func (o *AggregateModifyCollectionDefault) Error() string {
	return fmt.Sprintf("[PATCH /storage/aggregates][%d] aggregate_modify_collection default  %+v", o._statusCode, o.Payload)
}
		...
		if o.AggregateResponseInlineRecommendationSpares[i] != nil {
			if err := o.AggregateResponseInlineRecommendationSpares[i].Validate(formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					...
					return ce.ValidateName("info" + "." + "recommendation_spares" + "." + strconv.Itoa(i))
				}
				return err
			}
		}
		...
		if o.AggregateResponseInlineSpares[i] != nil {
			if err := o.AggregateResponseInlineSpares[i].Validate(formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					...
					return ce.ValidateName("info" + "." + "spares" + "." + strconv.Itoa(i))
				}
				return err
			}
		}
		...
		if o.AggregateResponseInlineWarnings[i] != nil {
			if err := o.AggregateResponseInlineWarnings[i].Validate(formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					...
					return ce.ValidateName("info" + "." + "warnings" + "." + strconv.Itoa(i))
				}
				return err
			}
		}
	...
	if o.BlockStorage != nil {
		if err := o.BlockStorage.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("info" + "." + "block_storage")
			}
			return err
		}
	}
	...
	if o.CloudStorage != nil {
		if err := o.CloudStorage.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("info" + "." + "cloud_storage")
			}
			return err
		}
	}
	...
	if o.DataEncryption != nil {
		if err := o.DataEncryption.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("info" + "." + "data_encryption")
			}
			return err
		}
	}
	...
	if o.DrHomeNode != nil {
		if err := o.DrHomeNode.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("info" + "." + "dr_home_node")
			}
			return err
		}
	}
	...
	if o.HomeNode != nil {
		if err := o.HomeNode.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("info" + "." + "home_node")
			}
			return err
		}
	}
	...
	if o.InactiveDataReporting != nil {
		if err := o.InactiveDataReporting.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("info" + "." + "inactive_data_reporting")
			}
			return err
		}
	}
	...
	if o.InodeAttributes != nil {
		if err := o.InodeAttributes.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("info" + "." + "inode_attributes")
			}
			return err
		}
	}
	...
	if o.Snapshot != nil {
		if err := o.Snapshot.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("info" + "." + "snapshot")
			}
			return err
		}
	}
	...
	if o.HybridCache != nil {
		if err := o.HybridCache.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("info" + "." + "block_storage" + "." + "hybrid_cache")
			}
			return err
		}
	}
	...
	if o.Mirror != nil {
		if err := o.Mirror.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("info" + "." + "block_storage" + "." + "mirror")
			}
			return err
		}
	}
		...
		if o.Plexes[i] != nil {
			if err := o.Plexes[i].Validate(formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					...
					return ce.ValidateName("info" + "." + "block_storage" + "." + "plexes" + "." + strconv.Itoa(i))
				}
				return err
			}
		}
	...
	if o.Primary != nil {
		if err := o.Primary.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("info" + "." + "block_storage" + "." + "primary")
			}
			return err
		}
	}
		...
		if o.SimulatedRaidGroups[i] != nil {
			if err := o.SimulatedRaidGroups[i].Validate(formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					...
					return ce.ValidateName("info" + "." + "block_storage" + "." + "hybrid_cache" + "." + "simulated_raid_groups" + "." + strconv.Itoa(i))
				}
				return err
			}
		}
		...
		if o.StoragePools[i] != nil {
			if err := o.StoragePools[i].Validate(formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					...
					return ce.ValidateName("info" + "." + "block_storage" + "." + "hybrid_cache" + "." + "storage_pools" + "." + strconv.Itoa(i))
				}
				return err
			}
		}
		...
		if o.SimulatedRaidGroups[i] != nil {
			if err := o.SimulatedRaidGroups[i].Validate(formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					...
					return ce.ValidateName("info" + "." + "block_storage" + "." + "primary" + "." + "simulated_raid_groups" + "." + strconv.Itoa(i))
				}
				return err
			}
		}
		...
		if o.Stores[i] != nil {
			if err := o.Stores[i].Validate(formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					...
					return ce.ValidateName("info" + "." + "cloud_storage" + "." + "stores" + "." + strconv.Itoa(i))
				}
				return err
			}
		}
	...
	if o.Links != nil {
		if err := o.Links.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("info" + "." + "home_node" + "." + "_links")
			}
			return err
		}
	}
	...
	if o.Self != nil {
		if err := o.Self.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("info" + "." + "home_node" + "." + "_links" + "." + "self")
			}
			return err
		}
	}
	...
	if o.BlockStorage != nil {
		if err := o.BlockStorage.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("info" + "." + "space" + "." + "block_storage")
			}
			return err
		}
	}
	...
	if o.CloudStorage != nil {
		if err := o.CloudStorage.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("info" + "." + "space" + "." + "cloud_storage")
			}
			return err
		}
	}
	...
	if o.Efficiency != nil {
		if err := o.Efficiency.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("info" + "." + "space" + "." + "efficiency")
			}
			return err
		}
	}
	...
	if o.EfficiencyWithoutSnapshots != nil {
		if err := o.EfficiencyWithoutSnapshots.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("info" + "." + "space" + "." + "efficiency_without_snapshots")
			}
			return err
		}
	}
	...
	if o.EfficiencyWithoutSnapshotsFlexclones != nil {
		if err := o.EfficiencyWithoutSnapshotsFlexclones.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("info" + "." + "space" + "." + "efficiency_without_snapshots_flexclones")
			}
			return err
		}
	}
...
func (o *AggregateInlineSpaceInlineBlockStorage) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	...
	if err := o.contextValidatePerformanceTierCacheUsed(ctx, formats); err != nil {
		res = append(res, err)
	}
...
func (o *AggregateInlineSpaceInlineBlockStorage) contextValidatePerformanceTierCacheUsed(ctx context.Context, formats strfmt.Registry) error {

	if err := validate.ReadOnly(ctx, "info"+"."+"space"+"."+"block_storage"+"."+"performance_tier_cache_used", "body", o.PerformanceTierCacheUsed); err != nil {
		return err
	}
