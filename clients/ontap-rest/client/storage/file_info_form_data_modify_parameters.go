...
func (o *FileInfoFormDataModifyParams) WithByteOffset(byteOffset *string) *FileInfoFormDataModifyParams {
	o.SetByteOffset(byteOffset)
	return o
}

// SetByteOffset adds the byteOffset to the file info form data modify params
func (o *FileInfoFormDataModifyParams) SetByteOffset(byteOffset *string) {
...
func (o *FileInfoFormDataModifyParams) WithReturnRecords(returnRecords *string) *FileInfoFormDataModifyParams {
	o.SetReturnRecords(returnRecords)
	return o
}

// SetReturnRecords adds the returnRecords to the file info form data modify params
func (o *FileInfoFormDataModifyParams) SetReturnRecords(returnRecords *string) {
