...
func (o *QtreeModifyParams) WithReturnTimeout(returnTimeout *string) *QtreeModifyParams {
	o.SetReturnTimeout(returnTimeout)
	return o
}

// SetReturnTimeout adds the returnTimeout to the qtree modify params
func (o *QtreeModifyParams) SetReturnTimeout(returnTimeout *string) {
	o.ReturnTimeout = returnTimeout
}

// WithSynchronous adds the synchronous to the qtree modify params
func (o *QtreeModifyParams) WithSynchronous(synchronous *string) *QtreeModifyParams {
	o.SetSynchronous(synchronous)
	return o
}

// SetSynchronous adds the synchronous to the qtree modify params
func (o *QtreeModifyParams) SetSynchronous(synchronous *string) {
