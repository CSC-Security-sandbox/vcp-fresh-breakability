...
func (o *StoragePoolModifyCollectionOK) Error() string {
	return fmt.Sprintf("[PATCH /storage/pools][%d] storagePoolModifyCollectionOK  %+v", 200, o.Payload)
}
...
func (o *StoragePoolModifyCollectionAccepted) Error() string {
	return fmt.Sprintf("[PATCH /storage/pools][%d] storagePoolModifyCollectionAccepted  %+v", 202, o.Payload)
}
...
func (o *StoragePoolModifyCollectionDefault) Error() string {
	return fmt.Sprintf("[PATCH /storage/pools][%d] storage_pool_modify_collection default  %+v", o._statusCode, o.Payload)
}
	...
	if o.Capacity != nil {
		if err := o.Capacity.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("info" + "." + "capacity")
			}
			return err
		}
	}
	...
	if o.Health != nil {
		if err := o.Health.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("info" + "." + "health")
			}
			return err
		}
	}
		...
		if o.StoragePoolInlineNodes[i] != nil {
			if err := o.StoragePoolInlineNodes[i].Validate(formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					...
					return ce.ValidateName("info" + "." + "nodes" + "." + strconv.Itoa(i))
				}
				return err
			}
		}
		...
		if o.Disks[i] != nil {
			if err := o.Disks[i].Validate(formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					...
					return ce.ValidateName("info" + "." + "capacity" + "." + "disks" + "." + strconv.Itoa(i))
				}
				return err
			}
		}
		...
		if o.SpareAllocationUnits[i] != nil {
			if err := o.SpareAllocationUnits[i].Validate(formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					...
					return ce.ValidateName("info" + "." + "capacity" + "." + "spare_allocation_units" + "." + strconv.Itoa(i))
				}
				return err
			}
		}
		...
		if o.UsedAllocationUnits[i] != nil {
			if err := o.UsedAllocationUnits[i].Validate(formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					...
					return ce.ValidateName("info" + "." + "capacity" + "." + "used_allocation_units" + "." + strconv.Itoa(i))
				}
				return err
			}
		}
	...
	if o.UnhealthyReason != nil {
		if err := o.UnhealthyReason.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("info" + "." + "health" + "." + "unhealthy_reason")
			}
			return err
		}
	}
