...
func (o *StorageAvailabilityZoneModifyCollectionOK) Error() string {
	return fmt.Sprintf("[PATCH /storage/availability-zones][%d] storageAvailabilityZoneModifyCollectionOK  %+v", 200, o.Payload)
}
...
func (o *StorageAvailabilityZoneModifyCollectionAccepted) Error() string {
	return fmt.Sprintf("[PATCH /storage/availability-zones][%d] storageAvailabilityZoneModifyCollectionAccepted  %+v", 202, o.Payload)
}
...
func (o *StorageAvailabilityZoneModifyCollectionDefault) Error() string {
	return fmt.Sprintf("[PATCH /storage/availability-zones][%d] storage_availability_zone_modify_collection default  %+v", o._statusCode, o.Payload)
}
...
func (o *StorageAvailabilityZoneModifyCollectionBody) contextValidateStorageAvailabilityZoneInlineNodes(ctx context.Context, formats strfmt.Registry) error {
	...
	if err := validate.ReadOnly(ctx, "info"+"."+"nodes", "body", []*StorageAvailabilityZoneInlineNodesInlineArrayItem(o.StorageAvailabilityZoneInlineNodes)); err != nil {
		return err
	}
