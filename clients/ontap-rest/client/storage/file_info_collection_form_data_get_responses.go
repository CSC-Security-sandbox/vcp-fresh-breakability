...
func (o *FileInfoCollectionFormDataGetOK) Error() string {
	return fmt.Sprintf("[GET //storage/volumes/{volume.uuid}/files/{path}][%d] fileInfoCollectionFormDataGetOK  %+v", 200, o.Payload)
}
...
func (o *FileInfoCollectionFormDataGetDefault) Error() string {
	return fmt.Sprintf("[GET //storage/volumes/{volume.uuid}/files/{path}][%d] file_info_collection_form_data_get default  %+v", o._statusCode, o.Payload)
}
