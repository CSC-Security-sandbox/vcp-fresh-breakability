...
func (o *FileDeleteParams) WithRecurse(recurse *string) *FileDeleteParams {
	o.SetRecurse(recurse)
	return o
}

// SetRecurse adds the recurse to the file delete params
func (o *FileDeleteParams) SetRecurse(recurse *string) {
	o.Recurse = recurse
}

// WithReturnRecords adds the returnRecords to the file delete params
func (o *FileDeleteParams) WithReturnRecords(returnRecords *string) *FileDeleteParams {
	o.SetReturnRecords(returnRecords)
	return o
}

// SetReturnRecords adds the returnRecords to the file delete params
func (o *FileDeleteParams) SetReturnRecords(returnRecords *string) {
	o.ReturnRecords = returnRecords
}

// WithReturnTimeout adds the returnTimeout to the file delete params
func (o *FileDeleteParams) WithReturnTimeout(returnTimeout *string) *FileDeleteParams {
	o.SetReturnTimeout(returnTimeout)
	return o
}

// SetReturnTimeout adds the returnTimeout to the file delete params
func (o *FileDeleteParams) SetReturnTimeout(returnTimeout *string) {
	o.ReturnTimeout = returnTimeout
}

// WithThrottleDeletion adds the throttleDeletion to the file delete params
func (o *FileDeleteParams) WithThrottleDeletion(throttleDeletion *string) *FileDeleteParams {
	o.SetThrottleDeletion(throttleDeletion)
	return o
}

// SetThrottleDeletion adds the throttleDeletion to the file delete params
func (o *FileDeleteParams) SetThrottleDeletion(throttleDeletion *string) {
