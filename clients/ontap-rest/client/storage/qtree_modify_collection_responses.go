...
func (o *QtreeModifyCollectionOK) Error() string {
	return fmt.Sprintf("[PATCH /storage/qtrees][%d] qtreeModifyCollectionOK  %+v", 200, o.Payload)
}
...
func (o *QtreeModifyCollectionAccepted) Error() string {
	return fmt.Sprintf("[PATCH /storage/qtrees][%d] qtreeModifyCollectionAccepted  %+v", 202, o.Payload)
}
...
func (o *QtreeModifyCollectionDefault) Error() string {
	return fmt.Sprintf("[PATCH /storage/qtrees][%d] qtree_modify_collection default  %+v", o._statusCode, o.Payload)
}
	...
	if o.ExportPolicy != nil {
		if err := o.ExportPolicy.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("info" + "." + "export_policy")
			}
			return err
		}
	}
	...
	if o.ExtPerformanceMonitoring != nil {
		if err := o.ExtPerformanceMonitoring.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("info" + "." + "ext_performance_monitoring")
			}
			return err
		}
	}
	...
	if o.Group != nil {
		if err := o.Group.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("info" + "." + "group")
			}
			return err
		}
	}
	...
	if o.User != nil {
		if err := o.User.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("info" + "." + "user")
			}
			return err
		}
	}
	...
	if o.Links != nil {
		if err := o.Links.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("info" + "." + "export_policy" + "." + "_links")
			}
			return err
		}
	}
	...
	if o.Self != nil {
		if err := o.Self.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("info" + "." + "export_policy" + "." + "_links" + "." + "self")
			}
			return err
		}
	}
