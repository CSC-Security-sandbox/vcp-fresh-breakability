...
// WithReturnTimeout adds the returnTimeout to the storage pool modify params
func (o *StoragePoolModifyParams) WithReturnTimeout(returnTimeout *string) *StoragePoolModifyParams {
	o.SetReturnTimeout(returnTimeout)
	return o
}

// SetReturnTimeout adds the returnTimeout to the storage pool modify params
func (o *StoragePoolModifyParams) SetReturnTimeout(returnTimeout *string) {
	o.ReturnTimeout = returnTimeout
}

// WithSimulate adds the simulate to the storage pool modify params
func (o *StoragePoolModifyParams) WithSimulate(simulate *string) *StoragePoolModifyParams {
	o.SetSimulate(simulate)
	return o
}

// SetSimulate adds the simulate to the storage pool modify params
func (o *StoragePoolModifyParams) SetSimulate(simulate *string) {
	o.Simulate = simulate
}

// WithUUID adds the uuid to the storage pool modify params
func (o *StoragePoolModifyParams) WithUUID(uuid string) *StoragePoolModifyParams {
	o.SetUUID(uuid)
	return o
}

// SetUUID adds the uuid to the storage pool modify params
func (o *StoragePoolModifyParams) SetUUID(uuid string) {
	o.UUID = uuid
}
