...
func (o *FlexcacheModifyParams) WithReturnTimeout(returnTimeout *string) *FlexcacheModifyParams {
	o.SetReturnTimeout(returnTimeout)
	return o
}

// SetReturnTimeout adds the returnTimeout to the flexcache modify params
func (o *FlexcacheModifyParams) SetReturnTimeout(returnTimeout *string) {
