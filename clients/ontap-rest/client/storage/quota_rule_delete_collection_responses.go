...
func (o *QuotaRuleDeleteCollectionOK) Error() string {
	return fmt.Sprintf("[DELETE /storage/quota/rules][%d] quotaRuleDeleteCollectionOK  %+v", 200, o.Payload)
}
...
func (o *QuotaRuleDeleteCollectionAccepted) Error() string {
	return fmt.Sprintf("[DELETE /storage/quota/rules][%d] quotaRuleDeleteCollectionAccepted  %+v", 202, o.Payload)
}
...
func (o *QuotaRuleDeleteCollectionDefault) Error() string {
	return fmt.Sprintf("[DELETE /storage/quota/rules][%d] quota_rule_delete_collection default  %+v", o._statusCode, o.Payload)
}
