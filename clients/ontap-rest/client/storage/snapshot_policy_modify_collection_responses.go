...
func (o *SnapshotPolicyModifyCollectionDefault) Error() string {
	return fmt.Sprintf("[PATCH /storage/snapshot-policies][%d] snapshot_policy_modify_collection default  %+v", o._statusCode, o.Payload)
}
		...
		if o.SnapshotPolicyInlineCopies[i] != nil {
			if err := o.SnapshotPolicyInlineCopies[i].Validate(formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					...
					return ce.ValidateName("info" + "." + "copies" + "." + strconv.Itoa(i))
				}
				return err
			}
		}
