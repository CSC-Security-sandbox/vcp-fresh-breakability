...
func (o *VolumeEfficiencyPolicyCreateParams) WithReturnRecords(returnRecords *string) *VolumeEfficiencyPolicyCreateParams {
	o.SetReturnRecords(returnRecords)
	return o
}

// SetReturnRecords adds the returnRecords to the volume efficiency policy create params
func (o *VolumeEfficiencyPolicyCreateParams) SetReturnRecords(returnRecords *string) {
