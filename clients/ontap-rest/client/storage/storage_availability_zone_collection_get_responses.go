...
func (o *StorageAvailabilityZoneCollectionGetOK) Error() string {
	return fmt.Sprintf("[GET /storage/availability-zones][%d] storageAvailabilityZoneCollectionGetOK  %+v", 200, o.Payload)
}
...
func (o *StorageAvailabilityZoneCollectionGetDefault) Error() string {
	return fmt.Sprintf("[GET /storage/availability-zones][%d] storage_availability_zone_collection_get default  %+v", o._statusCode, o.Payload)
}
