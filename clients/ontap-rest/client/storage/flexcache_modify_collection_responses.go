...
func (o *FlexcacheModifyCollectionOK) Error() string {
	return fmt.Sprintf("[PATCH /storage/flexcache/flexcaches][%d] flexcacheModifyCollectionOK  %+v", 200, o.Payload)
}
...
func (o *FlexcacheModifyCollectionAccepted) Error() string {
	return fmt.Sprintf("[PATCH /storage/flexcache/flexcaches][%d] flexcacheModifyCollectionAccepted  %+v", 202, o.Payload)
}
...
func (o *FlexcacheModifyCollectionDefault) Error() string {
	return fmt.Sprintf("[PATCH /storage/flexcache/flexcaches][%d] flexcache_modify_collection default  %+v", o._statusCode, o.Payload)
}
	...
	if o.AtimeScrub != nil {
		if err := o.AtimeScrub.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("info" + "." + "atime_scrub")
			}
			return err
		}
	}
	...
	if o.CifsChangeNotify != nil {
		if err := o.CifsChangeNotify.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("info" + "." + "cifs_change_notify")
			}
			return err
		}
	}
		...
		if o.FlexcacheInlineOrigins[i] != nil {
			if err := o.FlexcacheInlineOrigins[i].Validate(formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					...
					return ce.ValidateName("info" + "." + "origins" + "." + strconv.Itoa(i))
				}
				return err
			}
		}
	...
	if o.Prepopulate != nil {
		if err := o.Prepopulate.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("info" + "." + "prepopulate")
			}
			return err
		}
	}
	...
	if o.RelativeSize != nil {
		if err := o.RelativeSize.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("info" + "." + "relative_size")
			}
			return err
		}
	}
	...
	if o.Writeback != nil {
		if err := o.Writeback.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("info" + "." + "writeback")
			}
			return err
		}
	}
