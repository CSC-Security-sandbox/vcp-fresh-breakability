...
func (o *SplitLoadModifyCollectionDefault) Error() string {
	return fmt.Sprintf("[PATCH /storage/file/clone/split-loads][%d] split_load_modify_collection default  %+v", o._statusCode, o.Payload)
}
	...
	if o.Load != nil {
		if err := o.Load.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("info" + "." + "load")
			}
			return err
		}
	}
