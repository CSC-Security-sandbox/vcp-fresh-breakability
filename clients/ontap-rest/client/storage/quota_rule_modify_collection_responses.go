...
func (o *QuotaRuleModifyCollectionOK) Error() string {
	return fmt.Sprintf("[PATCH /storage/quota/rules][%d] quotaRuleModifyCollectionOK  %+v", 200, o.Payload)
}
...
func (o *QuotaRuleModifyCollectionAccepted) Error() string {
	return fmt.Sprintf("[PATCH /storage/quota/rules][%d] quotaRuleModifyCollectionAccepted  %+v", 202, o.Payload)
}
...
func (o *QuotaRuleModifyCollectionDefault) Error() string {
	return fmt.Sprintf("[PATCH /storage/quota/rules][%d] quota_rule_modify_collection default  %+v", o._statusCode, o.Payload)
}
	...
	if o.Links != nil {
		if err := o.Links.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("info" + "." + "qtree" + "." + "_links")
			}
			return err
		}
	}
	...
	if o.Self != nil {
		if err := o.Self.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("info" + "." + "qtree" + "." + "_links" + "." + "self")
			}
			return err
		}
	}
