...
func (o *StorageAvailabilityZoneGetOK) Error() string {
	return fmt.Sprintf("[GET /storage/availability-zones/{uuid}][%d] storageAvailabilityZoneGetOK  %+v", 200, o.Payload)
}
...
func (o *StorageAvailabilityZoneGetDefault) Error() string {
	return fmt.Sprintf("[GET /storage/availability-zones/{uuid}][%d] storage_availability_zone_get default  %+v", o._statusCode, o.Payload)
}
