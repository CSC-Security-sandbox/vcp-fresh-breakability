...
func (o *SnapshotPolicyCreateParams) WithReturnRecords(returnRecords *string) *SnapshotPolicyCreateParams {
	o.SetReturnRecords(returnRecords)
	return o
}

// SetReturnRecords adds the returnRecords to the snapshot policy create params
func (o *SnapshotPolicyCreateParams) SetReturnRecords(returnRecords *string) {
