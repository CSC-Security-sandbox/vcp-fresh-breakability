...
func (o *SecurityJitPrivilegeModifyCollectionOK) Error() string {
	return fmt.Sprintf("[PATCH /security/jit-privileges][%d] securityJitPrivilegeModifyCollectionOK  %+v", 200, o.Payload)
}
...
func (o *SecurityJitPrivilegeModifyCollectionDefault) Error() string {
	return fmt.Sprintf("[PATCH /security/jit-privileges][%d] security_jit_privilege_modify_collection default  %+v", o._statusCode, o.Payload)
}
