...
func (o *SecurityOauth2GetOK) Error() string {
	return fmt.Sprintf("[GET /security/authentication/cluster/oauth2/clients/{name}][%d] securityOauth2GetOK  %+v", 200, o.Payload)
}
...
func (o *SecurityOauth2GetDefault) Error() string {
	return fmt.Sprintf("[GET /security/authentication/cluster/oauth2/clients/{name}][%d] security_oauth2_get default  %+v", o._statusCode, o.Payload)
}
