...
func (o *GcpKmsRekeyInternalCreated) Error() string {
	return fmt.Sprintf("[POST /security/gcp-kms/{uuid}/rekey-internal][%d] gcpKmsRekeyInternalCreated  %+v", 201, o.Payload)
}
...
func (o *GcpKmsRekeyInternalAccepted) Error() string {
	return fmt.Sprintf("[POST /security/gcp-kms/{uuid}/rekey-internal][%d] gcpKmsRekeyInternalAccepted  %+v", 202, o.Payload)
}
