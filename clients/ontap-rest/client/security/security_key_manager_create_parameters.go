...
func (o *SecurityKeyManagerCreateParams) WithCreateInactive(createInactive *string) *SecurityKeyManagerCreateParams {
	o.SetCreateInactive(createInactive)
	return o
}

// SetCreateInactive adds the createInactive to the security key manager create params
func (o *SecurityKeyManagerCreateParams) SetCreateInactive(createInactive *string) {
...
func (o *SecurityKeyManagerCreateParams) WithReturnRecords(returnRecords *string) *SecurityKeyManagerCreateParams {
	o.SetReturnRecords(returnRecords)
	return o
}

// SetReturnRecords adds the returnRecords to the security key manager create params
func (o *SecurityKeyManagerCreateParams) SetReturnRecords(returnRecords *string) {
	o.ReturnRecords = returnRecords
}

// WithReturnTimeout adds the returnTimeout to the security key manager create params
func (o *SecurityKeyManagerCreateParams) WithReturnTimeout(returnTimeout *string) *SecurityKeyManagerCreateParams {
	o.SetReturnTimeout(returnTimeout)
	return o
}

// SetReturnTimeout adds the returnTimeout to the security key manager create params
func (o *SecurityKeyManagerCreateParams) SetReturnTimeout(returnTimeout *string) {
...
func (o *SecurityKeyManagerCreateParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
	...
	if o.CreateInactive != nil {
		...
		var qrCreateInactive string

		if o.CreateInactive != nil {
			qrCreateInactive = *o.CreateInactive
		}
		qCreateInactive := qrCreateInactive
		if qCreateInactive != "" {
