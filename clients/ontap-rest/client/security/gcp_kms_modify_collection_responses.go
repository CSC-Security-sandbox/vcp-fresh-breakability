...
func (o *GcpKmsModifyCollectionAccepted) Error() string {
	return fmt.Sprintf("[PATCH /security/gcp-kms][%d] gcpKmsModifyCollectionAccepted  %+v", 202, o.Payload)
}
...
func (o *GcpKmsModifyCollectionDefault) Error() string {
	return fmt.Sprintf("[PATCH /security/gcp-kms][%d] gcp_kms_modify_collection default  %+v", o._statusCode, o.Payload)
}
	...
	if o.GoogleReachability != nil {
		if err := o.GoogleReachability.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("info" + "." + "google_reachability")
			}
			return err
		}
	}
...
func (o *GcpKmsModifyCollectionBody) contextValidateGcpKmsInlineEkmipReachability(ctx context.Context, formats strfmt.Registry) error {
	...
	if err := validate.ReadOnly(ctx, "info"+"."+"ekmip_reachability", "body", []*GcpKmsInlineEkmipReachabilityInlineArrayItem(o.GcpKmsInlineEkmipReachability)); err != nil {
		return err
	}
