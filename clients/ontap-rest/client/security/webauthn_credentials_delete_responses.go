...
func (o *WebauthnCredentialsDeleteDefault) Error() string {
	return fmt.Sprintf("[DELETE /security/webauthn/credentials/{owner.uuid}/{username}/{index}/{relying_party.id}][%d] webauthn_credentials_delete default  %+v", o._statusCode, o.Payload)
}
