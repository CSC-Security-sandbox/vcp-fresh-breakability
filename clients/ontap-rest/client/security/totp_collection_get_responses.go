...
func (o *TotpCollectionGetOK) Error() string {
	return fmt.Sprintf("[GET /security/login/totps][%d] totpCollectionGetOK  %+v", 200, o.Payload)
}
...
func (o *TotpCollectionGetDefault) Error() string {
	return fmt.Sprintf("[GET /security/login/totps][%d] totp_collection_get default  %+v", o._statusCode, o.Payload)
}
