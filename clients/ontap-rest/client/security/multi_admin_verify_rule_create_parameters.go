...
func (o *MultiAdminVerifyRuleCreateParams) WithReturnRecords(returnRecords *string) *MultiAdminVerifyRuleCreateParams {
	o.SetReturnRecords(returnRecords)
	return o
}

// SetReturnRecords adds the returnRecords to the multi admin verify rule create params
func (o *MultiAdminVerifyRuleCreateParams) SetReturnRecords(returnRecords *string) {
