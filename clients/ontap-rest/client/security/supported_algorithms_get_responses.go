...
func (o *SupportedAlgorithmsGetOK) Error() string {
	return fmt.Sprintf("[GET /security/webauthn/supported-algorithms/{owner.uuid}/{algorithm.name}][%d] supportedAlgorithmsGetOK  %+v", 200, o.Payload)
}
...
func (o *SupportedAlgorithmsGetDefault) Error() string {
	return fmt.Sprintf("[GET /security/webauthn/supported-algorithms/{owner.uuid}/{algorithm.name}][%d] supported_algorithms_get default  %+v", o._statusCode, o.Payload)
}
