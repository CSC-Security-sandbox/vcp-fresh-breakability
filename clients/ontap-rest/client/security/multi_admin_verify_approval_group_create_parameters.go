...
func (o *MultiAdminVerifyApprovalGroupCreateParams) WithReturnRecords(returnRecords *string) *MultiAdminVerifyApprovalGroupCreateParams {
	o.SetReturnRecords(returnRecords)
	return o
}

// SetReturnRecords adds the returnRecords to the multi admin verify approval group create params
func (o *MultiAdminVerifyApprovalGroupCreateParams) SetReturnRecords(returnRecords *string) {
