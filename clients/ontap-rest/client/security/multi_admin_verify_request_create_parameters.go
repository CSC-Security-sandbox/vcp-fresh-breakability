...
func (o *MultiAdminVerifyRequestCreateParams) WithReturnRecords(returnRecords *string) *MultiAdminVerifyRequestCreateParams {
	o.SetReturnRecords(returnRecords)
	return o
}

// SetReturnRecords adds the returnRecords to the multi admin verify request create params
func (o *MultiAdminVerifyRequestCreateParams) SetReturnRecords(returnRecords *string) {
