...
func (o *AzureKeyVaultDeleteCollectionAccepted) Error() string {
	return fmt.Sprintf("[DELETE /security/azure-key-vaults][%d] azureKeyVaultDeleteCollectionAccepted  %+v", 202, o.Payload)
}
...
func (o *AzureKeyVaultDeleteCollectionDefault) Error() string {
	return fmt.Sprintf("[DELETE /security/azure-key-vaults][%d] azure_key_vault_delete_collection default  %+v", o._statusCode, o.Payload)
}
