...
func (o *AwsKmsRestoreCreated) Error() string {
	return fmt.Sprintf("[POST /security/aws-kms/{aws_kms.uuid}/restore][%d] awsKmsRestoreCreated  %+v", 201, o.Payload)
}
...
func (o *AwsKmsRestoreAccepted) Error() string {
	return fmt.Sprintf("[POST /security/aws-kms/{aws_kms.uuid}/restore][%d] awsKmsRestoreAccepted  %+v", 202, o.Payload)
}
