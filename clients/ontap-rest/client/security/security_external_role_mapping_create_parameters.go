...
func (o *SecurityExternalRoleMappingCreateParams) WithReturnRecords(returnRecords *string) *SecurityExternalRoleMappingCreateParams {
	o.SetReturnRecords(returnRecords)
	return o
}

// SetReturnRecords adds the returnRecords to the security external role mapping create params
func (o *SecurityExternalRoleMappingCreateParams) SetReturnRecords(returnRecords *string) {
