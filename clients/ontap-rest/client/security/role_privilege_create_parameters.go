...
func (o *RolePrivilegeCreateParams) WithReturnRecords(returnRecords *string) *RolePrivilegeCreateParams {
	o.SetReturnRecords(returnRecords)
	return o
}

// SetReturnRecords adds the returnRecords to the role privilege create params
func (o *RolePrivilegeCreateParams) SetReturnRecords(returnRecords *string) {
