...
func (o *SecurityOauth2DeleteCollectionParams) WithContinueOnFailure(continueOnFailure *string) *SecurityOauth2DeleteCollectionParams {
	o.SetContinueOnFailure(continueOnFailure)
	return o
}

// SetContinueOnFailure adds the continueOnFailure to the security oauth2 delete collection params
func (o *SecurityOauth2DeleteCollectionParams) SetContinueOnFailure(continueOnFailure *string) {
...
func (o *SecurityOauth2DeleteCollectionParams) WithReturnRecords(returnRecords *string) *SecurityOauth2DeleteCollectionParams {
	o.SetReturnRecords(returnRecords)
	return o
}

// SetReturnRecords adds the returnRecords to the security oauth2 delete collection params
func (o *SecurityOauth2DeleteCollectionParams) SetReturnRecords(returnRecords *string) {
	o.ReturnRecords = returnRecords
}

// WithReturnTimeout adds the returnTimeout to the security oauth2 delete collection params
func (o *SecurityOauth2DeleteCollectionParams) WithReturnTimeout(returnTimeout *string) *SecurityOauth2DeleteCollectionParams {
	o.SetReturnTimeout(returnTimeout)
	return o
}

// SetReturnTimeout adds the returnTimeout to the security oauth2 delete collection params
func (o *SecurityOauth2DeleteCollectionParams) SetReturnTimeout(returnTimeout *string) {
	o.ReturnTimeout = returnTimeout
}

// WithSerialRecords adds the serialRecords to the security oauth2 delete collection params
func (o *SecurityOauth2DeleteCollectionParams) WithSerialRecords(serialRecords *string) *SecurityOauth2DeleteCollectionParams {
	o.SetSerialRecords(serialRecords)
	return o
}

// SetSerialRecords adds the serialRecords to the security oauth2 delete collection params
func (o *SecurityOauth2DeleteCollectionParams) SetSerialRecords(serialRecords *string) {
	o.SerialRecords = serialRecords
}

// WithUseLocalRolesIfPresent adds the useLocalRolesIfPresent to the security oauth2 delete collection params
func (o *SecurityOauth2DeleteCollectionParams) WithUseLocalRolesIfPresent(useLocalRolesIfPresent *string) *SecurityOauth2DeleteCollectionParams {
...
func (o *SecurityOauth2DeleteCollectionParams) SetUseLocalRolesIfPresent(useLocalRolesIfPresent *string) {
...
func (o *SecurityOauth2DeleteCollectionParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
	...
	if o.UseLocalRolesIfPresent != nil {
		...
		var qrUseLocalRolesIfPresent string

		if o.UseLocalRolesIfPresent != nil {
			qrUseLocalRolesIfPresent = *o.UseLocalRolesIfPresent
		}
		qUseLocalRolesIfPresent := qrUseLocalRolesIfPresent
