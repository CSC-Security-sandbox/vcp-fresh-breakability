...
func (o *SecurityExternalRoleMappingGetOK) Error() string {
	return fmt.Sprintf("[GET /security/external-role-mappings/{external_role}/{provider}][%d] securityExternalRoleMappingGetOK  %+v", 200, o.Payload)
}
...
func (o *SecurityExternalRoleMappingGetDefault) Error() string {
	return fmt.Sprintf("[GET /security/external-role-mappings/{external_role}/{provider}][%d] security_external_role_mapping_get default  %+v", o._statusCode, o.Payload)
}
