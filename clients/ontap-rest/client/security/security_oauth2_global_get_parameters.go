...
func (o *SecurityOauth2GlobalGetParams) WithEnabled(enabled *string) *SecurityOauth2GlobalGetParams {
	o.SetEnabled(enabled)
	return o
}

// SetEnabled adds the enabled to the security oauth2 global get params
func (o *SecurityOauth2GlobalGetParams) SetEnabled(enabled *string) {
	o.Enabled = enabled
}
