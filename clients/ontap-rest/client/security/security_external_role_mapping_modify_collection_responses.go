...
func (o *SecurityExternalRoleMappingModifyCollectionOK) Error() string {
	return fmt.Sprintf("[PATCH /security/external-role-mappings][%d] securityExternalRoleMappingModifyCollectionOK  %+v", 200, o.Payload)
}
...
func (o *SecurityExternalRoleMappingModifyCollectionDefault) Error() string {
	return fmt.Sprintf("[PATCH /security/external-role-mappings][%d] security_external_role_mapping_modify_collection default  %+v", o._statusCode, o.Payload)
}
	...
	if o.ONTAPRole != nil {
		if err := o.ONTAPRole.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("info" + "." + "ontap_role")
			}
			return err
		}
	}
	...
	if o.Links != nil {
		if err := o.Links.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("info" + "." + "ontap_role" + "." + "_links")
			}
			return err
		}
	}
	...
	if o.Self != nil {
		if err := o.Self.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("info" + "." + "ontap_role" + "." + "_links" + "." + "self")
			}
			return err
		}
	}
