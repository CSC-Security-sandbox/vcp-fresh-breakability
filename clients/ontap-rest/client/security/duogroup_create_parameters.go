...
func (o *DuogroupCreateParams) WithReturnRecords(returnRecords *string) *DuogroupCreateParams {
	o.SetReturnRecords(returnRecords)
	return o
}

// SetReturnRecords adds the returnRecords to the duogroup create params
func (o *DuogroupCreateParams) SetReturnRecords(returnRecords *string) {
