...
func (o *AccountPasswordCreateParams) WithReturnRecords(returnRecords *string) *AccountPasswordCreateParams {
	o.SetReturnRecords(returnRecords)
	return o
}

// SetReturnRecords adds the returnRecords to the account password create params
func (o *AccountPasswordCreateParams) SetReturnRecords(returnRecords *string) {
