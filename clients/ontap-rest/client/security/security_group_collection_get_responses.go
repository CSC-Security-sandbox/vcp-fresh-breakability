...
func (o *SecurityGroupCollectionGetOK) Error() string {
	return fmt.Sprintf("[GET /security/groups][%d] securityGroupCollectionGetOK  %+v", 200, o.Payload)
}
...
func (o *SecurityGroupCollectionGetDefault) Error() string {
	return fmt.Sprintf("[GET /security/groups][%d] security_group_collection_get default  %+v", o._statusCode, o.Payload)
}
