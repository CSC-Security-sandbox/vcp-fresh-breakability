...
func (o *AzureKeyVaultModifyCollectionAccepted) Error() string {
	return fmt.Sprintf("[PATCH /security/azure-key-vaults][%d] azureKeyVaultModifyCollectionAccepted  %+v", 202, o.Payload)
}
...
func (o *AzureKeyVaultModifyCollectionDefault) Error() string {
	return fmt.Sprintf("[PATCH /security/azure-key-vaults][%d] azure_key_vault_modify_collection default  %+v", o._statusCode, o.Payload)
}
	...
	if o.AzureReachability != nil {
		if err := o.AzureReachability.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("info" + "." + "azure_reachability")
			}
			return err
		}
	}
...
func (o *AzureKeyVaultModifyCollectionBody) contextValidateAzureKeyVaultInlineEkmipReachability(ctx context.Context, formats strfmt.Registry) error {
	...
	if err := validate.ReadOnly(ctx, "info"+"."+"ekmip_reachability", "body", []*AzureKeyVaultInlineEkmipReachabilityInlineArrayItem(o.AzureKeyVaultInlineEkmipReachability)); err != nil {
		return err
	}
