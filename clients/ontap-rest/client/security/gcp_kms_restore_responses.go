...
func (o *GcpKmsRestoreCreated) Error() string {
	return fmt.Sprintf("[POST /security/gcp-kms/{uuid}/restore][%d] gcpKmsRestoreCreated  %+v", 201, o.Payload)
}
...
func (o *GcpKmsRestoreAccepted) Error() string {
	return fmt.Sprintf("[POST /security/gcp-kms/{uuid}/restore][%d] gcpKmsRestoreAccepted  %+v", 202, o.Payload)
}
