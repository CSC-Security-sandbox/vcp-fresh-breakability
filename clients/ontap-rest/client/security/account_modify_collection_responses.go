...
func (o *AccountModifyCollectionDefault) Error() string {
	return fmt.Sprintf("[PATCH /security/accounts][%d] account_modify_collection default  %+v", o._statusCode, o.Payload)
}
...
var accountModifyCollectionBodyAuthenticationMethodsItemsEnum []interface{}
...
func init() {
	...
	for _, v := range res {
		accountModifyCollectionBodyAuthenticationMethodsItemsEnum = append(accountModifyCollectionBodyAuthenticationMethodsItemsEnum, v)
	}
}

func (o *AccountModifyCollectionBody) validateAuthenticationMethodsItemsEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, accountModifyCollectionBodyAuthenticationMethodsItemsEnum, true); err != nil {
		return err
	}
	return nil
}

func (o *AccountModifyCollectionBody) validateAuthenticationMethods(formats strfmt.Registry) error {
	...
	if o.Links != nil {
		if err := o.Links.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("info" + "." + "role" + "." + "_links")
			}
			return err
		}
	}
	...
	if o.Self != nil {
		if err := o.Self.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("info" + "." + "role" + "." + "_links" + "." + "self")
			}
			return err
		}
	}
