...
func (o *SecurityJitPrivilegeGetOK) Error() string {
	return fmt.Sprintf("[GET /security/jit-privileges/{owner.uuid}/{application}][%d] securityJitPrivilegeGetOK  %+v", 200, o.Payload)
}
...
func (o *SecurityJitPrivilegeGetDefault) Error() string {
	return fmt.Sprintf("[GET /security/jit-privileges/{owner.uuid}/{application}][%d] security_jit_privilege_get default  %+v", o._statusCode, o.Payload)
}
