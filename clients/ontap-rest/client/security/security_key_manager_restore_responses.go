...
func (o *SecurityKeyManagerRestoreCreated) Error() string {
	return fmt.Sprintf("[POST /security/key-managers/{security_key_manager.uuid}/restore][%d] securityKeyManagerRestoreCreated  %+v", 201, o.Payload)
}
...
func (o *SecurityKeyManagerRestoreAccepted) Error() string {
	return fmt.Sprintf("[POST /security/key-managers/{security_key_manager.uuid}/restore][%d] securityKeyManagerRestoreAccepted  %+v", 202, o.Payload)
}
...
func (o *SecurityKeyManagerRestoreDefault) Error() string {
	return fmt.Sprintf("[POST /security/key-managers/{security_key_manager.uuid}/restore][%d] security_key_manager_restore default  %+v", o._statusCode, o.Payload)
}
