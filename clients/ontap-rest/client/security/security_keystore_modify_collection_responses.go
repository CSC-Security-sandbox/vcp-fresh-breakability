...
func (o *SecurityKeystoreModifyCollectionOK) Error() string {
	return fmt.Sprintf("[PATCH /security/key-stores][%d] securityKeystoreModifyCollectionOK  %+v", 200, o.Payload)
}
...
func (o *SecurityKeystoreModifyCollectionAccepted) Error() string {
	return fmt.Sprintf("[PATCH /security/key-stores][%d] securityKeystoreModifyCollectionAccepted  %+v", 202, o.Payload)
}
...
func (o *SecurityKeystoreModifyCollectionDefault) Error() string {
	return fmt.Sprintf("[PATCH /security/key-stores][%d] security_keystore_modify_collection default  %+v", o._statusCode, o.Payload)
}
