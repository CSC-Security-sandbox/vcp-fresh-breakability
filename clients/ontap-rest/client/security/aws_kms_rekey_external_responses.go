...
func (o *AwsKmsRekeyExternalCreated) Error() string {
	return fmt.Sprintf("[POST /security/aws-kms/{aws_kms.uuid}/rekey-external][%d] awsKmsRekeyExternalCreated  %+v", 201, o.Payload)
}
...
func (o *AwsKmsRekeyExternalAccepted) Error() string {
	return fmt.Sprintf("[POST /security/aws-kms/{aws_kms.uuid}/rekey-external][%d] awsKmsRekeyExternalAccepted  %+v", 202, o.Payload)
}
