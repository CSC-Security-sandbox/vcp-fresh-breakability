...
func (o *AzureKeyVaultDeleteParams) WithReturnTimeout(returnTimeout *string) *AzureKeyVaultDeleteParams {
	o.SetReturnTimeout(returnTimeout)
	return o
}

// SetReturnTimeout adds the returnTimeout to the azure key vault delete params
func (o *AzureKeyVaultDeleteParams) SetReturnTimeout(returnTimeout *string) {
