...
func (o *AntiRansomwareModifyOK) Error() string {
	return fmt.Sprintf("[PATCH /security/anti-ransomware][%d] antiRansomwareModifyOK  %+v", 200, o.Payload)
}
...
func (o *AntiRansomwareModifyAccepted) Error() string {
	return fmt.Sprintf("[PATCH /security/anti-ransomware][%d] antiRansomwareModifyAccepted  %+v", 202, o.Payload)
}
...
func (o *AntiRansomwareModifyDefault) Error() string {
	return fmt.Sprintf("[PATCH /security/anti-ransomware][%d] anti_ransomware_modify default  %+v", o._statusCode, o.Payload)
}
