...
func (o *IpsecPolicyCreateParams) WithReturnRecords(returnRecords *string) *IpsecPolicyCreateParams {
	o.SetReturnRecords(returnRecords)
	return o
}

// SetReturnRecords adds the returnRecords to the ipsec policy create params
func (o *IpsecPolicyCreateParams) SetReturnRecords(returnRecords *string) {
