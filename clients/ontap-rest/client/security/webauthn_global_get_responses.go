...
func (o *WebauthnGlobalGetOK) Error() string {
	return fmt.Sprintf("[GET /security/webauthn/global-settings/{owner.uuid}][%d] webauthnGlobalGetOK  %+v", 200, o.Payload)
}
...
func (o *WebauthnGlobalGetDefault) Error() string {
	return fmt.Sprintf("[GET /security/webauthn/global-settings/{owner.uuid}][%d] webauthn_global_get default  %+v", o._statusCode, o.Payload)
}
