...
func (o *DuogroupCreateCreated) Error() string {
	return fmt.Sprintf("[POST /security/authentication/duo/groups][%d] duogroupCreateCreated  %+v", 201, o.Payload)
}
...
func (o *DuogroupCreateDefault) Error() string {
	return fmt.Sprintf("[POST /security/authentication/duo/groups][%d] duogroup_create default  %+v", o._statusCode, o.Payload)
}
