...
func (o *SecurityAuditLogCollectionGetParams) WithIndex(index *string) *SecurityAuditLogCollectionGetParams {
	o.SetIndex(index)
	return o
}

// SetIndex adds the index to the security audit log collection get params
func (o *SecurityAuditLogCollectionGetParams) SetIndex(index *string) {
	o.Index = index
}
...
func (o *SecurityAuditLogCollectionGetParams) WithMaxRecords(maxRecords *string) *SecurityAuditLogCollectionGetParams {
	o.SetMaxRecords(maxRecords)
	return o
}

// SetMaxRecords adds the maxRecords to the security audit log collection get params
func (o *SecurityAuditLogCollectionGetParams) SetMaxRecords(maxRecords *string) {
...
func (o *SecurityAuditLogCollectionGetParams) WithReturnRecords(returnRecords *string) *SecurityAuditLogCollectionGetParams {
	o.SetReturnRecords(returnRecords)
	return o
}

// SetReturnRecords adds the returnRecords to the security audit log collection get params
func (o *SecurityAuditLogCollectionGetParams) SetReturnRecords(returnRecords *string) {
	o.ReturnRecords = returnRecords
}

// WithReturnTimeout adds the returnTimeout to the security audit log collection get params
func (o *SecurityAuditLogCollectionGetParams) WithReturnTimeout(returnTimeout *string) *SecurityAuditLogCollectionGetParams {
	o.SetReturnTimeout(returnTimeout)
	return o
}

// SetReturnTimeout adds the returnTimeout to the security audit log collection get params
func (o *SecurityAuditLogCollectionGetParams) SetReturnTimeout(returnTimeout *string) {
...
// WithTraceid adds the traceid to the security audit log collection get params
func (o *SecurityAuditLogCollectionGetParams) WithTraceid(traceid *string) *SecurityAuditLogCollectionGetParams {
	o.SetTraceid(traceid)
	return o
}

// SetTraceid adds the traceid to the security audit log collection get params
func (o *SecurityAuditLogCollectionGetParams) SetTraceid(traceid *string) {
	o.Traceid = traceid
}
...
func (o *SecurityAuditLogCollectionGetParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
	...
	if o.Traceid != nil {
		...
		if qTraceid != "" {
			...
			if err := r.SetQueryParam("traceid", qTraceid); err != nil {
				return err
			}
		}
	}
