...
func (o *DuogroupGetOK) Error() string {
	return fmt.Sprintf("[GET /security/authentication/duo/groups/{owner.uuid}/{name}][%d] duogroupGetOK  %+v", 200, o.Payload)
}
...
func (o *DuogroupGetDefault) Error() string {
	return fmt.Sprintf("[GET /security/authentication/duo/groups/{owner.uuid}/{name}][%d] duogroup_get default  %+v", o._statusCode, o.Payload)
}
