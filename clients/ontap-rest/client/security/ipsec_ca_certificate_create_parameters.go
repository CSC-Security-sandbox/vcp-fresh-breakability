...
func (o *IpsecCaCertificateCreateParams) WithReturnRecords(returnRecords *string) *IpsecCaCertificateCreateParams {
	o.SetReturnRecords(returnRecords)
	return o
}

// SetReturnRecords adds the returnRecords to the ipsec ca certificate create params
func (o *IpsecCaCertificateCreateParams) SetReturnRecords(returnRecords *string) {
