...
func (o *SecurityGroupCreateCreated) Error() string {
	return fmt.Sprintf("[POST /security/groups][%d] securityGroupCreateCreated  %+v", 201, o.Payload)
}
...
func (o *SecurityGroupCreateDefault) Error() string {
	return fmt.Sprintf("[POST /security/groups][%d] security_group_create default  %+v", o._statusCode, o.Payload)
}
