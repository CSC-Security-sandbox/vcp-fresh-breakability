...
// WithReturnTimeout adds the returnTimeout to the security config modify params
func (o *SecurityConfigModifyParams) WithReturnTimeout(returnTimeout *string) *SecurityConfigModifyParams {
	o.SetReturnTimeout(returnTimeout)
	return o
}

// SetReturnTimeout adds the returnTimeout to the security config modify params
func (o *SecurityConfigModifyParams) SetReturnTimeout(returnTimeout *string) {
