...
func (o *SecurityCertificateCreateParams) WithReturnRecords(returnRecords *string) *SecurityCertificateCreateParams {
	o.SetReturnRecords(returnRecords)
	return o
}

// SetReturnRecords adds the returnRecords to the security certificate create params
func (o *SecurityCertificateCreateParams) SetReturnRecords(returnRecords *string) {
