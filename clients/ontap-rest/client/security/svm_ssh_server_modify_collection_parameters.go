...
type SvmSSHServerModifyCollectionParams struct {
	...
	*/
	...
	/* IsRsaInPublickeyAlgorithmsEnabled.
	   ...
	   Format: boolean
	*/
	IsRsaInPublickeyAlgorithmsEnabled *string
	...
	*/
	...
	/* MaxAuthenticationRetryCount.
	   ...
	   Format: integer
	*/
	MaxAuthenticationRetryCount *string
...
func (o *SvmSSHServerModifyCollectionParams) WithContinueOnFailure(continueOnFailure *string) *SvmSSHServerModifyCollectionParams {
	o.SetContinueOnFailure(continueOnFailure)
	return o
}

// SetContinueOnFailure adds the continueOnFailure to the svm ssh server modify collection params
func (o *SvmSSHServerModifyCollectionParams) SetContinueOnFailure(continueOnFailure *string) {
...
func (o *SvmSSHServerModifyCollectionParams) WithIsRsaInPublickeyAlgorithmsEnabled(isRsaInPublickeyAlgorithmsEnabled *string) *SvmSSHServerModifyCollectionParams {
...
func (o *SvmSSHServerModifyCollectionParams) SetIsRsaInPublickeyAlgorithmsEnabled(isRsaInPublickeyAlgorithmsEnabled *string) {
...
func (o *SvmSSHServerModifyCollectionParams) WithMaxAuthenticationRetryCount(maxAuthenticationRetryCount *string) *SvmSSHServerModifyCollectionParams {
...
func (o *SvmSSHServerModifyCollectionParams) SetMaxAuthenticationRetryCount(maxAuthenticationRetryCount *string) {
...
func (o *SvmSSHServerModifyCollectionParams) WithReturnRecords(returnRecords *string) *SvmSSHServerModifyCollectionParams {
	o.SetReturnRecords(returnRecords)
	return o
}

// SetReturnRecords adds the returnRecords to the svm ssh server modify collection params
func (o *SvmSSHServerModifyCollectionParams) SetReturnRecords(returnRecords *string) {
	o.ReturnRecords = returnRecords
}

// WithReturnTimeout adds the returnTimeout to the svm ssh server modify collection params
func (o *SvmSSHServerModifyCollectionParams) WithReturnTimeout(returnTimeout *string) *SvmSSHServerModifyCollectionParams {
	o.SetReturnTimeout(returnTimeout)
	return o
}

// SetReturnTimeout adds the returnTimeout to the svm ssh server modify collection params
func (o *SvmSSHServerModifyCollectionParams) SetReturnTimeout(returnTimeout *string) {
	o.ReturnTimeout = returnTimeout
}

// WithSerialRecords adds the serialRecords to the svm ssh server modify collection params
func (o *SvmSSHServerModifyCollectionParams) WithSerialRecords(serialRecords *string) *SvmSSHServerModifyCollectionParams {
	o.SetSerialRecords(serialRecords)
	return o
}

// SetSerialRecords adds the serialRecords to the svm ssh server modify collection params
func (o *SvmSSHServerModifyCollectionParams) SetSerialRecords(serialRecords *string) {
...
func (o *SvmSSHServerModifyCollectionParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
	...
	if o.IsRsaInPublickeyAlgorithmsEnabled != nil {
		...
		var qrIsRsaInPublickeyAlgorithmsEnabled string

		if o.IsRsaInPublickeyAlgorithmsEnabled != nil {
			qrIsRsaInPublickeyAlgorithmsEnabled = *o.IsRsaInPublickeyAlgorithmsEnabled
		}
		qIsRsaInPublickeyAlgorithmsEnabled := qrIsRsaInPublickeyAlgorithmsEnabled
	...
	if o.MaxAuthenticationRetryCount != nil {
		...
		var qrMaxAuthenticationRetryCount string

		if o.MaxAuthenticationRetryCount != nil {
			qrMaxAuthenticationRetryCount = *o.MaxAuthenticationRetryCount
		}
		qMaxAuthenticationRetryCount := qrMaxAuthenticationRetryCount
