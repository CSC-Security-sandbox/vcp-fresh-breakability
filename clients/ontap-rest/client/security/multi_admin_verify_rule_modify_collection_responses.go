...
func (o *MultiAdminVerifyRuleModifyCollectionDefault) Error() string {
	return fmt.Sprintf("[PATCH /security/multi-admin-verify/rules][%d] multi_admin_verify_rule_modify_collection default  %+v", o._statusCode, o.Payload)
}
...
type MultiAdminVerifyRuleModifyCollectionBody struct {
	...
	// Allow values less than the valid expiry timers
	AllowInvalidExpiryTimers *bool `json:"allow_invalid_expiry_timers,omitempty"`
		...
		if o.MultiAdminVerifyRuleInlineApprovalGroups[i] != nil {
			if err := o.MultiAdminVerifyRuleInlineApprovalGroups[i].Validate(formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					...
					return ce.ValidateName("info" + "." + "approval_groups" + "." + strconv.Itoa(i))
				}
				return err
			}
		}
