...
func (o *SecurityExternalRoleMappingModifyOK) Error() string {
	return fmt.Sprintf("[PATCH /security/external-role-mappings/{external_role}/{provider}][%d] securityExternalRoleMappingModifyOK  %+v", 200, o.Payload)
}
...
func (o *SecurityExternalRoleMappingModifyDefault) Error() string {
	return fmt.Sprintf("[PATCH /security/external-role-mappings/{external_role}/{provider}][%d] security_external_role_mapping_modify default  %+v", o._statusCode, o.Payload)
}
