...
func (o *SecurityLogForwardingModifyCollectionOK) Error() string {
	return fmt.Sprintf("[PATCH /security/audit/destinations][%d] securityLogForwardingModifyCollectionOK  %+v", 200, o.Payload)
}
...
func (o *SecurityLogForwardingModifyCollectionDefault) Error() string {
	return fmt.Sprintf("[PATCH /security/audit/destinations][%d] security_log_forwarding_modify_collection default  %+v", o._statusCode, o.Payload)
}
