...
func (o *WebauthnGlobalCollectionGetOK) Error() string {
	return fmt.Sprintf("[GET /security/webauthn/global-settings][%d] webauthnGlobalCollectionGetOK  %+v", 200, o.Payload)
}
...
func (o *WebauthnGlobalCollectionGetDefault) Error() string {
	return fmt.Sprintf("[GET /security/webauthn/global-settings][%d] webauthn_global_collection_get default  %+v", o._statusCode, o.Payload)
}
