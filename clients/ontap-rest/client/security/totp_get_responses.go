...
func (o *TotpGetOK) Error() string {
	return fmt.Sprintf("[GET /security/login/totps/{owner.uuid}/{account.name}][%d] totpGetOK  %+v", 200, o.Payload)
}
...
func (o *TotpGetDefault) Error() string {
	return fmt.Sprintf("[GET /security/login/totps/{owner.uuid}/{account.name}][%d] totp_get default  %+v", o._statusCode, o.Payload)
}
