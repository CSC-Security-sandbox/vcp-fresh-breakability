...
func (o *MultiAdminVerifyApprovalGroupModifyCollectionDefault) Error() string {
	return fmt.Sprintf("[PATCH /security/multi-admin-verify/approval-groups][%d] multi_admin_verify_approval_group_modify_collection default  %+v", o._statusCode, o.Payload)
}
