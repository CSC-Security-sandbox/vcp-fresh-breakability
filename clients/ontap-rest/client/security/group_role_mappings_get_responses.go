...
func (o *GroupRoleMappingsGetOK) Error() string {
	return fmt.Sprintf("[GET /security/group/role-mappings/{group_id}/{ontap_role.name}][%d] groupRoleMappingsGetOK  %+v", 200, o.Payload)
}
...
func (o *GroupRoleMappingsGetDefault) Error() string {
	return fmt.Sprintf("[GET /security/group/role-mappings/{group_id}/{ontap_role.name}][%d] group_role_mappings_get default  %+v", o._statusCode, o.Payload)
}
