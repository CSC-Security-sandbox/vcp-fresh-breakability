...
func (o *SecurityCertificateSignParams) WithReturnRecords(returnRecords *string) *SecurityCertificateSignParams {
	o.SetReturnRecords(returnRecords)
	return o
}

// SetReturnRecords adds the returnRecords to the security certificate sign params
func (o *SecurityCertificateSignParams) SetReturnRecords(returnRecords *string) {
