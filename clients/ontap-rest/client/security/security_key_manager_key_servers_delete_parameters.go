...
func (o *SecurityKeyManagerKeyServersDeleteParams) WithForce(force *string) *SecurityKeyManagerKeyServersDeleteParams {
	o.SetForce(force)
	return o
}

// SetForce adds the force to the security key manager key servers delete params
func (o *SecurityKeyManagerKeyServersDeleteParams) SetForce(force *string) {
	o.Force = force
}
