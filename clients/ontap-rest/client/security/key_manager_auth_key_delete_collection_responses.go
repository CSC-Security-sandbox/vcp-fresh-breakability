...
func (o *KeyManagerAuthKeyDeleteCollectionDefault) Error() string {
	return fmt.Sprintf("[DELETE /security/key-managers/{security_key_manager.uuid}/auth-keys][%d] key_manager_auth_key_delete_collection default  %+v", o._statusCode, o.Payload)
}
