...
func (o *AwsKmsModifyCollectionAccepted) Error() string {
	return fmt.Sprintf("[PATCH /security/aws-kms][%d] awsKmsModifyCollectionAccepted  %+v", 202, o.Payload)
}
...
func (o *AwsKmsModifyCollectionDefault) Error() string {
	return fmt.Sprintf("[PATCH /security/aws-kms][%d] aws_kms_modify_collection default  %+v", o._statusCode, o.Payload)
}
	...
	if o.AmazonReachability != nil {
		if err := o.AmazonReachability.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("info" + "." + "amazon_reachability")
			}
			return err
		}
	}
...
func (o *AwsKmsModifyCollectionBody) contextValidateAwsKmsInlineEkmipReachability(ctx context.Context, formats strfmt.Registry) error {
	...
	if err := validate.ReadOnly(ctx, "info"+"."+"ekmip_reachability", "body", []*AwsKmsInlineEkmipReachabilityInlineArrayItem(o.AwsKmsInlineEkmipReachability)); err != nil {
		return err
	}
