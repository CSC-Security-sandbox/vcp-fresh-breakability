...
func (o *AzureKeyVaultRekeyInternalCreated) Error() string {
	return fmt.Sprintf("[POST /security/azure-key-vaults/{uuid}/rekey-internal][%d] azureKeyVaultRekeyInternalCreated  %+v", 201, o.Payload)
}
...
func (o *AzureKeyVaultRekeyInternalAccepted) Error() string {
	return fmt.Sprintf("[POST /security/azure-key-vaults/{uuid}/rekey-internal][%d] azureKeyVaultRekeyInternalAccepted  %+v", 202, o.Payload)
}
