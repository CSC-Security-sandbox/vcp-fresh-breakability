...
func (o *DuoCollectionGetOK) Error() string {
	return fmt.Sprintf("[GET /security/authentication/duo/profiles][%d] duoCollectionGetOK  %+v", 200, o.Payload)
}
...
func (o *DuoCollectionGetDefault) Error() string {
	return fmt.Sprintf("[GET /security/authentication/duo/profiles][%d] duo_collection_get default  %+v", o._statusCode, o.Payload)
}
