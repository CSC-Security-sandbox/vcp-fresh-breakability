...
func (o *CreateCertificateSigningRequestParams) WithReturnRecords(returnRecords *string) *CreateCertificateSigningRequestParams {
	o.SetReturnRecords(returnRecords)
	return o
}

// SetReturnRecords adds the returnRecords to the create certificate signing request params
func (o *CreateCertificateSigningRequestParams) SetReturnRecords(returnRecords *string) {
