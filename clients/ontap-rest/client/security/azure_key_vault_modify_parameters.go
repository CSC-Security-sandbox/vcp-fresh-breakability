...
func (o *AzureKeyVaultModifyParams) WithReturnTimeout(returnTimeout *string) *AzureKeyVaultModifyParams {
	o.SetReturnTimeout(returnTimeout)
	return o
}

// SetReturnTimeout adds the returnTimeout to the azure key vault modify params
func (o *AzureKeyVaultModifyParams) SetReturnTimeout(returnTimeout *string) {
