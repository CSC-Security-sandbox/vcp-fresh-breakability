...
func (o *AntiRansomwareSuspectDeleteCollectionOK) Error() string {
	return fmt.Sprintf("[DELETE /security/anti-ransomware/suspects][%d] antiRansomwareSuspectDeleteCollectionOK  %+v", 200, o.Payload)
}
...
func (o *AntiRansomwareSuspectDeleteCollectionAccepted) Error() string {
	return fmt.Sprintf("[DELETE /security/anti-ransomware/suspects][%d] antiRansomwareSuspectDeleteCollectionAccepted  %+v", 202, o.Payload)
}
