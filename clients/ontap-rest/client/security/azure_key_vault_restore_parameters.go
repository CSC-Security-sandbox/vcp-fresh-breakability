...
func (o *AzureKeyVaultRestoreParams) WithReturnRecords(returnRecords *string) *AzureKeyVaultRestoreParams {
	o.SetReturnRecords(returnRecords)
	return o
}

// SetReturnRecords adds the returnRecords to the azure key vault restore params
func (o *AzureKeyVaultRestoreParams) SetReturnRecords(returnRecords *string) {
	o.ReturnRecords = returnRecords
}

// WithReturnTimeout adds the returnTimeout to the azure key vault restore params
func (o *AzureKeyVaultRestoreParams) WithReturnTimeout(returnTimeout *string) *AzureKeyVaultRestoreParams {
	o.SetReturnTimeout(returnTimeout)
	return o
}

// SetReturnTimeout adds the returnTimeout to the azure key vault restore params
func (o *AzureKeyVaultRestoreParams) SetReturnTimeout(returnTimeout *string) {
