...
func (o *SecurityOauth2CollectionGetOK) Error() string {
	return fmt.Sprintf("[GET /security/authentication/cluster/oauth2/clients][%d] securityOauth2CollectionGetOK  %+v", 200, o.Payload)
}
...
func (o *SecurityOauth2CollectionGetDefault) Error() string {
	return fmt.Sprintf("[GET /security/authentication/cluster/oauth2/clients][%d] security_oauth2_collection_get default  %+v", o._statusCode, o.Payload)
}
