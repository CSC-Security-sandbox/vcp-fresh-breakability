...
func (o *AntiRansomwareModifyParams) WithReturnTimeout(returnTimeout *string) *AntiRansomwareModifyParams {
	o.SetReturnTimeout(returnTimeout)
	return o
}

// SetReturnTimeout adds the returnTimeout to the anti ransomware modify params
func (o *AntiRansomwareModifyParams) SetReturnTimeout(returnTimeout *string) {
