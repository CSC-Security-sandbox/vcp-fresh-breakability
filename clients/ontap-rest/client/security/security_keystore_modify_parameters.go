...
func (o *SecurityKeystoreModifyParams) WithReturnTimeout(returnTimeout *string) *SecurityKeystoreModifyParams {
	o.SetReturnTimeout(returnTimeout)
	return o
}

// SetReturnTimeout adds the returnTimeout to the security keystore modify params
func (o *SecurityKeystoreModifyParams) SetReturnTimeout(returnTimeout *string) {
