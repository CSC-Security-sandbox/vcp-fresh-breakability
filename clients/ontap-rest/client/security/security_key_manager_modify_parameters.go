...
func (o *SecurityKeyManagerModifyParams) WithReturnTimeout(returnTimeout *string) *SecurityKeyManagerModifyParams {
	o.SetReturnTimeout(returnTimeout)
	return o
}

// SetReturnTimeout adds the returnTimeout to the security key manager modify params
func (o *SecurityKeyManagerModifyParams) SetReturnTimeout(returnTimeout *string) {
