...
func (o *KeyManagerAuthKeyCreateParams) WithReturnRecords(returnRecords *string) *KeyManagerAuthKeyCreateParams {
	o.SetReturnRecords(returnRecords)
	return o
}

// SetReturnRecords adds the returnRecords to the key manager auth key create params
func (o *KeyManagerAuthKeyCreateParams) SetReturnRecords(returnRecords *string) {
