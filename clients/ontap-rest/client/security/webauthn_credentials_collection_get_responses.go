...
func (o *WebauthnCredentialsCollectionGetOK) Error() string {
	return fmt.Sprintf("[GET /security/webauthn/credentials][%d] webauthnCredentialsCollectionGetOK  %+v", 200, o.Payload)
}
...
func (o *WebauthnCredentialsCollectionGetDefault) Error() string {
	return fmt.Sprintf("[GET /security/webauthn/credentials][%d] webauthn_credentials_collection_get default  %+v", o._statusCode, o.Payload)
}
