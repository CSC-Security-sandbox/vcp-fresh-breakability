...
func (o *GroupRoleMappingsCreateCreated) Error() string {
	return fmt.Sprintf("[POST /security/group/role-mappings][%d] groupRoleMappingsCreateCreated  %+v", 201, o.Payload)
}
...
func (o *GroupRoleMappingsCreateDefault) Error() string {
	return fmt.Sprintf("[POST /security/group/role-mappings][%d] group_role_mappings_create default  %+v", o._statusCode, o.Payload)
}
