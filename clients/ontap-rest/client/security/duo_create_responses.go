...
func (o *DuoCreateCreated) Error() string {
	return fmt.Sprintf("[POST /security/authentication/duo/profiles][%d] duoCreateCreated  %+v", 201, o.Payload)
}
...
func (o *DuoCreateDefault) Error() string {
	return fmt.Sprintf("[POST /security/authentication/duo/profiles][%d] duo_create default  %+v", o._statusCode, o.Payload)
}
