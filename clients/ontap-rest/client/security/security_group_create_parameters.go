...
func (o *SecurityGroupCreateParams) WithReturnRecords(returnRecords *string) *SecurityGroupCreateParams {
	o.SetReturnRecords(returnRecords)
	return o
}

// SetReturnRecords adds the returnRecords to the security group create params
func (o *SecurityGroupCreateParams) SetReturnRecords(returnRecords *string) {
