...
func (o *SecurityJitPrivilegeModifyOK) Error() string {
	return fmt.Sprintf("[PATCH /security/jit-privileges/{owner.uuid}/{application}][%d] securityJitPrivilegeModifyOK  %+v", 200, o.Payload)
}
...
func (o *SecurityJitPrivilegeModifyDefault) Error() string {
	return fmt.Sprintf("[PATCH /security/jit-privileges/{owner.uuid}/{application}][%d] security_jit_privilege_modify default  %+v", o._statusCode, o.Payload)
}
