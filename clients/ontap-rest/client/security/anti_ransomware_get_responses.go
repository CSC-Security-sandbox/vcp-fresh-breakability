...
func (o *AntiRansomwareGetOK) Error() string {
	return fmt.Sprintf("[GET /security/anti-ransomware][%d] antiRansomwareGetOK  %+v", 200, o.Payload)
}
...
func (o *AntiRansomwareGetDefault) Error() string {
	return fmt.Sprintf("[GET /security/anti-ransomware][%d] anti_ransomware_get default  %+v", o._statusCode, o.Payload)
}
