...
func (o *SecurityKeystoreGetOK) Error() string {
	return fmt.Sprintf("[GET /security/key-stores/{uuid}][%d] securityKeystoreGetOK  %+v", 200, o.Payload)
}
...
func (o *SecurityKeystoreGetDefault) Error() string {
	return fmt.Sprintf("[GET /security/key-stores/{uuid}][%d] security_keystore_get default  %+v", o._statusCode, o.Payload)
}
