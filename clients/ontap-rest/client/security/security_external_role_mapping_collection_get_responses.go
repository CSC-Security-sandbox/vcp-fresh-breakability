...
func (o *SecurityExternalRoleMappingCollectionGetOK) Error() string {
	return fmt.Sprintf("[GET /security/external-role-mappings][%d] securityExternalRoleMappingCollectionGetOK  %+v", 200, o.Payload)
}
...
func (o *SecurityExternalRoleMappingCollectionGetDefault) Error() string {
	return fmt.Sprintf("[GET /security/external-role-mappings][%d] security_external_role_mapping_collection_get default  %+v", o._statusCode, o.Payload)
}
