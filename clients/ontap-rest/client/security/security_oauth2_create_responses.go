...
func (o *SecurityOauth2CreateCreated) Error() string {
	return fmt.Sprintf("[POST /security/authentication/cluster/oauth2/clients][%d] securityOauth2CreateCreated  %+v", 201, o.Payload)
}
...
func (o *SecurityOauth2CreateAccepted) Error() string {
	return fmt.Sprintf("[POST /security/authentication/cluster/oauth2/clients][%d] securityOauth2CreateAccepted  %+v", 202, o.Payload)
}
...
func (o *SecurityOauth2CreateDefault) Error() string {
	return fmt.Sprintf("[POST /security/authentication/cluster/oauth2/clients][%d] security_oauth2_create default  %+v", o._statusCode, o.Payload)
}
