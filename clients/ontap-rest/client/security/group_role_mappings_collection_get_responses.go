...
func (o *GroupRoleMappingsCollectionGetOK) Error() string {
	return fmt.Sprintf("[GET /security/group/role-mappings][%d] groupRoleMappingsCollectionGetOK  %+v", 200, o.Payload)
}
...
func (o *GroupRoleMappingsCollectionGetDefault) Error() string {
	return fmt.Sprintf("[GET /security/group/role-mappings][%d] group_role_mappings_collection_get default  %+v", o._statusCode, o.Payload)
}
