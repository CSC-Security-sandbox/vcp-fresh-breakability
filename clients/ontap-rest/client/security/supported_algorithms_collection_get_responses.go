...
func (o *SupportedAlgorithmsCollectionGetOK) Error() string {
	return fmt.Sprintf("[GET /security/webauthn/supported-algorithms][%d] supportedAlgorithmsCollectionGetOK  %+v", 200, o.Payload)
}
...
func (o *SupportedAlgorithmsCollectionGetDefault) Error() string {
	return fmt.Sprintf("[GET /security/webauthn/supported-algorithms][%d] supported_algorithms_collection_get default  %+v", o._statusCode, o.Payload)
}
