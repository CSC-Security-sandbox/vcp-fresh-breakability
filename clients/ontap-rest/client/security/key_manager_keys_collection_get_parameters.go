...
func (o *KeyManagerKeysCollectionGetParams) WithMaxRecords(maxRecords *string) *KeyManagerKeysCollectionGetParams {
	o.SetMaxRecords(maxRecords)
	return o
}

// SetMaxRecords adds the maxRecords to the key manager keys collection get params
func (o *KeyManagerKeysCollectionGetParams) SetMaxRecords(maxRecords *string) {
...
func (o *KeyManagerKeysCollectionGetParams) WithRestored(restored *string) *KeyManagerKeysCollectionGetParams {
	o.SetRestored(restored)
	return o
}

// SetRestored adds the restored to the key manager keys collection get params
func (o *KeyManagerKeysCollectionGetParams) SetRestored(restored *string) {
	o.Restored = restored
}

// WithReturnRecords adds the returnRecords to the key manager keys collection get params
func (o *KeyManagerKeysCollectionGetParams) WithReturnRecords(returnRecords *string) *KeyManagerKeysCollectionGetParams {
	o.SetReturnRecords(returnRecords)
	return o
}

// SetReturnRecords adds the returnRecords to the key manager keys collection get params
func (o *KeyManagerKeysCollectionGetParams) SetReturnRecords(returnRecords *string) {
	o.ReturnRecords = returnRecords
}

// WithReturnTimeout adds the returnTimeout to the key manager keys collection get params
func (o *KeyManagerKeysCollectionGetParams) WithReturnTimeout(returnTimeout *string) *KeyManagerKeysCollectionGetParams {
	o.SetReturnTimeout(returnTimeout)
	return o
}

// SetReturnTimeout adds the returnTimeout to the key manager keys collection get params
func (o *KeyManagerKeysCollectionGetParams) SetReturnTimeout(returnTimeout *string) {
...
func (o *KeyManagerKeysCollectionGetParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
	...
	if o.Restored != nil {
		...
		var qrRestored string

		if o.Restored != nil {
			qrRestored = *o.Restored
		}
		qRestored := qrRestored
		if qRestored != "" {
