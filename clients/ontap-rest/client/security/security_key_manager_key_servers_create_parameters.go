...
func (o *SecurityKeyManagerKeyServersCreateParams) WithReturnRecords(returnRecords *string) *SecurityKeyManagerKeyServersCreateParams {
	o.SetReturnRecords(returnRecords)
	return o
}

// SetReturnRecords adds the returnRecords to the security key manager key servers create params
func (o *SecurityKeyManagerKeyServersCreateParams) SetReturnRecords(returnRecords *string) {
