...
func (o *SecurityOauth2GlobalGetOK) Error() string {
	return fmt.Sprintf("[GET /security/authentication/cluster/oauth2][%d] securityOauth2GlobalGetOK  %+v", 200, o.Payload)
}
...
func (o *SecurityOauth2GlobalGetDefault) Error() string {
	return fmt.Sprintf("[GET /security/authentication/cluster/oauth2][%d] security_oauth2_global_get default  %+v", o._statusCode, o.Payload)
}
