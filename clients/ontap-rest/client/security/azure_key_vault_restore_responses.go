...
func (o *AzureKeyVaultRestoreCreated) Error() string {
	return fmt.Sprintf("[POST /security/azure-key-vaults/{uuid}/restore][%d] azureKeyVaultRestoreCreated  %+v", 201, o.Payload)
}
...
func (o *AzureKeyVaultRestoreAccepted) Error() string {
	return fmt.Sprintf("[POST /security/azure-key-vaults/{uuid}/restore][%d] azureKeyVaultRestoreAccepted  %+v", 202, o.Payload)
}
