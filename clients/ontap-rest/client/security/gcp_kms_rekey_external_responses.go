...
func (o *GcpKmsRekeyExternalCreated) Error() string {
	return fmt.Sprintf("[POST /security/gcp-kms/{gcp_kms.uuid}/rekey-external][%d] gcpKmsRekeyExternalCreated  %+v", 201, o.Payload)
}
...
func (o *GcpKmsRekeyExternalAccepted) Error() string {
	return fmt.Sprintf("[POST /security/gcp-kms/{gcp_kms.uuid}/rekey-external][%d] gcpKmsRekeyExternalAccepted  %+v", 202, o.Payload)
}
