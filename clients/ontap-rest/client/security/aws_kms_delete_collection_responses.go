...
func (o *AwsKmsDeleteCollectionAccepted) Error() string {
	return fmt.Sprintf("[DELETE /security/aws-kms][%d] awsKmsDeleteCollectionAccepted  %+v", 202, o.Payload)
}
...
func (o *AwsKmsDeleteCollectionDefault) Error() string {
	return fmt.Sprintf("[DELETE /security/aws-kms][%d] aws_kms_delete_collection default  %+v", o._statusCode, o.Payload)
}
