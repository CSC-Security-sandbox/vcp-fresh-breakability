...
func (o *SecurityKeyManagerModifyCollectionAccepted) Error() string {
	return fmt.Sprintf("[PATCH /security/key-managers][%d] securityKeyManagerModifyCollectionAccepted  %+v", 202, o.Payload)
}
...
func (o *SecurityKeyManagerModifyCollectionDefault) Error() string {
	return fmt.Sprintf("[PATCH /security/key-managers][%d] security_key_manager_modify_collection default  %+v", o._statusCode, o.Payload)
}
	...
	if o.Configuration != nil {
		if err := o.Configuration.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("info" + "." + "configuration")
			}
			return err
		}
	}
	...
	if o.External != nil {
		if err := o.External.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("info" + "." + "external")
			}
			return err
		}
	}
	...
	if o.Onboard != nil {
		if err := o.Onboard.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("info" + "." + "onboard")
			}
			return err
		}
	}
	...
	if o.VolumeEncryption != nil {
		if err := o.VolumeEncryption.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("info" + "." + "volume_encryption")
			}
			return err
		}
	}
	...
	if o.Links != nil {
		if err := o.Links.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("info" + "." + "configuration" + "." + "_links")
			}
			return err
		}
	}
	...
	if o.Self != nil {
		if err := o.Self.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("info" + "." + "configuration" + "." + "_links" + "." + "self")
			}
			return err
		}
	}
	...
	if o.ClientCertificate != nil {
		if err := o.ClientCertificate.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("info" + "." + "external" + "." + "client_certificate")
			}
			return err
		}
	}
		...
		if o.ServerCaCertificates[i] != nil {
			if err := o.ServerCaCertificates[i].Validate(formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					...
					return ce.ValidateName("info" + "." + "external" + "." + "server_ca_certificates" + "." + strconv.Itoa(i))
				}
				return err
			}
		}
		...
		if o.Servers[i] != nil {
			if err := o.Servers[i].Validate(formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					...
					return ce.ValidateName("info" + "." + "external" + "." + "servers" + "." + strconv.Itoa(i))
				}
				return err
			}
		}
	...
	if o.Links != nil {
		if err := o.Links.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("info" + "." + "external" + "." + "client_certificate" + "." + "_links")
			}
			return err
		}
	}
	...
	if o.Self != nil {
		if err := o.Self.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("info" + "." + "external" + "." + "client_certificate" + "." + "_links" + "." + "self")
			}
			return err
		}
	}
