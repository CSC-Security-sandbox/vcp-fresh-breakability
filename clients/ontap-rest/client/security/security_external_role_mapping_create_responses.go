...
func (o *SecurityExternalRoleMappingCreateCreated) Error() string {
	return fmt.Sprintf("[POST /security/external-role-mappings][%d] securityExternalRoleMappingCreateCreated  %+v", 201, o.Payload)
}
...
func (o *SecurityExternalRoleMappingCreateDefault) Error() string {
	return fmt.Sprintf("[POST /security/external-role-mappings][%d] security_external_role_mapping_create default  %+v", o._statusCode, o.Payload)
}
