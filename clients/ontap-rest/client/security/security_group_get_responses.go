...
func (o *SecurityGroupGetOK) Error() string {
	return fmt.Sprintf("[GET /security/groups/{owner.uuid}/{name}/{type}][%d] securityGroupGetOK  %+v", 200, o.Payload)
}
...
func (o *SecurityGroupGetDefault) Error() string {
	return fmt.Sprintf("[GET /security/groups/{owner.uuid}/{name}/{type}][%d] security_group_get default  %+v", o._statusCode, o.Payload)
}
