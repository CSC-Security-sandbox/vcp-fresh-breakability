...
func (o *SecuritySamlSpCreateParams) SetDefaults() {
	var (
		...
		verifyMetadataServerDefault = string("\"True\"")
	)
...
func (o *SecuritySamlSpCreateParams) WithReturnTimeout(returnTimeout *string) *SecuritySamlSpCreateParams {
	o.SetReturnTimeout(returnTimeout)
	return o
}

// SetReturnTimeout adds the returnTimeout to the security saml sp create params
func (o *SecuritySamlSpCreateParams) SetReturnTimeout(returnTimeout *string) {
	o.ReturnTimeout = returnTimeout
}

// WithVerifyMetadataServer adds the verifyMetadataServer to the security saml sp create params
func (o *SecuritySamlSpCreateParams) WithVerifyMetadataServer(verifyMetadataServer *string) *SecuritySamlSpCreateParams {
...
func (o *SecuritySamlSpCreateParams) SetVerifyMetadataServer(verifyMetadataServer *string) {
...
func (o *SecuritySamlSpCreateParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
	...
	if o.VerifyMetadataServer != nil {
		...
		var qrVerifyMetadataServer string

		if o.VerifyMetadataServer != nil {
			qrVerifyMetadataServer = *o.VerifyMetadataServer
		}
		qVerifyMetadataServer := qrVerifyMetadataServer
