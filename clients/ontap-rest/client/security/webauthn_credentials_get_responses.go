...
func (o *WebauthnCredentialsGetOK) Error() string {
	return fmt.Sprintf("[GET /security/webauthn/credentials/{owner.uuid}/{username}/{index}/{relying_party.id}][%d] webauthnCredentialsGetOK  %+v", 200, o.Payload)
}
...
func (o *WebauthnCredentialsGetDefault) Error() string {
	return fmt.Sprintf("[GET /security/webauthn/credentials/{owner.uuid}/{username}/{index}/{relying_party.id}][%d] webauthn_credentials_get default  %+v", o._statusCode, o.Payload)
}
