...
func (o *AzureKeyVaultRekeyInternalParams) WithReturnRecords(returnRecords *string) *AzureKeyVaultRekeyInternalParams {
	o.SetReturnRecords(returnRecords)
	return o
}

// SetReturnRecords adds the returnRecords to the azure key vault rekey internal params
func (o *AzureKeyVaultRekeyInternalParams) SetReturnRecords(returnRecords *string) {
	o.ReturnRecords = returnRecords
}

// WithReturnTimeout adds the returnTimeout to the azure key vault rekey internal params
func (o *AzureKeyVaultRekeyInternalParams) WithReturnTimeout(returnTimeout *string) *AzureKeyVaultRekeyInternalParams {
	o.SetReturnTimeout(returnTimeout)
	return o
}

// SetReturnTimeout adds the returnTimeout to the azure key vault rekey internal params
func (o *AzureKeyVaultRekeyInternalParams) SetReturnTimeout(returnTimeout *string) {
