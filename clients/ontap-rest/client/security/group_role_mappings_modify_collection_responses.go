...
func (o *GroupRoleMappingsModifyCollectionDefault) Error() string {
	return fmt.Sprintf("[PATCH /security/group/role-mappings][%d] group_role_mappings_modify_collection default  %+v", o._statusCode, o.Payload)
}
	...
	if o.Next != nil {
		if err := o.Next.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("info" + "." + "_links" + "." + "next")
			}
			return err
		}
	}
