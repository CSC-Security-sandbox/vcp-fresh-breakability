...
func (o *AwsKmsRekeyInternalCreated) Error() string {
	return fmt.Sprintf("[POST /security/aws-kms/{aws_kms.uuid}/rekey-internal][%d] awsKmsRekeyInternalCreated  %+v", 201, o.Payload)
}
...
func (o *AwsKmsRekeyInternalAccepted) Error() string {
	return fmt.Sprintf("[POST /security/aws-kms/{aws_kms.uuid}/rekey-internal][%d] awsKmsRekeyInternalAccepted  %+v", 202, o.Payload)
}
