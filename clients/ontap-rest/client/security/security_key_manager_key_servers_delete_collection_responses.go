...
func (o *SecurityKeyManagerKeyServersDeleteCollectionDefault) Error() string {
	return fmt.Sprintf("[DELETE /security/key-managers/{uuid}/key-servers][%d] security_key_manager_key_servers_delete_collection default  %+v", o._statusCode, o.Payload)
}
