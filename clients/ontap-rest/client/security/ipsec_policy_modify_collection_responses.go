...
func (o *IpsecPolicyModifyCollectionDefault) Error() string {
	return fmt.Sprintf("[PATCH /security/ipsec/policies][%d] ipsec_policy_modify_collection default  %+v", o._statusCode, o.Payload)
}
	...
	if o.LocalEndpoint != nil {
		if err := o.LocalEndpoint.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("info" + "." + "local_endpoint")
			}
			return err
		}
	}
	...
	if o.RemoteEndpoint != nil {
		if err := o.RemoteEndpoint.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("info" + "." + "remote_endpoint")
			}
			return err
		}
	}
