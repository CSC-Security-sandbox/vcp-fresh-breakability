...
func (o *IpsecPolicyDeleteCollectionDefault) Error() string {
	return fmt.Sprintf("[DELETE /security/ipsec/policies][%d] ipsec_policy_delete_collection default  %+v", o._statusCode, o.Payload)
}
		...
		if o.Arguments[i] != nil {
			if err := o.Arguments[i].Validate(formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					...
					return ce.ValidateName("info" + "." + "error" + "." + "arguments" + "." + strconv.Itoa(i))
				}
				return err
			}
		}
	...
	if o.LocalEndpoint != nil {
		if err := o.LocalEndpoint.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("local_endpoint")
			}
			return err
		}
	}
	...
	if o.RemoteEndpoint != nil {
		if err := o.RemoteEndpoint.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("remote_endpoint")
			}
			return err
		}
	}
	...
	if o.Address != nil {
		if err := o.Address.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("local_endpoint" + "." + "address")
			}
			return err
		}
	}
	...
	if o.Family != nil {
		if err := o.Family.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("local_endpoint" + "." + "family")
			}
			return err
		}
	}
	...
	if o.Netmask != nil {
		if err := o.Netmask.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("local_endpoint" + "." + "netmask")
			}
			return err
		}
	}
	...
	if o.Address != nil {
		if err := o.Address.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("remote_endpoint" + "." + "address")
			}
			return err
		}
	}
	...
	if o.Family != nil {
		if err := o.Family.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("remote_endpoint" + "." + "family")
			}
			return err
		}
	}
	...
	if o.Netmask != nil {
		if err := o.Netmask.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("remote_endpoint" + "." + "netmask")
			}
			return err
		}
	}
