...
func (o *SecurityJitPrivilegeUserCreateParams) WithReturnRecords(returnRecords *string) *SecurityJitPrivilegeUserCreateParams {
	o.SetReturnRecords(returnRecords)
	return o
}

// SetReturnRecords adds the returnRecords to the security jit privilege user create params
func (o *SecurityJitPrivilegeUserCreateParams) SetReturnRecords(returnRecords *string) {
