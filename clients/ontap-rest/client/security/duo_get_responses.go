...
func (o *DuoGetOK) Error() string {
	return fmt.Sprintf("[GET /security/authentication/duo/profiles/{owner.uuid}][%d] duoGetOK  %+v", 200, o.Payload)
}
...
func (o *DuoGetDefault) Error() string {
	return fmt.Sprintf("[GET /security/authentication/duo/profiles/{owner.uuid}][%d] duo_get default  %+v", o._statusCode, o.Payload)
}
