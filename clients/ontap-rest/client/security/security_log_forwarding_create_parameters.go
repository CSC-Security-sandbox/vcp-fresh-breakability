...
func (o *SecurityLogForwardingCreateParams) WithForce(force *string) *SecurityLogForwardingCreateParams {
	o.SetForce(force)
	return o
}

// SetForce adds the force to the security log forwarding create params
func (o *SecurityLogForwardingCreateParams) SetForce(force *string) {
	o.Force = force
}
...
func (o *SecurityLogForwardingCreateParams) WithReturnRecords(returnRecords *string) *SecurityLogForwardingCreateParams {
	o.SetReturnRecords(returnRecords)
	return o
}

// SetReturnRecords adds the returnRecords to the security log forwarding create params
func (o *SecurityLogForwardingCreateParams) SetReturnRecords(returnRecords *string) {
	o.ReturnRecords = returnRecords
}

// WithReturnTimeout adds the returnTimeout to the security log forwarding create params
func (o *SecurityLogForwardingCreateParams) WithReturnTimeout(returnTimeout *string) *SecurityLogForwardingCreateParams {
	o.SetReturnTimeout(returnTimeout)
	return o
}

// SetReturnTimeout adds the returnTimeout to the security log forwarding create params
func (o *SecurityLogForwardingCreateParams) SetReturnTimeout(returnTimeout *string) {
