...
func (o *PublickeyModifyCollectionDefault) Error() string {
	return fmt.Sprintf("[PATCH /security/authentication/publickeys][%d] publickey_modify_collection default  %+v", o._statusCode, o.Payload)
}
	...
	if o.Account != nil {
		if err := o.Account.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("info" + "." + "account")
			}
			return err
		}
	}
