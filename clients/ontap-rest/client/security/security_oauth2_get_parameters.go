...
func (o *SecurityOauth2GetParams) WithUseLocalRolesIfPresent(useLocalRolesIfPresent *string) *SecurityOauth2GetParams {
...
func (o *SecurityOauth2GetParams) SetUseLocalRolesIfPresent(useLocalRolesIfPresent *string) {
