...
func (o *RolePrivilegeModifyCollectionDefault) Error() string {
	return fmt.Sprintf("[PATCH /security/roles/{owner.uuid}/{name}/privileges][%d] role_privilege_modify_collection default  %+v", o._statusCode, o.Payload)
}
	...
	if o.Access != nil {
		if err := o.Access.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("info" + "." + "access")
			}
			return err
		}
	}
