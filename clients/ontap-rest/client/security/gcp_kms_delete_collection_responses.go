...
func (o *GcpKmsDeleteCollectionAccepted) Error() string {
	return fmt.Sprintf("[DELETE /security/gcp-kms][%d] gcpKmsDeleteCollectionAccepted  %+v", 202, o.Payload)
}
...
func (o *GcpKmsDeleteCollectionDefault) Error() string {
	return fmt.Sprintf("[DELETE /security/gcp-kms][%d] gcp_kms_delete_collection default  %+v", o._statusCode, o.Payload)
}
