...
func (o *NetworkIPRoutesCreateParams) WithReturnRecords(returnRecords *string) *NetworkIPRoutesCreateParams {
	o.SetReturnRecords(returnRecords)
	return o
}

// SetReturnRecords adds the returnRecords to the network ip routes create params
func (o *NetworkIPRoutesCreateParams) SetReturnRecords(returnRecords *string) {
