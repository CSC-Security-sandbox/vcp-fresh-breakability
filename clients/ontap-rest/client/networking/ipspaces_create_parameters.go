...
func (o *IpspacesCreateParams) WithReturnRecords(returnRecords *string) *IpspacesCreateParams {
	o.SetReturnRecords(returnRecords)
	return o
}

// SetReturnRecords adds the returnRecords to the ipspaces create params
func (o *IpspacesCreateParams) SetReturnRecords(returnRecords *string) {
