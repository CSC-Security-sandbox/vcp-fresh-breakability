...
func (o *IPSubnetCreateParams) WithReturnRecords(returnRecords *string) *IPSubnetCreateParams {
	o.SetReturnRecords(returnRecords)
	return o
}

// SetReturnRecords adds the returnRecords to the ip subnet create params
func (o *IPSubnetCreateParams) SetReturnRecords(returnRecords *string) {
