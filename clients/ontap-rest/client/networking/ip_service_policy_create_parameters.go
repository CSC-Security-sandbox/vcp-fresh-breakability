...
func (o *IPServicePolicyCreateParams) WithReturnRecords(returnRecords *string) *IPServicePolicyCreateParams {
	o.SetReturnRecords(returnRecords)
	return o
}

// SetReturnRecords adds the returnRecords to the ip service policy create params
func (o *IPServicePolicyCreateParams) SetReturnRecords(returnRecords *string) {
