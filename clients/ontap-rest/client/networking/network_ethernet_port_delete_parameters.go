...
func (o *NetworkEthernetPortDeleteParams) WithReturnTimeout(returnTimeout *string) *NetworkEthernetPortDeleteParams {
	o.SetReturnTimeout(returnTimeout)
	return o
}

// SetReturnTimeout adds the returnTimeout to the network ethernet port delete params
func (o *NetworkEthernetPortDeleteParams) SetReturnTimeout(returnTimeout *string) {
