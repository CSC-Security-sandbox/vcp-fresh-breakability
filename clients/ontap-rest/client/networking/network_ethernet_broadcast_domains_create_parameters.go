...
func (o *NetworkEthernetBroadcastDomainsCreateParams) WithReturnRecords(returnRecords *string) *NetworkEthernetBroadcastDomainsCreateParams {
	o.SetReturnRecords(returnRecords)
	return o
}

// SetReturnRecords adds the returnRecords to the network ethernet broadcast domains create params
func (o *NetworkEthernetBroadcastDomainsCreateParams) SetReturnRecords(returnRecords *string) {
