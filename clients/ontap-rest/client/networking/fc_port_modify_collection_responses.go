...
func (o *FcPortModifyCollectionDefault) Error() string {
	return fmt.Sprintf("[PATCH /network/fc/ports][%d] fc_port_modify_collection default  %+v", o._statusCode, o.Payload)
}
	...
	if o.Fabric != nil {
		if err := o.Fabric.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("info" + "." + "fabric")
			}
			return err
		}
	}
	...
	if o.Speed != nil {
		if err := o.Speed.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("info" + "." + "speed")
			}
			return err
		}
	}
	...
	if o.Transceiver != nil {
		if err := o.Transceiver.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("info" + "." + "transceiver")
			}
			return err
		}
	}
