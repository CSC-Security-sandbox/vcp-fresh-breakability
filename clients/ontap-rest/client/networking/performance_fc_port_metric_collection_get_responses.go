...
func (o *PerformanceFcPortMetricCollectionGetOK) Error() string {
	return fmt.Sprintf("[GET /network/fc/ports/{fc_port.uuid}/metrics][%d] performanceFcPortMetricCollectionGetOK  %+v", 200, o.Payload)
}
...
func (o *PerformanceFcPortMetricCollectionGetDefault) Error() string {
	return fmt.Sprintf("[GET /network/fc/ports/{fc_port.uuid}/metrics][%d] performance_fc_port_metric_collection_get default  %+v", o._statusCode, o.Payload)
}
