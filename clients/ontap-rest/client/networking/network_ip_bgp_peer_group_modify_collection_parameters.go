...
func (o *NetworkIPBgpPeerGroupModifyCollectionParams) WithContinueOnFailure(continueOnFailure *string) *NetworkIPBgpPeerGroupModifyCollectionParams {
	o.SetContinueOnFailure(continueOnFailure)
	return o
}

// SetContinueOnFailure adds the continueOnFailure to the network ip bgp peer group modify collection params
func (o *NetworkIPBgpPeerGroupModifyCollectionParams) SetContinueOnFailure(continueOnFailure *string) {
...
func (o *NetworkIPBgpPeerGroupModifyCollectionParams) WithPeerAsn(peerAsn *string) *NetworkIPBgpPeerGroupModifyCollectionParams {
	o.SetPeerAsn(peerAsn)
	return o
}

// SetPeerAsn adds the peerAsn to the network ip bgp peer group modify collection params
func (o *NetworkIPBgpPeerGroupModifyCollectionParams) SetPeerAsn(peerAsn *string) {
	o.PeerAsn = peerAsn
}

// WithPeerIsNextHop adds the peerIsNextHop to the network ip bgp peer group modify collection params
func (o *NetworkIPBgpPeerGroupModifyCollectionParams) WithPeerIsNextHop(peerIsNextHop *string) *NetworkIPBgpPeerGroupModifyCollectionParams {
...
func (o *NetworkIPBgpPeerGroupModifyCollectionParams) SetPeerIsNextHop(peerIsNextHop *string) {
...
func (o *NetworkIPBgpPeerGroupModifyCollectionParams) WithPeerMd5Enabled(peerMd5Enabled *string) *NetworkIPBgpPeerGroupModifyCollectionParams {
...
func (o *NetworkIPBgpPeerGroupModifyCollectionParams) SetPeerMd5Enabled(peerMd5Enabled *string) {
...
func (o *NetworkIPBgpPeerGroupModifyCollectionParams) WithReturnRecords(returnRecords *string) *NetworkIPBgpPeerGroupModifyCollectionParams {
	o.SetReturnRecords(returnRecords)
	return o
}

// SetReturnRecords adds the returnRecords to the network ip bgp peer group modify collection params
func (o *NetworkIPBgpPeerGroupModifyCollectionParams) SetReturnRecords(returnRecords *string) {
	o.ReturnRecords = returnRecords
}

// WithReturnTimeout adds the returnTimeout to the network ip bgp peer group modify collection params
func (o *NetworkIPBgpPeerGroupModifyCollectionParams) WithReturnTimeout(returnTimeout *string) *NetworkIPBgpPeerGroupModifyCollectionParams {
	o.SetReturnTimeout(returnTimeout)
	return o
}

// SetReturnTimeout adds the returnTimeout to the network ip bgp peer group modify collection params
func (o *NetworkIPBgpPeerGroupModifyCollectionParams) SetReturnTimeout(returnTimeout *string) {
	o.ReturnTimeout = returnTimeout
}

// WithSerialRecords adds the serialRecords to the network ip bgp peer group modify collection params
func (o *NetworkIPBgpPeerGroupModifyCollectionParams) WithSerialRecords(serialRecords *string) *NetworkIPBgpPeerGroupModifyCollectionParams {
	o.SetSerialRecords(serialRecords)
	return o
}

// SetSerialRecords adds the serialRecords to the network ip bgp peer group modify collection params
func (o *NetworkIPBgpPeerGroupModifyCollectionParams) SetSerialRecords(serialRecords *string) {
...
func (o *NetworkIPBgpPeerGroupModifyCollectionParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
	...
	if o.PeerIsNextHop != nil {
		...
		var qrPeerIsNextHop string

		if o.PeerIsNextHop != nil {
			qrPeerIsNextHop = *o.PeerIsNextHop
		}
		qPeerIsNextHop := qrPeerIsNextHop
		if qPeerIsNextHop != "" {
	...
	if o.PeerMd5Enabled != nil {
		...
		var qrPeerMd5Enabled string

		if o.PeerMd5Enabled != nil {
			qrPeerMd5Enabled = *o.PeerMd5Enabled
		}
		qPeerMd5Enabled := qrPeerMd5Enabled
		if qPeerMd5Enabled != "" {
