...
func (o *PerformanceFcInterfaceMetricGetOK) Error() string {
	return fmt.Sprintf("[GET /network/fc/interfaces/{fc_interface.uuid}/metrics/{timestamp}][%d] performanceFcInterfaceMetricGetOK  %+v", 200, o.Payload)
}
...
func (o *PerformanceFcInterfaceMetricGetDefault) Error() string {
	return fmt.Sprintf("[GET /network/fc/interfaces/{fc_interface.uuid}/metrics/{timestamp}][%d] performance_fc_interface_metric_get default  %+v", o._statusCode, o.Payload)
}
