...
func (o *NetworkEthernetPortModifyCollectionDefault) Error() string {
	return fmt.Sprintf("[PATCH /network/ethernet/ports][%d] network_ethernet_port_modify_collection default  %+v", o._statusCode, o.Payload)
}
	...
	if o.BroadcastDomain != nil {
		if err := o.BroadcastDomain.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("info" + "." + "broadcast_domain")
			}
			return err
		}
	}
	...
	if o.Lag != nil {
		if err := o.Lag.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("info" + "." + "lag")
			}
			return err
		}
	}
		...
		if o.PortInlineDiscoveredDevices[i] != nil {
			if err := o.PortInlineDiscoveredDevices[i].Validate(formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					...
					return ce.ValidateName("info" + "." + "discovered_devices" + "." + strconv.Itoa(i))
				}
				return err
			}
		}
		...
		if o.PortInlineReachableBroadcastDomains[i] != nil {
			if err := o.PortInlineReachableBroadcastDomains[i].Validate(formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					...
					return ce.ValidateName("info" + "." + "reachable_broadcast_domains" + "." + strconv.Itoa(i))
				}
				return err
			}
		}
	...
	if o.Vlan != nil {
		if err := o.Vlan.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("info" + "." + "vlan")
			}
			return err
		}
	}
...
func (o *NetworkEthernetPortModifyCollectionBody) contextValidatePortInlineDiscoveredDevices(ctx context.Context, formats strfmt.Registry) error {
	...
	if err := validate.ReadOnly(ctx, "info"+"."+"discovered_devices", "body", []*PortInlineDiscoveredDevicesInlineArrayItem(o.PortInlineDiscoveredDevices)); err != nil {
		return err
	}
...
func (o *NetworkEthernetPortModifyCollectionBody) contextValidatePortInlineReachableBroadcastDomains(ctx context.Context, formats strfmt.Registry) error {
	...
	if err := validate.ReadOnly(ctx, "info"+"."+"reachable_broadcast_domains", "body", []*PortInlineReachableBroadcastDomainsInlineArrayItem(o.PortInlineReachableBroadcastDomains)); err != nil {
		return err
	}
	...
	if o.Links != nil {
		if err := o.Links.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("info" + "." + "broadcast_domain" + "." + "_links")
			}
			return err
		}
	}
	...
	if o.Ipspace != nil {
		if err := o.Ipspace.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("info" + "." + "broadcast_domain" + "." + "ipspace")
			}
			return err
		}
	}
	...
	if o.Self != nil {
		if err := o.Self.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("info" + "." + "broadcast_domain" + "." + "_links" + "." + "self")
			}
			return err
		}
	}
		...
		if o.ActivePorts[i] != nil {
			if err := o.ActivePorts[i].Validate(formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					...
					return ce.ValidateName("info" + "." + "lag" + "." + "active_ports" + "." + strconv.Itoa(i))
				}
				return err
			}
		}
		...
		if o.MemberPorts[i] != nil {
			if err := o.MemberPorts[i].Validate(formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					...
					return ce.ValidateName("info" + "." + "lag" + "." + "member_ports" + "." + strconv.Itoa(i))
				}
				return err
			}
		}
	...
	if o.Device != nil {
		if err := o.Device.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("info" + "." + "statistics" + "." + "device")
			}
			return err
		}
	}
	...
	if o.ReceiveRaw != nil {
		if err := o.ReceiveRaw.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("info" + "." + "statistics" + "." + "device" + "." + "receive_raw")
			}
			return err
		}
	}
	...
	if o.TransmitRaw != nil {
		if err := o.TransmitRaw.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("info" + "." + "statistics" + "." + "device" + "." + "transmit_raw")
			}
			return err
		}
	}
	...
	if o.BasePort != nil {
		if err := o.BasePort.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("info" + "." + "vlan" + "." + "base_port")
			}
			return err
		}
	}
	...
	if o.Links != nil {
		if err := o.Links.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("info" + "." + "vlan" + "." + "base_port" + "." + "_links")
			}
			return err
		}
	}
	...
	if o.Node != nil {
		if err := o.Node.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("info" + "." + "vlan" + "." + "base_port" + "." + "node")
			}
			return err
		}
	}
	...
	if o.Self != nil {
		if err := o.Self.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("info" + "." + "vlan" + "." + "base_port" + "." + "_links" + "." + "self")
			}
			return err
		}
	}
