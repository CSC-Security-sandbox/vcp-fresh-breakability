...
func (o *PerformanceFcInterfaceMetricCollectionGetOK) Error() string {
	return fmt.Sprintf("[GET /network/fc/interfaces/{fc_interface.uuid}/metrics][%d] performanceFcInterfaceMetricCollectionGetOK  %+v", 200, o.Payload)
}
...
func (o *PerformanceFcInterfaceMetricCollectionGetDefault) Error() string {
	return fmt.Sprintf("[GET /network/fc/interfaces/{fc_interface.uuid}/metrics][%d] performance_fc_interface_metric_collection_get default  %+v", o._statusCode, o.Payload)
}
