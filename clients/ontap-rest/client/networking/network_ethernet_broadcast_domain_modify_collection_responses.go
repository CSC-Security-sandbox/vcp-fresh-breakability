...
func (o *NetworkEthernetBroadcastDomainModifyCollectionDefault) Error() string {
	return fmt.Sprintf("[PATCH /network/ethernet/broadcast-domains][%d] network_ethernet_broadcast_domain_modify_collection default  %+v", o._statusCode, o.Payload)
}
...
func (o *NetworkEthernetBroadcastDomainModifyCollectionBody) contextValidateBroadcastDomainInlinePorts(ctx context.Context, formats strfmt.Registry) error {
	...
	if err := validate.ReadOnly(ctx, "info"+"."+"ports", "body", []*BroadcastDomainInlinePortsInlineArrayItem(o.BroadcastDomainInlinePorts)); err != nil {
		return err
	}
