...
func (o *PerformanceFcPortMetricGetOK) Error() string {
	return fmt.Sprintf("[GET /network/fc/ports/{fc_port.uuid}/metrics/{timestamp}][%d] performanceFcPortMetricGetOK  %+v", 200, o.Payload)
}
...
func (o *PerformanceFcPortMetricGetDefault) Error() string {
	return fmt.Sprintf("[GET /network/fc/ports/{fc_port.uuid}/metrics/{timestamp}][%d] performance_fc_port_metric_get default  %+v", o._statusCode, o.Payload)
}
