...
func (o *NetworkIPBgpPeerGroupsCreateParams) WithReturnRecords(returnRecords *string) *NetworkIPBgpPeerGroupsCreateParams {
	o.SetReturnRecords(returnRecords)
	return o
}

// SetReturnRecords adds the returnRecords to the network ip bgp peer groups create params
func (o *NetworkIPBgpPeerGroupsCreateParams) SetReturnRecords(returnRecords *string) {
