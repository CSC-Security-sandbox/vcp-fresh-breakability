...
func (o *SwitchModifyCollectionOK) Error() string {
	return fmt.Sprintf("[PATCH /network/ethernet/switches][%d] switchModifyCollectionOK  %+v", 200, o.Payload)
}
...
func (o *SwitchModifyCollectionAccepted) Error() string {
	return fmt.Sprintf("[PATCH /network/ethernet/switches][%d] switchModifyCollectionAccepted  %+v", 202, o.Payload)
}
...
func (o *SwitchModifyCollectionDefault) Error() string {
	return fmt.Sprintf("[PATCH /network/ethernet/switches][%d] switch_modify_collection default  %+v", o._statusCode, o.Payload)
}
	...
	if o.Monitoring != nil {
		if err := o.Monitoring.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("info" + "." + "monitoring")
			}
			return err
		}
	}
	...
	if o.Snmp != nil {
		if err := o.Snmp.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("info" + "." + "snmp")
			}
			return err
		}
	}
