...
func (o *NetworkEthernetPortsCreateParams) WithReturnRecords(returnRecords *string) *NetworkEthernetPortsCreateParams {
	o.SetReturnRecords(returnRecords)
	return o
}

// SetReturnRecords adds the returnRecords to the network ethernet ports create params
func (o *NetworkEthernetPortsCreateParams) SetReturnRecords(returnRecords *string) {
