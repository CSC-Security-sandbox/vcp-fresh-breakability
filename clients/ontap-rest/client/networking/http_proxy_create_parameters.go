...
func (o *HTTPProxyCreateParams) WithReturnRecords(returnRecords *string) *HTTPProxyCreateParams {
	o.SetReturnRecords(returnRecords)
	return o
}

// SetReturnRecords adds the returnRecords to the http proxy create params
func (o *HTTPProxyCreateParams) SetReturnRecords(returnRecords *string) {
