...
func (o *NetworkIPBgpPeerGroupsGetParams) WithMaxRecords(maxRecords *string) *NetworkIPBgpPeerGroupsGetParams {
	o.SetMaxRecords(maxRecords)
	return o
}

// SetMaxRecords adds the maxRecords to the network ip bgp peer groups get params
func (o *NetworkIPBgpPeerGroupsGetParams) SetMaxRecords(maxRecords *string) {
...
func (o *NetworkIPBgpPeerGroupsGetParams) WithPeerAsn(peerAsn *string) *NetworkIPBgpPeerGroupsGetParams {
	o.SetPeerAsn(peerAsn)
	return o
}

// SetPeerAsn adds the peerAsn to the network ip bgp peer groups get params
func (o *NetworkIPBgpPeerGroupsGetParams) SetPeerAsn(peerAsn *string) {
	o.PeerAsn = peerAsn
}

// WithPeerIsNextHop adds the peerIsNextHop to the network ip bgp peer groups get params
func (o *NetworkIPBgpPeerGroupsGetParams) WithPeerIsNextHop(peerIsNextHop *string) *NetworkIPBgpPeerGroupsGetParams {
	o.SetPeerIsNextHop(peerIsNextHop)
	return o
}

// SetPeerIsNextHop adds the peerIsNextHop to the network ip bgp peer groups get params
func (o *NetworkIPBgpPeerGroupsGetParams) SetPeerIsNextHop(peerIsNextHop *string) {
	o.PeerIsNextHop = peerIsNextHop
}

// WithPeerMd5Enabled adds the peerMd5Enabled to the network ip bgp peer groups get params
func (o *NetworkIPBgpPeerGroupsGetParams) WithPeerMd5Enabled(peerMd5Enabled *string) *NetworkIPBgpPeerGroupsGetParams {
	o.SetPeerMd5Enabled(peerMd5Enabled)
	return o
}

// SetPeerMd5Enabled adds the peerMd5Enabled to the network ip bgp peer groups get params
func (o *NetworkIPBgpPeerGroupsGetParams) SetPeerMd5Enabled(peerMd5Enabled *string) {
...
func (o *NetworkIPBgpPeerGroupsGetParams) WithReturnRecords(returnRecords *string) *NetworkIPBgpPeerGroupsGetParams {
	o.SetReturnRecords(returnRecords)
	return o
}

// SetReturnRecords adds the returnRecords to the network ip bgp peer groups get params
func (o *NetworkIPBgpPeerGroupsGetParams) SetReturnRecords(returnRecords *string) {
	o.ReturnRecords = returnRecords
}

// WithReturnTimeout adds the returnTimeout to the network ip bgp peer groups get params
func (o *NetworkIPBgpPeerGroupsGetParams) WithReturnTimeout(returnTimeout *string) *NetworkIPBgpPeerGroupsGetParams {
	o.SetReturnTimeout(returnTimeout)
	return o
}

// SetReturnTimeout adds the returnTimeout to the network ip bgp peer groups get params
func (o *NetworkIPBgpPeerGroupsGetParams) SetReturnTimeout(returnTimeout *string) {
