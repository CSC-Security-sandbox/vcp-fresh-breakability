...
func (o *NetworkIPInterfacesCreateParams) WithReturnRecords(returnRecords *string) *NetworkIPInterfacesCreateParams {
	o.SetReturnRecords(returnRecords)
	return o
}

// SetReturnRecords adds the returnRecords to the network ip interfaces create params
func (o *NetworkIPInterfacesCreateParams) SetReturnRecords(returnRecords *string) {
