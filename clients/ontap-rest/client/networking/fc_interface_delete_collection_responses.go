...
func (o *FcInterfaceDeleteCollectionDefault) Error() string {
	return fmt.Sprintf("[DELETE /network/fc/interfaces][%d] fc_interface_delete_collection default  %+v", o._statusCode, o.Payload)
}
		...
		if o.Messages[i] != nil {
			if err := o.Messages[i].Validate(formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					...
					return ce.ValidateName("info" + "." + "recommend" + "." + "messages" + "." + strconv.Itoa(i))
				}
				return err
			}
		}
