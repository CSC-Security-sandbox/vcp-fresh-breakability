...
func (o *FcInterfaceCreateParams) WithReturnRecords(returnRecords *string) *FcInterfaceCreateParams {
	o.SetReturnRecords(returnRecords)
	return o
}

// SetReturnRecords adds the returnRecords to the fc interface create params
func (o *FcInterfaceCreateParams) SetReturnRecords(returnRecords *string) {
