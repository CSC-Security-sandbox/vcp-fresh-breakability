...
func (o *CloudTargetModifyCollectionOK) Error() string {
	return fmt.Sprintf("[PATCH /cloud/targets][%d] cloudTargetModifyCollectionOK  %+v", 200, o.Payload)
}
...
func (o *CloudTargetModifyCollectionAccepted) Error() string {
	return fmt.Sprintf("[PATCH /cloud/targets][%d] cloudTargetModifyCollectionAccepted  %+v", 202, o.Payload)
}
...
func (o *CloudTargetModifyCollectionDefault) Error() string {
	return fmt.Sprintf("[PATCH /cloud/targets][%d] cloud_target_modify_collection default  %+v", o._statusCode, o.Payload)
}
