...
func (o *CloudTargetDeleteCollectionOK) Error() string {
	return fmt.Sprintf("[DELETE /cloud/targets][%d] cloudTargetDeleteCollectionOK  %+v", 200, o.Payload)
}
...
func (o *CloudTargetDeleteCollectionAccepted) Error() string {
	return fmt.Sprintf("[DELETE /cloud/targets][%d] cloudTargetDeleteCollectionAccepted  %+v", 202, o.Payload)
}
...
func (o *CloudTargetDeleteCollectionDefault) Error() string {
	return fmt.Sprintf("[DELETE /cloud/targets][%d] cloud_target_delete_collection default  %+v", o._statusCode, o.Payload)
}
