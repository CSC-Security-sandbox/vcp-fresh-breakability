...
func (o *CloudTargetDeleteParams) WithReturnTimeout(returnTimeout *string) *CloudTargetDeleteParams {
	o.SetReturnTimeout(returnTimeout)
	return o
}

// SetReturnTimeout adds the returnTimeout to the cloud target delete params
func (o *CloudTargetDeleteParams) SetReturnTimeout(returnTimeout *string) {
