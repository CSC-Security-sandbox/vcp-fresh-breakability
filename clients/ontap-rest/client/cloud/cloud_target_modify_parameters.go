...
func (o *CloudTargetModifyParams) WithCheckOnly(checkOnly *string) *CloudTargetModifyParams {
	o.SetCheckOnly(checkOnly)
	return o
}

// SetCheckOnly adds the checkOnly to the cloud target modify params
func (o *CloudTargetModifyParams) SetCheckOnly(checkOnly *string) {
	o.CheckOnly = checkOnly
}

// WithIgnoreWarnings adds the ignoreWarnings to the cloud target modify params
func (o *CloudTargetModifyParams) WithIgnoreWarnings(ignoreWarnings *string) *CloudTargetModifyParams {
	o.SetIgnoreWarnings(ignoreWarnings)
	return o
}

// SetIgnoreWarnings adds the ignoreWarnings to the cloud target modify params
func (o *CloudTargetModifyParams) SetIgnoreWarnings(ignoreWarnings *string) {
...
func (o *CloudTargetModifyParams) WithReturnTimeout(returnTimeout *string) *CloudTargetModifyParams {
	o.SetReturnTimeout(returnTimeout)
	return o
}

// SetReturnTimeout adds the returnTimeout to the cloud target modify params
func (o *CloudTargetModifyParams) SetReturnTimeout(returnTimeout *string) {
