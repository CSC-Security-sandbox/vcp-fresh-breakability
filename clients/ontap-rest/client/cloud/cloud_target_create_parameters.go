...
func (o *CloudTargetCreateParams) WithCheckOnly(checkOnly *string) *CloudTargetCreateParams {
	o.SetCheckOnly(checkOnly)
	return o
}

// SetCheckOnly adds the checkOnly to the cloud target create params
func (o *CloudTargetCreateParams) SetCheckOnly(checkOnly *string) {
	o.CheckOnly = checkOnly
}

// WithIgnoreWarnings adds the ignoreWarnings to the cloud target create params
func (o *CloudTargetCreateParams) WithIgnoreWarnings(ignoreWarnings *string) *CloudTargetCreateParams {
	o.SetIgnoreWarnings(ignoreWarnings)
	return o
}

// SetIgnoreWarnings adds the ignoreWarnings to the cloud target create params
func (o *CloudTargetCreateParams) SetIgnoreWarnings(ignoreWarnings *string) {
...
func (o *CloudTargetCreateParams) WithReturnRecords(returnRecords *string) *CloudTargetCreateParams {
	o.SetReturnRecords(returnRecords)
	return o
}

// SetReturnRecords adds the returnRecords to the cloud target create params
func (o *CloudTargetCreateParams) SetReturnRecords(returnRecords *string) {
	o.ReturnRecords = returnRecords
}

// WithReturnTimeout adds the returnTimeout to the cloud target create params
func (o *CloudTargetCreateParams) WithReturnTimeout(returnTimeout *string) *CloudTargetCreateParams {
	o.SetReturnTimeout(returnTimeout)
	return o
}

// SetReturnTimeout adds the returnTimeout to the cloud target create params
func (o *CloudTargetCreateParams) SetReturnTimeout(returnTimeout *string) {
