...
func (o *ConfigurationBackupFileDeleteCollectionParams) WithAuto(auto *string) *ConfigurationBackupFileDeleteCollectionParams {
	o.SetAuto(auto)
	return o
}

// SetAuto adds the auto to the configuration backup file delete collection params
func (o *ConfigurationBackupFileDeleteCollectionParams) SetAuto(auto *string) {
	o.Auto = auto
}
...
func (o *ConfigurationBackupFileDeleteCollectionParams) WithContinueOnFailure(continueOnFailure *string) *ConfigurationBackupFileDeleteCollectionParams {
	o.SetContinueOnFailure(continueOnFailure)
	return o
}

// SetContinueOnFailure adds the continueOnFailure to the configuration backup file delete collection params
func (o *ConfigurationBackupFileDeleteCollectionParams) SetContinueOnFailure(continueOnFailure *string) {
...
func (o *ConfigurationBackupFileDeleteCollectionParams) WithReturnRecords(returnRecords *string) *ConfigurationBackupFileDeleteCollectionParams {
	o.SetReturnRecords(returnRecords)
	return o
}

// SetReturnRecords adds the returnRecords to the configuration backup file delete collection params
func (o *ConfigurationBackupFileDeleteCollectionParams) SetReturnRecords(returnRecords *string) {
	o.ReturnRecords = returnRecords
}

// WithReturnTimeout adds the returnTimeout to the configuration backup file delete collection params
func (o *ConfigurationBackupFileDeleteCollectionParams) WithReturnTimeout(returnTimeout *string) *ConfigurationBackupFileDeleteCollectionParams {
	o.SetReturnTimeout(returnTimeout)
	return o
}

// SetReturnTimeout adds the returnTimeout to the configuration backup file delete collection params
func (o *ConfigurationBackupFileDeleteCollectionParams) SetReturnTimeout(returnTimeout *string) {
	o.ReturnTimeout = returnTimeout
}

// WithSerialRecords adds the serialRecords to the configuration backup file delete collection params
func (o *ConfigurationBackupFileDeleteCollectionParams) WithSerialRecords(serialRecords *string) *ConfigurationBackupFileDeleteCollectionParams {
	o.SetSerialRecords(serialRecords)
	return o
}

// SetSerialRecords adds the serialRecords to the configuration backup file delete collection params
func (o *ConfigurationBackupFileDeleteCollectionParams) SetSerialRecords(serialRecords *string) {
	o.SerialRecords = serialRecords
}

// WithSize adds the size to the configuration backup file delete collection params
func (o *ConfigurationBackupFileDeleteCollectionParams) WithSize(size *string) *ConfigurationBackupFileDeleteCollectionParams {
	o.SetSize(size)
	return o
}

// SetSize adds the size to the configuration backup file delete collection params
func (o *ConfigurationBackupFileDeleteCollectionParams) SetSize(size *string) {
	o.Size = size
}
