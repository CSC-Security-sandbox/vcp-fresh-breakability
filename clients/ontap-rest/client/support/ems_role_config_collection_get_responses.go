...
func (o *EmsRoleConfigCollectionGetOK) Error() string {
	return fmt.Sprintf("[GET /support/ems/role-configs][%d] emsRoleConfigCollectionGetOK  %+v", 200, o.Payload)
}
...
func (o *EmsRoleConfigCollectionGetDefault) Error() string {
	return fmt.Sprintf("[GET /support/ems/role-configs][%d] ems_role_config_collection_get default  %+v", o._statusCode, o.Payload)
}
