...
func (o *EmsFiltersRulesCreateParams) WithReturnRecords(returnRecords *string) *EmsFiltersRulesCreateParams {
	o.SetReturnRecords(returnRecords)
	return o
}

// SetReturnRecords adds the returnRecords to the ems filters rules create params
func (o *EmsFiltersRulesCreateParams) SetReturnRecords(returnRecords *string) {
