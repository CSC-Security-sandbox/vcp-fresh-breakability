...
func (o *EmsRoleConfigModifyCollectionDefault) Error() string {
	return fmt.Sprintf("[PATCH /support/ems/role-configs][%d] ems_role_config_modify_collection default  %+v", o._statusCode, o.Payload)
}
	...
	if o.EventFilter != nil {
		if err := o.EventFilter.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("info" + "." + "event_filter")
			}
			return err
		}
	}
