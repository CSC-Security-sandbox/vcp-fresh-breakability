...
func (o *AutosupportMessageGetOK) Error() string {
	return fmt.Sprintf("[GET /support/autosupport/messages/{node.uuid}/{index}/{destination}][%d] autosupportMessageGetOK  %+v", 200, o.Payload)
}
...
func (o *AutosupportMessageGetDefault) Error() string {
	return fmt.Sprintf("[GET /support/autosupport/messages/{node.uuid}/{index}/{destination}][%d] autosupport_message_get default  %+v", o._statusCode, o.Payload)
}
