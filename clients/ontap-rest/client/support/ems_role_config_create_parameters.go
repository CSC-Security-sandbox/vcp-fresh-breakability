...
func (o *EmsRoleConfigCreateParams) WithReturnRecords(returnRecords *string) *EmsRoleConfigCreateParams {
	o.SetReturnRecords(returnRecords)
	return o
}

// SetReturnRecords adds the returnRecords to the ems role config create params
func (o *EmsRoleConfigCreateParams) SetReturnRecords(returnRecords *string) {
