...
func (o *AutosupportCreateParams) WithReturnRecords(returnRecords *string) *AutosupportCreateParams {
	o.SetReturnRecords(returnRecords)
	return o
}

// SetReturnRecords adds the returnRecords to the autosupport create params
func (o *AutosupportCreateParams) SetReturnRecords(returnRecords *string) {
