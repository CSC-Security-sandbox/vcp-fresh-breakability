...
func (o *AutoUpdateConfigurationModifyCollectionDefault) Error() string {
	return fmt.Sprintf("[PATCH /support/auto-update/configurations][%d] auto_update_configuration_modify_collection default  %+v", o._statusCode, o.Payload)
}
	...
	if o.Description != nil {
		if err := o.Description.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("info" + "." + "description")
			}
			return err
		}
	}
