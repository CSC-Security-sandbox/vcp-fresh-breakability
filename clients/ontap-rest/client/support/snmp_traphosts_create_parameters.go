...
func (o *SnmpTraphostsCreateParams) WithReturnRecords(returnRecords *string) *SnmpTraphostsCreateParams {
	o.SetReturnRecords(returnRecords)
	return o
}

// SetReturnRecords adds the returnRecords to the snmp traphosts create params
func (o *SnmpTraphostsCreateParams) SetReturnRecords(returnRecords *string) {
