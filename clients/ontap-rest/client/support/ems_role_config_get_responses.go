...
func (o *EmsRoleConfigGetOK) Error() string {
	return fmt.Sprintf("[GET /support/ems/role-configs/{access_control_role.name}][%d] emsRoleConfigGetOK  %+v", 200, o.Payload)
}
...
func (o *EmsRoleConfigGetDefault) Error() string {
	return fmt.Sprintf("[GET /support/ems/role-configs/{access_control_role.name}][%d] ems_role_config_get default  %+v", o._statusCode, o.Payload)
}
