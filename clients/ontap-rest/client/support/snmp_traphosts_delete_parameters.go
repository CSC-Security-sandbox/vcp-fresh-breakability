...
func (o *SnmpTraphostsDeleteParams) WithReturnTimeout(returnTimeout *string) *SnmpTraphostsDeleteParams {
	o.SetReturnTimeout(returnTimeout)
	return o
}

// SetReturnTimeout adds the returnTimeout to the snmp traphosts delete params
func (o *SnmpTraphostsDeleteParams) SetReturnTimeout(returnTimeout *string) {
