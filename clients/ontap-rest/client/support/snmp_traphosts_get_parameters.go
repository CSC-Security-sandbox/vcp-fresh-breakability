...
func (o *SnmpTraphostsGetParams) WithReturnTimeout(returnTimeout *string) *SnmpTraphostsGetParams {
	o.SetReturnTimeout(returnTimeout)
	return o
}

// SetReturnTimeout adds the returnTimeout to the snmp traphosts get params
func (o *SnmpTraphostsGetParams) SetReturnTimeout(returnTimeout *string) {
