...
func (o *EmsDestinationModifyCollectionOK) Error() string {
	return fmt.Sprintf("[PATCH /support/ems/destinations][%d] emsDestinationModifyCollectionOK  %+v", 200, o.Payload)
}
...
func (o *EmsDestinationModifyCollectionDefault) Error() string {
	return fmt.Sprintf("[PATCH /support/ems/destinations][%d] ems_destination_modify_collection default  %+v", o._statusCode, o.Payload)
}
	...
	if o.AccessControlRole != nil {
		if err := o.AccessControlRole.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("info" + "." + "access_control_role")
			}
			return err
		}
	}
	...
	if o.Connectivity != nil {
		if err := o.Connectivity.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("info" + "." + "connectivity")
			}
			return err
		}
	}
		...
		if o.Filters[i] != nil {
			if err := o.Filters[i].Validate(formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					...
					return ce.ValidateName("info" + "." + "filters" + "." + strconv.Itoa(i))
				}
				return err
			}
		}
	...
	if o.Syslog != nil {
		if err := o.Syslog.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("info" + "." + "syslog")
			}
			return err
		}
	}
		...
		if o.Arguments[i] != nil {
			if err := o.Arguments[i].Validate(formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					...
					return ce.ValidateName("message" + "." + "arguments" + "." + strconv.Itoa(i))
				}
				return err
			}
		}
