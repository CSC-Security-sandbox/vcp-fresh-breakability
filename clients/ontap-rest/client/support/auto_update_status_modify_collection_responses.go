...
func (o *AutoUpdateStatusModifyCollectionDefault) Error() string {
	return fmt.Sprintf("[PATCH /support/auto-update/updates][%d] auto_update_status_modify_collection default  %+v", o._statusCode, o.Payload)
}
	...
	if o.Self != nil {
		if err := o.Self.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("info" + "." + "_links" + "." + "self" + "." + "self")
			}
			return err
		}
	}
		...
		if o.Arguments[i] != nil {
			if err := o.Arguments[i].Validate(formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					...
					return ce.ValidateName("info" + "." + "status" + "." + "arguments" + "." + strconv.Itoa(i))
				}
				return err
			}
		}
