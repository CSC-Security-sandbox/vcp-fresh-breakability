...
// WithActionable adds the actionable to the ems event collection get params
func (o *EmsEventCollectionGetParams) WithActionable(actionable *string) *EmsEventCollectionGetParams {
	o.SetActionable(actionable)
	return o
}

// SetActionable adds the actionable to the ems event collection get params
func (o *EmsEventCollectionGetParams) SetActionable(actionable *string) {
	o.Actionable = actionable
}

// WithCreationTime adds the creationTime to the ems event collection get params
func (o *EmsEventCollectionGetParams) WithCreationTime(creationTime *string) *EmsEventCollectionGetParams {
	o.SetCreationTime(creationTime)
	return o
}

// SetCreationTime adds the creationTime to the ems event collection get params
func (o *EmsEventCollectionGetParams) SetCreationTime(creationTime *string) {
...
// WithHistoryLogMessage adds the historyLogMessage to the ems event collection get params
func (o *EmsEventCollectionGetParams) WithHistoryLogMessage(historyLogMessage *string) *EmsEventCollectionGetParams {
	o.SetHistoryLogMessage(historyLogMessage)
	return o
}

// SetHistoryLogMessage adds the historyLogMessage to the ems event collection get params
func (o *EmsEventCollectionGetParams) SetHistoryLogMessage(historyLogMessage *string) {
	o.HistoryLogMessage = historyLogMessage
}

// WithHistoryState adds the historyState to the ems event collection get params
func (o *EmsEventCollectionGetParams) WithHistoryState(historyState *string) *EmsEventCollectionGetParams {
	o.SetHistoryState(historyState)
	return o
}

// SetHistoryState adds the historyState to the ems event collection get params
func (o *EmsEventCollectionGetParams) SetHistoryState(historyState *string) {
	o.HistoryState = historyState
}

// WithHistoryUpdateTime adds the historyUpdateTime to the ems event collection get params
func (o *EmsEventCollectionGetParams) WithHistoryUpdateTime(historyUpdateTime *string) *EmsEventCollectionGetParams {
	o.SetHistoryUpdateTime(historyUpdateTime)
	return o
}

// SetHistoryUpdateTime adds the historyUpdateTime to the ems event collection get params
func (o *EmsEventCollectionGetParams) SetHistoryUpdateTime(historyUpdateTime *string) {
	o.HistoryUpdateTime = historyUpdateTime
}

// WithIndex adds the index to the ems event collection get params
func (o *EmsEventCollectionGetParams) WithIndex(index *string) *EmsEventCollectionGetParams {
	o.SetIndex(index)
	return o
}

// SetIndex adds the index to the ems event collection get params
func (o *EmsEventCollectionGetParams) SetIndex(index *string) {
	o.Index = index
}

// WithLastUpdateTime adds the lastUpdateTime to the ems event collection get params
func (o *EmsEventCollectionGetParams) WithLastUpdateTime(lastUpdateTime *string) *EmsEventCollectionGetParams {
	o.SetLastUpdateTime(lastUpdateTime)
	return o
}

// SetLastUpdateTime adds the lastUpdateTime to the ems event collection get params
func (o *EmsEventCollectionGetParams) SetLastUpdateTime(lastUpdateTime *string) {
...
func (o *EmsEventCollectionGetParams) WithMaxRecords(maxRecords *string) *EmsEventCollectionGetParams {
	o.SetMaxRecords(maxRecords)
	return o
}

// SetMaxRecords adds the maxRecords to the ems event collection get params
func (o *EmsEventCollectionGetParams) SetMaxRecords(maxRecords *string) {
...
// WithNumOccurrences adds the numOccurrences to the ems event collection get params
func (o *EmsEventCollectionGetParams) WithNumOccurrences(numOccurrences *string) *EmsEventCollectionGetParams {
	o.SetNumOccurrences(numOccurrences)
	return o
}

// SetNumOccurrences adds the numOccurrences to the ems event collection get params
func (o *EmsEventCollectionGetParams) SetNumOccurrences(numOccurrences *string) {
...
func (o *EmsEventCollectionGetParams) WithReturnRecords(returnRecords *string) *EmsEventCollectionGetParams {
	o.SetReturnRecords(returnRecords)
	return o
}

// SetReturnRecords adds the returnRecords to the ems event collection get params
func (o *EmsEventCollectionGetParams) SetReturnRecords(returnRecords *string) {
	o.ReturnRecords = returnRecords
}

// WithReturnTimeout adds the returnTimeout to the ems event collection get params
func (o *EmsEventCollectionGetParams) WithReturnTimeout(returnTimeout *string) *EmsEventCollectionGetParams {
	o.SetReturnTimeout(returnTimeout)
	return o
}

// SetReturnTimeout adds the returnTimeout to the ems event collection get params
func (o *EmsEventCollectionGetParams) SetReturnTimeout(returnTimeout *string) {
...
// WithState adds the state to the ems event collection get params
func (o *EmsEventCollectionGetParams) WithState(state *string) *EmsEventCollectionGetParams {
	o.SetState(state)
	return o
}

// SetState adds the state to the ems event collection get params
func (o *EmsEventCollectionGetParams) SetState(state *string) {
	o.State = state
}

// WithStateful adds the stateful to the ems event collection get params
func (o *EmsEventCollectionGetParams) WithStateful(stateful *string) *EmsEventCollectionGetParams {
	o.SetStateful(stateful)
	return o
}

// SetStateful adds the stateful to the ems event collection get params
func (o *EmsEventCollectionGetParams) SetStateful(stateful *string) {
	o.Stateful = stateful
}
...
// WithUUID adds the uuid to the ems event collection get params
func (o *EmsEventCollectionGetParams) WithUUID(uuid *string) *EmsEventCollectionGetParams {
	o.SetUUID(uuid)
	return o
}

// SetUUID adds the uuid to the ems event collection get params
func (o *EmsEventCollectionGetParams) SetUUID(uuid *string) {
	o.UUID = uuid
}
