...
func (o *EmsFilterRuleCollectionGetParams) WithIndex(index *string) *EmsFilterRuleCollectionGetParams {
	o.SetIndex(index)
	return o
}

// SetIndex adds the index to the ems filter rule collection get params
func (o *EmsFilterRuleCollectionGetParams) SetIndex(index *string) {
	o.Index = index
}

// WithMaxRecords adds the maxRecords to the ems filter rule collection get params
func (o *EmsFilterRuleCollectionGetParams) WithMaxRecords(maxRecords *string) *EmsFilterRuleCollectionGetParams {
	o.SetMaxRecords(maxRecords)
	return o
}

// SetMaxRecords adds the maxRecords to the ems filter rule collection get params
func (o *EmsFilterRuleCollectionGetParams) SetMaxRecords(maxRecords *string) {
...
func (o *EmsFilterRuleCollectionGetParams) WithReturnRecords(returnRecords *string) *EmsFilterRuleCollectionGetParams {
	o.SetReturnRecords(returnRecords)
	return o
}

// SetReturnRecords adds the returnRecords to the ems filter rule collection get params
func (o *EmsFilterRuleCollectionGetParams) SetReturnRecords(returnRecords *string) {
	o.ReturnRecords = returnRecords
}

// WithReturnTimeout adds the returnTimeout to the ems filter rule collection get params
func (o *EmsFilterRuleCollectionGetParams) WithReturnTimeout(returnTimeout *string) *EmsFilterRuleCollectionGetParams {
	o.SetReturnTimeout(returnTimeout)
	return o
}

// SetReturnTimeout adds the returnTimeout to the ems filter rule collection get params
func (o *EmsFilterRuleCollectionGetParams) SetReturnTimeout(returnTimeout *string) {
