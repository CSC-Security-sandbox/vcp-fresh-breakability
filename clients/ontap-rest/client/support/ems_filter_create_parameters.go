...
func (o *EmsFilterCreateParams) WithReturnRecords(returnRecords *string) *EmsFilterCreateParams {
	o.SetReturnRecords(returnRecords)
	return o
}

// SetReturnRecords adds the returnRecords to the ems filter create params
func (o *EmsFilterCreateParams) SetReturnRecords(returnRecords *string) {
