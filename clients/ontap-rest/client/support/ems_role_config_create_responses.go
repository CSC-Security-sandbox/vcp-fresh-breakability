...
func (o *EmsRoleConfigCreateCreated) Error() string {
	return fmt.Sprintf("[POST /support/ems/role-configs][%d] emsRoleConfigCreateCreated  %+v", 201, o.Payload)
}
...
func (o *EmsRoleConfigCreateDefault) Error() string {
	return fmt.Sprintf("[POST /support/ems/role-configs][%d] ems_role_config_create default  %+v", o._statusCode, o.Payload)
}
