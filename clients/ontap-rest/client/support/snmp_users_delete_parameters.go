...
func (o *SnmpUsersDeleteParams) WithReturnTimeout(returnTimeout *string) *SnmpUsersDeleteParams {
	o.SetReturnTimeout(returnTimeout)
	return o
}

// SetReturnTimeout adds the returnTimeout to the snmp users delete params
func (o *SnmpUsersDeleteParams) SetReturnTimeout(returnTimeout *string) {
