...
func (o *EmsDestinationCreateParams) WithReturnRecords(returnRecords *string) *EmsDestinationCreateParams {
	o.SetReturnRecords(returnRecords)
	return o
}

// SetReturnRecords adds the returnRecords to the ems destination create params
func (o *EmsDestinationCreateParams) SetReturnRecords(returnRecords *string) {
