...
func (o *SnmpUsersModifyParams) WithReturnTimeout(returnTimeout *string) *SnmpUsersModifyParams {
	o.SetReturnTimeout(returnTimeout)
	return o
}

// SetReturnTimeout adds the returnTimeout to the snmp users modify params
func (o *SnmpUsersModifyParams) SetReturnTimeout(returnTimeout *string) {
