...
func (o *EmsDestinationDeleteCollectionDefault) Error() string {
	return fmt.Sprintf("[DELETE /support/ems/destinations][%d] ems_destination_delete_collection default  %+v", o._statusCode, o.Payload)
}
		...
		if o.Errors[i] != nil {
			if err := o.Errors[i].Validate(formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					...
					return ce.ValidateName("connectivity" + "." + "errors" + "." + strconv.Itoa(i))
				}
				return err
			}
		}
	...
	if o.Format != nil {
		if err := o.Format.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("syslog" + "." + "format")
			}
			return err
		}
	}
