...
func (o *EmsApplicationLogsCreateParams) WithReturnRecords(returnRecords *string) *EmsApplicationLogsCreateParams {
	o.SetReturnRecords(returnRecords)
	return o
}

// SetReturnRecords adds the returnRecords to the ems application logs create params
func (o *EmsApplicationLogsCreateParams) SetReturnRecords(returnRecords *string) {
