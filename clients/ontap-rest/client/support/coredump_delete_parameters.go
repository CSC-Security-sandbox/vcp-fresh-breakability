...
func (o *CoredumpDeleteParams) WithReturnTimeout(returnTimeout *string) *CoredumpDeleteParams {
	o.SetReturnTimeout(returnTimeout)
	return o
}

// SetReturnTimeout adds the returnTimeout to the coredump delete params
func (o *CoredumpDeleteParams) SetReturnTimeout(returnTimeout *string) {
