...
func (o *SnmpUsersModifyCollectionDefault) Error() string {
	return fmt.Sprintf("[PATCH /support/snmp/users][%d] snmp_users_modify_collection default  %+v", o._statusCode, o.Payload)
}
	...
	if o.Snmpv3 != nil {
		if err := o.Snmpv3.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("info" + "." + "snmpv3")
			}
			return err
		}
	}
	...
	if o.Links != nil {
		if err := o.Links.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("info" + "." + "snmpv3" + "." + "_links")
			}
			return err
		}
	}
	...
	if o.Self != nil {
		if err := o.Self.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("info" + "." + "snmpv3" + "." + "_links" + "." + "self")
			}
			return err
		}
	}
