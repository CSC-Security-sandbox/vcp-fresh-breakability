...
func (o *S3BucketSnapshotGetOK) Error() string {
	return fmt.Sprintf("[GET /protocols/s3/services/{svm.uuid}/buckets/{s3_bucket.uuid}/snapshots/{uuid}][%d] s3BucketSnapshotGetOK  %+v", 200, o.Payload)
}
...
func (o *S3BucketSnapshotGetDefault) Error() string {
	return fmt.Sprintf("[GET /protocols/s3/services/{svm.uuid}/buckets/{s3_bucket.uuid}/snapshots/{uuid}][%d] s3_bucket_snapshot_get default  %+v", o._statusCode, o.Payload)
}
