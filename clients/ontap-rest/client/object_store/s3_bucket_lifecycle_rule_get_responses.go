...
func (o *S3BucketLifecycleRuleGetOK) Error() string {
	return fmt.Sprintf("[GET /protocols/s3/services/{svm.uuid}/buckets/{s3_bucket.uuid}/rules/{name}][%d] s3BucketLifecycleRuleGetOK  %+v", 200, o.Payload)
}
...
func (o *S3BucketLifecycleRuleGetDefault) Error() string {
	return fmt.Sprintf("[GET /protocols/s3/services/{svm.uuid}/buckets/{s3_bucket.uuid}/rules/{name}][%d] s3_bucket_lifecycle_rule_get default  %+v", o._statusCode, o.Payload)
}
