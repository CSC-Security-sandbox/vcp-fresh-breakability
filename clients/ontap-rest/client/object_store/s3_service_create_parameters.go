...
func (o *S3ServiceCreateParams) WithReturnRecords(returnRecords *string) *S3ServiceCreateParams {
	o.SetReturnRecords(returnRecords)
	return o
}

// SetReturnRecords adds the returnRecords to the s3 service create params
func (o *S3ServiceCreateParams) SetReturnRecords(returnRecords *string) {
