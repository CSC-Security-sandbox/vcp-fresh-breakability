...
func (o *S3ServiceDeleteCollectionOK) Error() string {
	return fmt.Sprintf("[DELETE /protocols/s3/services][%d] s3ServiceDeleteCollectionOK  %+v", 200, o.Payload)
}
...
func (o *S3ServiceDeleteCollectionAccepted) Error() string {
	return fmt.Sprintf("[DELETE /protocols/s3/services][%d] s3ServiceDeleteCollectionAccepted  %+v", 202, o.Payload)
}
...
func (o *S3ServiceDeleteCollectionDefault) Error() string {
	return fmt.Sprintf("[DELETE /protocols/s3/services][%d] s3_service_delete_collection default  %+v", o._statusCode, o.Payload)
}
