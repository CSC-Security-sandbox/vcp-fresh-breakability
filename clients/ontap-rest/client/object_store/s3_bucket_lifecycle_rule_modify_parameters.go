...
func (o *S3BucketLifecycleRuleModifyParams) WithReturnTimeout(returnTimeout *string) *S3BucketLifecycleRuleModifyParams {
	o.SetReturnTimeout(returnTimeout)
	return o
}

// SetReturnTimeout adds the returnTimeout to the s3 bucket lifecycle rule modify params
func (o *S3BucketLifecycleRuleModifyParams) SetReturnTimeout(returnTimeout *string) {
