...
func (o *S3BucketModifyParams) WithReturnTimeout(returnTimeout *string) *S3BucketModifyParams {
	o.SetReturnTimeout(returnTimeout)
	return o
}

// SetReturnTimeout adds the returnTimeout to the s3 bucket modify params
func (o *S3BucketModifyParams) SetReturnTimeout(returnTimeout *string) {
