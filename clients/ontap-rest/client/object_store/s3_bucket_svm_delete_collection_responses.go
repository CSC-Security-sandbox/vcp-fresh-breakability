...
func (o *S3BucketSvmDeleteCollectionOK) Error() string {
	return fmt.Sprintf("[DELETE /protocols/s3/services/{svm.uuid}/buckets][%d] s3BucketSvmDeleteCollectionOK  %+v", 200, o.Payload)
}
...
func (o *S3BucketSvmDeleteCollectionAccepted) Error() string {
	return fmt.Sprintf("[DELETE /protocols/s3/services/{svm.uuid}/buckets][%d] s3BucketSvmDeleteCollectionAccepted  %+v", 202, o.Payload)
}
...
func (o *S3BucketSvmDeleteCollectionDefault) Error() string {
	return fmt.Sprintf("[DELETE /protocols/s3/services/{svm.uuid}/buckets][%d] s3_bucket_svm_delete_collection default  %+v", o._statusCode, o.Payload)
}
