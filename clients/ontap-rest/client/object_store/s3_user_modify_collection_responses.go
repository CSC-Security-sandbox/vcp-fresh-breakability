...
func (o *S3UserModifyCollectionOK) Error() string {
	return fmt.Sprintf("[PATCH /protocols/s3/services/{svm.uuid}/users][%d] s3UserModifyCollectionOK  %+v", 200, o.Payload)
}
...
func (o *S3UserModifyCollectionDefault) Error() string {
	return fmt.Sprintf("[PATCH /protocols/s3/services/{svm.uuid}/users][%d] s3_user_modify_collection default  %+v", o._statusCode, o.Payload)
}
		...
		if o.S3UserInlineKeys[i] != nil {
			if err := o.S3UserInlineKeys[i].Validate(formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					...
					return ce.ValidateName("info" + "." + "keys" + "." + strconv.Itoa(i))
				}
				return err
			}
		}
...
func (o *S3UserModifyCollectionBody) contextValidateS3UserInlineKeys(ctx context.Context, formats strfmt.Registry) error {
	...
	if err := validate.ReadOnly(ctx, "info"+"."+"keys", "body", []*S3UserInlineKeysInlineArrayItem(o.S3UserInlineKeys)); err != nil {
		return err
	}
...
/*
S3UserInlineKeysInlineArrayItem Specifies a key associated with an S3 user. At most only two keys can be associated with a user. <private>This is a private object in ONTAP 9.15.1 as the multi-key feature is dark in this release.<\private>
