...
func (o *S3UserModifyParams) WithDeleteKeys(deleteKeys *string) *S3UserModifyParams {
	o.SetDeleteKeys(deleteKeys)
	return o
}

// SetDeleteKeys adds the deleteKeys to the s3 user modify params
func (o *S3UserModifyParams) SetDeleteKeys(deleteKeys *string) {
...
func (o *S3UserModifyParams) WithRegenerateKeys(regenerateKeys *string) *S3UserModifyParams {
	o.SetRegenerateKeys(regenerateKeys)
	return o
}

// SetRegenerateKeys adds the regenerateKeys to the s3 user modify params
func (o *S3UserModifyParams) SetRegenerateKeys(regenerateKeys *string) {
