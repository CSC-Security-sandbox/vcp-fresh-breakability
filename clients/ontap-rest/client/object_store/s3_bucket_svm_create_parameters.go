...
func (o *S3BucketSvmCreateParams) WithReturnRecords(returnRecords *string) *S3BucketSvmCreateParams {
	o.SetReturnRecords(returnRecords)
	return o
}

// SetReturnRecords adds the returnRecords to the s3 bucket svm create params
func (o *S3BucketSvmCreateParams) SetReturnRecords(returnRecords *string) {
	o.ReturnRecords = returnRecords
}

// WithReturnTimeout adds the returnTimeout to the s3 bucket svm create params
func (o *S3BucketSvmCreateParams) WithReturnTimeout(returnTimeout *string) *S3BucketSvmCreateParams {
	o.SetReturnTimeout(returnTimeout)
	return o
}

// SetReturnTimeout adds the returnTimeout to the s3 bucket svm create params
func (o *S3BucketSvmCreateParams) SetReturnTimeout(returnTimeout *string) {
