...
func (o *S3PolicyModifyCollectionDefault) Error() string {
	return fmt.Sprintf("[PATCH /protocols/s3/services/{svm.uuid}/policies][%d] s3_policy_modify_collection default  %+v", o._statusCode, o.Payload)
}
		...
		if o.S3PolicyInlineStatements[i] != nil {
			if err := o.S3PolicyInlineStatements[i].Validate(formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					...
					return ce.ValidateName("info" + "." + "statements" + "." + strconv.Itoa(i))
				}
				return err
			}
		}
