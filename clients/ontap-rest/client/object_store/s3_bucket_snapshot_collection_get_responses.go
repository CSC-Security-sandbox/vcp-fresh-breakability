...
func (o *S3BucketSnapshotCollectionGetOK) Error() string {
	return fmt.Sprintf("[GET /protocols/s3/services/{svm.uuid}/buckets/{s3_bucket.uuid}/snapshots][%d] s3BucketSnapshotCollectionGetOK  %+v", 200, o.Payload)
}
...
func (o *S3BucketSnapshotCollectionGetDefault) Error() string {
	return fmt.Sprintf("[GET /protocols/s3/services/{svm.uuid}/buckets/{s3_bucket.uuid}/snapshots][%d] s3_bucket_snapshot_collection_get default  %+v", o._statusCode, o.Payload)
}
