...
func (o *S3BucketLifecycleRuleModifyOK) Error() string {
	return fmt.Sprintf("[PATCH /protocols/s3/services/{svm.uuid}/buckets/{s3_bucket.uuid}/rules/{name}][%d] s3BucketLifecycleRuleModifyOK  %+v", 200, o.Payload)
}
...
func (o *S3BucketLifecycleRuleModifyAccepted) Error() string {
	return fmt.Sprintf("[PATCH /protocols/s3/services/{svm.uuid}/buckets/{s3_bucket.uuid}/rules/{name}][%d] s3BucketLifecycleRuleModifyAccepted  %+v", 202, o.Payload)
}
...
func (o *S3BucketLifecycleRuleModifyDefault) Error() string {
	return fmt.Sprintf("[PATCH /protocols/s3/services/{svm.uuid}/buckets/{s3_bucket.uuid}/rules/{name}][%d] s3_bucket_lifecycle_rule_modify default  %+v", o._statusCode, o.Payload)
}
