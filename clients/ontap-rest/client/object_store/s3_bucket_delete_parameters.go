...
func (o *S3BucketDeleteParams) WithReturnTimeout(returnTimeout *string) *S3BucketDeleteParams {
	o.SetReturnTimeout(returnTimeout)
	return o
}

// SetReturnTimeout adds the returnTimeout to the s3 bucket delete params
func (o *S3BucketDeleteParams) SetReturnTimeout(returnTimeout *string) {
