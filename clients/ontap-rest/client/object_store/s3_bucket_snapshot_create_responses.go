...
func (o *S3BucketSnapshotCreateAccepted) Error() string {
	return fmt.Sprintf("[POST /protocols/s3/services/{svm.uuid}/buckets/{s3_bucket.uuid}/snapshots][%d] s3BucketSnapshotCreateAccepted  %+v", 202, o.Payload)
}
...
func (o *S3BucketSnapshotCreateDefault) Error() string {
	return fmt.Sprintf("[POST /protocols/s3/services/{svm.uuid}/buckets/{s3_bucket.uuid}/snapshots][%d] s3_bucket_snapshot_create default  %+v", o._statusCode, o.Payload)
}
