...
func (o *S3GroupModifyCollectionDefault) Error() string {
	return fmt.Sprintf("[PATCH /protocols/s3/services/{svm.uuid}/groups][%d] s3_group_modify_collection default  %+v", o._statusCode, o.Payload)
}
		...
		if o.S3GroupInlinePolicies[i] != nil {
			if err := o.S3GroupInlinePolicies[i].Validate(formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					...
					return ce.ValidateName("info" + "." + "policies" + "." + strconv.Itoa(i))
				}
				return err
			}
		}
