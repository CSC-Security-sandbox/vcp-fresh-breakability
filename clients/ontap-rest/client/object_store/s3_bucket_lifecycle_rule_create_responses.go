...
func (o *S3BucketLifecycleRuleCreateAccepted) Error() string {
	return fmt.Sprintf("[POST /protocols/s3/services/{svm.uuid}/buckets/{s3_bucket.uuid}/rules][%d] s3BucketLifecycleRuleCreateAccepted  %+v", 202, o.Payload)
}
...
func (o *S3BucketLifecycleRuleCreateDefault) Error() string {
	return fmt.Sprintf("[POST /protocols/s3/services/{svm.uuid}/buckets/{s3_bucket.uuid}/rules][%d] s3_bucket_lifecycle_rule_create default  %+v", o._statusCode, o.Payload)
}
