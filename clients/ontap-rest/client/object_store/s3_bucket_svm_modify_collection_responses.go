...
func (o *S3BucketSvmModifyCollectionOK) Error() string {
	return fmt.Sprintf("[PATCH /protocols/s3/services/{svm.uuid}/buckets][%d] s3BucketSvmModifyCollectionOK  %+v", 200, o.Payload)
}
...
func (o *S3BucketSvmModifyCollectionAccepted) Error() string {
	return fmt.Sprintf("[PATCH /protocols/s3/services/{svm.uuid}/buckets][%d] s3BucketSvmModifyCollectionAccepted  %+v", 202, o.Payload)
}
...
func (o *S3BucketSvmModifyCollectionDefault) Error() string {
	return fmt.Sprintf("[PATCH /protocols/s3/services/{svm.uuid}/buckets][%d] s3_bucket_svm_modify_collection default  %+v", o._statusCode, o.Payload)
}
	...
	if o.AuditEventSelector != nil {
		if err := o.AuditEventSelector.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("info" + "." + "audit_event_selector")
			}
			return err
		}
	}
	...
	if o.Cors != nil {
		if err := o.Cors.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("info" + "." + "cors")
			}
			return err
		}
	}
	...
	if o.LifecycleManagement != nil {
		if err := o.LifecycleManagement.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("info" + "." + "lifecycle_management")
			}
			return err
		}
	}
	...
	if o.ProtectionStatus != nil {
		if err := o.ProtectionStatus.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("info" + "." + "protection_status")
			}
			return err
		}
	}
	...
	if o.Retention != nil {
		if err := o.Retention.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("info" + "." + "retention")
			}
			return err
		}
	}
	...
	if o.Volume != nil {
		if err := o.Volume.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("info" + "." + "volume")
			}
			return err
		}
	}
		...
		if o.Rules[i] != nil {
			if err := o.Rules[i].Validate(formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					...
					return ce.ValidateName("info" + "." + "cors" + "." + "rules" + "." + strconv.Itoa(i))
				}
				return err
			}
		}
		...
		if o.Rules[i] != nil {
			if err := o.Rules[i].Validate(formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					...
					return ce.ValidateName("info" + "." + "lifecycle_management" + "." + "rules" + "." + strconv.Itoa(i))
				}
				return err
			}
		}
		...
		if o.Statements[i] != nil {
			if err := o.Statements[i].Validate(formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					...
					return ce.ValidateName("info" + "." + "policy" + "." + "statements" + "." + strconv.Itoa(i))
				}
				return err
			}
		}
	...
	if o.Destination != nil {
		if err := o.Destination.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("info" + "." + "protection_status" + "." + "destination")
			}
			return err
		}
	}
	...
	if o.Links != nil {
		if err := o.Links.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("info" + "." + "volume" + "." + "_links")
			}
			return err
		}
	}
	...
	if o.Self != nil {
		if err := o.Self.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("info" + "." + "volume" + "." + "_links" + "." + "self")
			}
			return err
		}
	}
