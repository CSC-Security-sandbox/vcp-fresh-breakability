...
func (o *S3BucketLifecycleRuleCreateParams) WithReturnRecords(returnRecords *string) *S3BucketLifecycleRuleCreateParams {
	o.SetReturnRecords(returnRecords)
	return o
}

// SetReturnRecords adds the returnRecords to the s3 bucket lifecycle rule create params
func (o *S3BucketLifecycleRuleCreateParams) SetReturnRecords(returnRecords *string) {
	o.ReturnRecords = returnRecords
}

// WithReturnTimeout adds the returnTimeout to the s3 bucket lifecycle rule create params
func (o *S3BucketLifecycleRuleCreateParams) WithReturnTimeout(returnTimeout *string) *S3BucketLifecycleRuleCreateParams {
	o.SetReturnTimeout(returnTimeout)
	return o
}

// SetReturnTimeout adds the returnTimeout to the s3 bucket lifecycle rule create params
func (o *S3BucketLifecycleRuleCreateParams) SetReturnTimeout(returnTimeout *string) {
