...
func (o *S3BucketCreateParams) WithReturnRecords(returnRecords *string) *S3BucketCreateParams {
	o.SetReturnRecords(returnRecords)
	return o
}

// SetReturnRecords adds the returnRecords to the s3 bucket create params
func (o *S3BucketCreateParams) SetReturnRecords(returnRecords *string) {
	o.ReturnRecords = returnRecords
}

// WithReturnTimeout adds the returnTimeout to the s3 bucket create params
func (o *S3BucketCreateParams) WithReturnTimeout(returnTimeout *string) *S3BucketCreateParams {
	o.SetReturnTimeout(returnTimeout)
	return o
}

// SetReturnTimeout adds the returnTimeout to the s3 bucket create params
func (o *S3BucketCreateParams) SetReturnTimeout(returnTimeout *string) {
