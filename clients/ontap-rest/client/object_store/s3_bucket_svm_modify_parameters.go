...
func (o *S3BucketSvmModifyParams) WithReturnTimeout(returnTimeout *string) *S3BucketSvmModifyParams {
	o.SetReturnTimeout(returnTimeout)
	return o
}

// SetReturnTimeout adds the returnTimeout to the s3 bucket svm modify params
func (o *S3BucketSvmModifyParams) SetReturnTimeout(returnTimeout *string) {
