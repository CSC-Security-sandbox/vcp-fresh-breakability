...
func (o *S3BucketModifyCollectionOK) Error() string {
	return fmt.Sprintf("[PATCH /protocols/s3/buckets][%d] s3BucketModifyCollectionOK  %+v", 200, o.Payload)
}
...
func (o *S3BucketModifyCollectionAccepted) Error() string {
	return fmt.Sprintf("[PATCH /protocols/s3/buckets][%d] s3BucketModifyCollectionAccepted  %+v", 202, o.Payload)
}
...
func (o *S3BucketModifyCollectionDefault) Error() string {
	return fmt.Sprintf("[PATCH /protocols/s3/buckets][%d] s3_bucket_modify_collection default  %+v", o._statusCode, o.Payload)
}
