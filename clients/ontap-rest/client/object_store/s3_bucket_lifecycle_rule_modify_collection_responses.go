...
func (o *S3BucketLifecycleRuleModifyCollectionOK) Error() string {
	return fmt.Sprintf("[PATCH /protocols/s3/services/{svm.uuid}/buckets/{s3_bucket.uuid}/rules][%d] s3BucketLifecycleRuleModifyCollectionOK  %+v", 200, o.Payload)
}
...
func (o *S3BucketLifecycleRuleModifyCollectionAccepted) Error() string {
	return fmt.Sprintf("[PATCH /protocols/s3/services/{svm.uuid}/buckets/{s3_bucket.uuid}/rules][%d] s3BucketLifecycleRuleModifyCollectionAccepted  %+v", 202, o.Payload)
}
...
func (o *S3BucketLifecycleRuleModifyCollectionDefault) Error() string {
	return fmt.Sprintf("[PATCH /protocols/s3/services/{svm.uuid}/buckets/{s3_bucket.uuid}/rules][%d] s3_bucket_lifecycle_rule_modify_collection default  %+v", o._statusCode, o.Payload)
}
	...
	if o.AbortIncompleteMultipartUpload != nil {
		if err := o.AbortIncompleteMultipartUpload.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("info" + "." + "abort_incomplete_multipart_upload")
			}
			return err
		}
	}
	...
	if o.Expiration != nil {
		if err := o.Expiration.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("info" + "." + "expiration")
			}
			return err
		}
	}
	...
	if o.NonCurrentVersionExpiration != nil {
		if err := o.NonCurrentVersionExpiration.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("info" + "." + "non_current_version_expiration")
			}
			return err
		}
	}
	...
	if o.ObjectFilter != nil {
		if err := o.ObjectFilter.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("info" + "." + "object_filter")
			}
			return err
		}
	}
	...
	if o.Links != nil {
		if err := o.Links.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("info" + "." + "abort_incomplete_multipart_upload" + "." + "_links")
			}
			return err
		}
	}
	...
	if o.Self != nil {
		if err := o.Self.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("info" + "." + "abort_incomplete_multipart_upload" + "." + "_links" + "." + "self")
			}
			return err
		}
	}
	...
	if o.Links != nil {
		if err := o.Links.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("info" + "." + "expiration" + "." + "_links")
			}
			return err
		}
	}
	...
	if o.Self != nil {
		if err := o.Self.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("info" + "." + "expiration" + "." + "_links" + "." + "self")
			}
			return err
		}
	}
	...
	if o.Links != nil {
		if err := o.Links.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("info" + "." + "non_current_version_expiration" + "." + "_links")
			}
			return err
		}
	}
	...
	if o.Self != nil {
		if err := o.Self.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("info" + "." + "non_current_version_expiration" + "." + "_links" + "." + "self")
			}
			return err
		}
	}
	...
	if o.Links != nil {
		if err := o.Links.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("info" + "." + "object_filter" + "." + "_links")
			}
			return err
		}
	}
	...
	if o.Self != nil {
		if err := o.Self.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("info" + "." + "object_filter" + "." + "_links" + "." + "self")
			}
			return err
		}
	}
