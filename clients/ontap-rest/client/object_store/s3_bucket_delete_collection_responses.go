...
func (o *S3BucketDeleteCollectionOK) Error() string {
	return fmt.Sprintf("[DELETE /protocols/s3/buckets][%d] s3BucketDeleteCollectionOK  %+v", 200, o.Payload)
}
...
func (o *S3BucketDeleteCollectionAccepted) Error() string {
	return fmt.Sprintf("[DELETE /protocols/s3/buckets][%d] s3BucketDeleteCollectionAccepted  %+v", 202, o.Payload)
}
...
func (o *S3BucketDeleteCollectionDefault) Error() string {
	return fmt.Sprintf("[DELETE /protocols/s3/buckets][%d] s3_bucket_delete_collection default  %+v", o._statusCode, o.Payload)
}
