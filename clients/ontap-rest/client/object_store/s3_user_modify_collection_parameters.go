...
func (o *S3UserModifyCollectionParams) SetDefaults() {
	var (
		...
		deleteKeysDefault = string("\"False\"")

		regenerateKeysDefault = string("\"False\"")
...
func (o *S3UserModifyCollectionParams) WithContinueOnFailure(continueOnFailure *string) *S3UserModifyCollectionParams {
	o.SetContinueOnFailure(continueOnFailure)
	return o
}

// SetContinueOnFailure adds the continueOnFailure to the s3 user modify collection params
func (o *S3UserModifyCollectionParams) SetContinueOnFailure(continueOnFailure *string) {
	o.ContinueOnFailure = continueOnFailure
}

// WithDeleteKeys adds the deleteKeys to the s3 user modify collection params
func (o *S3UserModifyCollectionParams) WithDeleteKeys(deleteKeys *string) *S3UserModifyCollectionParams {
	o.SetDeleteKeys(deleteKeys)
	return o
}

// SetDeleteKeys adds the deleteKeys to the s3 user modify collection params
func (o *S3UserModifyCollectionParams) SetDeleteKeys(deleteKeys *string) {
...
func (o *S3UserModifyCollectionParams) WithKeysID(keysID *string) *S3UserModifyCollectionParams {
	o.SetKeysID(keysID)
	return o
}

// SetKeysID adds the keysId to the s3 user modify collection params
func (o *S3UserModifyCollectionParams) SetKeysID(keysID *string) {
	o.KeysID = keysID
}
...
func (o *S3UserModifyCollectionParams) WithRegenerateKeys(regenerateKeys *string) *S3UserModifyCollectionParams {
	o.SetRegenerateKeys(regenerateKeys)
	return o
}

// SetRegenerateKeys adds the regenerateKeys to the s3 user modify collection params
func (o *S3UserModifyCollectionParams) SetRegenerateKeys(regenerateKeys *string) {
	o.RegenerateKeys = regenerateKeys
}

// WithReturnRecords adds the returnRecords to the s3 user modify collection params
func (o *S3UserModifyCollectionParams) WithReturnRecords(returnRecords *string) *S3UserModifyCollectionParams {
	o.SetReturnRecords(returnRecords)
	return o
}

// SetReturnRecords adds the returnRecords to the s3 user modify collection params
func (o *S3UserModifyCollectionParams) SetReturnRecords(returnRecords *string) {
	o.ReturnRecords = returnRecords
}

// WithReturnTimeout adds the returnTimeout to the s3 user modify collection params
func (o *S3UserModifyCollectionParams) WithReturnTimeout(returnTimeout *string) *S3UserModifyCollectionParams {
	o.SetReturnTimeout(returnTimeout)
	return o
}

// SetReturnTimeout adds the returnTimeout to the s3 user modify collection params
func (o *S3UserModifyCollectionParams) SetReturnTimeout(returnTimeout *string) {
	o.ReturnTimeout = returnTimeout
}

// WithSerialRecords adds the serialRecords to the s3 user modify collection params
func (o *S3UserModifyCollectionParams) WithSerialRecords(serialRecords *string) *S3UserModifyCollectionParams {
	o.SetSerialRecords(serialRecords)
	return o
}

// SetSerialRecords adds the serialRecords to the s3 user modify collection params
func (o *S3UserModifyCollectionParams) SetSerialRecords(serialRecords *string) {
...
func (o *S3UserModifyCollectionParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
	...
	if o.DeleteKeys != nil {
		...
		var qrDeleteKeys string

		if o.DeleteKeys != nil {
			qrDeleteKeys = *o.DeleteKeys
		}
		qDeleteKeys := qrDeleteKeys
		if qDeleteKeys != "" {
	...
	if o.RegenerateKeys != nil {
		...
		var qrRegenerateKeys string

		if o.RegenerateKeys != nil {
			qrRegenerateKeys = *o.RegenerateKeys
		}
		qRegenerateKeys := qrRegenerateKeys
		if qRegenerateKeys != "" {
