...
func (o *S3BucketSvmDeleteParams) WithReturnTimeout(returnTimeout *string) *S3BucketSvmDeleteParams {
	o.SetReturnTimeout(returnTimeout)
	return o
}

// SetReturnTimeout adds the returnTimeout to the s3 bucket svm delete params
func (o *S3BucketSvmDeleteParams) SetReturnTimeout(returnTimeout *string) {
