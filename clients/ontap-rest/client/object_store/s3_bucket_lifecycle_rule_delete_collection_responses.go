...
func (o *S3BucketLifecycleRuleDeleteCollectionDefault) Error() string {
	return fmt.Sprintf("[DELETE /protocols/s3/services/{svm.uuid}/buckets/{s3_bucket.uuid}/rules][%d] s3_bucket_lifecycle_rule_delete_collection default  %+v", o._statusCode, o.Payload)
}
