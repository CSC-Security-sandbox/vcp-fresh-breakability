...
func (o *S3BucketSnapshotDeleteDefault) Error() string {
	return fmt.Sprintf("[DELETE /protocols/s3/services/{svm.uuid}/buckets/{s3_bucket.uuid}/snapshots/{uuid}][%d] s3_bucket_snapshot_delete default  %+v", o._statusCode, o.Payload)
}
