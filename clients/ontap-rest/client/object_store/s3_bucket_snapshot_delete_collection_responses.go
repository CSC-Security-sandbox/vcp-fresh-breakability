...
func (o *S3BucketSnapshotDeleteCollectionDefault) Error() string {
	return fmt.Sprintf("[DELETE /protocols/s3/services/{svm.uuid}/buckets/{s3_bucket.uuid}/snapshots][%d] s3_bucket_snapshot_delete_collection default  %+v", o._statusCode, o.Payload)
}
