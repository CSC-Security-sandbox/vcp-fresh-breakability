...
func (o *S3BucketLifecycleRuleCollectionGetOK) Error() string {
	return fmt.Sprintf("[GET /protocols/s3/services/{svm.uuid}/buckets/{s3_bucket.uuid}/rules][%d] s3BucketLifecycleRuleCollectionGetOK  %+v", 200, o.Payload)
}
...
func (o *S3BucketLifecycleRuleCollectionGetDefault) Error() string {
	return fmt.Sprintf("[GET /protocols/s3/services/{svm.uuid}/buckets/{s3_bucket.uuid}/rules][%d] s3_bucket_lifecycle_rule_collection_get default  %+v", o._statusCode, o.Payload)
}
