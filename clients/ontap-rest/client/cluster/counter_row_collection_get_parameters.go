...
func (o *CounterRowCollectionGetParams) WithAggregationComplete(aggregationComplete *string) *CounterRowCollectionGetParams {
...
func (o *CounterRowCollectionGetParams) SetAggregationComplete(aggregationComplete *string) {
...
func (o *CounterRowCollectionGetParams) WithAggregationCount(aggregationCount *string) *CounterRowCollectionGetParams {
...
func (o *CounterRowCollectionGetParams) SetAggregationCount(aggregationCount *string) {
...
func (o *CounterRowCollectionGetParams) WithCountersCountersValues(countersCountersValues *string) *CounterRowCollectionGetParams {
...
func (o *CounterRowCollectionGetParams) SetCountersCountersValues(countersCountersValues *string) {
...
func (o *CounterRowCollectionGetParams) WithCountersValue(countersValue *string) *CounterRowCollectionGetParams {
	o.SetCountersValue(countersValue)
	return o
}

// SetCountersValue adds the countersValue to the counter row collection get params
func (o *CounterRowCollectionGetParams) SetCountersValue(countersValue *string) {
	o.CountersValue = countersValue
}

// WithCountersValues adds the countersValues to the counter row collection get params
func (o *CounterRowCollectionGetParams) WithCountersValues(countersValues *string) *CounterRowCollectionGetParams {
	o.SetCountersValues(countersValues)
	return o
}

// SetCountersValues adds the countersValues to the counter row collection get params
func (o *CounterRowCollectionGetParams) SetCountersValues(countersValues *string) {
...
func (o *CounterRowCollectionGetParams) WithMaxRecords(maxRecords *string) *CounterRowCollectionGetParams {
	o.SetMaxRecords(maxRecords)
	return o
}

// SetMaxRecords adds the maxRecords to the counter row collection get params
func (o *CounterRowCollectionGetParams) SetMaxRecords(maxRecords *string) {
...
func (o *CounterRowCollectionGetParams) WithReturnRecords(returnRecords *string) *CounterRowCollectionGetParams {
	o.SetReturnRecords(returnRecords)
	return o
}

// SetReturnRecords adds the returnRecords to the counter row collection get params
func (o *CounterRowCollectionGetParams) SetReturnRecords(returnRecords *string) {
	o.ReturnRecords = returnRecords
}

// WithReturnTimeout adds the returnTimeout to the counter row collection get params
func (o *CounterRowCollectionGetParams) WithReturnTimeout(returnTimeout *string) *CounterRowCollectionGetParams {
	o.SetReturnTimeout(returnTimeout)
	return o
}

// SetReturnTimeout adds the returnTimeout to the counter row collection get params
func (o *CounterRowCollectionGetParams) SetReturnTimeout(returnTimeout *string) {
...
func (o *CounterRowCollectionGetParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
	...
	if o.AggregationComplete != nil {
		...
		var qrAggregationComplete string

		if o.AggregationComplete != nil {
			qrAggregationComplete = *o.AggregationComplete
		}
		qAggregationComplete := qrAggregationComplete
	...
	if o.AggregationCount != nil {
		...
		var qrAggregationCount string

		if o.AggregationCount != nil {
			qrAggregationCount = *o.AggregationCount
		}
		qAggregationCount := qrAggregationCount
	...
	if o.CountersCountersValues != nil {
		...
		var qrCountersCountersValues string

		if o.CountersCountersValues != nil {
			qrCountersCountersValues = *o.CountersCountersValues
		}
		qCountersCountersValues := qrCountersCountersValues
	...
	if o.CountersValue != nil {
		...
		var qrCountersValue string

		if o.CountersValue != nil {
			qrCountersValue = *o.CountersValue
		}
		qCountersValue := qrCountersValue
		if qCountersValue != "" {
	...
	if o.CountersValues != nil {
		...
		var qrCountersValues string

		if o.CountersValues != nil {
			qrCountersValues = *o.CountersValues
		}
		qCountersValues := qrCountersValues
		if qCountersValues != "" {
