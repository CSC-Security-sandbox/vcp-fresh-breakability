...
func (o *ClusterNtpServersModifyCollectionOK) Error() string {
	return fmt.Sprintf("[PATCH /cluster/ntp/servers][%d] clusterNtpServersModifyCollectionOK  %+v", 200, o.Payload)
}
...
func (o *ClusterNtpServersModifyCollectionAccepted) Error() string {
	return fmt.Sprintf("[PATCH /cluster/ntp/servers][%d] clusterNtpServersModifyCollectionAccepted  %+v", 202, o.Payload)
}
...
func (o *ClusterNtpServersModifyCollectionDefault) Error() string {
	return fmt.Sprintf("[PATCH /cluster/ntp/servers][%d] cluster_ntp_servers_modify_collection default  %+v", o._statusCode, o.Payload)
}
	...
	if o.Key != nil {
		if err := o.Key.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("info" + "." + "key")
			}
			return err
		}
	}
