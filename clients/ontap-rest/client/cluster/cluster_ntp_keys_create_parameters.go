...
func (o *ClusterNtpKeysCreateParams) WithReturnRecords(returnRecords *string) *ClusterNtpKeysCreateParams {
	o.SetReturnRecords(returnRecords)
	return o
}

// SetReturnRecords adds the returnRecords to the cluster ntp keys create params
func (o *ClusterNtpKeysCreateParams) SetReturnRecords(returnRecords *string) {
