...
func (o *SoftwarePackageCreateParams) WithReturnTimeout(returnTimeout *string) *SoftwarePackageCreateParams {
	o.SetReturnTimeout(returnTimeout)
	return o
}

// SetReturnTimeout adds the returnTimeout to the software package create params
func (o *SoftwarePackageCreateParams) SetReturnTimeout(returnTimeout *string) {
