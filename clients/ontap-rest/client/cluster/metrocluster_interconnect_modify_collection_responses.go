...
func (o *MetroclusterInterconnectModifyCollectionOK) Error() string {
	return fmt.Sprintf("[PATCH /cluster/metrocluster/interconnects][%d] metroclusterInterconnectModifyCollectionOK  %+v", 200, o.Payload)
}
...
func (o *MetroclusterInterconnectModifyCollectionAccepted) Error() string {
	return fmt.Sprintf("[PATCH /cluster/metrocluster/interconnects][%d] metroclusterInterconnectModifyCollectionAccepted  %+v", 202, o.Payload)
}
...
func (o *MetroclusterInterconnectModifyCollectionDefault) Error() string {
	return fmt.Sprintf("[PATCH /cluster/metrocluster/interconnects][%d] metrocluster_interconnect_modify_collection default  %+v", o._statusCode, o.Payload)
}
		...
		if o.MetroclusterInterconnectInlineInterfaces[i] != nil {
			if err := o.MetroclusterInterconnectInlineInterfaces[i].Validate(formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					...
					return ce.ValidateName("info" + "." + "interfaces" + "." + strconv.Itoa(i))
				}
				return err
			}
		}
	...
	if o.Mirror != nil {
		if err := o.Mirror.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("info" + "." + "mirror")
			}
			return err
		}
	}
	...
	if o.Netmask != nil {
		if err := o.Netmask.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("netmask")
			}
			return err
		}
	}
