...
func (o *MetroclusterDiagnosticsCreateParams) WithReturnTimeout(returnTimeout *string) *MetroclusterDiagnosticsCreateParams {
	o.SetReturnTimeout(returnTimeout)
	return o
}

// SetReturnTimeout adds the returnTimeout to the metrocluster diagnostics create params
func (o *MetroclusterDiagnosticsCreateParams) SetReturnTimeout(returnTimeout *string) {
	o.ReturnTimeout = returnTimeout
}

// WithSchedule adds the schedule to the metrocluster diagnostics create params
func (o *MetroclusterDiagnosticsCreateParams) WithSchedule(schedule *string) *MetroclusterDiagnosticsCreateParams {
	o.SetSchedule(schedule)
	return o
}

// SetSchedule adds the schedule to the metrocluster diagnostics create params
func (o *MetroclusterDiagnosticsCreateParams) SetSchedule(schedule *string) {
	o.Schedule = schedule
}
