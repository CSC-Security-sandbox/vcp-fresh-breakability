...
func (o *MetroclusterDrGroupCollectionGetParams) WithID(id *string) *MetroclusterDrGroupCollectionGetParams {
	o.SetID(id)
	return o
}

// SetID adds the id to the metrocluster dr group collection get params
func (o *MetroclusterDrGroupCollectionGetParams) SetID(id *string) {
	o.ID = id
}

// WithMaxRecords adds the maxRecords to the metrocluster dr group collection get params
func (o *MetroclusterDrGroupCollectionGetParams) WithMaxRecords(maxRecords *string) *MetroclusterDrGroupCollectionGetParams {
	o.SetMaxRecords(maxRecords)
	return o
}

// SetMaxRecords adds the maxRecords to the metrocluster dr group collection get params
func (o *MetroclusterDrGroupCollectionGetParams) SetMaxRecords(maxRecords *string) {
...
func (o *MetroclusterDrGroupCollectionGetParams) WithReturnRecords(returnRecords *string) *MetroclusterDrGroupCollectionGetParams {
	o.SetReturnRecords(returnRecords)
	return o
}

// SetReturnRecords adds the returnRecords to the metrocluster dr group collection get params
func (o *MetroclusterDrGroupCollectionGetParams) SetReturnRecords(returnRecords *string) {
	o.ReturnRecords = returnRecords
}

// WithReturnTimeout adds the returnTimeout to the metrocluster dr group collection get params
func (o *MetroclusterDrGroupCollectionGetParams) WithReturnTimeout(returnTimeout *string) *MetroclusterDrGroupCollectionGetParams {
	o.SetReturnTimeout(returnTimeout)
	return o
}

// SetReturnTimeout adds the returnTimeout to the metrocluster dr group collection get params
func (o *MetroclusterDrGroupCollectionGetParams) SetReturnTimeout(returnTimeout *string) {
