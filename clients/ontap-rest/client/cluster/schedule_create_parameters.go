...
func (o *ScheduleCreateParams) WithReturnRecords(returnRecords *string) *ScheduleCreateParams {
	o.SetReturnRecords(returnRecords)
	return o
}

// SetReturnRecords adds the returnRecords to the schedule create params
func (o *ScheduleCreateParams) SetReturnRecords(returnRecords *string) {
