...
func (o *NodeDeleteCollectionOK) Error() string {
	return fmt.Sprintf("[DELETE /cluster/nodes][%d] nodeDeleteCollectionOK  %+v", 200, o.Payload)
}
...
func (o *NodeDeleteCollectionAccepted) Error() string {
	return fmt.Sprintf("[DELETE /cluster/nodes][%d] nodeDeleteCollectionAccepted  %+v", 202, o.Payload)
}
...
func (o *NodeDeleteCollectionDefault) Error() string {
	return fmt.Sprintf("[DELETE /cluster/nodes][%d] node_delete_collection default  %+v", o._statusCode, o.Payload)
}
...
func (o *NodeResponseInlineRecordsInlineArrayItem) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	...
	if err := o.contextValidateDisaggregated(ctx, formats); err != nil {
		res = append(res, err)
	}
	...
	if err := o.contextValidateIsAllFlashOptimized(ctx, formats); err != nil {
		res = append(res, err)
	}

	if err := o.contextValidateIsAllFlashSelectOptimized(ctx, formats); err != nil {
		res = append(res, err)
	}

	if err := o.contextValidateIsCapacityOptimized(ctx, formats); err != nil {
		res = append(res, err)
	}

	if err := o.contextValidateIsPerformanceOptimized(ctx, formats); err != nil {
		res = append(res, err)
	}
	...
	if err := o.contextValidateSANOptimized(ctx, formats); err != nil {
		res = append(res, err)
	}
...
func (o *NodeResponseInlineRecordsInlineArrayItem) contextValidateDisaggregated(ctx context.Context, formats strfmt.Registry) error {

	if err := validate.ReadOnly(ctx, "disaggregated", "body", o.Disaggregated); err != nil {
		return err
	}
...
func (o *NodeResponseInlineRecordsInlineArrayItem) contextValidateIsAllFlashOptimized(ctx context.Context, formats strfmt.Registry) error {

	if err := validate.ReadOnly(ctx, "is_all_flash_optimized", "body", o.IsAllFlashOptimized); err != nil {
		return err
	}
...
func (o *NodeResponseInlineRecordsInlineArrayItem) contextValidateIsAllFlashSelectOptimized(ctx context.Context, formats strfmt.Registry) error {

	if err := validate.ReadOnly(ctx, "is_all_flash_select_optimized", "body", o.IsAllFlashSelectOptimized); err != nil {
		return err
	}
...
func (o *NodeResponseInlineRecordsInlineArrayItem) contextValidateIsCapacityOptimized(ctx context.Context, formats strfmt.Registry) error {

	if err := validate.ReadOnly(ctx, "is_capacity_optimized", "body", o.IsCapacityOptimized); err != nil {
		return err
	}
...
func (o *NodeResponseInlineRecordsInlineArrayItem) contextValidateIsPerformanceOptimized(ctx context.Context, formats strfmt.Registry) error {

	if err := validate.ReadOnly(ctx, "is_performance_optimized", "body", o.IsPerformanceOptimized); err != nil {
		return err
	}
...
func (o *NodeResponseInlineRecordsInlineArrayItem) contextValidateSANOptimized(ctx context.Context, formats strfmt.Registry) error {

	if err := validate.ReadOnly(ctx, "san_optimized", "body", o.SANOptimized); err != nil {
		return err
	}
...
func (o *NodeResponseInlineRecordsInlineArrayItemInlineVersion) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	...
	if err := o.contextValidatePatch(ctx, formats); err != nil {
		res = append(res, err)
	}
...
func (o *NodeResponseInlineRecordsInlineArrayItemInlineVersion) contextValidatePatch(ctx context.Context, formats strfmt.Registry) error {

	if err := validate.ReadOnly(ctx, "version"+"."+"patch", "body", o.Patch); err != nil {
		return err
	}
...
func (o *NodeResponseInlineRecordsInlineArrayItemInlineVM) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	...
	if err := o.contextValidateAccountID(ctx, formats); err != nil {
		res = append(res, err)
	}

	if err := o.contextValidateDeploymentID(ctx, formats); err != nil {
		res = append(res, err)
	}

	if err := o.contextValidateFaultDomain(ctx, formats); err != nil {
		res = append(res, err)
	}

	if err := o.contextValidateInstanceID(ctx, formats); err != nil {
		res = append(res, err)
	}

	if err := o.contextValidatePrimaryIP(ctx, formats); err != nil {
		res = append(res, err)
	}
	...
	if err := o.contextValidateUpdateDomain(ctx, formats); err != nil {
		res = append(res, err)
	}
...
func (o *NodeResponseInlineRecordsInlineArrayItemInlineVM) contextValidateAccountID(ctx context.Context, formats strfmt.Registry) error {

	if err := validate.ReadOnly(ctx, "vm"+"."+"account_id", "body", o.AccountID); err != nil {
		return err
	}
...
func (o *NodeResponseInlineRecordsInlineArrayItemInlineVM) contextValidateDeploymentID(ctx context.Context, formats strfmt.Registry) error {

	if err := validate.ReadOnly(ctx, "vm"+"."+"deployment_id", "body", o.DeploymentID); err != nil {
		return err
	}
...
func (o *NodeResponseInlineRecordsInlineArrayItemInlineVM) contextValidateFaultDomain(ctx context.Context, formats strfmt.Registry) error {

	if err := validate.ReadOnly(ctx, "vm"+"."+"fault_domain", "body", o.FaultDomain); err != nil {
		return err
	}
...
func (o *NodeResponseInlineRecordsInlineArrayItemInlineVM) contextValidateInstanceID(ctx context.Context, formats strfmt.Registry) error {

	if err := validate.ReadOnly(ctx, "vm"+"."+"instance_id", "body", o.InstanceID); err != nil {
		return err
	}
...
func (o *NodeResponseInlineRecordsInlineArrayItemInlineVM) contextValidatePrimaryIP(ctx context.Context, formats strfmt.Registry) error {

	if err := validate.ReadOnly(ctx, "vm"+"."+"primary_ip", "body", o.PrimaryIP); err != nil {
		return err
	}
...
func (o *NodeResponseInlineRecordsInlineArrayItemInlineVM) contextValidateUpdateDomain(ctx context.Context, formats strfmt.Registry) error {

	if err := validate.ReadOnly(ctx, "vm"+"."+"update_domain", "body", o.UpdateDomain); err != nil {
		return err
	}
