...
func (o *ClusterCreateParams) SetDefaults() {
	var (
		...
		keepPreclusterConfigDefault = string("\"False\"")
...
func (o *ClusterCreateParams) WithCreateRecommendedAggregates(createRecommendedAggregates *string) *ClusterCreateParams {
...
func (o *ClusterCreateParams) SetCreateRecommendedAggregates(createRecommendedAggregates *string) {
...
func (o *ClusterCreateParams) WithKeepPreclusterConfig(keepPreclusterConfig *string) *ClusterCreateParams {
...
func (o *ClusterCreateParams) SetKeepPreclusterConfig(keepPreclusterConfig *string) {
	o.KeepPreclusterConfig = keepPreclusterConfig
}

// WithReturnTimeout adds the returnTimeout to the cluster create params
func (o *ClusterCreateParams) WithReturnTimeout(returnTimeout *string) *ClusterCreateParams {
	o.SetReturnTimeout(returnTimeout)
	return o
}

// SetReturnTimeout adds the returnTimeout to the cluster create params
func (o *ClusterCreateParams) SetReturnTimeout(returnTimeout *string) {
	o.ReturnTimeout = returnTimeout
}

// WithSingleNodeCluster adds the singleNodeCluster to the cluster create params
func (o *ClusterCreateParams) WithSingleNodeCluster(singleNodeCluster *string) *ClusterCreateParams {
	o.SetSingleNodeCluster(singleNodeCluster)
	return o
}

// SetSingleNodeCluster adds the singleNodeCluster to the cluster create params
func (o *ClusterCreateParams) SetSingleNodeCluster(singleNodeCluster *string) {
...
func (o *ClusterCreateParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
	...
	if o.KeepPreclusterConfig != nil {
		...
		var qrKeepPreclusterConfig string

		if o.KeepPreclusterConfig != nil {
			qrKeepPreclusterConfig = *o.KeepPreclusterConfig
		}
		qKeepPreclusterConfig := qrKeepPreclusterConfig
	...
	if o.SingleNodeCluster != nil {
		...
		var qrSingleNodeCluster string

		if o.SingleNodeCluster != nil {
			qrSingleNodeCluster = *o.SingleNodeCluster
		}
		qSingleNodeCluster := qrSingleNodeCluster
