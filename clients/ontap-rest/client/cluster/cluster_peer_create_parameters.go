...
func (o *ClusterPeerCreateParams) WithReturnRecords(returnRecords *string) *ClusterPeerCreateParams {
	o.SetReturnRecords(returnRecords)
	return o
}

// SetReturnRecords adds the returnRecords to the cluster peer create params
func (o *ClusterPeerCreateParams) SetReturnRecords(returnRecords *string) {
