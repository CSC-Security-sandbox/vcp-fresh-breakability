...
type SoftwareModifyParams struct {
	...
	*/
	...
	It's an invalid option until effective cluster version is 9_16_0.
	     ...
	     Format: boolean
	*/
	SkipNodesAtTargetVersion *string
...
func (o *SoftwareModifyParams) WithEstimateOnly(estimateOnly *string) *SoftwareModifyParams {
	o.SetEstimateOnly(estimateOnly)
	return o
}

// SetEstimateOnly adds the estimateOnly to the software modify params
func (o *SoftwareModifyParams) SetEstimateOnly(estimateOnly *string) {
	o.EstimateOnly = estimateOnly
}

// WithForceRolling adds the forceRolling to the software modify params
func (o *SoftwareModifyParams) WithForceRolling(forceRolling *string) *SoftwareModifyParams {
	o.SetForceRolling(forceRolling)
	return o
}

// SetForceRolling adds the forceRolling to the software modify params
func (o *SoftwareModifyParams) SetForceRolling(forceRolling *string) {
...
func (o *SoftwareModifyParams) WithReturnTimeout(returnTimeout *string) *SoftwareModifyParams {
	o.SetReturnTimeout(returnTimeout)
	return o
}

// SetReturnTimeout adds the returnTimeout to the software modify params
func (o *SoftwareModifyParams) SetReturnTimeout(returnTimeout *string) {
	o.ReturnTimeout = returnTimeout
}

// WithShowValidationDetails adds the showValidationDetails to the software modify params
func (o *SoftwareModifyParams) WithShowValidationDetails(showValidationDetails *string) *SoftwareModifyParams {
...
func (o *SoftwareModifyParams) SetShowValidationDetails(showValidationDetails *string) {
...
func (o *SoftwareModifyParams) WithSkipNodesAtTargetVersion(skipNodesAtTargetVersion *string) *SoftwareModifyParams {
...
func (o *SoftwareModifyParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
	...
	if o.EstimateOnly != nil {
		...
		var qrEstimateOnly string

		if o.EstimateOnly != nil {
			qrEstimateOnly = *o.EstimateOnly
		}
		qEstimateOnly := qrEstimateOnly
		if qEstimateOnly != "" {
	...
	if o.ForceRolling != nil {
		...
		var qrForceRolling string

		if o.ForceRolling != nil {
			qrForceRolling = *o.ForceRolling
		}
		qForceRolling := qrForceRolling
		if qForceRolling != "" {
	...
	if o.ShowValidationDetails != nil {
		...
		var qrShowValidationDetails string

		if o.ShowValidationDetails != nil {
			qrShowValidationDetails = *o.ShowValidationDetails
		}
		qShowValidationDetails := qrShowValidationDetails
	...
	if o.SkipNodesAtTargetVersion != nil {
		...
		var qrSkipNodesAtTargetVersion string

		if o.SkipNodesAtTargetVersion != nil {
			qrSkipNodesAtTargetVersion = *o.SkipNodesAtTargetVersion
		}
		qSkipNodesAtTargetVersion := qrSkipNodesAtTargetVersion
	...
	if o.SkipWarnings != nil {
		...
		var qrSkipWarnings string

		if o.SkipWarnings != nil {
			qrSkipWarnings = *o.SkipWarnings
		}
		qSkipWarnings := qrSkipWarnings
		if qSkipWarnings != "" {
	...
	if o.StabilizeMinutes != nil {
		...
		var qrStabilizeMinutes string

		if o.StabilizeMinutes != nil {
			qrStabilizeMinutes = *o.StabilizeMinutes
		}
		qStabilizeMinutes := qrStabilizeMinutes
