...
func (o *ClusterNtpServersModifyParams) WithReturnTimeout(returnTimeout *string) *ClusterNtpServersModifyParams {
	o.SetReturnTimeout(returnTimeout)
	return o
}

// SetReturnTimeout adds the returnTimeout to the cluster ntp servers modify params
func (o *ClusterNtpServersModifyParams) SetReturnTimeout(returnTimeout *string) {
