...
func (o *ResourceTagGetOK) Error() string {
	return fmt.Sprintf("[GET /resource-tags/{value}][%d] resourceTagGetOK  %+v", 200, o.Payload)
}
...
func (o *ResourceTagGetDefault) Error() string {
	return fmt.Sprintf("[GET /resource-tags/{value}][%d] resource_tag_get default  %+v", o._statusCode, o.Payload)
}
