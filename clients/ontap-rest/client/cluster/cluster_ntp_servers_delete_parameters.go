...
func (o *ClusterNtpServersDeleteParams) WithReturnTimeout(returnTimeout *string) *ClusterNtpServersDeleteParams {
	o.SetReturnTimeout(returnTimeout)
	return o
}

// SetReturnTimeout adds the returnTimeout to the cluster ntp servers delete params
func (o *ClusterNtpServersDeleteParams) SetReturnTimeout(returnTimeout *string) {
