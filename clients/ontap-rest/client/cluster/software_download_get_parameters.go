...
func (o *SoftwareDownloadGetParams) WithReturnTimeout(returnTimeout *string) *SoftwareDownloadGetParams {
	o.SetReturnTimeout(returnTimeout)
	return o
}

// SetReturnTimeout adds the returnTimeout to the software download get params
func (o *SoftwareDownloadGetParams) SetReturnTimeout(returnTimeout *string) {
