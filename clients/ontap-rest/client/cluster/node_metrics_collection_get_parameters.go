...
func (o *NodeMetricsCollectionGetParams) WithMaxRecords(maxRecords *string) *NodeMetricsCollectionGetParams {
	o.SetMaxRecords(maxRecords)
	return o
}

// SetMaxRecords adds the maxRecords to the node metrics collection get params
func (o *NodeMetricsCollectionGetParams) SetMaxRecords(maxRecords *string) {
...
func (o *NodeMetricsCollectionGetParams) WithProcessorUtilization(processorUtilization *string) *NodeMetricsCollectionGetParams {
...
func (o *NodeMetricsCollectionGetParams) SetProcessorUtilization(processorUtilization *string) {
...
func (o *NodeMetricsCollectionGetParams) WithReturnRecords(returnRecords *string) *NodeMetricsCollectionGetParams {
	o.SetReturnRecords(returnRecords)
	return o
}

// SetReturnRecords adds the returnRecords to the node metrics collection get params
func (o *NodeMetricsCollectionGetParams) SetReturnRecords(returnRecords *string) {
	o.ReturnRecords = returnRecords
}

// WithReturnTimeout adds the returnTimeout to the node metrics collection get params
func (o *NodeMetricsCollectionGetParams) WithReturnTimeout(returnTimeout *string) *NodeMetricsCollectionGetParams {
	o.SetReturnTimeout(returnTimeout)
	return o
}

// SetReturnTimeout adds the returnTimeout to the node metrics collection get params
func (o *NodeMetricsCollectionGetParams) SetReturnTimeout(returnTimeout *string) {
...
func (o *NodeMetricsCollectionGetParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
	...
	if o.ProcessorUtilization != nil {
		...
		var qrProcessorUtilization string

		if o.ProcessorUtilization != nil {
			qrProcessorUtilization = *o.ProcessorUtilization
		}
		qProcessorUtilization := qrProcessorUtilization
