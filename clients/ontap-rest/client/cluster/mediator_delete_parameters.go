...
func (o *MediatorDeleteParams) WithReturnTimeout(returnTimeout *string) *MediatorDeleteParams {
	o.SetReturnTimeout(returnTimeout)
	return o
}

// SetReturnTimeout adds the returnTimeout to the mediator delete params
func (o *MediatorDeleteParams) SetReturnTimeout(returnTimeout *string) {
