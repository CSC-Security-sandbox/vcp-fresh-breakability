...
func (o *ClusterNtpKeysCollectionGetParams) WithID(id *string) *ClusterNtpKeysCollectionGetParams {
	o.SetID(id)
	return o
}

// SetID adds the id to the cluster ntp keys collection get params
func (o *ClusterNtpKeysCollectionGetParams) SetID(id *string) {
	o.ID = id
}

// WithMaxRecords adds the maxRecords to the cluster ntp keys collection get params
func (o *ClusterNtpKeysCollectionGetParams) WithMaxRecords(maxRecords *string) *ClusterNtpKeysCollectionGetParams {
	o.SetMaxRecords(maxRecords)
	return o
}

// SetMaxRecords adds the maxRecords to the cluster ntp keys collection get params
func (o *ClusterNtpKeysCollectionGetParams) SetMaxRecords(maxRecords *string) {
...
func (o *ClusterNtpKeysCollectionGetParams) WithReturnRecords(returnRecords *string) *ClusterNtpKeysCollectionGetParams {
	o.SetReturnRecords(returnRecords)
	return o
}

// SetReturnRecords adds the returnRecords to the cluster ntp keys collection get params
func (o *ClusterNtpKeysCollectionGetParams) SetReturnRecords(returnRecords *string) {
	o.ReturnRecords = returnRecords
}

// WithReturnTimeout adds the returnTimeout to the cluster ntp keys collection get params
func (o *ClusterNtpKeysCollectionGetParams) WithReturnTimeout(returnTimeout *string) *ClusterNtpKeysCollectionGetParams {
	o.SetReturnTimeout(returnTimeout)
	return o
}

// SetReturnTimeout adds the returnTimeout to the cluster ntp keys collection get params
func (o *ClusterNtpKeysCollectionGetParams) SetReturnTimeout(returnTimeout *string) {
