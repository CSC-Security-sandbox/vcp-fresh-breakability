...
func (o *ClusterPeerModifyCollectionOK) Error() string {
	return fmt.Sprintf("[PATCH /cluster/peers][%d] clusterPeerModifyCollectionOK  %+v", 200, o.Payload)
}
...
func (o *ClusterPeerModifyCollectionDefault) Error() string {
	return fmt.Sprintf("[PATCH /cluster/peers][%d] cluster_peer_modify_collection default  %+v", o._statusCode, o.Payload)
}
	...
	if o.Authentication != nil {
		if err := o.Authentication.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("info" + "." + "authentication")
			}
			return err
		}
	}
		...
		if o.ClusterPeerInlineInitialAllowedSvms[i] != nil {
			if err := o.ClusterPeerInlineInitialAllowedSvms[i].Validate(formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					...
					return ce.ValidateName("info" + "." + "initial_allowed_svms" + "." + strconv.Itoa(i))
				}
				return err
			}
		}
		...
		if o.ClusterPeerInlinePeerApplications[i] != nil {
			if err := o.ClusterPeerInlinePeerApplications[i].Validate(formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					...
					return ce.ValidateName("info" + "." + "peer_applications" + "." + strconv.Itoa(i))
				}
				return err
			}
		}
	...
	if o.IPAddress != nil {
		if err := o.IPAddress.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("info" + "." + "ip_address")
			}
			return err
		}
	}
	...
	if o.LocalNetwork != nil {
		if err := o.LocalNetwork.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("info" + "." + "local_network")
			}
			return err
		}
	}
	...
	if o.Remote != nil {
		if err := o.Remote.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("info" + "." + "remote")
			}
			return err
		}
	}
	...
	if o.Interfaces != nil {
		if err := o.Interfaces.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("info" + "." + "_links" + "." + "interfaces")
			}
			return err
		}
	}
		...
		if o.Interfaces[i] != nil {
			if err := o.Interfaces[i].Validate(formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					...
					return ce.ValidateName("info" + "." + "local_network" + "." + "interfaces" + "." + strconv.Itoa(i))
				}
				return err
			}
		}
		...
		if o.IPAddresses[i] != nil {
			if err := o.IPAddresses[i].Validate(formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					...
					return ce.ValidateName("info" + "." + "remote" + "." + "ip_addresses" + "." + strconv.Itoa(i))
				}
				return err
			}
		}
...
func (o *ClusterPeerInlineVersion) contextValidatePatch(ctx context.Context, formats strfmt.Registry) error {

	if err := validate.ReadOnly(ctx, "info"+"."+"version"+"."+"patch", "body", o.Patch); err != nil {
		return err
	}
