...
func (o *MetroclusterDrGroupDeleteCollectionOK) Error() string {
	return fmt.Sprintf("[DELETE /cluster/metrocluster/dr-groups][%d] metroclusterDrGroupDeleteCollectionOK  %+v", 200, o.Payload)
}
...
func (o *MetroclusterDrGroupDeleteCollectionAccepted) Error() string {
	return fmt.Sprintf("[DELETE /cluster/metrocluster/dr-groups][%d] metroclusterDrGroupDeleteCollectionAccepted  %+v", 202, o.Payload)
}
...
func (o *MetroclusterDrGroupDeleteCollectionDefault) Error() string {
	return fmt.Sprintf("[DELETE /cluster/metrocluster/dr-groups][%d] metrocluster_dr_group_delete_collection default  %+v", o._statusCode, o.Payload)
}
