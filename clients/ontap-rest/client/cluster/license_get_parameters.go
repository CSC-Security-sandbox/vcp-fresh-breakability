...
func (o *LicenseGetParams) WithLicensesActive(licensesActive *string) *LicenseGetParams {
	o.SetLicensesActive(licensesActive)
	return o
}

// SetLicensesActive adds the licensesActive to the license get params
func (o *LicenseGetParams) SetLicensesActive(licensesActive *string) {
...
func (o *LicenseGetParams) WithLicensesCapacityMaximumSize(licensesCapacityMaximumSize *string) *LicenseGetParams {
...
func (o *LicenseGetParams) SetLicensesCapacityMaximumSize(licensesCapacityMaximumSize *string) {
...
func (o *LicenseGetParams) WithLicensesCapacityUsedSize(licensesCapacityUsedSize *string) *LicenseGetParams {
...
func (o *LicenseGetParams) SetLicensesCapacityUsedSize(licensesCapacityUsedSize *string) {
...
func (o *LicenseGetParams) WithLicensesEvaluation(licensesEvaluation *string) *LicenseGetParams {
	o.SetLicensesEvaluation(licensesEvaluation)
	return o
}

// SetLicensesEvaluation adds the licensesEvaluation to the license get params
func (o *LicenseGetParams) SetLicensesEvaluation(licensesEvaluation *string) {
...
func (o *LicenseGetParams) WithLicensesShutdownImminent(licensesShutdownImminent *string) *LicenseGetParams {
...
func (o *LicenseGetParams) SetLicensesShutdownImminent(licensesShutdownImminent *string) {
