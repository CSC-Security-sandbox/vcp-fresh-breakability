...
func (o *ResourceTagResourceCollectionGetOK) Error() string {
	return fmt.Sprintf("[GET /resource-tags/{resource_tag.value}/resources][%d] resourceTagResourceCollectionGetOK  %+v", 200, o.Payload)
}
...
func (o *ResourceTagResourceCollectionGetDefault) Error() string {
	return fmt.Sprintf("[GET /resource-tags/{resource_tag.value}/resources][%d] resource_tag_resource_collection_get default  %+v", o._statusCode, o.Payload)
}
