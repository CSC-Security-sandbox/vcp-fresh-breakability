...
func (o *MetroclusterInterconnectModifyParams) WithReturnTimeout(returnTimeout *string) *MetroclusterInterconnectModifyParams {
	o.SetReturnTimeout(returnTimeout)
	return o
}

// SetReturnTimeout adds the returnTimeout to the metrocluster interconnect modify params
func (o *MetroclusterInterconnectModifyParams) SetReturnTimeout(returnTimeout *string) {
