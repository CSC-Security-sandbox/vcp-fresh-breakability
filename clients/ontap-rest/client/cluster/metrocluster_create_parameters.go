...
func (o *MetroclusterCreateParams) WithReturnTimeout(returnTimeout *string) *MetroclusterCreateParams {
	o.SetReturnTimeout(returnTimeout)
	return o
}

// SetReturnTimeout adds the returnTimeout to the metrocluster create params
func (o *MetroclusterCreateParams) SetReturnTimeout(returnTimeout *string) {
