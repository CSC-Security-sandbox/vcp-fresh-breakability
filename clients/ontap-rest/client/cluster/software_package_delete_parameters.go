...
func (o *SoftwarePackageDeleteParams) WithReturnTimeout(returnTimeout *string) *SoftwarePackageDeleteParams {
	o.SetReturnTimeout(returnTimeout)
	return o
}

// SetReturnTimeout adds the returnTimeout to the software package delete params
func (o *SoftwarePackageDeleteParams) SetReturnTimeout(returnTimeout *string) {
