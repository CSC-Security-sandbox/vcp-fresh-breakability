...
func (o *ResourceTagCollectionGetOK) Error() string {
	return fmt.Sprintf("[GET /resource-tags][%d] resourceTagCollectionGetOK  %+v", 200, o.Payload)
}
...
func (o *ResourceTagCollectionGetDefault) Error() string {
	return fmt.Sprintf("[GET /resource-tags][%d] resource_tag_collection_get default  %+v", o._statusCode, o.Payload)
}
