...
func (o *NodeModifyCollectionOK) Error() string {
	return fmt.Sprintf("[PATCH /cluster/nodes][%d] nodeModifyCollectionOK  %+v", 200, o.Payload)
}
...
func (o *NodeModifyCollectionAccepted) Error() string {
	return fmt.Sprintf("[PATCH /cluster/nodes][%d] nodeModifyCollectionAccepted  %+v", 202, o.Payload)
}
...
func (o *NodeModifyCollectionDefault) Error() string {
	return fmt.Sprintf("[PATCH /cluster/nodes][%d] node_modify_collection default  %+v", o._statusCode, o.Payload)
}
	...
	if o.ClusterInterface != nil {
		if err := o.ClusterInterface.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("info" + "." + "cluster_interface")
			}
			return err
		}
	}
		...
		if o.ClusterInterfaces[i] != nil {
			if err := o.ClusterInterfaces[i].Validate(formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					...
					return ce.ValidateName("info" + "." + "cluster_interfaces" + "." + strconv.Itoa(i))
				}
				return err
			}
		}
	...
	if o.Controller != nil {
		if err := o.Controller.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("info" + "." + "controller")
			}
			return err
		}
	}
	...
	if o.ExternalCache != nil {
		if err := o.ExternalCache.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("info" + "." + "external_cache")
			}
			return err
		}
	}
	...
	if o.ExternalCacheBypass != nil {
		if err := o.ExternalCacheBypass.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("info" + "." + "external_cache_bypass")
			}
			return err
		}
	}
	...
	if o.Ha != nil {
		if err := o.Ha.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("info" + "." + "ha")
			}
			return err
		}
	}
	...
	if o.HwAssist != nil {
		if err := o.HwAssist.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("info" + "." + "hw_assist")
			}
			return err
		}
	}
	...
	if o.ManagementInterface != nil {
		if err := o.ManagementInterface.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("info" + "." + "management_interface")
			}
			return err
		}
	}
		...
		if o.ManagementInterfaces[i] != nil {
			if err := o.ManagementInterfaces[i].Validate(formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					...
					return ce.ValidateName("info" + "." + "management_interfaces" + "." + strconv.Itoa(i))
				}
				return err
			}
		}
	...
	if o.Metrocluster != nil {
		if err := o.Metrocluster.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("info" + "." + "metrocluster")
			}
			return err
		}
	}
	...
	if o.Nvram != nil {
		if err := o.Nvram.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("info" + "." + "nvram")
			}
			return err
		}
	}
	...
	if o.ServiceProcessor != nil {
		if err := o.ServiceProcessor.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("info" + "." + "service_processor")
			}
			return err
		}
	}
	...
	if o.SystemAggregate != nil {
		if err := o.SystemAggregate.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("info" + "." + "system_aggregate")
			}
			return err
		}
	}
	...
	if o.Version != nil {
		if err := o.Version.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("info" + "." + "version")
			}
			return err
		}
	}
	...
	if o.VM != nil {
		if err := o.VM.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("info" + "." + "vm")
			}
			return err
		}
	}
...
func (o *NodeModifyCollectionBody) contextValidateDisaggregated(ctx context.Context, formats strfmt.Registry) error {

	if err := validate.ReadOnly(ctx, "info"+"."+"disaggregated", "body", o.Disaggregated); err != nil {
		return err
	}
...
func (o *NodeModifyCollectionBody) contextValidateIsAllFlashOptimized(ctx context.Context, formats strfmt.Registry) error {

	if err := validate.ReadOnly(ctx, "info"+"."+"is_all_flash_optimized", "body", o.IsAllFlashOptimized); err != nil {
		return err
	}
...
func (o *NodeModifyCollectionBody) contextValidateIsAllFlashSelectOptimized(ctx context.Context, formats strfmt.Registry) error {

	if err := validate.ReadOnly(ctx, "info"+"."+"is_all_flash_select_optimized", "body", o.IsAllFlashSelectOptimized); err != nil {
		return err
	}
...
func (o *NodeModifyCollectionBody) contextValidateIsCapacityOptimized(ctx context.Context, formats strfmt.Registry) error {

	if err := validate.ReadOnly(ctx, "info"+"."+"is_capacity_optimized", "body", o.IsCapacityOptimized); err != nil {
		return err
	}
...
func (o *NodeModifyCollectionBody) contextValidateIsPerformanceOptimized(ctx context.Context, formats strfmt.Registry) error {

	if err := validate.ReadOnly(ctx, "info"+"."+"is_performance_optimized", "body", o.IsPerformanceOptimized); err != nil {
		return err
	}
...
func (o *NodeModifyCollectionBody) contextValidateSANOptimized(ctx context.Context, formats strfmt.Registry) error {

	if err := validate.ReadOnly(ctx, "info"+"."+"san_optimized", "body", o.SANOptimized); err != nil {
		return err
	}
