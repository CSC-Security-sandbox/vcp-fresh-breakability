...
func (o *CapacityPoolGetParams) WithNodesUsedSize(nodesUsedSize *string) *CapacityPoolGetParams {
	o.SetNodesUsedSize(nodesUsedSize)
	return o
}

// SetNodesUsedSize adds the nodesUsedSize to the capacity pool get params
func (o *CapacityPoolGetParams) SetNodesUsedSize(nodesUsedSize *string) {
