...
func (o *MetroclusterDrGroupDeleteParams) WithReturnTimeout(returnTimeout *string) *MetroclusterDrGroupDeleteParams {
	o.SetReturnTimeout(returnTimeout)
	return o
}

// SetReturnTimeout adds the returnTimeout to the metrocluster dr group delete params
func (o *MetroclusterDrGroupDeleteParams) SetReturnTimeout(returnTimeout *string) {
