...
func (o *MediatorDeleteCollectionOK) Error() string {
	return fmt.Sprintf("[DELETE /cluster/mediators][%d] mediatorDeleteCollectionOK  %+v", 200, o.Payload)
}
...
func (o *MediatorDeleteCollectionAccepted) Error() string {
	return fmt.Sprintf("[DELETE /cluster/mediators][%d] mediatorDeleteCollectionAccepted  %+v", 202, o.Payload)
}
...
func (o *MediatorDeleteCollectionDefault) Error() string {
	return fmt.Sprintf("[DELETE /cluster/mediators][%d] mediator_delete_collection default  %+v", o._statusCode, o.Payload)
}
