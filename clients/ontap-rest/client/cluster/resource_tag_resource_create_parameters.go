...
func (o *ResourceTagResourceCreateParams) WithReturnRecords(returnRecords *string) *ResourceTagResourceCreateParams {
	o.SetReturnRecords(returnRecords)
	return o
}

// SetReturnRecords adds the returnRecords to the resource tag resource create params
func (o *ResourceTagResourceCreateParams) SetReturnRecords(returnRecords *string) {
