...
func (o *MetroclusterDiagnosticsCreateCreated) Error() string {
	return fmt.Sprintf("[POST /cluster/metrocluster/diagnostics][%d] metroclusterDiagnosticsCreateCreated  %+v", 201, o.Payload)
}
...
func (o *MetroclusterDiagnosticsCreateDefault) Error() string {
	return fmt.Sprintf("[POST /cluster/metrocluster/diagnostics][%d] metrocluster_diagnostics_create default  %+v", o._statusCode, o.Payload)
}
