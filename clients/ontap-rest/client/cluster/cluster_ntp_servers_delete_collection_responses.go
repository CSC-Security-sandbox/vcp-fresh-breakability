...
func (o *ClusterNtpServersDeleteCollectionOK) Error() string {
	return fmt.Sprintf("[DELETE /cluster/ntp/servers][%d] clusterNtpServersDeleteCollectionOK  %+v", 200, o.Payload)
}
...
func (o *ClusterNtpServersDeleteCollectionAccepted) Error() string {
	return fmt.Sprintf("[DELETE /cluster/ntp/servers][%d] clusterNtpServersDeleteCollectionAccepted  %+v", 202, o.Payload)
}
...
func (o *ClusterNtpServersDeleteCollectionDefault) Error() string {
	return fmt.Sprintf("[DELETE /cluster/ntp/servers][%d] cluster_ntp_servers_delete_collection default  %+v", o._statusCode, o.Payload)
}
