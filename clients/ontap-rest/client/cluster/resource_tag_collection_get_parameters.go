...
func (o *ResourceTagCollectionGetParams) WithMaxRecords(maxRecords *string) *ResourceTagCollectionGetParams {
	o.SetMaxRecords(maxRecords)
	return o
}

// SetMaxRecords adds the maxRecords to the resource tag collection get params
func (o *ResourceTagCollectionGetParams) SetMaxRecords(maxRecords *string) {
	o.MaxRecords = maxRecords
}

// WithNumResources adds the numResources to the resource tag collection get params
func (o *ResourceTagCollectionGetParams) WithNumResources(numResources *string) *ResourceTagCollectionGetParams {
	o.SetNumResources(numResources)
	return o
}

// SetNumResources adds the numResources to the resource tag collection get params
func (o *ResourceTagCollectionGetParams) SetNumResources(numResources *string) {
...
func (o *ResourceTagCollectionGetParams) WithReturnRecords(returnRecords *string) *ResourceTagCollectionGetParams {
	o.SetReturnRecords(returnRecords)
	return o
}

// SetReturnRecords adds the returnRecords to the resource tag collection get params
func (o *ResourceTagCollectionGetParams) SetReturnRecords(returnRecords *string) {
	o.ReturnRecords = returnRecords
}

// WithReturnTimeout adds the returnTimeout to the resource tag collection get params
func (o *ResourceTagCollectionGetParams) WithReturnTimeout(returnTimeout *string) *ResourceTagCollectionGetParams {
	o.SetReturnTimeout(returnTimeout)
	return o
}

// SetReturnTimeout adds the returnTimeout to the resource tag collection get params
func (o *ResourceTagCollectionGetParams) SetReturnTimeout(returnTimeout *string) {
...
func (o *ResourceTagCollectionGetParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
	...
	if o.NumResources != nil {
		...
		var qrNumResources string

		if o.NumResources != nil {
			qrNumResources = *o.NumResources
		}
		qNumResources := qrNumResources
		if qNumResources != "" {
