...
func (o *LicenseManagerModifyCollectionOK) Error() string {
	return fmt.Sprintf("[PATCH /cluster/licensing/license-managers][%d] licenseManagerModifyCollectionOK  %+v", 200, o.Payload)
}
...
func (o *LicenseManagerModifyCollectionAccepted) Error() string {
	return fmt.Sprintf("[PATCH /cluster/licensing/license-managers][%d] licenseManagerModifyCollectionAccepted  %+v", 202, o.Payload)
}
...
func (o *LicenseManagerModifyCollectionDefault) Error() string {
	return fmt.Sprintf("[PATCH /cluster/licensing/license-managers][%d] license_manager_modify_collection default  %+v", o._statusCode, o.Payload)
}
	...
	if o.URI != nil {
		if err := o.URI.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("info" + "." + "uri")
			}
			return err
		}
	}
