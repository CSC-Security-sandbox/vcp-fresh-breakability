...
func (o *MetroclusterNodeCollectionGetParams) WithAutomaticUso(automaticUso *string) *MetroclusterNodeCollectionGetParams {
	o.SetAutomaticUso(automaticUso)
	return o
}

// SetAutomaticUso adds the automaticUso to the metrocluster node collection get params
func (o *MetroclusterNodeCollectionGetParams) SetAutomaticUso(automaticUso *string) {
...
func (o *MetroclusterNodeCollectionGetParams) WithDrGroupID(drGroupID *string) *MetroclusterNodeCollectionGetParams {
	o.SetDrGroupID(drGroupID)
	return o
}

// SetDrGroupID adds the drGroupId to the metrocluster node collection get params
func (o *MetroclusterNodeCollectionGetParams) SetDrGroupID(drGroupID *string) {
...
func (o *MetroclusterNodeCollectionGetParams) WithEncryptionEnabled(encryptionEnabled *string) *MetroclusterNodeCollectionGetParams {
...
func (o *MetroclusterNodeCollectionGetParams) SetEncryptionEnabled(encryptionEnabled *string) {
...
func (o *MetroclusterNodeCollectionGetParams) WithIsMccip(isMccip *string) *MetroclusterNodeCollectionGetParams {
	o.SetIsMccip(isMccip)
	return o
}

// SetIsMccip adds the isMccip to the metrocluster node collection get params
func (o *MetroclusterNodeCollectionGetParams) SetIsMccip(isMccip *string) {
	o.IsMccip = isMccip
}
...
func (o *MetroclusterNodeCollectionGetParams) WithMaxRecords(maxRecords *string) *MetroclusterNodeCollectionGetParams {
	o.SetMaxRecords(maxRecords)
	return o
}

// SetMaxRecords adds the maxRecords to the metrocluster node collection get params
func (o *MetroclusterNodeCollectionGetParams) SetMaxRecords(maxRecords *string) {
...
func (o *MetroclusterNodeCollectionGetParams) WithReturnRecords(returnRecords *string) *MetroclusterNodeCollectionGetParams {
	o.SetReturnRecords(returnRecords)
	return o
}

// SetReturnRecords adds the returnRecords to the metrocluster node collection get params
func (o *MetroclusterNodeCollectionGetParams) SetReturnRecords(returnRecords *string) {
	o.ReturnRecords = returnRecords
}

// WithReturnTimeout adds the returnTimeout to the metrocluster node collection get params
func (o *MetroclusterNodeCollectionGetParams) WithReturnTimeout(returnTimeout *string) *MetroclusterNodeCollectionGetParams {
	o.SetReturnTimeout(returnTimeout)
	return o
}

// SetReturnTimeout adds the returnTimeout to the metrocluster node collection get params
func (o *MetroclusterNodeCollectionGetParams) SetReturnTimeout(returnTimeout *string) {
...
func (o *MetroclusterNodeCollectionGetParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
	...
	if o.AutomaticUso != nil {
		...
		var qrAutomaticUso string

		if o.AutomaticUso != nil {
			qrAutomaticUso = *o.AutomaticUso
		}
		qAutomaticUso := qrAutomaticUso
		if qAutomaticUso != "" {
	...
	if o.DrGroupID != nil {
		...
		var qrDrGroupID string

		if o.DrGroupID != nil {
			qrDrGroupID = *o.DrGroupID
		}
		qDrGroupID := qrDrGroupID
		if qDrGroupID != "" {
