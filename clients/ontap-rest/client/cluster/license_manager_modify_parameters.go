...
func (o *LicenseManagerModifyParams) WithReturnTimeout(returnTimeout *string) *LicenseManagerModifyParams {
	o.SetReturnTimeout(returnTimeout)
	return o
}

// SetReturnTimeout adds the returnTimeout to the license manager modify params
func (o *LicenseManagerModifyParams) SetReturnTimeout(returnTimeout *string) {
