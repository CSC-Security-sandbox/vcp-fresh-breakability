...
func (o *NodeDeleteParams) WithForce(force *string) *NodeDeleteParams {
	o.SetForce(force)
	return o
}

// SetForce adds the force to the node delete params
func (o *NodeDeleteParams) SetForce(force *string) {
	o.Force = force
}

// WithReturnTimeout adds the returnTimeout to the node delete params
func (o *NodeDeleteParams) WithReturnTimeout(returnTimeout *string) *NodeDeleteParams {
	o.SetReturnTimeout(returnTimeout)
	return o
}

// SetReturnTimeout adds the returnTimeout to the node delete params
func (o *NodeDeleteParams) SetReturnTimeout(returnTimeout *string) {
