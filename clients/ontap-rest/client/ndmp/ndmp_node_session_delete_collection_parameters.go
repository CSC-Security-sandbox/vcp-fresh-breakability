...
func (o *NdmpNodeSessionDeleteCollectionParams) WithClientPort(clientPort *string) *NdmpNodeSessionDeleteCollectionParams {
	o.SetClientPort(clientPort)
	return o
}

// SetClientPort adds the clientPort to the ndmp node session delete collection params
func (o *NdmpNodeSessionDeleteCollectionParams) SetClientPort(clientPort *string) {
...
func (o *NdmpNodeSessionDeleteCollectionParams) WithContinueOnFailure(continueOnFailure *string) *NdmpNodeSessionDeleteCollectionParams {
	o.SetContinueOnFailure(continueOnFailure)
	return o
}

// SetContinueOnFailure adds the continueOnFailure to the ndmp node session delete collection params
func (o *NdmpNodeSessionDeleteCollectionParams) SetContinueOnFailure(continueOnFailure *string) {
	o.ContinueOnFailure = continueOnFailure
}

// WithDataBytesProcessed adds the dataBytesProcessed to the ndmp node session delete collection params
func (o *NdmpNodeSessionDeleteCollectionParams) WithDataBytesProcessed(dataBytesProcessed *string) *NdmpNodeSessionDeleteCollectionParams {
...
func (o *NdmpNodeSessionDeleteCollectionParams) SetDataBytesProcessed(dataBytesProcessed *string) {
...
func (o *NdmpNodeSessionDeleteCollectionParams) WithDataConnectionPort(dataConnectionPort *string) *NdmpNodeSessionDeleteCollectionParams {
...
func (o *NdmpNodeSessionDeleteCollectionParams) SetDataConnectionPort(dataConnectionPort *string) {
...
func (o *NdmpNodeSessionDeleteCollectionParams) WithMoverBytesMoved(moverBytesMoved *string) *NdmpNodeSessionDeleteCollectionParams {
...
func (o *NdmpNodeSessionDeleteCollectionParams) SetMoverBytesMoved(moverBytesMoved *string) {
...
func (o *NdmpNodeSessionDeleteCollectionParams) WithMoverConnectionPort(moverConnectionPort *string) *NdmpNodeSessionDeleteCollectionParams {
...
func (o *NdmpNodeSessionDeleteCollectionParams) SetMoverConnectionPort(moverConnectionPort *string) {
...
func (o *NdmpNodeSessionDeleteCollectionParams) WithReturnRecords(returnRecords *string) *NdmpNodeSessionDeleteCollectionParams {
	o.SetReturnRecords(returnRecords)
	return o
}

// SetReturnRecords adds the returnRecords to the ndmp node session delete collection params
func (o *NdmpNodeSessionDeleteCollectionParams) SetReturnRecords(returnRecords *string) {
	o.ReturnRecords = returnRecords
}

// WithReturnTimeout adds the returnTimeout to the ndmp node session delete collection params
func (o *NdmpNodeSessionDeleteCollectionParams) WithReturnTimeout(returnTimeout *string) *NdmpNodeSessionDeleteCollectionParams {
	o.SetReturnTimeout(returnTimeout)
	return o
}

// SetReturnTimeout adds the returnTimeout to the ndmp node session delete collection params
func (o *NdmpNodeSessionDeleteCollectionParams) SetReturnTimeout(returnTimeout *string) {
...
func (o *NdmpNodeSessionDeleteCollectionParams) WithScsiHostAdapter(scsiHostAdapter *string) *NdmpNodeSessionDeleteCollectionParams {
...
func (o *NdmpNodeSessionDeleteCollectionParams) SetScsiHostAdapter(scsiHostAdapter *string) {
	o.ScsiHostAdapter = scsiHostAdapter
}

// WithScsiLunID adds the scsiLunID to the ndmp node session delete collection params
func (o *NdmpNodeSessionDeleteCollectionParams) WithScsiLunID(scsiLunID *string) *NdmpNodeSessionDeleteCollectionParams {
	o.SetScsiLunID(scsiLunID)
	return o
}

// SetScsiLunID adds the scsiLunId to the ndmp node session delete collection params
func (o *NdmpNodeSessionDeleteCollectionParams) SetScsiLunID(scsiLunID *string) {
	o.ScsiLunID = scsiLunID
}

// WithScsiTargetID adds the scsiTargetID to the ndmp node session delete collection params
func (o *NdmpNodeSessionDeleteCollectionParams) WithScsiTargetID(scsiTargetID *string) *NdmpNodeSessionDeleteCollectionParams {
	o.SetScsiTargetID(scsiTargetID)
	return o
}

// SetScsiTargetID adds the scsiTargetId to the ndmp node session delete collection params
func (o *NdmpNodeSessionDeleteCollectionParams) SetScsiTargetID(scsiTargetID *string) {
	o.ScsiTargetID = scsiTargetID
}

// WithSerialRecords adds the serialRecords to the ndmp node session delete collection params
func (o *NdmpNodeSessionDeleteCollectionParams) WithSerialRecords(serialRecords *string) *NdmpNodeSessionDeleteCollectionParams {
	o.SetSerialRecords(serialRecords)
	return o
}

// SetSerialRecords adds the serialRecords to the ndmp node session delete collection params
func (o *NdmpNodeSessionDeleteCollectionParams) SetSerialRecords(serialRecords *string) {
...
func (o *NdmpNodeSessionDeleteCollectionParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
	...
	if o.ClientPort != nil {
		...
		var qrClientPort string

		if o.ClientPort != nil {
			qrClientPort = *o.ClientPort
		}
		qClientPort := qrClientPort
		if qClientPort != "" {
	...
	if o.DataBytesProcessed != nil {
		...
		var qrDataBytesProcessed string

		if o.DataBytesProcessed != nil {
			qrDataBytesProcessed = *o.DataBytesProcessed
		}
		qDataBytesProcessed := qrDataBytesProcessed
	...
	if o.DataConnectionPort != nil {
		...
		var qrDataConnectionPort string

		if o.DataConnectionPort != nil {
			qrDataConnectionPort = *o.DataConnectionPort
		}
		qDataConnectionPort := qrDataConnectionPort
	...
	if o.MoverBytesMoved != nil {
		...
		var qrMoverBytesMoved string

		if o.MoverBytesMoved != nil {
			qrMoverBytesMoved = *o.MoverBytesMoved
		}
		qMoverBytesMoved := qrMoverBytesMoved
		if qMoverBytesMoved != "" {
	...
	if o.MoverConnectionPort != nil {
		...
		var qrMoverConnectionPort string

		if o.MoverConnectionPort != nil {
			qrMoverConnectionPort = *o.MoverConnectionPort
		}
		qMoverConnectionPort := qrMoverConnectionPort
	...
	if o.ScsiHostAdapter != nil {
		...
		var qrScsiHostAdapter string

		if o.ScsiHostAdapter != nil {
			qrScsiHostAdapter = *o.ScsiHostAdapter
		}
		qScsiHostAdapter := qrScsiHostAdapter
		if qScsiHostAdapter != "" {
	...
	if o.ScsiLunID != nil {
		...
		var qrScsiLunID string

		if o.ScsiLunID != nil {
			qrScsiLunID = *o.ScsiLunID
		}
		qScsiLunID := qrScsiLunID
		if qScsiLunID != "" {
	...
	if o.ScsiTargetID != nil {
		...
		var qrScsiTargetID string

		if o.ScsiTargetID != nil {
			qrScsiTargetID = *o.ScsiTargetID
		}
		qScsiTargetID := qrScsiTargetID
		if qScsiTargetID != "" {
