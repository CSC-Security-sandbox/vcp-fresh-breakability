...
func (o *NdmpSvmModifyCollectionOK) Error() string {
	return fmt.Sprintf("[PATCH /protocols/ndmp/svms][%d] ndmpSvmModifyCollectionOK  %+v", 200, o.Payload)
}
...
func (o *NdmpSvmModifyCollectionDefault) Error() string {
	return fmt.Sprintf("[PATCH /protocols/ndmp/svms][%d] ndmp_svm_modify_collection default  %+v", o._statusCode, o.Payload)
}
