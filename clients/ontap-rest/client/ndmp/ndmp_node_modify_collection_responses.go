...
func (o *NdmpNodeModifyCollectionOK) Error() string {
	return fmt.Sprintf("[PATCH /protocols/ndmp/nodes][%d] ndmpNodeModifyCollectionOK  %+v", 200, o.Payload)
}
...
func (o *NdmpNodeModifyCollectionDefault) Error() string {
	return fmt.Sprintf("[PATCH /protocols/ndmp/nodes][%d] ndmp_node_modify_collection default  %+v", o._statusCode, o.Payload)
}
		...
		if o.NdmpNodeInlineAuthenticationTypes[i] != nil {
			if err := o.NdmpNodeInlineAuthenticationTypes[i].Validate(formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					...
					return ce.ValidateName("info" + "." + "authentication_types" + "." + strconv.Itoa(i))
				}
				return err
			}
		}
