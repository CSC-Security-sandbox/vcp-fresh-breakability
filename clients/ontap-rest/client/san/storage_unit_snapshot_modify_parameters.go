...
func (o *StorageUnitSnapshotModifyParams) WithReturnTimeout(returnTimeout *string) *StorageUnitSnapshotModifyParams {
	o.SetReturnTimeout(returnTimeout)
	return o
}

// SetReturnTimeout adds the returnTimeout to the storage unit snapshot modify params
func (o *StorageUnitSnapshotModifyParams) SetReturnTimeout(returnTimeout *string) {
