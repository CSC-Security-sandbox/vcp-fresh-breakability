...
func (o *LunFormDataDeleteParams) WithAllowDeleteWhileMapped(allowDeleteWhileMapped *string) *LunFormDataDeleteParams {
...
func (o *LunFormDataDeleteParams) SetAllowDeleteWhileMapped(allowDeleteWhileMapped *string) {
...
func (o *LunFormDataDeleteParams) WithReturnTimeout(returnTimeout *string) *LunFormDataDeleteParams {
	o.SetReturnTimeout(returnTimeout)
	return o
}

// SetReturnTimeout adds the returnTimeout to the lun form data delete params
func (o *LunFormDataDeleteParams) SetReturnTimeout(returnTimeout *string) {
