...
func (o *StorageUnitSnapshotModifyCollectionOK) Error() string {
	return fmt.Sprintf("[PATCH /storage/storage-units/{storage_unit.uuid}/snapshots][%d] storageUnitSnapshotModifyCollectionOK  %+v", 200, o.Payload)
}
...
func (o *StorageUnitSnapshotModifyCollectionAccepted) Error() string {
	return fmt.Sprintf("[PATCH /storage/storage-units/{storage_unit.uuid}/snapshots][%d] storageUnitSnapshotModifyCollectionAccepted  %+v", 202, o.Payload)
}
...
func (o *StorageUnitSnapshotModifyCollectionDefault) Error() string {
	return fmt.Sprintf("[PATCH /storage/storage-units/{storage_unit.uuid}/snapshots][%d] storage_unit_snapshot_modify_collection default  %+v", o._statusCode, o.Payload)
}
	...
	if o.Delta != nil {
		if err := o.Delta.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("info" + "." + "delta")
			}
			return err
		}
	}
	...
	if o.StorageUnit != nil {
		if err := o.StorageUnit.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("info" + "." + "storage_unit")
			}
			return err
		}
	}
	...
	if o.Links != nil {
		if err := o.Links.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("info" + "." + "storage_unit" + "." + "_links")
			}
			return err
		}
	}
	...
	if o.Self != nil {
		if err := o.Self.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("info" + "." + "storage_unit" + "." + "_links" + "." + "self")
			}
			return err
		}
	}
