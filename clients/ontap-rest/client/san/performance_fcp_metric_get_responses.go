...
func (o *PerformanceFcpMetricGetOK) Error() string {
	return fmt.Sprintf("[GET /protocols/san/fcp/services/{svm.uuid}/metrics/{timestamp}][%d] performanceFcpMetricGetOK  %+v", 200, o.Payload)
}
...
func (o *PerformanceFcpMetricGetDefault) Error() string {
	return fmt.Sprintf("[GET /protocols/san/fcp/services/{svm.uuid}/metrics/{timestamp}][%d] performance_fcp_metric_get default  %+v", o._statusCode, o.Payload)
}
