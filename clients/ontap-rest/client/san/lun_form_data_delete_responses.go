...
func (o *LunFormDataDeleteAccepted) Error() string {
	return fmt.Sprintf("[DELETE //storage/luns/{uuid}][%d] lunFormDataDeleteAccepted  %+v", 202, o.Payload)
}
...
func (o *LunFormDataDeleteDefault) Error() string {
	return fmt.Sprintf("[DELETE //storage/luns/{uuid}][%d] lun_form_data_delete default  %+v", o._statusCode, o.Payload)
}
