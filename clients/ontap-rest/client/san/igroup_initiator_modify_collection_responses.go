...
func (o *IgroupInitiatorModifyCollectionDefault) Error() string {
	return fmt.Sprintf("[PATCH /protocols/san/igroups/{igroup.uuid}/initiators][%d] igroup_initiator_modify_collection default  %+v", o._statusCode, o.Payload)
}
		...
		if o.Connections[i] != nil {
			if err := o.Connections[i].Validate(formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					...
					return ce.ValidateName("info" + "." + "connectivity_tracking" + "." + "connections" + "." + strconv.Itoa(i))
				}
				return err
			}
		}
	...
	if o.Links != nil {
		if err := o.Links.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("info" + "." + "igroup" + "." + "_links")
			}
			return err
		}
	}
	...
	if o.Self != nil {
		if err := o.Self.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("info" + "." + "igroup" + "." + "_links" + "." + "self")
			}
			return err
		}
	}
		...
		if o.PeerSvms[i] != nil {
			if err := o.PeerSvms[i].Validate(formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					...
					return ce.ValidateName("info" + "." + "proximity" + "." + "peer_svms" + "." + strconv.Itoa(i))
				}
				return err
			}
		}
