...
func (o *StorageUnitCreateCreated) Error() string {
	return fmt.Sprintf("[POST /storage/storage-units][%d] storageUnitCreateCreated  %+v", 201, o.Payload)
}
...
func (o *StorageUnitCreateAccepted) Error() string {
	return fmt.Sprintf("[POST /storage/storage-units][%d] storageUnitCreateAccepted  %+v", 202, o.Payload)
}
...
func (o *StorageUnitCreateDefault) Error() string {
	return fmt.Sprintf("[POST /storage/storage-units][%d] storage_unit_create default  %+v", o._statusCode, o.Payload)
}
