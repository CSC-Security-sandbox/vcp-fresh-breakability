...
func (o *PerformanceIscsiMetricGetOK) Error() string {
	return fmt.Sprintf("[GET /protocols/san/iscsi/services/{svm.uuid}/metrics/{timestamp}][%d] performanceIscsiMetricGetOK  %+v", 200, o.Payload)
}
...
func (o *PerformanceIscsiMetricGetDefault) Error() string {
	return fmt.Sprintf("[GET /protocols/san/iscsi/services/{svm.uuid}/metrics/{timestamp}][%d] performance_iscsi_metric_get default  %+v", o._statusCode, o.Payload)
}
