...
func (o *PortsetInterfaceCreateParams) WithReturnRecords(returnRecords *string) *PortsetInterfaceCreateParams {
	o.SetReturnRecords(returnRecords)
	return o
}

// SetReturnRecords adds the returnRecords to the portset interface create params
func (o *PortsetInterfaceCreateParams) SetReturnRecords(returnRecords *string) {
