...
func (o *StorageUnitSnapshotDeleteOK) Error() string {
	return fmt.Sprintf("[DELETE /storage/storage-units/{storage_unit.uuid}/snapshots/{uuid}][%d] storageUnitSnapshotDeleteOK  %+v", 200, o.Payload)
}
...
func (o *StorageUnitSnapshotDeleteAccepted) Error() string {
	return fmt.Sprintf("[DELETE /storage/storage-units/{storage_unit.uuid}/snapshots/{uuid}][%d] storageUnitSnapshotDeleteAccepted  %+v", 202, o.Payload)
}
...
func (o *StorageUnitSnapshotDeleteDefault) Error() string {
	return fmt.Sprintf("[DELETE /storage/storage-units/{storage_unit.uuid}/snapshots/{uuid}][%d] storage_unit_snapshot_delete default  %+v", o._statusCode, o.Payload)
}
