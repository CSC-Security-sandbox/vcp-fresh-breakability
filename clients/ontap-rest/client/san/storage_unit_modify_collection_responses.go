...
func (o *StorageUnitModifyCollectionOK) Error() string {
	return fmt.Sprintf("[PATCH /storage/storage-units][%d] storageUnitModifyCollectionOK  %+v", 200, o.Payload)
}
...
func (o *StorageUnitModifyCollectionAccepted) Error() string {
	return fmt.Sprintf("[PATCH /storage/storage-units][%d] storageUnitModifyCollectionAccepted  %+v", 202, o.Payload)
}
...
| 5376508 | A storage unit move operation of a secondary LUN or NVMe namespace is not supported. To move a secondary, you must move the associated primary LUN or NVMe namespace which will move all of the secondaries. |
...
func (o *StorageUnitModifyCollectionDefault) Error() string {
	return fmt.Sprintf("[PATCH /storage/storage-units][%d] storage_unit_modify_collection default  %+v", o._statusCode, o.Payload)
}
		...
		if o.StorageUnitInlineMaps[i] != nil {
			if err := o.StorageUnitInlineMaps[i].Validate(formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					...
					return ce.ValidateName("info" + "." + "maps" + "." + strconv.Itoa(i))
				}
				return err
			}
		}
...
func (o *StorageUnitModifyCollectionBody) contextValidateStorageUnitInlineMaps(ctx context.Context, formats strfmt.Registry) error {
	...
	if err := validate.ReadOnly(ctx, "info"+"."+"maps", "body", []*StorageUnitInlineMapsInlineArrayItem(o.StorageUnitInlineMaps)); err != nil {
		return err
	}
	...
	if o.HostGroup != nil {
		if err := o.HostGroup.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("host_group")
			}
			return err
		}
	}
	...
	if o.LunMap != nil {
		if err := o.LunMap.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("lun_map")
			}
			return err
		}
	}
	...
	if o.Links != nil {
		if err := o.Links.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("lun_map" + "." + "_links")
			}
			return err
		}
	}
	...
	if o.Igroup != nil {
		if err := o.Igroup.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("lun_map" + "." + "igroup")
			}
			return err
		}
	}
	...
	if o.Self != nil {
		if err := o.Self.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("lun_map" + "." + "_links" + "." + "self")
			}
			return err
		}
	}
	...
	if o.Links != nil {
		if err := o.Links.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("lun_map" + "." + "igroup" + "." + "_links")
			}
			return err
		}
	}
	...
	if o.Self != nil {
		if err := o.Self.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("lun_map" + "." + "igroup" + "." + "_links" + "." + "self")
			}
			return err
		}
	}
...
type StorageUnitInlineMovement struct {
	...
	// The state of the storage unit move operation. Update the state to `aborted` to cancel the storage unit move operation. Update the state to `cutover` to trigger cutover. Update the state to `paused` to pause the storage unit move operation in progress. Update the state to `replicating` to resume the paused storage unit move operation. Update the state to `cutover_wait` to go into cutover manually. When the storage unit move operation is waiting to go into the `cutover` state, the state is `cutover_pending`. A change of state is only supported if a storage unit move operation is in progress.</br>
	// There is an added computational cost to retrieving this property's value. It is not populated for a GET request unless it is explicitly requested using the `fields` query parameter. See [`Requesting specific fields`](#Requesting_specific_fields) to learn more.
	//
	// Example: replicating
	...
	if o.Destination != nil {
		if err := o.Destination.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("info" + "." + "movement" + "." + "destination")
			}
			return err
		}
	}
	...
	if o.Source != nil {
		if err := o.Source.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("info" + "." + "movement" + "." + "source")
			}
			return err
		}
	}
	...
	if o.StorageAvailabilityZone != nil {
		if err := o.StorageAvailabilityZone.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("info" + "." + "movement" + "." + "destination" + "." + "storage_availability_zone")
			}
			return err
		}
	}
	...
	if o.Links != nil {
		if err := o.Links.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("info" + "." + "movement" + "." + "destination" + "." + "storage_availability_zone" + "." + "_links")
			}
			return err
		}
	}
	...
	if o.Self != nil {
		if err := o.Self.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("info" + "." + "movement" + "." + "destination" + "." + "storage_availability_zone" + "." + "_links" + "." + "self")
			}
			return err
		}
	}
	...
	if o.StorageAvailabilityZone != nil {
		if err := o.StorageAvailabilityZone.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("info" + "." + "movement" + "." + "source" + "." + "storage_availability_zone")
			}
			return err
		}
	}
	...
	if o.Links != nil {
		if err := o.Links.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("info" + "." + "movement" + "." + "source" + "." + "storage_availability_zone" + "." + "_links")
			}
			return err
		}
	}
	...
	if o.Self != nil {
		if err := o.Self.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("info" + "." + "movement" + "." + "source" + "." + "storage_availability_zone" + "." + "_links" + "." + "self")
			}
			return err
		}
	}
