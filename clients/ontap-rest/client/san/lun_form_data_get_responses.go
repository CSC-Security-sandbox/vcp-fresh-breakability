...
func (o *LunFormDataGetOK) Error() string {
	return fmt.Sprintf("[GET //storage/luns/{uuid}][%d] lunFormDataGetOK  %+v", 200, o.Payload)
}
...
func (o *LunFormDataGetDefault) Error() string {
	return fmt.Sprintf("[GET //storage/luns/{uuid}][%d] lun_form_data_get default  %+v", o._statusCode, o.Payload)
}
