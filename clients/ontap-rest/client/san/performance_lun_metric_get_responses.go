...
func (o *PerformanceLunMetricGetOK) Error() string {
	return fmt.Sprintf("[GET /storage/luns/{lun.uuid}/metrics/{timestamp}][%d] performanceLunMetricGetOK  %+v", 200, o.Payload)
}
...
func (o *PerformanceLunMetricGetDefault) Error() string {
	return fmt.Sprintf("[GET /storage/luns/{lun.uuid}/metrics/{timestamp}][%d] performance_lun_metric_get default  %+v", o._statusCode, o.Payload)
}
