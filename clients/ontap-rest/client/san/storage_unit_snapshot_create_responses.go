...
func (o *StorageUnitSnapshotCreateCreated) Error() string {
	return fmt.Sprintf("[POST /storage/storage-units/{storage_unit.uuid}/snapshots][%d] storageUnitSnapshotCreateCreated  %+v", 201, o.Payload)
}
...
func (o *StorageUnitSnapshotCreateAccepted) Error() string {
	return fmt.Sprintf("[POST /storage/storage-units/{storage_unit.uuid}/snapshots][%d] storageUnitSnapshotCreateAccepted  %+v", 202, o.Payload)
}
...
func (o *StorageUnitSnapshotCreateDefault) Error() string {
	return fmt.Sprintf("[POST /storage/storage-units/{storage_unit.uuid}/snapshots][%d] storage_unit_snapshot_create default  %+v", o._statusCode, o.Payload)
}
