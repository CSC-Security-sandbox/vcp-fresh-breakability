...
func (o *IscsiServiceCreateParams) WithReturnRecords(returnRecords *string) *IscsiServiceCreateParams {
	o.SetReturnRecords(returnRecords)
	return o
}

// SetReturnRecords adds the returnRecords to the iscsi service create params
func (o *IscsiServiceCreateParams) SetReturnRecords(returnRecords *string) {
