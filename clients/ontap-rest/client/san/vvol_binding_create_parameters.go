...
func (o *VvolBindingCreateParams) WithReturnRecords(returnRecords *string) *VvolBindingCreateParams {
	o.SetReturnRecords(returnRecords)
	return o
}

// SetReturnRecords adds the returnRecords to the vvol binding create params
func (o *VvolBindingCreateParams) SetReturnRecords(returnRecords *string) {
