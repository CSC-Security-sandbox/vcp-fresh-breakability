...
func (o *LunFormDataModifyAccepted) Error() string {
	return fmt.Sprintf("[PATCH //storage/luns/{uuid}][%d] lunFormDataModifyAccepted  %+v", 202, o.Payload)
}
...
func (o *LunFormDataModifyDefault) Error() string {
	return fmt.Sprintf("[PATCH //storage/luns/{uuid}][%d] lun_form_data_modify default  %+v", o._statusCode, o.Payload)
}
