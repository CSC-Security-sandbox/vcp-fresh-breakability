...
func (o *StorageUnitSnapshotModifyOK) Error() string {
	return fmt.Sprintf("[PATCH /storage/storage-units/{storage_unit.uuid}/snapshots/{uuid}][%d] storageUnitSnapshotModifyOK  %+v", 200, o.Payload)
}
...
func (o *StorageUnitSnapshotModifyAccepted) Error() string {
	return fmt.Sprintf("[PATCH /storage/storage-units/{storage_unit.uuid}/snapshots/{uuid}][%d] storageUnitSnapshotModifyAccepted  %+v", 202, o.Payload)
}
...
func (o *StorageUnitSnapshotModifyDefault) Error() string {
	return fmt.Sprintf("[PATCH /storage/storage-units/{storage_unit.uuid}/snapshots/{uuid}][%d] storage_unit_snapshot_modify default  %+v", o._statusCode, o.Payload)
}
