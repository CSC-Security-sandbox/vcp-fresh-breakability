...
func (o *StorageUnitCollectionGetOK) Error() string {
	return fmt.Sprintf("[GET /storage/storage-units][%d] storageUnitCollectionGetOK  %+v", 200, o.Payload)
}
...
func (o *StorageUnitCollectionGetDefault) Error() string {
	return fmt.Sprintf("[GET /storage/storage-units][%d] storage_unit_collection_get default  %+v", o._statusCode, o.Payload)
}
