...
func (o *InitiatorCollectionGetOK) Error() string {
	return fmt.Sprintf("[GET /protocols/san/initiators][%d] initiatorCollectionGetOK  %+v", 200, o.Payload)
}
...
func (o *InitiatorCollectionGetDefault) Error() string {
	return fmt.Sprintf("[GET /protocols/san/initiators][%d] initiator_collection_get default  %+v", o._statusCode, o.Payload)
}
