...
// WithAsync adds the async to the lun form data modify params
func (o *LunFormDataModifyParams) WithAsync(async *string) *LunFormDataModifyParams {
	o.SetAsync(async)
	return o
}

// SetAsync adds the async to the lun form data modify params
func (o *LunFormDataModifyParams) SetAsync(async *string) {
	o.Async = async
}
...
func (o *LunFormDataModifyParams) WithDataOffset(dataOffset *string) *LunFormDataModifyParams {
	o.SetDataOffset(dataOffset)
	return o
}

// SetDataOffset adds the dataOffset to the lun form data modify params
func (o *LunFormDataModifyParams) SetDataOffset(dataOffset *string) {
	o.DataOffset = dataOffset
}

// WithReturnTimeout adds the returnTimeout to the lun form data modify params
func (o *LunFormDataModifyParams) WithReturnTimeout(returnTimeout *string) *LunFormDataModifyParams {
	o.SetReturnTimeout(returnTimeout)
	return o
}

// SetReturnTimeout adds the returnTimeout to the lun form data modify params
func (o *LunFormDataModifyParams) SetReturnTimeout(returnTimeout *string) {
