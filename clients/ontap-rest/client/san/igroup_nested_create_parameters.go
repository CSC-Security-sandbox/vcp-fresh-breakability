...
func (o *IgroupNestedCreateParams) WithReturnRecords(returnRecords *string) *IgroupNestedCreateParams {
	o.SetReturnRecords(returnRecords)
	return o
}

// SetReturnRecords adds the returnRecords to the igroup nested create params
func (o *IgroupNestedCreateParams) SetReturnRecords(returnRecords *string) {
