...
func (o *StorageUnitSnapshotGetOK) Error() string {
	return fmt.Sprintf("[GET /storage/storage-units/{storage_unit.uuid}/snapshots/{uuid}][%d] storageUnitSnapshotGetOK  %+v", 200, o.Payload)
}
...
func (o *StorageUnitSnapshotGetDefault) Error() string {
	return fmt.Sprintf("[GET /storage/storage-units/{storage_unit.uuid}/snapshots/{uuid}][%d] storage_unit_snapshot_get default  %+v", o._statusCode, o.Payload)
}
