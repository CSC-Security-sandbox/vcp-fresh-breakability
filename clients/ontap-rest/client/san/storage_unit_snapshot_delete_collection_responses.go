...
func (o *StorageUnitSnapshotDeleteCollectionOK) Error() string {
	return fmt.Sprintf("[DELETE /storage/storage-units/{storage_unit.uuid}/snapshots][%d] storageUnitSnapshotDeleteCollectionOK  %+v", 200, o.Payload)
}
...
func (o *StorageUnitSnapshotDeleteCollectionAccepted) Error() string {
	return fmt.Sprintf("[DELETE /storage/storage-units/{storage_unit.uuid}/snapshots][%d] storageUnitSnapshotDeleteCollectionAccepted  %+v", 202, o.Payload)
}
...
func (o *StorageUnitSnapshotDeleteCollectionDefault) Error() string {
	return fmt.Sprintf("[DELETE /storage/storage-units/{storage_unit.uuid}/snapshots][%d] storage_unit_snapshot_delete_collection default  %+v", o._statusCode, o.Payload)
}
