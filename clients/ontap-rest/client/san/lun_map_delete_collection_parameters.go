...
func (o *LunMapDeleteCollectionParams) WithContinueOnFailure(continueOnFailure *string) *LunMapDeleteCollectionParams {
	o.SetContinueOnFailure(continueOnFailure)
	return o
}

// SetContinueOnFailure adds the continueOnFailure to the lun map delete collection params
func (o *LunMapDeleteCollectionParams) SetContinueOnFailure(continueOnFailure *string) {
...
func (o *LunMapDeleteCollectionParams) WithIgroupReplicated(igroupReplicated *string) *LunMapDeleteCollectionParams {
...
func (o *LunMapDeleteCollectionParams) SetIgroupReplicated(igroupReplicated *string) {
...
func (o *LunMapDeleteCollectionParams) WithLogicalUnitNumber(logicalUnitNumber *string) *LunMapDeleteCollectionParams {
...
func (o *LunMapDeleteCollectionParams) SetLogicalUnitNumber(logicalUnitNumber *string) {
...
func (o *LunMapDeleteCollectionParams) WithLunSmbcReplicated(lunSmbcReplicated *string) *LunMapDeleteCollectionParams {
...
func (o *LunMapDeleteCollectionParams) SetLunSmbcReplicated(lunSmbcReplicated *string) {
...
func (o *LunMapDeleteCollectionParams) WithReturnRecords(returnRecords *string) *LunMapDeleteCollectionParams {
	o.SetReturnRecords(returnRecords)
	return o
}

// SetReturnRecords adds the returnRecords to the lun map delete collection params
func (o *LunMapDeleteCollectionParams) SetReturnRecords(returnRecords *string) {
	o.ReturnRecords = returnRecords
}

// WithReturnTimeout adds the returnTimeout to the lun map delete collection params
func (o *LunMapDeleteCollectionParams) WithReturnTimeout(returnTimeout *string) *LunMapDeleteCollectionParams {
	o.SetReturnTimeout(returnTimeout)
	return o
}

// SetReturnTimeout adds the returnTimeout to the lun map delete collection params
func (o *LunMapDeleteCollectionParams) SetReturnTimeout(returnTimeout *string) {
	o.ReturnTimeout = returnTimeout
}

// WithSerialRecords adds the serialRecords to the lun map delete collection params
func (o *LunMapDeleteCollectionParams) WithSerialRecords(serialRecords *string) *LunMapDeleteCollectionParams {
	o.SetSerialRecords(serialRecords)
	return o
}

// SetSerialRecords adds the serialRecords to the lun map delete collection params
func (o *LunMapDeleteCollectionParams) SetSerialRecords(serialRecords *string) {
...
func (o *LunMapDeleteCollectionParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
	...
	if o.IgroupReplicated != nil {
		...
		var qrIgroupReplicated string

		if o.IgroupReplicated != nil {
			qrIgroupReplicated = *o.IgroupReplicated
		}
		qIgroupReplicated := qrIgroupReplicated
	...
	if o.LogicalUnitNumber != nil {
		...
		var qrLogicalUnitNumber string

		if o.LogicalUnitNumber != nil {
			qrLogicalUnitNumber = *o.LogicalUnitNumber
		}
		qLogicalUnitNumber := qrLogicalUnitNumber
	...
	if o.LunSmbcReplicated != nil {
		...
		var qrLunSmbcReplicated string

		if o.LunSmbcReplicated != nil {
			qrLunSmbcReplicated = *o.LunSmbcReplicated
		}
		qLunSmbcReplicated := qrLunSmbcReplicated
