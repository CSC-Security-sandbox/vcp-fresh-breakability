...
func (o *FcpServiceCreateParams) WithReturnRecords(returnRecords *string) *FcpServiceCreateParams {
	o.SetReturnRecords(returnRecords)
	return o
}

// SetReturnRecords adds the returnRecords to the fcp service create params
func (o *FcpServiceCreateParams) SetReturnRecords(returnRecords *string) {
