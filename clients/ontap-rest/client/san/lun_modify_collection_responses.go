...
func (o *LunModifyCollectionAccepted) Error() string {
	return fmt.Sprintf("[PATCH /storage/luns][%d] lunModifyCollectionAccepted  %+v", 202, o.Payload)
}
...
func (o *LunModifyCollectionDefault) Error() string {
	return fmt.Sprintf("[PATCH /storage/luns][%d] lun_modify_collection default  %+v", o._statusCode, o.Payload)
}
	...
	if o.Copy != nil {
		if err := o.Copy.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("info" + "." + "copy")
			}
			return err
		}
	}
		...
		if o.LunInlineAttributes[i] != nil {
			if err := o.LunInlineAttributes[i].Validate(formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					...
					return ce.ValidateName("info" + "." + "attributes" + "." + strconv.Itoa(i))
				}
				return err
			}
		}
	...
	if o.Vvol != nil {
		if err := o.Vvol.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("info" + "." + "vvol")
			}
			return err
		}
	}
	...
	if o.Namespace != nil {
		if err := o.Namespace.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("info" + "." + "convert" + "." + "namespace")
			}
			return err
		}
	}
		...
		if o.Destinations[i] != nil {
			if err := o.Destinations[i].Validate(formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					...
					return ce.ValidateName("info" + "." + "copy" + "." + "destinations" + "." + strconv.Itoa(i))
				}
				return err
			}
		}
	...
	if o.Source != nil {
		if err := o.Source.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("info" + "." + "copy" + "." + "source")
			}
			return err
		}
	}
	...
	if o.Links != nil {
		if err := o.Links.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("info" + "." + "copy" + "." + "source" + "." + "_links")
			}
			return err
		}
	}
	...
	if o.Peer != nil {
		if err := o.Peer.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("info" + "." + "copy" + "." + "source" + "." + "peer")
			}
			return err
		}
	}
	...
	if o.Progress != nil {
		if err := o.Progress.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("info" + "." + "copy" + "." + "source" + "." + "progress")
			}
			return err
		}
	}
	...
	if o.Self != nil {
		if err := o.Self.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("info" + "." + "copy" + "." + "source" + "." + "_links" + "." + "self")
			}
			return err
		}
	}
	...
	if o.Links != nil {
		if err := o.Links.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("info" + "." + "copy" + "." + "source" + "." + "peer" + "." + "_links")
			}
			return err
		}
	}
	...
	if o.Self != nil {
		if err := o.Self.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("info" + "." + "copy" + "." + "source" + "." + "peer" + "." + "_links" + "." + "self")
			}
			return err
		}
	}
	...
	if o.Failure != nil {
		if err := o.Failure.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("info" + "." + "copy" + "." + "source" + "." + "progress" + "." + "failure")
			}
			return err
		}
	}
	...
	if o.Paths != nil {
		if err := o.Paths.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("info" + "." + "movement" + "." + "paths")
			}
			return err
		}
	}
	...
	if o.Progress != nil {
		if err := o.Progress.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("info" + "." + "movement" + "." + "progress")
			}
			return err
		}
	}
	...
	if o.Failure != nil {
		if err := o.Failure.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("info" + "." + "movement" + "." + "progress" + "." + "failure")
			}
			return err
		}
	}
		...
		if o.Bindings[i] != nil {
			if err := o.Bindings[i].Validate(formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					...
					return ce.ValidateName("info" + "." + "vvol" + "." + "bindings" + "." + strconv.Itoa(i))
				}
				return err
			}
		}
