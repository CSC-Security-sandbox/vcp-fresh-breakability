...
func (o *LunMapReportingNodeDeleteCollectionDefault) Error() string {
	return fmt.Sprintf("[DELETE /protocols/san/lun-maps/{lun.uuid}/{igroup.uuid}/reporting-nodes][%d] lun_map_reporting_node_delete_collection default  %+v", o._statusCode, o.Payload)
}
