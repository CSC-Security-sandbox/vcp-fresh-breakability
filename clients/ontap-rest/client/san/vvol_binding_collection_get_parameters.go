...
func (o *VvolBindingCollectionGetParams) WithCount(count *string) *VvolBindingCollectionGetParams {
	o.SetCount(count)
	return o
}

// SetCount adds the count to the vvol binding collection get params
func (o *VvolBindingCollectionGetParams) SetCount(count *string) {
	o.Count = count
}
...
func (o *VvolBindingCollectionGetParams) WithID(id *string) *VvolBindingCollectionGetParams {
	o.SetID(id)
	return o
}

// SetID adds the id to the vvol binding collection get params
func (o *VvolBindingCollectionGetParams) SetID(id *string) {
	o.ID = id
}

// WithIsOptimal adds the isOptimal to the vvol binding collection get params
func (o *VvolBindingCollectionGetParams) WithIsOptimal(isOptimal *string) *VvolBindingCollectionGetParams {
	o.SetIsOptimal(isOptimal)
	return o
}

// SetIsOptimal adds the isOptimal to the vvol binding collection get params
func (o *VvolBindingCollectionGetParams) SetIsOptimal(isOptimal *string) {
	o.IsOptimal = isOptimal
}

// WithMaxRecords adds the maxRecords to the vvol binding collection get params
func (o *VvolBindingCollectionGetParams) WithMaxRecords(maxRecords *string) *VvolBindingCollectionGetParams {
	o.SetMaxRecords(maxRecords)
	return o
}

// SetMaxRecords adds the maxRecords to the vvol binding collection get params
func (o *VvolBindingCollectionGetParams) SetMaxRecords(maxRecords *string) {
...
func (o *VvolBindingCollectionGetParams) WithReturnRecords(returnRecords *string) *VvolBindingCollectionGetParams {
	o.SetReturnRecords(returnRecords)
	return o
}

// SetReturnRecords adds the returnRecords to the vvol binding collection get params
func (o *VvolBindingCollectionGetParams) SetReturnRecords(returnRecords *string) {
	o.ReturnRecords = returnRecords
}

// WithReturnTimeout adds the returnTimeout to the vvol binding collection get params
func (o *VvolBindingCollectionGetParams) WithReturnTimeout(returnTimeout *string) *VvolBindingCollectionGetParams {
	o.SetReturnTimeout(returnTimeout)
	return o
}

// SetReturnTimeout adds the returnTimeout to the vvol binding collection get params
func (o *VvolBindingCollectionGetParams) SetReturnTimeout(returnTimeout *string) {
