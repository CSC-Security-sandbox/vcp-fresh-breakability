...
func (o *StorageUnitGetOK) Error() string {
	return fmt.Sprintf("[GET /storage/storage-units/{uuid}][%d] storageUnitGetOK  %+v", 200, o.Payload)
}
...
func (o *StorageUnitGetDefault) Error() string {
	return fmt.Sprintf("[GET /storage/storage-units/{uuid}][%d] storage_unit_get default  %+v", o._statusCode, o.Payload)
}
