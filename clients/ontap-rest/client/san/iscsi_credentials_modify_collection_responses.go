...
func (o *IscsiCredentialsModifyCollectionDefault) Error() string {
	return fmt.Sprintf("[PATCH /protocols/san/iscsi/credentials][%d] iscsi_credentials_modify_collection default  %+v", o._statusCode, o.Payload)
}
	...
	if o.Chap != nil {
		if err := o.Chap.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("info" + "." + "chap")
			}
			return err
		}
	}
	...
	if o.InitiatorAddress != nil {
		if err := o.InitiatorAddress.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("info" + "." + "initiator_address")
			}
			return err
		}
	}
	...
	if o.Inbound != nil {
		if err := o.Inbound.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("info" + "." + "chap" + "." + "inbound")
			}
			return err
		}
	}
	...
	if o.Outbound != nil {
		if err := o.Outbound.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("info" + "." + "chap" + "." + "outbound")
			}
			return err
		}
	}
		...
		if o.Masks[i] != nil {
			if err := o.Masks[i].Validate(formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					...
					return ce.ValidateName("info" + "." + "initiator_address" + "." + "masks" + "." + strconv.Itoa(i))
				}
				return err
			}
		}
		...
		if o.Ranges[i] != nil {
			if err := o.Ranges[i].Validate(formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					...
					return ce.ValidateName("info" + "." + "initiator_address" + "." + "ranges" + "." + strconv.Itoa(i))
				}
				return err
			}
		}
