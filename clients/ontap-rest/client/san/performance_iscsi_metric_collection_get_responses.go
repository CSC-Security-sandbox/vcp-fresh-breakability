...
func (o *PerformanceIscsiMetricCollectionGetOK) Error() string {
	return fmt.Sprintf("[GET /protocols/san/iscsi/services/{svm.uuid}/metrics][%d] performanceIscsiMetricCollectionGetOK  %+v", 200, o.Payload)
}
...
func (o *PerformanceIscsiMetricCollectionGetDefault) Error() string {
	return fmt.Sprintf("[GET /protocols/san/iscsi/services/{svm.uuid}/metrics][%d] performance_iscsi_metric_collection_get default  %+v", o._statusCode, o.Payload)
}
