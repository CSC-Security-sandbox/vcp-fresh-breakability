...
func (o *StorageUnitModifyOK) Error() string {
	return fmt.Sprintf("[PATCH /storage/storage-units/{uuid}][%d] storageUnitModifyOK  %+v", 200, o.Payload)
}
...
func (o *StorageUnitModifyAccepted) Error() string {
	return fmt.Sprintf("[PATCH /storage/storage-units/{uuid}][%d] storageUnitModifyAccepted  %+v", 202, o.Payload)
}
...
func (o *StorageUnitModifyDefault) Error() string {
	return fmt.Sprintf("[PATCH /storage/storage-units/{uuid}][%d] storage_unit_modify default  %+v", o._statusCode, o.Payload)
}
