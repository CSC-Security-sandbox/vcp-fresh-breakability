...
func (o *LunMapReportingNodeCreateParams) WithReturnRecords(returnRecords *string) *LunMapReportingNodeCreateParams {
	o.SetReturnRecords(returnRecords)
	return o
}

// SetReturnRecords adds the returnRecords to the lun map reporting node create params
func (o *LunMapReportingNodeCreateParams) SetReturnRecords(returnRecords *string) {
