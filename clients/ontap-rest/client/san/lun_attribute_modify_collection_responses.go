...
func (o *LunAttributeModifyCollectionDefault) Error() string {
	return fmt.Sprintf("[PATCH /storage/luns/{lun.uuid}/attributes][%d] lun_attribute_modify_collection default  %+v", o._statusCode, o.Payload)
}
	...
	if o.Lun != nil {
		if err := o.Lun.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("info" + "." + "lun")
			}
			return err
		}
	}
	...
	if o.Links != nil {
		if err := o.Links.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("info" + "." + "lun" + "." + "_links")
			}
			return err
		}
	}
	...
	if o.Self != nil {
		if err := o.Self.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("info" + "." + "lun" + "." + "_links" + "." + "self")
			}
			return err
		}
	}
