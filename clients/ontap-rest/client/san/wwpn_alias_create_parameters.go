...
func (o *WwpnAliasCreateParams) WithReturnRecords(returnRecords *string) *WwpnAliasCreateParams {
	o.SetReturnRecords(returnRecords)
	return o
}

// SetReturnRecords adds the returnRecords to the wwpn alias create params
func (o *WwpnAliasCreateParams) SetReturnRecords(returnRecords *string) {
