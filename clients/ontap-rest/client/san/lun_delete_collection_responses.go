...
func (o *LunDeleteCollectionAccepted) Error() string {
	return fmt.Sprintf("[DELETE /storage/luns][%d] lunDeleteCollectionAccepted  %+v", 202, o.Payload)
}
...
func (o *LunDeleteCollectionDefault) Error() string {
	return fmt.Sprintf("[DELETE /storage/luns][%d] lun_delete_collection default  %+v", o._statusCode, o.Payload)
}
