...
func (o *PerformanceFcpMetricCollectionGetOK) Error() string {
	return fmt.Sprintf("[GET /protocols/san/fcp/services/{svm.uuid}/metrics][%d] performanceFcpMetricCollectionGetOK  %+v", 200, o.Payload)
}
...
func (o *PerformanceFcpMetricCollectionGetDefault) Error() string {
	return fmt.Sprintf("[GET /protocols/san/fcp/services/{svm.uuid}/metrics][%d] performance_fcp_metric_collection_get default  %+v", o._statusCode, o.Payload)
}
