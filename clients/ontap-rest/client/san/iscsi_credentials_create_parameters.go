...
func (o *IscsiCredentialsCreateParams) WithReturnRecords(returnRecords *string) *IscsiCredentialsCreateParams {
	o.SetReturnRecords(returnRecords)
	return o
}

// SetReturnRecords adds the returnRecords to the iscsi credentials create params
func (o *IscsiCredentialsCreateParams) SetReturnRecords(returnRecords *string) {
