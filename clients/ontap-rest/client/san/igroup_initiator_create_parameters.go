...
func (o *IgroupInitiatorCreateParams) WithReturnRecords(returnRecords *string) *IgroupInitiatorCreateParams {
	o.SetReturnRecords(returnRecords)
	return o
}

// SetReturnRecords adds the returnRecords to the igroup initiator create params
func (o *IgroupInitiatorCreateParams) SetReturnRecords(returnRecords *string) {
