...
func (o *PerformanceLunMetricCollectionGetOK) Error() string {
	return fmt.Sprintf("[GET /storage/luns/{lun.uuid}/metrics][%d] performanceLunMetricCollectionGetOK  %+v", 200, o.Payload)
}
...
func (o *PerformanceLunMetricCollectionGetDefault) Error() string {
	return fmt.Sprintf("[GET /storage/luns/{lun.uuid}/metrics][%d] performance_lun_metric_collection_get default  %+v", o._statusCode, o.Payload)
}
