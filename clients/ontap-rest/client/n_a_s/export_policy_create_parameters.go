...
func (o *ExportPolicyCreateParams) WithReturnRecords(returnRecords *string) *ExportPolicyCreateParams {
	o.SetReturnRecords(returnRecords)
	return o
}

// SetReturnRecords adds the returnRecords to the export policy create params
func (o *ExportPolicyCreateParams) SetReturnRecords(returnRecords *string) {
