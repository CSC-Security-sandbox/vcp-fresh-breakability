...
func (o *UserGroupPrivilegesCreateParams) WithReturnRecords(returnRecords *string) *UserGroupPrivilegesCreateParams {
	o.SetReturnRecords(returnRecords)
	return o
}

// SetReturnRecords adds the returnRecords to the user group privileges create params
func (o *UserGroupPrivilegesCreateParams) SetReturnRecords(returnRecords *string) {
