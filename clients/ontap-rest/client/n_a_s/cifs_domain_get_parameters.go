...
func (o *CifsDomainGetParams) SetDefaults() {
	var (
		rediscoverTrustsDefault = string("\"False\"")

		resetDiscoveredServersDefault = string("\"False\"")
	)
...
func (o *CifsDomainGetParams) WithRediscoverTrusts(rediscoverTrusts *string) *CifsDomainGetParams {
	o.SetRediscoverTrusts(rediscoverTrusts)
	return o
}

// SetRediscoverTrusts adds the rediscoverTrusts to the cifs domain get params
func (o *CifsDomainGetParams) SetRediscoverTrusts(rediscoverTrusts *string) {
...
func (o *CifsDomainGetParams) WithResetDiscoveredServers(resetDiscoveredServers *string) *CifsDomainGetParams {
...
func (o *CifsDomainGetParams) SetResetDiscoveredServers(resetDiscoveredServers *string) {
...
func (o *CifsDomainGetParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
	...
	if o.RediscoverTrusts != nil {
		...
		var qrRediscoverTrusts string

		if o.RediscoverTrusts != nil {
			qrRediscoverTrusts = *o.RediscoverTrusts
		}
		qRediscoverTrusts := qrRediscoverTrusts
	...
	if o.ResetDiscoveredServers != nil {
		...
		var qrResetDiscoveredServers string

		if o.ResetDiscoveredServers != nil {
			qrResetDiscoveredServers = *o.ResetDiscoveredServers
		}
		qResetDiscoveredServers := qrResetDiscoveredServers
