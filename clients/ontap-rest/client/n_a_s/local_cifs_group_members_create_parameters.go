...
func (o *LocalCifsGroupMembersCreateParams) WithReturnRecords(returnRecords *string) *LocalCifsGroupMembersCreateParams {
	o.SetReturnRecords(returnRecords)
	return o
}

// SetReturnRecords adds the returnRecords to the local cifs group members create params
func (o *LocalCifsGroupMembersCreateParams) SetReturnRecords(returnRecords *string) {
