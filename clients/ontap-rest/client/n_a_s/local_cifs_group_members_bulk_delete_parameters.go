...
func (o *LocalCifsGroupMembersBulkDeleteParams) WithReturnRecords(returnRecords *string) *LocalCifsGroupMembersBulkDeleteParams {
	o.SetReturnRecords(returnRecords)
	return o
}

// SetReturnRecords adds the returnRecords to the local cifs group members bulk delete params
func (o *LocalCifsGroupMembersBulkDeleteParams) SetReturnRecords(returnRecords *string) {
