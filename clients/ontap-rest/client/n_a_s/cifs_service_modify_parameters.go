...
func (o *CifsServiceModifyParams) WithForce(force *string) *CifsServiceModifyParams {
	o.SetForce(force)
	return o
}

// SetForce adds the force to the cifs service modify params
func (o *CifsServiceModifyParams) SetForce(force *string) {
	o.Force = force
}
...
func (o *CifsServiceModifyParams) WithReturnTimeout(returnTimeout *string) *CifsServiceModifyParams {
	o.SetReturnTimeout(returnTimeout)
	return o
}

// SetReturnTimeout adds the returnTimeout to the cifs service modify params
func (o *CifsServiceModifyParams) SetReturnTimeout(returnTimeout *string) {
