...
func (o *PerformanceNamespaceMetricGetOK) Error() string {
	return fmt.Sprintf("[GET /storage/namespaces/{nvme_namespace.uuid}/metrics/{timestamp}][%d] performanceNamespaceMetricGetOK  %+v", 200, o.Payload)
}
...
func (o *PerformanceNamespaceMetricGetDefault) Error() string {
	return fmt.Sprintf("[GET /storage/namespaces/{nvme_namespace.uuid}/metrics/{timestamp}][%d] performance_namespace_metric_get default  %+v", o._statusCode, o.Payload)
}
