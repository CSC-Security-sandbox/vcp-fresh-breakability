...
func (o *NVMENamespaceModifyParams) WithReturnTimeout(returnTimeout *string) *NVMENamespaceModifyParams {
	o.SetReturnTimeout(returnTimeout)
	return o
}

// SetReturnTimeout adds the returnTimeout to the nvme namespace modify params
func (o *NVMENamespaceModifyParams) SetReturnTimeout(returnTimeout *string) {
