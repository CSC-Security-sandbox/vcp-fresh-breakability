...
func (o *NVMESubsystemMapCreateParams) WithReturnRecords(returnRecords *string) *NVMESubsystemMapCreateParams {
	o.SetReturnRecords(returnRecords)
	return o
}

// SetReturnRecords adds the returnRecords to the nvme subsystem map create params
func (o *NVMESubsystemMapCreateParams) SetReturnRecords(returnRecords *string) {
