...
func (o *PerformanceNamespaceMetricCollectionGetOK) Error() string {
	return fmt.Sprintf("[GET /storage/namespaces/{nvme_namespace.uuid}/metrics][%d] performanceNamespaceMetricCollectionGetOK  %+v", 200, o.Payload)
}
...
func (o *PerformanceNamespaceMetricCollectionGetDefault) Error() string {
	return fmt.Sprintf("[GET /storage/namespaces/{nvme_namespace.uuid}/metrics][%d] performance_namespace_metric_collection_get default  %+v", o._statusCode, o.Payload)
}
