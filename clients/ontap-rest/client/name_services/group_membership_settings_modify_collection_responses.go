...
func (o *GroupMembershipSettingsModifyCollectionDefault) Error() string {
	return fmt.Sprintf("[PATCH /name-services/cache/group-membership/settings][%d] group_membership_settings_modify_collection default  %+v", o._statusCode, o.Payload)
}
