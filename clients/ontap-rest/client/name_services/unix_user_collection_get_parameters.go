...
func (o *UnixUserCollectionGetParams) WithID(id *string) *UnixUserCollectionGetParams {
	o.SetID(id)
	return o
}

// SetID adds the id to the unix user collection get params
func (o *UnixUserCollectionGetParams) SetID(id *string) {
	o.ID = id
}

// WithMaxRecords adds the maxRecords to the unix user collection get params
func (o *UnixUserCollectionGetParams) WithMaxRecords(maxRecords *string) *UnixUserCollectionGetParams {
	o.SetMaxRecords(maxRecords)
	return o
}

// SetMaxRecords adds the maxRecords to the unix user collection get params
func (o *UnixUserCollectionGetParams) SetMaxRecords(maxRecords *string) {
...
func (o *UnixUserCollectionGetParams) WithPrimaryGid(primaryGid *string) *UnixUserCollectionGetParams {
	o.SetPrimaryGid(primaryGid)
	return o
}

// SetPrimaryGid adds the primaryGid to the unix user collection get params
func (o *UnixUserCollectionGetParams) SetPrimaryGid(primaryGid *string) {
	o.PrimaryGid = primaryGid
}

// WithReturnRecords adds the returnRecords to the unix user collection get params
func (o *UnixUserCollectionGetParams) WithReturnRecords(returnRecords *string) *UnixUserCollectionGetParams {
	o.SetReturnRecords(returnRecords)
	return o
}

// SetReturnRecords adds the returnRecords to the unix user collection get params
func (o *UnixUserCollectionGetParams) SetReturnRecords(returnRecords *string) {
	o.ReturnRecords = returnRecords
}

// WithReturnTimeout adds the returnTimeout to the unix user collection get params
func (o *UnixUserCollectionGetParams) WithReturnTimeout(returnTimeout *string) *UnixUserCollectionGetParams {
	o.SetReturnTimeout(returnTimeout)
	return o
}

// SetReturnTimeout adds the returnTimeout to the unix user collection get params
func (o *UnixUserCollectionGetParams) SetReturnTimeout(returnTimeout *string) {
