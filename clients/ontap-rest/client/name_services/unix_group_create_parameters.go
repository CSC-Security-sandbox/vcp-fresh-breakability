...
func (o *UnixGroupCreateParams) WithReturnRecords(returnRecords *string) *UnixGroupCreateParams {
	o.SetReturnRecords(returnRecords)
	return o
}

// SetReturnRecords adds the returnRecords to the unix group create params
func (o *UnixGroupCreateParams) SetReturnRecords(returnRecords *string) {
