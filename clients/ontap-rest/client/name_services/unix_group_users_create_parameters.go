...
func (o *UnixGroupUsersCreateParams) WithReturnRecords(returnRecords *string) *UnixGroupUsersCreateParams {
	o.SetReturnRecords(returnRecords)
	return o
}

// SetReturnRecords adds the returnRecords to the unix group users create params
func (o *UnixGroupUsersCreateParams) SetReturnRecords(returnRecords *string) {
