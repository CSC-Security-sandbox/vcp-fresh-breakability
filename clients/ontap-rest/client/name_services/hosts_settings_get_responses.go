...
func (o *HostsSettingsGetOK) Error() string {
	return fmt.Sprintf("[GET /name-services/cache/host/settings/{uuid}][%d] hostsSettingsGetOK  %+v", 200, o.Payload)
}
...
func (o *HostsSettingsGetDefault) Error() string {
	return fmt.Sprintf("[GET /name-services/cache/host/settings/{uuid}][%d] hosts_settings_get default  %+v", o._statusCode, o.Payload)
}
