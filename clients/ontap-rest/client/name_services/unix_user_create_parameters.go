...
func (o *UnixUserCreateParams) WithReturnRecords(returnRecords *string) *UnixUserCreateParams {
	o.SetReturnRecords(returnRecords)
	return o
}

// SetReturnRecords adds the returnRecords to the unix user create params
func (o *UnixUserCreateParams) SetReturnRecords(returnRecords *string) {
