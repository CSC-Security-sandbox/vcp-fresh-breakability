...
func (o *LdapSchemaModifyCollectionDefault) Error() string {
	return fmt.Sprintf("[PATCH /name-services/ldap-schemas][%d] ldap_schema_modify_collection default  %+v", o._statusCode, o.Payload)
}
	...
	if o.Rfc2307 != nil {
		if err := o.Rfc2307.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("info" + "." + "rfc2307")
			}
			return err
		}
	}
	...
	if o.Rfc2307bis != nil {
		if err := o.Rfc2307bis.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("info" + "." + "rfc2307bis")
			}
			return err
		}
	}
	...
	if o.Self != nil {
		if err := o.Self.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("info" + "." + "template" + "." + "_links" + "." + "self")
			}
			return err
		}
	}
