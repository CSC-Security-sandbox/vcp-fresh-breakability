...
func (o *HostRecordGetParams) WithUseCache(useCache *string) *HostRecordGetParams {
	o.SetUseCache(useCache)
	return o
}

// SetUseCache adds the useCache to the host record get params
func (o *HostRecordGetParams) SetUseCache(useCache *string) {
	o.UseCache = useCache
}
