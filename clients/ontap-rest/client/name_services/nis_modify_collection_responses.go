...
func (o *NisModifyCollectionDefault) Error() string {
	return fmt.Sprintf("[PATCH /name-services/nis][%d] nis_modify_collection default  %+v", o._statusCode, o.Payload)
}
		...
		if o.NisServiceInlineBindingDetails[i] != nil {
			if err := o.NisServiceInlineBindingDetails[i].Validate(formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					...
					return ce.ValidateName("info" + "." + "binding_details" + "." + strconv.Itoa(i))
				}
				return err
			}
		}
...
func (o *NisModifyCollectionBody) contextValidateNisServiceInlineBindingDetails(ctx context.Context, formats strfmt.Registry) error {
	...
	if err := validate.ReadOnly(ctx, "info"+"."+"binding_details", "body", []*NisServiceInlineBindingDetailsInlineArrayItem(o.NisServiceInlineBindingDetails)); err != nil {
		return err
	}
