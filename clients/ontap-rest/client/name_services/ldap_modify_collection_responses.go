...
func (o *LdapModifyCollectionDefault) Error() string {
	return fmt.Sprintf("[PATCH /name-services/ldap][%d] ldap_modify_collection default  %+v", o._statusCode, o.Payload)
}
	...
	if o.IPV4 != nil {
		if err := o.IPV4.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("info" + "." + "status" + "." + "ipv4")
			}
			return err
		}
	}
	...
	if o.IPV6 != nil {
		if err := o.IPV6.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("info" + "." + "status" + "." + "ipv6")
			}
			return err
		}
	}
