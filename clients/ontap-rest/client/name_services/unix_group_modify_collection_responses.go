...
func (o *UnixGroupModifyCollectionDefault) Error() string {
	return fmt.Sprintf("[PATCH /name-services/unix-groups][%d] unix_group_modify_collection default  %+v", o._statusCode, o.Payload)
}
...
func (o *UnixGroupModifyCollectionBody) contextValidateUnixGroupInlineUsers(ctx context.Context, formats strfmt.Registry) error {
	...
	if err := validate.ReadOnly(ctx, "info"+"."+"users", "body", []*UnixGroupInlineUsersInlineArrayItem(o.UnixGroupInlineUsers)); err != nil {
		return err
	}
