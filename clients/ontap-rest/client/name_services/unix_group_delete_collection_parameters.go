...
func (o *UnixGroupDeleteCollectionParams) WithContinueOnFailure(continueOnFailure *string) *UnixGroupDeleteCollectionParams {
	o.SetContinueOnFailure(continueOnFailure)
	return o
}

// SetContinueOnFailure adds the continueOnFailure to the unix group delete collection params
func (o *UnixGroupDeleteCollectionParams) SetContinueOnFailure(continueOnFailure *string) {
	o.ContinueOnFailure = continueOnFailure
}

// WithID adds the id to the unix group delete collection params
func (o *UnixGroupDeleteCollectionParams) WithID(id *string) *UnixGroupDeleteCollectionParams {
	o.SetID(id)
	return o
}

// SetID adds the id to the unix group delete collection params
func (o *UnixGroupDeleteCollectionParams) SetID(id *string) {
	o.ID = id
}
...
func (o *UnixGroupDeleteCollectionParams) WithReturnRecords(returnRecords *string) *UnixGroupDeleteCollectionParams {
	o.SetReturnRecords(returnRecords)
	return o
}

// SetReturnRecords adds the returnRecords to the unix group delete collection params
func (o *UnixGroupDeleteCollectionParams) SetReturnRecords(returnRecords *string) {
	o.ReturnRecords = returnRecords
}

// WithReturnTimeout adds the returnTimeout to the unix group delete collection params
func (o *UnixGroupDeleteCollectionParams) WithReturnTimeout(returnTimeout *string) *UnixGroupDeleteCollectionParams {
	o.SetReturnTimeout(returnTimeout)
	return o
}

// SetReturnTimeout adds the returnTimeout to the unix group delete collection params
func (o *UnixGroupDeleteCollectionParams) SetReturnTimeout(returnTimeout *string) {
	o.ReturnTimeout = returnTimeout
}

// WithSerialRecords adds the serialRecords to the unix group delete collection params
func (o *UnixGroupDeleteCollectionParams) WithSerialRecords(serialRecords *string) *UnixGroupDeleteCollectionParams {
	o.SetSerialRecords(serialRecords)
	return o
}

// SetSerialRecords adds the serialRecords to the unix group delete collection params
func (o *UnixGroupDeleteCollectionParams) SetSerialRecords(serialRecords *string) {
