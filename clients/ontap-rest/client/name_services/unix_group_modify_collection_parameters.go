...
func (o *UnixGroupModifyCollectionParams) WithContinueOnFailure(continueOnFailure *string) *UnixGroupModifyCollectionParams {
	o.SetContinueOnFailure(continueOnFailure)
	return o
}

// SetContinueOnFailure adds the continueOnFailure to the unix group modify collection params
func (o *UnixGroupModifyCollectionParams) SetContinueOnFailure(continueOnFailure *string) {
	o.ContinueOnFailure = continueOnFailure
}

// WithID adds the id to the unix group modify collection params
func (o *UnixGroupModifyCollectionParams) WithID(id *string) *UnixGroupModifyCollectionParams {
	o.SetID(id)
	return o
}

// SetID adds the id to the unix group modify collection params
func (o *UnixGroupModifyCollectionParams) SetID(id *string) {
	o.ID = id
}
...
func (o *UnixGroupModifyCollectionParams) WithReturnRecords(returnRecords *string) *UnixGroupModifyCollectionParams {
	o.SetReturnRecords(returnRecords)
	return o
}

// SetReturnRecords adds the returnRecords to the unix group modify collection params
func (o *UnixGroupModifyCollectionParams) SetReturnRecords(returnRecords *string) {
	o.ReturnRecords = returnRecords
}

// WithReturnTimeout adds the returnTimeout to the unix group modify collection params
func (o *UnixGroupModifyCollectionParams) WithReturnTimeout(returnTimeout *string) *UnixGroupModifyCollectionParams {
	o.SetReturnTimeout(returnTimeout)
	return o
}

// SetReturnTimeout adds the returnTimeout to the unix group modify collection params
func (o *UnixGroupModifyCollectionParams) SetReturnTimeout(returnTimeout *string) {
	o.ReturnTimeout = returnTimeout
}

// WithSerialRecords adds the serialRecords to the unix group modify collection params
func (o *UnixGroupModifyCollectionParams) WithSerialRecords(serialRecords *string) *UnixGroupModifyCollectionParams {
	o.SetSerialRecords(serialRecords)
	return o
}

// SetSerialRecords adds the serialRecords to the unix group modify collection params
func (o *UnixGroupModifyCollectionParams) SetSerialRecords(serialRecords *string) {
