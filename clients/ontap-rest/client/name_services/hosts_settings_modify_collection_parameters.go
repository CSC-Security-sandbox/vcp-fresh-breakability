...
func (o *HostsSettingsModifyCollectionParams) WithContinueOnFailure(continueOnFailure *string) *HostsSettingsModifyCollectionParams {
	o.SetContinueOnFailure(continueOnFailure)
	return o
}

// SetContinueOnFailure adds the continueOnFailure to the hosts settings modify collection params
func (o *HostsSettingsModifyCollectionParams) SetContinueOnFailure(continueOnFailure *string) {
	o.ContinueOnFailure = continueOnFailure
}

// WithDNSTTLEnabled adds the dNSTTLEnabled to the hosts settings modify collection params
func (o *HostsSettingsModifyCollectionParams) WithDNSTTLEnabled(dNSTTLEnabled *string) *HostsSettingsModifyCollectionParams {
	o.SetDNSTTLEnabled(dNSTTLEnabled)
	return o
}

// SetDNSTTLEnabled adds the dnsTtlEnabled to the hosts settings modify collection params
func (o *HostsSettingsModifyCollectionParams) SetDNSTTLEnabled(dNSTTLEnabled *string) {
	o.DNSTTLEnabled = dNSTTLEnabled
}

// WithEnabled adds the enabled to the hosts settings modify collection params
func (o *HostsSettingsModifyCollectionParams) WithEnabled(enabled *string) *HostsSettingsModifyCollectionParams {
	o.SetEnabled(enabled)
	return o
}

// SetEnabled adds the enabled to the hosts settings modify collection params
func (o *HostsSettingsModifyCollectionParams) SetEnabled(enabled *string) {
	o.Enabled = enabled
}
...
func (o *HostsSettingsModifyCollectionParams) WithNegativeCacheEnabled(negativeCacheEnabled *string) *HostsSettingsModifyCollectionParams {
...
func (o *HostsSettingsModifyCollectionParams) SetNegativeCacheEnabled(negativeCacheEnabled *string) {
...
func (o *HostsSettingsModifyCollectionParams) WithReturnRecords(returnRecords *string) *HostsSettingsModifyCollectionParams {
	o.SetReturnRecords(returnRecords)
	return o
}

// SetReturnRecords adds the returnRecords to the hosts settings modify collection params
func (o *HostsSettingsModifyCollectionParams) SetReturnRecords(returnRecords *string) {
	o.ReturnRecords = returnRecords
}

// WithReturnTimeout adds the returnTimeout to the hosts settings modify collection params
func (o *HostsSettingsModifyCollectionParams) WithReturnTimeout(returnTimeout *string) *HostsSettingsModifyCollectionParams {
	o.SetReturnTimeout(returnTimeout)
	return o
}

// SetReturnTimeout adds the returnTimeout to the hosts settings modify collection params
func (o *HostsSettingsModifyCollectionParams) SetReturnTimeout(returnTimeout *string) {
	o.ReturnTimeout = returnTimeout
}

// WithSerialRecords adds the serialRecords to the hosts settings modify collection params
func (o *HostsSettingsModifyCollectionParams) WithSerialRecords(serialRecords *string) *HostsSettingsModifyCollectionParams {
	o.SetSerialRecords(serialRecords)
	return o
}

// SetSerialRecords adds the serialRecords to the hosts settings modify collection params
func (o *HostsSettingsModifyCollectionParams) SetSerialRecords(serialRecords *string) {
...
func (o *HostsSettingsModifyCollectionParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
	...
	if o.DNSTTLEnabled != nil {
		...
		var qrDNSTTLEnabled string

		if o.DNSTTLEnabled != nil {
			qrDNSTTLEnabled = *o.DNSTTLEnabled
		}
		qDNSTTLEnabled := qrDNSTTLEnabled
		if qDNSTTLEnabled != "" {
