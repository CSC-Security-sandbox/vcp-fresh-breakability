...
func (o *LdapSchemaCreateParams) WithReturnRecords(returnRecords *string) *LdapSchemaCreateParams {
	o.SetReturnRecords(returnRecords)
	return o
}

// SetReturnRecords adds the returnRecords to the ldap schema create params
func (o *LdapSchemaCreateParams) SetReturnRecords(returnRecords *string) {
