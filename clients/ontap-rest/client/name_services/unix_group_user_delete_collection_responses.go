...
func (o *UnixGroupUserDeleteCollectionDefault) Error() string {
	return fmt.Sprintf("[DELETE /name-services/unix-groups/{svm.uuid}/{unix_group.name}/users][%d] unix_group_user_delete_collection default  %+v", o._statusCode, o.Payload)
}
