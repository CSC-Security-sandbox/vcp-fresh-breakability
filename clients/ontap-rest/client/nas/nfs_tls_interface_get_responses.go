...
func (o *NfsTLSInterfaceGetOK) Error() string {
	return fmt.Sprintf("[GET /protocols/nfs/tls/interfaces/{interface.uuid}][%d] nfsTlsInterfaceGetOK  %+v", 200, o.Payload)
}
...
func (o *NfsTLSInterfaceGetDefault) Error() string {
	return fmt.Sprintf("[GET /protocols/nfs/tls/interfaces/{interface.uuid}][%d] nfs_tls_interface_get default  %+v", o._statusCode, o.Payload)
}
