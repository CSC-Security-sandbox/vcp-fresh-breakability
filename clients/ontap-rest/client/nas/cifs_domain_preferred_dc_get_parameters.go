...
func (o *CifsDomainPreferredDcGetParams) WithNeedStatus(needStatus *string) *CifsDomainPreferredDcGetParams {
	o.SetNeedStatus(needStatus)
	return o
}

// SetNeedStatus adds the needStatus to the cifs domain preferred dc get params
func (o *CifsDomainPreferredDcGetParams) SetNeedStatus(needStatus *string) {
