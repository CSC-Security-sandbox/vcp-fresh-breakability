...
func (o *ExportRuleCreateParams) WithReturnRecords(returnRecords *string) *ExportRuleCreateParams {
	o.SetReturnRecords(returnRecords)
	return o
}

// SetReturnRecords adds the returnRecords to the export rule create params
func (o *ExportRuleCreateParams) SetReturnRecords(returnRecords *string) {
