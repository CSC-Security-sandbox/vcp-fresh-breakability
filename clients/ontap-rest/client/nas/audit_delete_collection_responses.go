...
func (o *AuditDeleteCollectionOK) Error() string {
	return fmt.Sprintf("[DELETE /protocols/audit][%d] auditDeleteCollectionOK  %+v", 200, o.Payload)
}
...
func (o *AuditDeleteCollectionAccepted) Error() string {
	return fmt.Sprintf("[DELETE /protocols/audit][%d] auditDeleteCollectionAccepted  %+v", 202, o.Payload)
}
...
func (o *AuditDeleteCollectionDefault) Error() string {
	return fmt.Sprintf("[DELETE /protocols/audit][%d] audit_delete_collection default  %+v", o._statusCode, o.Payload)
}
