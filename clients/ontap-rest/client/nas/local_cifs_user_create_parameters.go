...
// WithReturnRecords adds the returnRecords to the local cifs user create params
func (o *LocalCifsUserCreateParams) WithReturnRecords(returnRecords *string) *LocalCifsUserCreateParams {
	o.SetReturnRecords(returnRecords)
	return o
}

// SetReturnRecords adds the returnRecords to the local cifs user create params
func (o *LocalCifsUserCreateParams) SetReturnRecords(returnRecords *string) {
