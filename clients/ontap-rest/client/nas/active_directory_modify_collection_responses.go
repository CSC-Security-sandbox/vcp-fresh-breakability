...
func (o *ActiveDirectoryModifyCollectionOK) Error() string {
	return fmt.Sprintf("[PATCH /protocols/active-directory][%d] activeDirectoryModifyCollectionOK  %+v", 200, o.Payload)
}
...
func (o *ActiveDirectoryModifyCollectionDefault) Error() string {
	return fmt.Sprintf("[PATCH /protocols/active-directory][%d] active_directory_modify_collection default  %+v", o._statusCode, o.Payload)
}
...
func (o *ActiveDirectoryModifyCollectionBody) contextValidateActiveDirectoryInlineDiscoveredServers(ctx context.Context, formats strfmt.Registry) error {
	...
	if err := validate.ReadOnly(ctx, "info"+"."+"discovered_servers", "body", []*ActiveDirectoryInlineDiscoveredServersInlineArrayItem(o.ActiveDirectoryInlineDiscoveredServers)); err != nil {
		return err
	}
...
func (o *ActiveDirectoryModifyCollectionBody) contextValidateActiveDirectoryInlinePreferredDcs(ctx context.Context, formats strfmt.Registry) error {
	...
	if err := validate.ReadOnly(ctx, "info"+"."+"preferred_dcs", "body", []*ActiveDirectoryInlinePreferredDcsInlineArrayItem(o.ActiveDirectoryInlinePreferredDcs)); err != nil {
		return err
	}
