...
func (o *FpolicyPersistentStoreDeleteParams) WithDeleteVolume(deleteVolume *string) *FpolicyPersistentStoreDeleteParams {
	o.SetDeleteVolume(deleteVolume)
	return o
}

// SetDeleteVolume adds the deleteVolume to the fpolicy persistent store delete params
func (o *FpolicyPersistentStoreDeleteParams) SetDeleteVolume(deleteVolume *string) {
