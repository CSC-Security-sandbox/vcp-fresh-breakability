...
func (o *FileDirectorySecurityACLDeleteParams) WithReturnRecords(returnRecords *string) *FileDirectorySecurityACLDeleteParams {
	o.SetReturnRecords(returnRecords)
	return o
}

// SetReturnRecords adds the returnRecords to the file directory security acl delete params
func (o *FileDirectorySecurityACLDeleteParams) SetReturnRecords(returnRecords *string) {
	o.ReturnRecords = returnRecords
}

// WithReturnTimeout adds the returnTimeout to the file directory security acl delete params
func (o *FileDirectorySecurityACLDeleteParams) WithReturnTimeout(returnTimeout *string) *FileDirectorySecurityACLDeleteParams {
	o.SetReturnTimeout(returnTimeout)
	return o
}

// SetReturnTimeout adds the returnTimeout to the file directory security acl delete params
func (o *FileDirectorySecurityACLDeleteParams) SetReturnTimeout(returnTimeout *string) {
