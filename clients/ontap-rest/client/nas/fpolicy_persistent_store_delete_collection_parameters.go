...
func (o *FpolicyPersistentStoreDeleteCollectionParams) SetDefaults() {
	var (
		...
		deleteVolumeDefault = string("\"False\"")
...
func (o *FpolicyPersistentStoreDeleteCollectionParams) WithContinueOnFailure(continueOnFailure *string) *FpolicyPersistentStoreDeleteCollectionParams {
	o.SetContinueOnFailure(continueOnFailure)
	return o
}

// SetContinueOnFailure adds the continueOnFailure to the fpolicy persistent store delete collection params
func (o *FpolicyPersistentStoreDeleteCollectionParams) SetContinueOnFailure(continueOnFailure *string) {
	o.ContinueOnFailure = continueOnFailure
}

// WithDeleteVolume adds the deleteVolume to the fpolicy persistent store delete collection params
func (o *FpolicyPersistentStoreDeleteCollectionParams) WithDeleteVolume(deleteVolume *string) *FpolicyPersistentStoreDeleteCollectionParams {
...
func (o *FpolicyPersistentStoreDeleteCollectionParams) SetDeleteVolume(deleteVolume *string) {
...
func (o *FpolicyPersistentStoreDeleteCollectionParams) WithReturnRecords(returnRecords *string) *FpolicyPersistentStoreDeleteCollectionParams {
	o.SetReturnRecords(returnRecords)
	return o
}

// SetReturnRecords adds the returnRecords to the fpolicy persistent store delete collection params
func (o *FpolicyPersistentStoreDeleteCollectionParams) SetReturnRecords(returnRecords *string) {
	o.ReturnRecords = returnRecords
}

// WithReturnTimeout adds the returnTimeout to the fpolicy persistent store delete collection params
func (o *FpolicyPersistentStoreDeleteCollectionParams) WithReturnTimeout(returnTimeout *string) *FpolicyPersistentStoreDeleteCollectionParams {
	o.SetReturnTimeout(returnTimeout)
	return o
}

// SetReturnTimeout adds the returnTimeout to the fpolicy persistent store delete collection params
func (o *FpolicyPersistentStoreDeleteCollectionParams) SetReturnTimeout(returnTimeout *string) {
	o.ReturnTimeout = returnTimeout
}

// WithSerialRecords adds the serialRecords to the fpolicy persistent store delete collection params
func (o *FpolicyPersistentStoreDeleteCollectionParams) WithSerialRecords(serialRecords *string) *FpolicyPersistentStoreDeleteCollectionParams {
	o.SetSerialRecords(serialRecords)
	return o
}

// SetSerialRecords adds the serialRecords to the fpolicy persistent store delete collection params
func (o *FpolicyPersistentStoreDeleteCollectionParams) SetSerialRecords(serialRecords *string) {
	o.SerialRecords = serialRecords
}

// WithSize adds the size to the fpolicy persistent store delete collection params
func (o *FpolicyPersistentStoreDeleteCollectionParams) WithSize(size *string) *FpolicyPersistentStoreDeleteCollectionParams {
	o.SetSize(size)
	return o
}

// SetSize adds the size to the fpolicy persistent store delete collection params
func (o *FpolicyPersistentStoreDeleteCollectionParams) SetSize(size *string) {
	o.Size = size
}
...
func (o *FpolicyPersistentStoreDeleteCollectionParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
	...
	if o.DeleteVolume != nil {
		...
		var qrDeleteVolume string

		if o.DeleteVolume != nil {
			qrDeleteVolume = *o.DeleteVolume
		}
		qDeleteVolume := qrDeleteVolume
		if qDeleteVolume != "" {
