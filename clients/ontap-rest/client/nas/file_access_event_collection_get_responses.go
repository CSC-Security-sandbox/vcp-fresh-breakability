...
// IsSuccess returns true when this file access event collection get o k response has a 2xx status code
func (o *FileAccessEventCollectionGetOK) IsSuccess() bool {
	return true
}

// IsRedirect returns true when this file access event collection get o k response has a 3xx status code
func (o *FileAccessEventCollectionGetOK) IsRedirect() bool {
	return false
}

// IsClientError returns true when this file access event collection get o k response has a 4xx status code
func (o *FileAccessEventCollectionGetOK) IsClientError() bool {
	return false
}

// IsServerError returns true when this file access event collection get o k response has a 5xx status code
func (o *FileAccessEventCollectionGetOK) IsServerError() bool {
	return false
}

// IsCode returns true when this file access event collection get o k response a status code equal to that given
func (o *FileAccessEventCollectionGetOK) IsCode(code int) bool {
	return code == 200
}

// Code gets the status code for the file access event collection get o k response
func (o *FileAccessEventCollectionGetOK) Code() int {
	return 200
}
...
func (o *FileAccessEventCollectionGetOK) String() string {
	return fmt.Sprintf("[GET /protocols/file-access-tracing/events][%d] fileAccessEventCollectionGetOK  %+v", 200, o.Payload)
}
...
// IsSuccess returns true when this file access event collection get default response has a 2xx status code
func (o *FileAccessEventCollectionGetDefault) IsSuccess() bool {
	return o._statusCode/100 == 2
}

// IsRedirect returns true when this file access event collection get default response has a 3xx status code
func (o *FileAccessEventCollectionGetDefault) IsRedirect() bool {
	return o._statusCode/100 == 3
}

// IsClientError returns true when this file access event collection get default response has a 4xx status code
func (o *FileAccessEventCollectionGetDefault) IsClientError() bool {
	return o._statusCode/100 == 4
}

// IsServerError returns true when this file access event collection get default response has a 5xx status code
func (o *FileAccessEventCollectionGetDefault) IsServerError() bool {
	return o._statusCode/100 == 5
}

// IsCode returns true when this file access event collection get default response a status code equal to that given
func (o *FileAccessEventCollectionGetDefault) IsCode(code int) bool {
...
func (o *FileAccessEventCollectionGetDefault) String() string {
	return fmt.Sprintf("[GET /protocols/file-access-tracing/events][%d] file_access_event_collection_get default  %+v", o._statusCode, o.Payload)
}
