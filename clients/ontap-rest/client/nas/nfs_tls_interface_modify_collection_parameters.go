...
type NfsTLSInterfaceModifyCollectionParams struct {
	...
	*/
	...
	/* EnforceHostAuthentication.

	   Filter by enforce_host_authentication

	   Format: boolean
	*/
	EnforceHostAuthentication *string
...
func (o *NfsTLSInterfaceModifyCollectionParams) WithContinueOnFailure(continueOnFailure *string) *NfsTLSInterfaceModifyCollectionParams {
	o.SetContinueOnFailure(continueOnFailure)
	return o
}

// SetContinueOnFailure adds the continueOnFailure to the nfs tls interface modify collection params
func (o *NfsTLSInterfaceModifyCollectionParams) SetContinueOnFailure(continueOnFailure *string) {
	o.ContinueOnFailure = continueOnFailure
}

// WithEnabled adds the enabled to the nfs tls interface modify collection params
func (o *NfsTLSInterfaceModifyCollectionParams) WithEnabled(enabled *string) *NfsTLSInterfaceModifyCollectionParams {
	o.SetEnabled(enabled)
	return o
}

// SetEnabled adds the enabled to the nfs tls interface modify collection params
func (o *NfsTLSInterfaceModifyCollectionParams) SetEnabled(enabled *string) {
	o.Enabled = enabled
}

// WithEnforceHostAuthentication adds the enforceHostAuthentication to the nfs tls interface modify collection params
func (o *NfsTLSInterfaceModifyCollectionParams) WithEnforceHostAuthentication(enforceHostAuthentication *string) *NfsTLSInterfaceModifyCollectionParams {
	o.SetEnforceHostAuthentication(enforceHostAuthentication)
	return o
}

// SetEnforceHostAuthentication adds the enforceHostAuthentication to the nfs tls interface modify collection params
func (o *NfsTLSInterfaceModifyCollectionParams) SetEnforceHostAuthentication(enforceHostAuthentication *string) {
	o.EnforceHostAuthentication = enforceHostAuthentication
}
...
func (o *NfsTLSInterfaceModifyCollectionParams) WithReturnRecords(returnRecords *string) *NfsTLSInterfaceModifyCollectionParams {
	o.SetReturnRecords(returnRecords)
	return o
}

// SetReturnRecords adds the returnRecords to the nfs tls interface modify collection params
func (o *NfsTLSInterfaceModifyCollectionParams) SetReturnRecords(returnRecords *string) {
	o.ReturnRecords = returnRecords
}

// WithReturnTimeout adds the returnTimeout to the nfs tls interface modify collection params
func (o *NfsTLSInterfaceModifyCollectionParams) WithReturnTimeout(returnTimeout *string) *NfsTLSInterfaceModifyCollectionParams {
	o.SetReturnTimeout(returnTimeout)
	return o
}

// SetReturnTimeout adds the returnTimeout to the nfs tls interface modify collection params
func (o *NfsTLSInterfaceModifyCollectionParams) SetReturnTimeout(returnTimeout *string) {
	o.ReturnTimeout = returnTimeout
}

// WithSerialRecords adds the serialRecords to the nfs tls interface modify collection params
func (o *NfsTLSInterfaceModifyCollectionParams) WithSerialRecords(serialRecords *string) *NfsTLSInterfaceModifyCollectionParams {
	o.SetSerialRecords(serialRecords)
	return o
}

// SetSerialRecords adds the serialRecords to the nfs tls interface modify collection params
func (o *NfsTLSInterfaceModifyCollectionParams) SetSerialRecords(serialRecords *string) {
	o.SerialRecords = serialRecords
}

// WithSkipSANValidation adds the skipSANValidation to the nfs tls interface modify collection params
func (o *NfsTLSInterfaceModifyCollectionParams) WithSkipSANValidation(skipSANValidation *string) *NfsTLSInterfaceModifyCollectionParams {
...
func (o *NfsTLSInterfaceModifyCollectionParams) SetSkipSANValidation(skipSANValidation *string) {
...
func (o *NfsTLSInterfaceModifyCollectionParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
	...
	if o.EnforceHostAuthentication != nil {

		// query param enforce_host_authentication
		var qrEnforceHostAuthentication string

		if o.EnforceHostAuthentication != nil {
			qrEnforceHostAuthentication = *o.EnforceHostAuthentication
		}
		qEnforceHostAuthentication := qrEnforceHostAuthentication
		if qEnforceHostAuthentication != "" {

			if err := r.SetQueryParam("enforce_host_authentication", qEnforceHostAuthentication); err != nil {
				return err
			}
		}
	}
	...
	if o.SkipSANValidation != nil {
		...
		var qrSkipSANValidation string

		if o.SkipSANValidation != nil {
			qrSkipSANValidation = *o.SkipSANValidation
		}
		qSkipSANValidation := qrSkipSANValidation
