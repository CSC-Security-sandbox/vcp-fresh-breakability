...
func (o *VscanScannerCreateParams) WithReturnRecords(returnRecords *string) *VscanScannerCreateParams {
	o.SetReturnRecords(returnRecords)
	return o
}

// SetReturnRecords adds the returnRecords to the vscan scanner create params
func (o *VscanScannerCreateParams) SetReturnRecords(returnRecords *string) {
