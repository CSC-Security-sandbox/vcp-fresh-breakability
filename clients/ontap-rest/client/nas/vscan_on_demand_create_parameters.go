...
func (o *VscanOnDemandCreateParams) WithReturnRecords(returnRecords *string) *VscanOnDemandCreateParams {
	o.SetReturnRecords(returnRecords)
	return o
}

// SetReturnRecords adds the returnRecords to the vscan on demand create params
func (o *VscanOnDemandCreateParams) SetReturnRecords(returnRecords *string) {
