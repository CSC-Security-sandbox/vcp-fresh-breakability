...
func (o *ActiveDirectoryCreateParams) WithReturnRecords(returnRecords *string) *ActiveDirectoryCreateParams {
	o.SetReturnRecords(returnRecords)
	return o
}

// SetReturnRecords adds the returnRecords to the active directory create params
func (o *ActiveDirectoryCreateParams) SetReturnRecords(returnRecords *string) {
