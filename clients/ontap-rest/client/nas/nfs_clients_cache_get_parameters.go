...
type NfsClientsCacheGetParams struct {
	...
	*/
	...
	/* EnableNfsClientsDeletion.
	   ...
	   Format: boolean
	*/
	EnableNfsClientsDeletion *string
...
func (o *NfsClientsCacheGetParams) WithEnableNfsClientsDeletion(enableNfsClientsDeletion *string) *NfsClientsCacheGetParams {
...
func (o *NfsClientsCacheGetParams) SetEnableNfsClientsDeletion(enableNfsClientsDeletion *string) {
...
func (o *NfsClientsCacheGetParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
	...
	if o.EnableNfsClientsDeletion != nil {
		...
		var qrEnableNfsClientsDeletion string

		if o.EnableNfsClientsDeletion != nil {
			qrEnableNfsClientsDeletion = *o.EnableNfsClientsDeletion
		}
		qEnableNfsClientsDeletion := qrEnableNfsClientsDeletion
