...
func (o *ExportRuleClientsCreateParams) WithReturnRecords(returnRecords *string) *ExportRuleClientsCreateParams {
	o.SetReturnRecords(returnRecords)
	return o
}

// SetReturnRecords adds the returnRecords to the export rule clients create params
func (o *ExportRuleClientsCreateParams) SetReturnRecords(returnRecords *string) {
