...
func (o *AuditModifyOK) Error() string {
	return fmt.Sprintf("[PATCH /protocols/audit/{svm.uuid}][%d] auditModifyOK  %+v", 200, o.Payload)
}
...
func (o *AuditModifyAccepted) Error() string {
	return fmt.Sprintf("[PATCH /protocols/audit/{svm.uuid}][%d] auditModifyAccepted  %+v", 202, o.Payload)
}
