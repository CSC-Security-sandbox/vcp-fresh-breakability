...
func (o *CifsSessionDeleteCollectionParams) WithConnectionCount(connectionCount *string) *CifsSessionDeleteCollectionParams {
...
func (o *CifsSessionDeleteCollectionParams) SetConnectionCount(connectionCount *string) {
	o.ConnectionCount = connectionCount
}

// WithConnectionID adds the connectionID to the cifs session delete collection params
func (o *CifsSessionDeleteCollectionParams) WithConnectionID(connectionID *string) *CifsSessionDeleteCollectionParams {
	o.SetConnectionID(connectionID)
	return o
}

// SetConnectionID adds the connectionId to the cifs session delete collection params
func (o *CifsSessionDeleteCollectionParams) SetConnectionID(connectionID *string) {
	o.ConnectionID = connectionID
}

// WithContinueOnFailure adds the continueOnFailure to the cifs session delete collection params
func (o *CifsSessionDeleteCollectionParams) WithContinueOnFailure(continueOnFailure *string) *CifsSessionDeleteCollectionParams {
	o.SetContinueOnFailure(continueOnFailure)
	return o
}

// SetContinueOnFailure adds the continueOnFailure to the cifs session delete collection params
func (o *CifsSessionDeleteCollectionParams) SetContinueOnFailure(continueOnFailure *string) {
...
func (o *CifsSessionDeleteCollectionParams) WithIdentifier(identifier *string) *CifsSessionDeleteCollectionParams {
	o.SetIdentifier(identifier)
	return o
}

// SetIdentifier adds the identifier to the cifs session delete collection params
func (o *CifsSessionDeleteCollectionParams) SetIdentifier(identifier *string) {
...
func (o *CifsSessionDeleteCollectionParams) WithLargeMtu(largeMtu *string) *CifsSessionDeleteCollectionParams {
	o.SetLargeMtu(largeMtu)
	return o
}

// SetLargeMtu adds the largeMtu to the cifs session delete collection params
func (o *CifsSessionDeleteCollectionParams) SetLargeMtu(largeMtu *string) {
	o.LargeMtu = largeMtu
}
...
func (o *CifsSessionDeleteCollectionParams) WithOpenFiles(openFiles *string) *CifsSessionDeleteCollectionParams {
	o.SetOpenFiles(openFiles)
	return o
}

// SetOpenFiles adds the openFiles to the cifs session delete collection params
func (o *CifsSessionDeleteCollectionParams) SetOpenFiles(openFiles *string) {
	o.OpenFiles = openFiles
}

// WithOpenOther adds the openOther to the cifs session delete collection params
func (o *CifsSessionDeleteCollectionParams) WithOpenOther(openOther *string) *CifsSessionDeleteCollectionParams {
	o.SetOpenOther(openOther)
	return o
}

// SetOpenOther adds the openOther to the cifs session delete collection params
func (o *CifsSessionDeleteCollectionParams) SetOpenOther(openOther *string) {
	o.OpenOther = openOther
}

// WithOpenShares adds the openShares to the cifs session delete collection params
func (o *CifsSessionDeleteCollectionParams) WithOpenShares(openShares *string) *CifsSessionDeleteCollectionParams {
	o.SetOpenShares(openShares)
	return o
}

// SetOpenShares adds the openShares to the cifs session delete collection params
func (o *CifsSessionDeleteCollectionParams) SetOpenShares(openShares *string) {
...
func (o *CifsSessionDeleteCollectionParams) WithReturnRecords(returnRecords *string) *CifsSessionDeleteCollectionParams {
	o.SetReturnRecords(returnRecords)
	return o
}

// SetReturnRecords adds the returnRecords to the cifs session delete collection params
func (o *CifsSessionDeleteCollectionParams) SetReturnRecords(returnRecords *string) {
	o.ReturnRecords = returnRecords
}

// WithReturnTimeout adds the returnTimeout to the cifs session delete collection params
func (o *CifsSessionDeleteCollectionParams) WithReturnTimeout(returnTimeout *string) *CifsSessionDeleteCollectionParams {
	o.SetReturnTimeout(returnTimeout)
	return o
}

// SetReturnTimeout adds the returnTimeout to the cifs session delete collection params
func (o *CifsSessionDeleteCollectionParams) SetReturnTimeout(returnTimeout *string) {
	o.ReturnTimeout = returnTimeout
}

// WithSerialRecords adds the serialRecords to the cifs session delete collection params
func (o *CifsSessionDeleteCollectionParams) WithSerialRecords(serialRecords *string) *CifsSessionDeleteCollectionParams {
	o.SetSerialRecords(serialRecords)
	return o
}

// SetSerialRecords adds the serialRecords to the cifs session delete collection params
func (o *CifsSessionDeleteCollectionParams) SetSerialRecords(serialRecords *string) {
...
func (o *CifsSessionDeleteCollectionParams) WithSmbSigning(smbSigning *string) *CifsSessionDeleteCollectionParams {
	o.SetSmbSigning(smbSigning)
	return o
}

// SetSmbSigning adds the smbSigning to the cifs session delete collection params
func (o *CifsSessionDeleteCollectionParams) SetSmbSigning(smbSigning *string) {
...
func (o *CifsSessionDeleteCollectionParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
	...
	if o.ConnectionCount != nil {
		...
		var qrConnectionCount string

		if o.ConnectionCount != nil {
			qrConnectionCount = *o.ConnectionCount
		}
		qConnectionCount := qrConnectionCount
		if qConnectionCount != "" {
	...
	if o.LargeMtu != nil {
		...
		var qrLargeMtu string

		if o.LargeMtu != nil {
			qrLargeMtu = *o.LargeMtu
		}
		qLargeMtu := qrLargeMtu
		if qLargeMtu != "" {
	...
	if o.OpenFiles != nil {
		...
		var qrOpenFiles string

		if o.OpenFiles != nil {
			qrOpenFiles = *o.OpenFiles
		}
		qOpenFiles := qrOpenFiles
		if qOpenFiles != "" {
	...
	if o.OpenOther != nil {
		...
		var qrOpenOther string

		if o.OpenOther != nil {
			qrOpenOther = *o.OpenOther
		}
		qOpenOther := qrOpenOther
		if qOpenOther != "" {
	...
	if o.OpenShares != nil {
		...
		var qrOpenShares string

		if o.OpenShares != nil {
			qrOpenShares = *o.OpenShares
		}
		qOpenShares := qrOpenShares
		if qOpenShares != "" {
	...
	if o.SmbSigning != nil {
		...
		var qrSmbSigning string

		if o.SmbSigning != nil {
			qrSmbSigning = *o.SmbSigning
		}
		qSmbSigning := qrSmbSigning
		if qSmbSigning != "" {
