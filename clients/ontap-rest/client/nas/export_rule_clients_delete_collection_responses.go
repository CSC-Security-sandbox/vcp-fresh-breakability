...
func (o *ExportRuleClientsDeleteCollectionDefault) Error() string {
	return fmt.Sprintf("[DELETE /protocols/nfs/export-policies/{policy.id}/rules/{index}/clients][%d] export_rule_clients_delete_collection default  %+v", o._statusCode, o.Payload)
}
