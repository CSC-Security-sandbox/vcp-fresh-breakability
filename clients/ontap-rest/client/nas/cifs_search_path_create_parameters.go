...
func (o *CifsSearchPathCreateParams) WithReturnRecords(returnRecords *string) *CifsSearchPathCreateParams {
	o.SetReturnRecords(returnRecords)
	return o
}

// SetReturnRecords adds the returnRecords to the cifs search path create params
func (o *CifsSearchPathCreateParams) SetReturnRecords(returnRecords *string) {
