...
func (o *CifsShareModifyCollectionDefault) Error() string {
	return fmt.Sprintf("[PATCH /protocols/cifs/shares][%d] cifs_share_modify_collection default  %+v", o._statusCode, o.Payload)
}
		...
		if o.CifsShareInlineAcls[i] != nil {
			if err := o.CifsShareInlineAcls[i].Validate(formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					...
					return ce.ValidateName("info" + "." + "acls" + "." + strconv.Itoa(i))
				}
				return err
			}
		}
