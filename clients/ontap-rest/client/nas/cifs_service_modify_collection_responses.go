...
func (o *CifsServiceModifyCollectionOK) Error() string {
	return fmt.Sprintf("[PATCH /protocols/cifs/services][%d] cifsServiceModifyCollectionOK  %+v", 200, o.Payload)
}
...
func (o *CifsServiceModifyCollectionAccepted) Error() string {
	return fmt.Sprintf("[PATCH /protocols/cifs/services][%d] cifsServiceModifyCollectionAccepted  %+v", 202, o.Payload)
}
...
func (o *CifsServiceModifyCollectionDefault) Error() string {
	return fmt.Sprintf("[PATCH /protocols/cifs/services][%d] cifs_service_modify_collection default  %+v", o._statusCode, o.Payload)
}
	...
	if o.AdDomain != nil {
		if err := o.AdDomain.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("info" + "." + "ad_domain")
			}
			return err
		}
	}
	...
	if o.Netbios != nil {
		if err := o.Netbios.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("info" + "." + "netbios")
			}
			return err
		}
	}
	...
	if o.Options != nil {
		if err := o.Options.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("info" + "." + "options")
			}
			return err
		}
	}
