...
func (o *KerberosRealmModifyCollectionDefault) Error() string {
	return fmt.Sprintf("[PATCH /protocols/nfs/kerberos/realms][%d] kerberos_realm_modify_collection default  %+v", o._statusCode, o.Payload)
}
	...
	if o.AdServer != nil {
		if err := o.AdServer.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("info" + "." + "ad_server")
			}
			return err
		}
	}
	...
	if o.AdminServer != nil {
		if err := o.AdminServer.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("info" + "." + "admin_server")
			}
			return err
		}
	}
	...
	if o.Kdc != nil {
		if err := o.Kdc.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("info" + "." + "kdc")
			}
			return err
		}
	}
	...
	if o.PasswordServer != nil {
		if err := o.PasswordServer.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("info" + "." + "password_server")
			}
			return err
		}
	}
