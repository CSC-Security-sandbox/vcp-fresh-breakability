...
func (o *FileDirectorySecurityCreateParams) WithReturnTimeout(returnTimeout *string) *FileDirectorySecurityCreateParams {
	o.SetReturnTimeout(returnTimeout)
	return o
}

// SetReturnTimeout adds the returnTimeout to the file directory security create params
func (o *FileDirectorySecurityCreateParams) SetReturnTimeout(returnTimeout *string) {
