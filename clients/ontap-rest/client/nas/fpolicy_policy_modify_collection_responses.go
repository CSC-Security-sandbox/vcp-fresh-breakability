...
func (o *FpolicyPolicyModifyCollectionDefault) Error() string {
	return fmt.Sprintf("[PATCH /protocols/fpolicy/{svm.uuid}/policies][%d] fpolicy_policy_modify_collection default  %+v", o._statusCode, o.Payload)
}
	...
	if o.Engine != nil {
		if err := o.Engine.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("info" + "." + "engine")
			}
			return err
		}
	}
		...
		if o.FpolicyPolicyInlineEvents[i] != nil {
			if err := o.FpolicyPolicyInlineEvents[i].Validate(formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					...
					return ce.ValidateName("info" + "." + "events" + "." + strconv.Itoa(i))
				}
				return err
			}
		}
