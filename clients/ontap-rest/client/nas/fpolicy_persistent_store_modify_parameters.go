...
func (o *FpolicyPersistentStoreModifyParams) WithDeleteVolume(deleteVolume *string) *FpolicyPersistentStoreModifyParams {
	o.SetDeleteVolume(deleteVolume)
	return o
}

// SetDeleteVolume adds the deleteVolume to the fpolicy persistent store modify params
func (o *FpolicyPersistentStoreModifyParams) SetDeleteVolume(deleteVolume *string) {
