...
func (o *AuditModifyCollectionOK) Error() string {
	return fmt.Sprintf("[PATCH /protocols/audit][%d] auditModifyCollectionOK  %+v", 200, o.Payload)
}
...
func (o *AuditModifyCollectionAccepted) Error() string {
	return fmt.Sprintf("[PATCH /protocols/audit][%d] auditModifyCollectionAccepted  %+v", 202, o.Payload)
}
...
func (o *AuditModifyCollectionDefault) Error() string {
	return fmt.Sprintf("[PATCH /protocols/audit][%d] audit_modify_collection default  %+v", o._statusCode, o.Payload)
}
	...
	if o.Events != nil {
		if err := o.Events.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("info" + "." + "events")
			}
			return err
		}
	}
	...
	if o.Log != nil {
		if err := o.Log.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("info" + "." + "log")
			}
			return err
		}
	}
