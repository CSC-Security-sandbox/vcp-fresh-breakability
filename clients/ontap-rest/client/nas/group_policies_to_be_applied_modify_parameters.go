...
func (o *GroupPoliciesToBeAppliedModifyParams) WithApplyUpdates(applyUpdates *string) *GroupPoliciesToBeAppliedModifyParams {
	o.SetApplyUpdates(applyUpdates)
	return o
}

// SetApplyUpdates adds the applyUpdates to the group policies to be applied modify params
func (o *GroupPoliciesToBeAppliedModifyParams) SetApplyUpdates(applyUpdates *string) {
...
func (o *GroupPoliciesToBeAppliedModifyParams) WithForceReapplyAllSettings(forceReapplyAllSettings *string) *GroupPoliciesToBeAppliedModifyParams {
...
func (o *GroupPoliciesToBeAppliedModifyParams) SetForceReapplyAllSettings(forceReapplyAllSettings *string) {
