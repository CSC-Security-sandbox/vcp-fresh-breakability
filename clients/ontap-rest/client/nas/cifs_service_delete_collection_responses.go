...
func (o *CifsServiceDeleteCollectionOK) Error() string {
	return fmt.Sprintf("[DELETE /protocols/cifs/services][%d] cifsServiceDeleteCollectionOK  %+v", 200, o.Payload)
}
...
func (o *CifsServiceDeleteCollectionAccepted) Error() string {
	return fmt.Sprintf("[DELETE /protocols/cifs/services][%d] cifsServiceDeleteCollectionAccepted  %+v", 202, o.Payload)
}
...
func (o *CifsServiceDeleteCollectionDefault) Error() string {
	return fmt.Sprintf("[DELETE /protocols/cifs/services][%d] cifs_service_delete_collection default  %+v", o._statusCode, o.Payload)
}
