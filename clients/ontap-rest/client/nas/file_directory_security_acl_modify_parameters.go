...
func (o *FileDirectorySecurityACLModifyParams) WithReturnRecords(returnRecords *string) *FileDirectorySecurityACLModifyParams {
	o.SetReturnRecords(returnRecords)
	return o
}

// SetReturnRecords adds the returnRecords to the file directory security acl modify params
func (o *FileDirectorySecurityACLModifyParams) SetReturnRecords(returnRecords *string) {
	o.ReturnRecords = returnRecords
}

// WithReturnTimeout adds the returnTimeout to the file directory security acl modify params
func (o *FileDirectorySecurityACLModifyParams) WithReturnTimeout(returnTimeout *string) *FileDirectorySecurityACLModifyParams {
	o.SetReturnTimeout(returnTimeout)
	return o
}

// SetReturnTimeout adds the returnTimeout to the file directory security acl modify params
func (o *FileDirectorySecurityACLModifyParams) SetReturnTimeout(returnTimeout *string) {
