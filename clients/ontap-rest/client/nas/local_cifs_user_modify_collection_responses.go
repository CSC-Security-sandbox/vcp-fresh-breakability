...
func (o *LocalCifsUserModifyCollectionDefault) Error() string {
	return fmt.Sprintf("[PATCH /protocols/cifs/local-users][%d] local_cifs_user_modify_collection default  %+v", o._statusCode, o.Payload)
}
		...
		if o.LocalCifsUserInlineMembership[i] != nil {
			if err := o.LocalCifsUserInlineMembership[i].Validate(formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					...
					return ce.ValidateName("info" + "." + "membership" + "." + strconv.Itoa(i))
				}
				return err
			}
		}
...
func (o *LocalCifsUserModifyCollectionBody) contextValidateLocalCifsUserInlineMembership(ctx context.Context, formats strfmt.Registry) error {
	...
	if err := validate.ReadOnly(ctx, "info"+"."+"membership", "body", []*LocalCifsUserInlineMembershipInlineArrayItem(o.LocalCifsUserInlineMembership)); err != nil {
		return err
	}
