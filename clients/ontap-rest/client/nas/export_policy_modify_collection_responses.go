...
func (o *ExportPolicyModifyCollectionDefault) Error() string {
	return fmt.Sprintf("[PATCH /protocols/nfs/export-policies][%d] export_policy_modify_collection default  %+v", o._statusCode, o.Payload)
}
		...
		if o.ExportPolicyInlineRules[i] != nil {
			if err := o.ExportPolicyInlineRules[i].Validate(formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					...
					return ce.ValidateName("info" + "." + "rules" + "." + strconv.Itoa(i))
				}
				return err
			}
		}
