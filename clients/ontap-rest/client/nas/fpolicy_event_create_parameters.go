...
func (o *FpolicyEventCreateParams) WithReturnRecords(returnRecords *string) *FpolicyEventCreateParams {
	o.SetReturnRecords(returnRecords)
	return o
}

// SetReturnRecords adds the returnRecords to the fpolicy event create params
func (o *FpolicyEventCreateParams) SetReturnRecords(returnRecords *string) {
