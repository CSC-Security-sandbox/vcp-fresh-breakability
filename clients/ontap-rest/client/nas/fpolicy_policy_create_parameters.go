...
func (o *FpolicyPolicyCreateParams) WithReturnRecords(returnRecords *string) *FpolicyPolicyCreateParams {
	o.SetReturnRecords(returnRecords)
	return o
}

// SetReturnRecords adds the returnRecords to the fpolicy policy create params
func (o *FpolicyPolicyCreateParams) SetReturnRecords(returnRecords *string) {
