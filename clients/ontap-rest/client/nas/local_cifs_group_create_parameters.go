...
func (o *LocalCifsGroupCreateParams) WithReturnRecords(returnRecords *string) *LocalCifsGroupCreateParams {
	o.SetReturnRecords(returnRecords)
	return o
}

// SetReturnRecords adds the returnRecords to the local cifs group create params
func (o *LocalCifsGroupCreateParams) SetReturnRecords(returnRecords *string) {
