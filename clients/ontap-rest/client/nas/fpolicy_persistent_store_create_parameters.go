...
func (o *FpolicyPersistentStoreCreateParams) WithReturnRecords(returnRecords *string) *FpolicyPersistentStoreCreateParams {
	o.SetReturnRecords(returnRecords)
	return o
}

// SetReturnRecords adds the returnRecords to the fpolicy persistent store create params
func (o *FpolicyPersistentStoreCreateParams) SetReturnRecords(returnRecords *string) {
