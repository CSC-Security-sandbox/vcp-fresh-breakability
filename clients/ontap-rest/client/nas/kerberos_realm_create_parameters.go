...
func (o *KerberosRealmCreateParams) WithReturnRecords(returnRecords *string) *KerberosRealmCreateParams {
	o.SetReturnRecords(returnRecords)
	return o
}

// SetReturnRecords adds the returnRecords to the kerberos realm create params
func (o *KerberosRealmCreateParams) SetReturnRecords(returnRecords *string) {
