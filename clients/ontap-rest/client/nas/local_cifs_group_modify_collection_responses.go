...
func (o *LocalCifsGroupModifyCollectionDefault) Error() string {
	return fmt.Sprintf("[PATCH /protocols/cifs/local-groups][%d] local_cifs_group_modify_collection default  %+v", o._statusCode, o.Payload)
}
		...
		if o.LocalCifsGroupInlineMembers[i] != nil {
			if err := o.LocalCifsGroupInlineMembers[i].Validate(formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					...
					return ce.ValidateName("info" + "." + "members" + "." + strconv.Itoa(i))
				}
				return err
			}
		}
...
func (o *LocalCifsGroupModifyCollectionBody) contextValidateLocalCifsGroupInlineMembers(ctx context.Context, formats strfmt.Registry) error {
	...
	if err := validate.ReadOnly(ctx, "info"+"."+"members", "body", []*LocalCifsGroupInlineMembersInlineArrayItem(o.LocalCifsGroupInlineMembers)); err != nil {
		return err
	}
