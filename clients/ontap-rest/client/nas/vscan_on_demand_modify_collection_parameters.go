...
func (o *VscanOnDemandModifyCollectionParams) WithContinueOnFailure(continueOnFailure *string) *VscanOnDemandModifyCollectionParams {
	o.SetContinueOnFailure(continueOnFailure)
	return o
}

// SetContinueOnFailure adds the continueOnFailure to the vscan on demand modify collection params
func (o *VscanOnDemandModifyCollectionParams) SetContinueOnFailure(continueOnFailure *string) {
...
func (o *VscanOnDemandModifyCollectionParams) WithReturnRecords(returnRecords *string) *VscanOnDemandModifyCollectionParams {
	o.SetReturnRecords(returnRecords)
	return o
}

// SetReturnRecords adds the returnRecords to the vscan on demand modify collection params
func (o *VscanOnDemandModifyCollectionParams) SetReturnRecords(returnRecords *string) {
	o.ReturnRecords = returnRecords
}

// WithReturnTimeout adds the returnTimeout to the vscan on demand modify collection params
func (o *VscanOnDemandModifyCollectionParams) WithReturnTimeout(returnTimeout *string) *VscanOnDemandModifyCollectionParams {
	o.SetReturnTimeout(returnTimeout)
	return o
}

// SetReturnTimeout adds the returnTimeout to the vscan on demand modify collection params
func (o *VscanOnDemandModifyCollectionParams) SetReturnTimeout(returnTimeout *string) {
...
func (o *VscanOnDemandModifyCollectionParams) WithScopeMaxFileSize(scopeMaxFileSize *string) *VscanOnDemandModifyCollectionParams {
...
func (o *VscanOnDemandModifyCollectionParams) SetScopeMaxFileSize(scopeMaxFileSize *string) {
...
func (o *VscanOnDemandModifyCollectionParams) WithScopeScanWithoutExtension(scopeScanWithoutExtension *string) *VscanOnDemandModifyCollectionParams {
...
func (o *VscanOnDemandModifyCollectionParams) SetScopeScanWithoutExtension(scopeScanWithoutExtension *string) {
...
func (o *VscanOnDemandModifyCollectionParams) WithSerialRecords(serialRecords *string) *VscanOnDemandModifyCollectionParams {
	o.SetSerialRecords(serialRecords)
	return o
}

// SetSerialRecords adds the serialRecords to the vscan on demand modify collection params
func (o *VscanOnDemandModifyCollectionParams) SetSerialRecords(serialRecords *string) {
