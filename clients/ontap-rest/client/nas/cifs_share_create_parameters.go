...
func (o *CifsShareCreateParams) WithReturnRecords(returnRecords *string) *CifsShareCreateParams {
	o.SetReturnRecords(returnRecords)
	return o
}

// SetReturnRecords adds the returnRecords to the cifs share create params
func (o *CifsShareCreateParams) SetReturnRecords(returnRecords *string) {
