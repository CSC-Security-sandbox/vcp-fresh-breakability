...
func (o *LocalCifsUsersAndGroupsImportModifyParams) WithReturnTimeout(returnTimeout *string) *LocalCifsUsersAndGroupsImportModifyParams {
	o.SetReturnTimeout(returnTimeout)
	return o
}

// SetReturnTimeout adds the returnTimeout to the local cifs users and groups import modify params
func (o *LocalCifsUsersAndGroupsImportModifyParams) SetReturnTimeout(returnTimeout *string) {
