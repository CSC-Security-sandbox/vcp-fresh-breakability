...
func (o *FpolicyPersistentStoreCreateCreated) Error() string {
	return fmt.Sprintf("[POST /protocols/fpolicy/{svm.uuid}/persistent-stores][%d] fpolicyPersistentStoreCreateCreated  %+v", 201, o.Payload)
}
...
func (o *FpolicyPersistentStoreCreateDefault) Error() string {
	return fmt.Sprintf("[POST /protocols/fpolicy/{svm.uuid}/persistent-stores][%d] fpolicy_persistent_store_create default  %+v", o._statusCode, o.Payload)
}
