...
func (o *CifsDomainPreferredDcDeleteCollectionDefault) Error() string {
	return fmt.Sprintf("[DELETE /protocols/cifs/domains/{svm.uuid}/preferred-domain-controllers][%d] cifs_domain_preferred_dc_delete_collection default  %+v", o._statusCode, o.Payload)
}
