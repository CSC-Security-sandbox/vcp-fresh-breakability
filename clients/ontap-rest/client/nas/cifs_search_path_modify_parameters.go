...
func (o *CifsSearchPathModifyParams) WithNewIndex(newIndex *string) *CifsSearchPathModifyParams {
	o.SetNewIndex(newIndex)
	return o
}

// SetNewIndex adds the newIndex to the cifs search path modify params
func (o *CifsSearchPathModifyParams) SetNewIndex(newIndex *string) {
	o.NewIndex = newIndex
}
