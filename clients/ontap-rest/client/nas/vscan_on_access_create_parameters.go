...
func (o *VscanOnAccessCreateParams) WithReturnRecords(returnRecords *string) *VscanOnAccessCreateParams {
	o.SetReturnRecords(returnRecords)
	return o
}

// SetReturnRecords adds the returnRecords to the vscan on access create params
func (o *VscanOnAccessCreateParams) SetReturnRecords(returnRecords *string) {
