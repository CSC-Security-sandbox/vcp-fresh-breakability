...
func (o *FpolicyConnectionModifyCollectionDefault) Error() string {
	return fmt.Sprintf("[PATCH /protocols/fpolicy/{svm.uuid}/connections][%d] fpolicy_connection_modify_collection default  %+v", o._statusCode, o.Payload)
}
	...
	if o.DisconnectedReason != nil {
		if err := o.DisconnectedReason.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("info" + "." + "disconnected_reason")
			}
			return err
		}
	}
