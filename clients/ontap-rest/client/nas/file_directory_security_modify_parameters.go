...
func (o *FileDirectorySecurityModifyParams) WithReturnTimeout(returnTimeout *string) *FileDirectorySecurityModifyParams {
	o.SetReturnTimeout(returnTimeout)
	return o
}

// SetReturnTimeout adds the returnTimeout to the file directory security modify params
func (o *FileDirectorySecurityModifyParams) SetReturnTimeout(returnTimeout *string) {
