...
func (o *ExportRuleClientsDeleteParams) WithReturnRecords(returnRecords *string) *ExportRuleClientsDeleteParams {
	o.SetReturnRecords(returnRecords)
	return o
}

// SetReturnRecords adds the returnRecords to the export rule clients delete params
func (o *ExportRuleClientsDeleteParams) SetReturnRecords(returnRecords *string) {
