...
func (o *ShadowcopyModifyCollectionOK) Error() string {
	return fmt.Sprintf("[PATCH /protocols/cifs/shadow-copies][%d] shadowcopyModifyCollectionOK  %+v", 200, o.Payload)
}
...
func (o *ShadowcopyModifyCollectionDefault) Error() string {
	return fmt.Sprintf("[PATCH /protocols/cifs/shadow-copies][%d] shadowcopy_modify_collection default  %+v", o._statusCode, o.Payload)
}
	...
	if o.ShadowcopySet != nil {
		if err := o.ShadowcopySet.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("info" + "." + "shadowcopy_set")
			}
			return err
		}
	}
	...
	if o.Share != nil {
		if err := o.Share.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("info" + "." + "share")
			}
			return err
		}
	}
	...
	if o.Links != nil {
		if err := o.Links.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("info" + "." + "shadowcopy_set" + "." + "_links")
			}
			return err
		}
	}
	...
	if o.Links != nil {
		if err := o.Links.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("info" + "." + "share" + "." + "_links")
			}
			return err
		}
	}
	...
	if o.Self != nil {
		if err := o.Self.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("info" + "." + "share" + "." + "_links" + "." + "self")
			}
			return err
		}
	}
