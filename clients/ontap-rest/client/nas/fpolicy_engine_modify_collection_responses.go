...
func (o *FpolicyEngineModifyCollectionDefault) Error() string {
	return fmt.Sprintf("[PATCH /protocols/fpolicy/{svm.uuid}/engines][%d] fpolicy_engine_modify_collection default  %+v", o._statusCode, o.Payload)
}
	...
	if o.BufferSize != nil {
		if err := o.BufferSize.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("info" + "." + "buffer_size")
			}
			return err
		}
	}
	...
	if o.Resiliency != nil {
		if err := o.Resiliency.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("info" + "." + "resiliency")
			}
			return err
		}
	}
