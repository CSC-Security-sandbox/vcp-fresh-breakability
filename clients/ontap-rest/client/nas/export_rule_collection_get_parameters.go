...
func (o *ExportRuleCollectionGetParams) WithAllowDeviceCreation(allowDeviceCreation *string) *ExportRuleCollectionGetParams {
...
func (o *ExportRuleCollectionGetParams) SetAllowDeviceCreation(allowDeviceCreation *string) {
	o.AllowDeviceCreation = allowDeviceCreation
}

// WithAllowNfsTLSOnly adds the allowNfsTLSOnly to the export rule collection get params
func (o *ExportRuleCollectionGetParams) WithAllowNfsTLSOnly(allowNfsTLSOnly *string) *ExportRuleCollectionGetParams {
	o.SetAllowNfsTLSOnly(allowNfsTLSOnly)
	return o
}

// SetAllowNfsTLSOnly adds the allowNfsTlsOnly to the export rule collection get params
func (o *ExportRuleCollectionGetParams) SetAllowNfsTLSOnly(allowNfsTLSOnly *string) {
	o.AllowNfsTLSOnly = allowNfsTLSOnly
}

// WithAllowSuid adds the allowSuid to the export rule collection get params
func (o *ExportRuleCollectionGetParams) WithAllowSuid(allowSuid *string) *ExportRuleCollectionGetParams {
	o.SetAllowSuid(allowSuid)
	return o
}

// SetAllowSuid adds the allowSuid to the export rule collection get params
func (o *ExportRuleCollectionGetParams) SetAllowSuid(allowSuid *string) {
...
func (o *ExportRuleCollectionGetParams) WithIndex(index *string) *ExportRuleCollectionGetParams {
	o.SetIndex(index)
	return o
}

// SetIndex adds the index to the export rule collection get params
func (o *ExportRuleCollectionGetParams) SetIndex(index *string) {
	o.Index = index
}

// WithMaxRecords adds the maxRecords to the export rule collection get params
func (o *ExportRuleCollectionGetParams) WithMaxRecords(maxRecords *string) *ExportRuleCollectionGetParams {
	o.SetMaxRecords(maxRecords)
	return o
}

// SetMaxRecords adds the maxRecords to the export rule collection get params
func (o *ExportRuleCollectionGetParams) SetMaxRecords(maxRecords *string) {
...
func (o *ExportRuleCollectionGetParams) WithReturnRecords(returnRecords *string) *ExportRuleCollectionGetParams {
	o.SetReturnRecords(returnRecords)
	return o
}

// SetReturnRecords adds the returnRecords to the export rule collection get params
func (o *ExportRuleCollectionGetParams) SetReturnRecords(returnRecords *string) {
	o.ReturnRecords = returnRecords
}

// WithReturnTimeout adds the returnTimeout to the export rule collection get params
func (o *ExportRuleCollectionGetParams) WithReturnTimeout(returnTimeout *string) *ExportRuleCollectionGetParams {
	o.SetReturnTimeout(returnTimeout)
	return o
}

// SetReturnTimeout adds the returnTimeout to the export rule collection get params
func (o *ExportRuleCollectionGetParams) SetReturnTimeout(returnTimeout *string) {
