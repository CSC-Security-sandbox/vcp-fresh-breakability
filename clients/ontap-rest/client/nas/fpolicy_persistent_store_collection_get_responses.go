...
func (o *FpolicyPersistentStoreCollectionGetOK) Error() string {
	return fmt.Sprintf("[GET /protocols/fpolicy/{svm.uuid}/persistent-stores][%d] fpolicyPersistentStoreCollectionGetOK  %+v", 200, o.Payload)
}
...
func (o *FpolicyPersistentStoreCollectionGetDefault) Error() string {
	return fmt.Sprintf("[GET /protocols/fpolicy/{svm.uuid}/persistent-stores][%d] fpolicy_persistent_store_collection_get default  %+v", o._statusCode, o.Payload)
}
