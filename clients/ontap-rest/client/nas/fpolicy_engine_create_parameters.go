...
func (o *FpolicyEngineCreateParams) WithReturnRecords(returnRecords *string) *FpolicyEngineCreateParams {
	o.SetReturnRecords(returnRecords)
	return o
}

// SetReturnRecords adds the returnRecords to the fpolicy engine create params
func (o *FpolicyEngineCreateParams) SetReturnRecords(returnRecords *string) {
