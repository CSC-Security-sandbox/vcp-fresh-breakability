...
func (o *GroupPoliciesToBeAppliedModifyCollectionDefault) Error() string {
	return fmt.Sprintf("[PATCH /protocols/cifs/group-policies][%d] group_policies_to_be_applied_modify_collection default  %+v", o._statusCode, o.Payload)
}
	...
	if o.ToBeApplied != nil {
		if err := o.ToBeApplied.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("info" + "." + "to_be_applied")
			}
			return err
		}
	}
		...
		if o.AccessPolicies[i] != nil {
			if err := o.AccessPolicies[i].Validate(formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					...
					return ce.ValidateName("info" + "." + "to_be_applied" + "." + "access_policies" + "." + strconv.Itoa(i))
				}
				return err
			}
		}
		...
		if o.AccessRules[i] != nil {
			if err := o.AccessRules[i].Validate(formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					...
					return ce.ValidateName("info" + "." + "to_be_applied" + "." + "access_rules" + "." + strconv.Itoa(i))
				}
				return err
			}
		}
		...
		if o.Objects[i] != nil {
			if err := o.Objects[i].Validate(formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					...
					return ce.ValidateName("info" + "." + "to_be_applied" + "." + "objects" + "." + strconv.Itoa(i))
				}
				return err
			}
		}
		...
		if o.RestrictedGroups[i] != nil {
			if err := o.RestrictedGroups[i].Validate(formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					...
					return ce.ValidateName("info" + "." + "to_be_applied" + "." + "restricted_groups" + "." + strconv.Itoa(i))
				}
				return err
			}
		}
