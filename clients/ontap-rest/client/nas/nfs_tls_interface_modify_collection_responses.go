...
func (o *NfsTLSInterfaceModifyCollectionDefault) Error() string {
	return fmt.Sprintf("[PATCH /protocols/nfs/tls/interfaces][%d] nfs_tls_interface_modify_collection default  %+v", o._statusCode, o.Payload)
}
...
type NfsTLSInterfaceModifyCollectionBody struct {
	...
	// Indicates whether NFS over TLS host authentication is enforced or not.
	EnforceHostAuthentication *bool `json:"enforce_host_authentication,omitempty"`
	...
	if o.Interface != nil {
		if err := o.Interface.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("info" + "." + "interface")
			}
			return err
		}
	}
	...
	if o.Links != nil {
		if err := o.Links.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("info" + "." + "interface" + "." + "_links")
			}
			return err
		}
	}
	...
	if o.IP != nil {
		if err := o.IP.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("info" + "." + "interface" + "." + "ip")
			}
			return err
		}
	}
	...
	if o.Self != nil {
		if err := o.Self.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("info" + "." + "interface" + "." + "_links" + "." + "self")
			}
			return err
		}
	}
	...
	if o.Address != nil {
		if err := o.Address.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("info" + "." + "interface" + "." + "ip" + "." + "address")
			}
			return err
		}
	}
