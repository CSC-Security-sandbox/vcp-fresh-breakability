...
func (o *ActiveDirectoryPreferredDcDeleteCollectionDefault) Error() string {
	return fmt.Sprintf("[DELETE /protocols/active-directory/{svm.uuid}/preferred-domain-controllers][%d] active_directory_preferred_dc_delete_collection default  %+v", o._statusCode, o.Payload)
}
