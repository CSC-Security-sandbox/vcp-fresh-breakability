...
func (o *FpolicyEventModifyCollectionDefault) Error() string {
	return fmt.Sprintf("[PATCH /protocols/fpolicy/{svm.uuid}/events][%d] fpolicy_event_modify_collection default  %+v", o._statusCode, o.Payload)
}
	...
	if o.FileOperations != nil {
		if err := o.FileOperations.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("info" + "." + "file_operations")
			}
			return err
		}
	}
	...
	if o.Filters != nil {
		if err := o.Filters.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("info" + "." + "filters")
			}
			return err
		}
	}
