...
func (o *CifsShareACLCreateParams) WithReturnRecords(returnRecords *string) *CifsShareACLCreateParams {
	o.SetReturnRecords(returnRecords)
	return o
}

// SetReturnRecords adds the returnRecords to the cifs share acl create params
func (o *CifsShareACLCreateParams) SetReturnRecords(returnRecords *string) {
