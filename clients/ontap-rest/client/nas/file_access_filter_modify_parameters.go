...
// WithIndex adds the index to the file access filter modify params
func (o *FileAccessFilterModifyParams) WithIndex(index int64) *FileAccessFilterModifyParams {
	o.SetIndex(index)
	return o
}

// SetIndex adds the index to the file access filter modify params
func (o *FileAccessFilterModifyParams) SetIndex(index int64) {
	o.Index = index
}
...
// WithSvmUUID adds the svmUUID to the file access filter modify params
func (o *FileAccessFilterModifyParams) WithSvmUUID(svmUUID string) *FileAccessFilterModifyParams {
	o.SetSvmUUID(svmUUID)
	return o
}

// SetSvmUUID adds the svmUuid to the file access filter modify params
func (o *FileAccessFilterModifyParams) SetSvmUUID(svmUUID string) {
	o.SvmUUID = svmUUID
}
