...
func (o *AuditDeleteOK) Error() string {
	return fmt.Sprintf("[DELETE /protocols/audit/{svm.uuid}][%d] auditDeleteOK  %+v", 200, o.Payload)
}
...
func (o *AuditDeleteAccepted) Error() string {
	return fmt.Sprintf("[DELETE /protocols/audit/{svm.uuid}][%d] auditDeleteAccepted  %+v", 202, o.Payload)
}
