...
type ClusterPeer struct {
	...
	// Overwrite the local role for the cluster peer
	// Example: none
		...
		if m.ClusterPeerInlineInitialAllowedSvms[i] != nil {
			if err := m.ClusterPeerInlineInitialAllowedSvms[i].Validate(formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					...
					return ce.ValidateName("initial_allowed_svms" + "." + strconv.Itoa(i))
				}
				return err
			}
		}
		...
		if m.ClusterPeerInlinePeerApplications[i] != nil {
			if err := m.ClusterPeerInlinePeerApplications[i].Validate(formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					...
					return ce.ValidateName("peer_applications" + "." + strconv.Itoa(i))
				}
				return err
			}
		}
	...
	if m.LocalNetwork != nil {
		if err := m.LocalNetwork.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("local_network")
			}
			return err
		}
	}
	...
	if m.Interfaces != nil {
		if err := m.Interfaces.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("_links" + "." + "interfaces")
			}
			return err
		}
	}
		...
		if m.Interfaces[i] != nil {
			if err := m.Interfaces[i].Validate(formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					...
					return ce.ValidateName("local_network" + "." + "interfaces" + "." + strconv.Itoa(i))
				}
				return err
			}
		}
		...
		if m.IPAddresses[i] != nil {
			if err := m.IPAddresses[i].Validate(formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					...
					return ce.ValidateName("remote" + "." + "ip_addresses" + "." + strconv.Itoa(i))
				}
				return err
			}
		}
...
func (m *ClusterPeerInlineVersion) contextValidatePatch(ctx context.Context, formats strfmt.Registry) error {
