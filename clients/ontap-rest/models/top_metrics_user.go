...
func (m *TopMetricsUserInlineIops) contextValidateTotal(ctx context.Context, formats strfmt.Registry) error {
...
func (m *TopMetricsUserInlineThroughput) contextValidateTotal(ctx context.Context, formats strfmt.Registry) error {
