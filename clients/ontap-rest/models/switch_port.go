	...
	if m.RemotePort != nil {
		if err := m.RemotePort.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("remote_port")
			}
			return err
		}
	}
	...
	if m.Device != nil {
		if err := m.Device.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("remote_port" + "." + "device")
			}
			return err
		}
	}
	...
	if m.Node != nil {
		if err := m.Node.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("remote_port" + "." + "device" + "." + "node")
			}
			return err
		}
	}
	...
	if m.Shelf != nil {
		if err := m.Shelf.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("remote_port" + "." + "device" + "." + "shelf")
			}
			return err
		}
	}
	...
	if m.Links != nil {
		if err := m.Links.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("remote_port" + "." + "device" + "." + "node" + "." + "_links")
			}
			return err
		}
	}
	...
	if m.Self != nil {
		if err := m.Self.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("remote_port" + "." + "device" + "." + "node" + "." + "_links" + "." + "self")
			}
			return err
		}
	}
	...
	if m.Links != nil {
		if err := m.Links.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("remote_port" + "." + "device" + "." + "shelf" + "." + "_links")
			}
			return err
		}
	}
	...
	if m.Self != nil {
		if err := m.Self.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("remote_port" + "." + "device" + "." + "shelf" + "." + "_links" + "." + "self")
			}
			return err
		}
	}
...
type SwitchPortInlineRolesInlineArrayItem struct {
	...
	// Allowed use type.
	// Enum: [cluster storage isl vpc_peer_link]
	Type *string `json:"type,omitempty"`
...
func init() {
	var res []string
	if err := json.Unmarshal([]byte(`["cluster","storage","isl","vpc_peer_link"]`), &res); err != nil {
		panic(err)
	}
	for _, v := range res {
...
const (
	...
	// SwitchPortInlineRolesInlineArrayItemTypeIsl captures enum value "isl"
	SwitchPortInlineRolesInlineArrayItemTypeIsl string = "isl"
	...
	if m.ReceiveRaw != nil {
		if err := m.ReceiveRaw.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("statistics" + "." + "receive_raw")
			}
			return err
		}
	}
	...
	if m.TransmitRaw != nil {
		if err := m.TransmitRaw.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("statistics" + "." + "transmit_raw")
			}
			return err
		}
	}
	...
	if m.Links != nil {
		if err := m.Links.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("switch" + "." + "_links")
			}
			return err
		}
	}
