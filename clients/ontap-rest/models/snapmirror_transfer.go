...
func (m *SnapmirrorTransfer) Validate(formats strfmt.Registry) error {
	...
	if err := m.validateSnapmirrorTransferInlineOptions(formats); err != nil {
		res = append(res, err)
	}
...
var snapmirrorTransferTypeArchiveRetrievalPriorityPropEnum []interface{}
...
func init() {
	...
	for _, v := range res {
		snapmirrorTransferTypeArchiveRetrievalPriorityPropEnum = append(snapmirrorTransferTypeArchiveRetrievalPriorityPropEnum, v)
	}
}

const (

	// SnapmirrorTransferArchiveRetrievalPriorityStandard captures enum value "standard"
	SnapmirrorTransferArchiveRetrievalPriorityStandard string = "standard"

	// SnapmirrorTransferArchiveRetrievalPriorityHigh captures enum value "high"
	SnapmirrorTransferArchiveRetrievalPriorityHigh string = "high"

	// SnapmirrorTransferArchiveRetrievalPriorityLow captures enum value "low"
	SnapmirrorTransferArchiveRetrievalPriorityLow string = "low"
)

// prop value enum
func (m *SnapmirrorTransfer) validateArchiveRetrievalPriorityEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, snapmirrorTransferTypeArchiveRetrievalPriorityPropEnum, true); err != nil {
		return err
	}
	return nil
}

func (m *SnapmirrorTransfer) validateArchiveRetrievalPriority(formats strfmt.Registry) error {
	...
	if m.ErrorInfo != nil {
		if err := m.ErrorInfo.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("error_info")
			}
			return err
		}
	}
...
func (m *SnapmirrorTransfer) validateSnapmirrorTransferInlineOptions(formats strfmt.Registry) error {
	if swag.IsZero(m.SnapmirrorTransferInlineOptions) { // not required
		return nil
	}
	...
	for i := 0; i < len(m.SnapmirrorTransferInlineOptions); i++ {
		...
		if m.SnapmirrorTransferInlineOptions[i] != nil {
			if err := m.SnapmirrorTransferInlineOptions[i].Validate(formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
...
func (m *SnapmirrorTransfer) validateSourceSnapshotUUID(formats strfmt.Registry) error {
...
func (m *SnapmirrorTransfer) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	...
	if err := m.contextValidateBytesTransferredPercent(ctx, formats); err != nil {
		res = append(res, err)
	}
	...
	if err := m.contextValidateSnapmirrorTransferInlineOptions(ctx, formats); err != nil {
		res = append(res, err)
	}
...
func (m *SnapmirrorTransfer) contextValidateBytesTransferredPercent(ctx context.Context, formats strfmt.Registry) error {

	if err := validate.ReadOnly(ctx, "bytes_transferred_percent", "body", m.BytesTransferredPercent); err != nil {
		return err
	}
...
func (m *SnapmirrorTransfer) contextValidateSnapmirrorTransferInlineOptions(ctx context.Context, formats strfmt.Registry) error {
...
func (m *SnapmirrorTransferInlineOptionsInlineArrayItem) Validate(formats strfmt.Registry) error {
	return nil
}

// ContextValidate validates this snapmirror transfer inline options inline array item based on context it is used
func (m *SnapmirrorTransferInlineOptionsInlineArrayItem) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (m *SnapmirrorTransferInlineOptionsInlineArrayItem) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
	return swag.WriteJSON(m)
...
// UnmarshalBinary interface implementation
func (m *SnapmirrorTransferInlineOptionsInlineArrayItem) UnmarshalBinary(b []byte) error {
	...
	if m.Destination != nil {
		if err := m.Destination.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("relationship" + "." + "destination")
			}
			return err
		}
	}
