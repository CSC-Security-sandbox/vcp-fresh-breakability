...
func (m *SnapmirrorPolicy) validateArchive(formats strfmt.Registry) error {
...
var snapmirrorPolicyTypeSnapshotLockModePropEnum []interface{}
...
func init() {
	...
	for _, v := range res {
		snapmirrorPolicyTypeSnapshotLockModePropEnum = append(snapmirrorPolicyTypeSnapshotLockModePropEnum, v)
	}
}

const (

	// SnapmirrorPolicySnapshotLockModeNone captures enum value "none"
	SnapmirrorPolicySnapshotLockModeNone string = "none"

	// SnapmirrorPolicySnapshotLockModeCompliance captures enum value "compliance"
	SnapmirrorPolicySnapshotLockModeCompliance string = "compliance"

	// SnapmirrorPolicySnapshotLockModeEnterprise captures enum value "enterprise"
	SnapmirrorPolicySnapshotLockModeEnterprise string = "enterprise"
)

// prop value enum
func (m *SnapmirrorPolicy) validateSnapshotLockModeEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, snapmirrorPolicyTypeSnapshotLockModePropEnum, true); err != nil {
		return err
	}
	return nil
}

func (m *SnapmirrorPolicy) validateSnapshotLockMode(formats strfmt.Registry) error {
...
func (m *SnapmirrorPolicyInlineArchive) Validate(formats strfmt.Registry) error {
	return nil
}

// ContextValidate validates this snapmirror policy inline archive based on context it is used
func (m *SnapmirrorPolicyInlineArchive) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (m *SnapmirrorPolicyInlineArchive) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
	return swag.WriteJSON(m)
...
// UnmarshalBinary interface implementation
func (m *SnapmirrorPolicyInlineArchive) UnmarshalBinary(b []byte) error {
