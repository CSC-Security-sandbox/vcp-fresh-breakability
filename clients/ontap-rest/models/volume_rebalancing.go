	...
	if m.Movement != nil {
		if err := m.Movement.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("engine" + "." + "movement")
			}
			return err
		}
	}
	...
	if m.Scanner != nil {
		if err := m.Scanner.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("engine" + "." + "scanner")
			}
			return err
		}
	}
	...
	if m.LastError != nil {
		if err := m.LastError.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("engine" + "." + "movement" + "." + "last_error")
			}
			return err
		}
	}
	...
	if m.BlocksSkipped != nil {
		if err := m.BlocksSkipped.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("engine" + "." + "scanner" + "." + "blocks_skipped")
			}
			return err
		}
	}
	...
	if m.FilesSkipped != nil {
		if err := m.FilesSkipped.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("engine" + "." + "scanner" + "." + "files_skipped")
			}
			return err
		}
	}
