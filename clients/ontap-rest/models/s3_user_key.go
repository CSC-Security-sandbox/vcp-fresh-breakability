...
// S3UserKey Specifies a key associated with an S3 user. At most only two keys can be associated with a user. <private>This is a private object in ONTAP 9.15.1 as the multi-key feature is dark in this release.<\private>
//
