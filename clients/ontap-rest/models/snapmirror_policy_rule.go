...
type SnapmirrorPolicyRule struct {
	...
	// Number of snapshots to be kept for retention. Maximum value will differ based on type of relationship and scaling factor. For normal SnapMirror relationship without snapshot scaling enabled maximum value can be 251 and with snapshot scaling enabled it can be 1019. For object store SnapMirror relationships maximum value can be 4091.
	// Example: 7
