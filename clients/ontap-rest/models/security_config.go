...
type SecurityConfig struct {
	...
	UsFederalCybersecurity *SecurityConfigInlineUsFederalCybersecurity `json:"us_federal_cybersecurity,omitempty"`
}
...
func (m *SecurityConfig) validateUsFederalCybersecurity(formats strfmt.Registry) error {
...
func (m *SecurityConfig) contextValidateUsFederalCybersecurity(ctx context.Context, formats strfmt.Registry) error {
...
// SecurityConfigInlineUsFederalCybersecurity Cluster-wide cybersecurity compliance information as per United States federal standards.
//
// swagger:model security_config_inline_us_federal_cybersecurity
type SecurityConfigInlineUsFederalCybersecurity struct {
...
// Validate validates this security config inline us federal cybersecurity
func (m *SecurityConfigInlineUsFederalCybersecurity) Validate(formats strfmt.Registry) error {
	return nil
}

// ContextValidate validates this security config inline us federal cybersecurity based on context it is used
func (m *SecurityConfigInlineUsFederalCybersecurity) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (m *SecurityConfigInlineUsFederalCybersecurity) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
	return swag.WriteJSON(m)
...
// UnmarshalBinary interface implementation
func (m *SecurityConfigInlineUsFederalCybersecurity) UnmarshalBinary(b []byte) error {
	var res SecurityConfigInlineUsFederalCybersecurity
	if err := swag.ReadJSON(b, &res); err != nil {
		return err
	}
	*m = res
