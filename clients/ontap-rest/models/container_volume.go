...
// ContainerVolumeInlineQos QoS information
//
...
func (m *ContainerVolumeInlineQosInlinePolicy) validateMaxThroughputIops(formats strfmt.Registry) error {
...
func (m *ContainerVolumeInlineQosInlinePolicy) validateMaxThroughputMbps(formats strfmt.Registry) error {
...
func (m *ContainerVolumeInlineQosInlinePolicy) validateMinThroughputIops(formats strfmt.Registry) error {
...
func (m *ContainerVolumeInlineQosInlinePolicy) validateMinThroughputMbps(formats strfmt.Registry) error {
...
// ContainerVolumeInlineQosInlinePolicyInlineLinks container volume inline qos inline policy inline links
//
// swagger:model container_volume_inline_qos_inline_policy_inline__links
type ContainerVolumeInlineQosInlinePolicyInlineLinks struct {

	// self
	Self *Href `json:"self,omitempty"`
}

// Validate validates this container volume inline qos inline policy inline links
func (m *ContainerVolumeInlineQosInlinePolicyInlineLinks) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ContainerVolumeInlineQosInlinePolicyInlineLinks) validateSelf(formats strfmt.Registry) error {
...
// ContextValidate validate this container volume inline qos inline policy inline links based on the context it is used
func (m *ContainerVolumeInlineQosInlinePolicyInlineLinks) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *ContainerVolumeInlineQosInlinePolicyInlineLinks) contextValidateSelf(ctx context.Context, formats strfmt.Registry) error {
...
// MarshalBinary interface implementation
func (m *ContainerVolumeInlineQosInlinePolicyInlineLinks) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
	return swag.WriteJSON(m)
...
// UnmarshalBinary interface implementation
func (m *ContainerVolumeInlineQosInlinePolicyInlineLinks) UnmarshalBinary(b []byte) error {
	var res ContainerVolumeInlineQosInlinePolicyInlineLinks
	if err := swag.ReadJSON(b, &res); err != nil {
		return err
	}
	*m = res
...
type ContainerVolumeInlineS3Bucket struct {
	...
	// access policies
	AccessPolicies *ContainerVolumeInlineS3BucketInlineAccessPolicies `json:"access_policies,omitempty"`
	...
	SnapshotPolicyReference *ContainerVolumeInlineS3BucketInlineSnapshotPolicyReference `json:"snapshot_policy_reference,omitempty"`
}
...
func (m *ContainerVolumeInlineS3Bucket) validateAccessPolicies(formats strfmt.Registry) error {
...
func (m *ContainerVolumeInlineS3Bucket) validateSnapshotPolicyReference(formats strfmt.Registry) error {
...
func (m *ContainerVolumeInlineS3Bucket) contextValidateAccessPolicies(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ContainerVolumeInlineS3Bucket) contextValidateSnapshotPolicyReference(ctx context.Context, formats strfmt.Registry) error {
...
// ContainerVolumeInlineS3BucketInlineAccessPolicies A policy is an object associated with a bucket. It defines resource (bucket, folder, or object) permissions. These policies are evaluated when an S3 user makes a request by executing a specific command. The user must be part of the principal (user or group) specified in the policy. Permissions in the policies determine whether the request is allowed or denied.
//
// swagger:model container_volume_inline_s3_bucket_inline_access_policies
type ContainerVolumeInlineS3BucketInlineAccessPolicies struct {

	// Specifies the bucket access policy statement.
	// Max Items: 10
	// Min Items: 0
	Statements []*ContainerVolumeS3BucketAccessPoliciesStatementsItems0 `json:"statements,omitempty"`
}

// Validate validates this container volume inline s3 bucket inline access policies
func (m *ContainerVolumeInlineS3BucketInlineAccessPolicies) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ContainerVolumeInlineS3BucketInlineAccessPolicies) validateStatements(formats strfmt.Registry) error {
...
// ContextValidate validate this container volume inline s3 bucket inline access policies based on the context it is used
func (m *ContainerVolumeInlineS3BucketInlineAccessPolicies) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *ContainerVolumeInlineS3BucketInlineAccessPolicies) contextValidateStatements(ctx context.Context, formats strfmt.Registry) error {
...
// MarshalBinary interface implementation
func (m *ContainerVolumeInlineS3BucketInlineAccessPolicies) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
	return swag.WriteJSON(m)
...
// UnmarshalBinary interface implementation
func (m *ContainerVolumeInlineS3BucketInlineAccessPolicies) UnmarshalBinary(b []byte) error {
	var res ContainerVolumeInlineS3BucketInlineAccessPolicies
	if err := swag.ReadJSON(b, &res); err != nil {
		return err
	}
	*m = res
...
// ContainerVolumeS3BucketAccessPoliciesStatementsItems0 Specifies information about a single access permission.
//
// swagger:model ContainerVolumeS3BucketAccessPoliciesStatementsItems0
type ContainerVolumeS3BucketAccessPoliciesStatementsItems0 struct {
...
// Validate validates this container volume s3 bucket access policies statements items0
func (m *ContainerVolumeS3BucketAccessPoliciesStatementsItems0) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ContainerVolumeS3BucketAccessPoliciesStatementsItems0) validateConditions(formats strfmt.Registry) error {
...
var containerVolumeS3BucketAccessPoliciesStatementsItems0TypeEffectPropEnum []interface{}
...
func init() {
	...
	for _, v := range res {
		containerVolumeS3BucketAccessPoliciesStatementsItems0TypeEffectPropEnum = append(containerVolumeS3BucketAccessPoliciesStatementsItems0TypeEffectPropEnum, v)
	}
}

const (

	// ContainerVolumeS3BucketAccessPoliciesStatementsItems0EffectAllow captures enum value "allow"
	ContainerVolumeS3BucketAccessPoliciesStatementsItems0EffectAllow string = "allow"

	// ContainerVolumeS3BucketAccessPoliciesStatementsItems0EffectDeny captures enum value "deny"
	ContainerVolumeS3BucketAccessPoliciesStatementsItems0EffectDeny string = "deny"
)

// prop value enum
func (m *ContainerVolumeS3BucketAccessPoliciesStatementsItems0) validateEffectEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, containerVolumeS3BucketAccessPoliciesStatementsItems0TypeEffectPropEnum, true); err != nil {
		return err
	}
	return nil
}

func (m *ContainerVolumeS3BucketAccessPoliciesStatementsItems0) validateEffect(formats strfmt.Registry) error {
...
func (m *ContainerVolumeS3BucketAccessPoliciesStatementsItems0) validateSid(formats strfmt.Registry) error {
...
// ContextValidate validate this container volume s3 bucket access policies statements items0 based on the context it is used
func (m *ContainerVolumeS3BucketAccessPoliciesStatementsItems0) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *ContainerVolumeS3BucketAccessPoliciesStatementsItems0) contextValidateConditions(ctx context.Context, formats strfmt.Registry) error {
...
// MarshalBinary interface implementation
func (m *ContainerVolumeS3BucketAccessPoliciesStatementsItems0) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
	return swag.WriteJSON(m)
...
// UnmarshalBinary interface implementation
func (m *ContainerVolumeS3BucketAccessPoliciesStatementsItems0) UnmarshalBinary(b []byte) error {
	var res ContainerVolumeS3BucketAccessPoliciesStatementsItems0
	if err := swag.ReadJSON(b, &res); err != nil {
		return err
	}
	*m = res
...
// ContainerVolumeInlineS3BucketInlineSnapshotPolicyReference This is a reference to the snapshot policy.
//
// swagger:model container_volume_inline_s3_bucket_inline_snapshot_policy_reference
type ContainerVolumeInlineS3BucketInlineSnapshotPolicyReference struct {

	// links
	Links *ContainerVolumeInlineS3BucketInlineSnapshotPolicyReferenceInlineLinks `json:"_links,omitempty"`
...
// Validate validates this container volume inline s3 bucket inline snapshot policy reference
func (m *ContainerVolumeInlineS3BucketInlineSnapshotPolicyReference) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ContainerVolumeInlineS3BucketInlineSnapshotPolicyReference) validateLinks(formats strfmt.Registry) error {
	if swag.IsZero(m.Links) { // not required
		return nil
	}
...
// ContextValidate validate this container volume inline s3 bucket inline snapshot policy reference based on the context it is used
func (m *ContainerVolumeInlineS3BucketInlineSnapshotPolicyReference) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *ContainerVolumeInlineS3BucketInlineSnapshotPolicyReference) contextValidateLinks(ctx context.Context, formats strfmt.Registry) error {
...
// MarshalBinary interface implementation
func (m *ContainerVolumeInlineS3BucketInlineSnapshotPolicyReference) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
	return swag.WriteJSON(m)
...
// UnmarshalBinary interface implementation
func (m *ContainerVolumeInlineS3BucketInlineSnapshotPolicyReference) UnmarshalBinary(b []byte) error {
	var res ContainerVolumeInlineS3BucketInlineSnapshotPolicyReference
	if err := swag.ReadJSON(b, &res); err != nil {
		return err
	}
	*m = res
...
// ContainerVolumeInlineS3BucketInlineSnapshotPolicyReferenceInlineLinks container volume inline s3 bucket inline snapshot policy reference inline links
//
// swagger:model container_volume_inline_s3_bucket_inline_snapshot_policy_reference_inline__links
type ContainerVolumeInlineS3BucketInlineSnapshotPolicyReferenceInlineLinks struct {

	// self
	Self *Href `json:"self,omitempty"`
}

// Validate validates this container volume inline s3 bucket inline snapshot policy reference inline links
func (m *ContainerVolumeInlineS3BucketInlineSnapshotPolicyReferenceInlineLinks) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ContainerVolumeInlineS3BucketInlineSnapshotPolicyReferenceInlineLinks) validateSelf(formats strfmt.Registry) error {
	if swag.IsZero(m.Self) { // not required
		return nil
	}
...
// ContextValidate validate this container volume inline s3 bucket inline snapshot policy reference inline links based on the context it is used
func (m *ContainerVolumeInlineS3BucketInlineSnapshotPolicyReferenceInlineLinks) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *ContainerVolumeInlineS3BucketInlineSnapshotPolicyReferenceInlineLinks) contextValidateSelf(ctx context.Context, formats strfmt.Registry) error {
...
// MarshalBinary interface implementation
func (m *ContainerVolumeInlineS3BucketInlineSnapshotPolicyReferenceInlineLinks) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
	return swag.WriteJSON(m)
...
// UnmarshalBinary interface implementation
func (m *ContainerVolumeInlineS3BucketInlineSnapshotPolicyReferenceInlineLinks) UnmarshalBinary(b []byte) error {
	var res ContainerVolumeInlineS3BucketInlineSnapshotPolicyReferenceInlineLinks
	if err := swag.ReadJSON(b, &res); err != nil {
		return err
	}
	*m = res
