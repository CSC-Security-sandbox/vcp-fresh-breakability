	...
	if m.JunctionParent != nil {
		if err := m.JunctionParent.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("junction_parent")
			}
			return err
		}
	}
		...
		if m.Shares[i] != nil {
			if err := m.Shares[i].Validate(formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					...
					return ce.ValidateName("cifs" + "." + "shares" + "." + strconv.Itoa(i))
				}
				return err
			}
		}
		...
		if m.Rules[i] != nil {
			if err := m.Rules[i].Validate(formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					...
					return ce.ValidateName("export_policy" + "." + "rules" + "." + strconv.Itoa(i))
				}
				return err
			}
		}
	...
	if m.Links != nil {
		if err := m.Links.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("junction_parent" + "." + "_links")
			}
			return err
		}
	}
