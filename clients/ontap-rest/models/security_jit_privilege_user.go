...
func (m *SecurityJitPrivilegeUser) validateEndDate(formats strfmt.Registry) error {
...
func (m *SecurityJitPrivilegeUser) validateStartDate(formats strfmt.Registry) error {
...
func (m *SecurityJitPrivilegeUser) contextValidateEndDate(ctx context.Context, formats strfmt.Registry) error {

	if err := validate.ReadOnly(ctx, "end_date", "body", m.EndDate); err != nil {
		return err
	}
