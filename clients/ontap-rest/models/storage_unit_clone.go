	...
	if m.Snapshot != nil {
		if err := m.Snapshot.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("source" + "." + "snapshot")
			}
			return err
		}
	}
	...
	if m.StorageUnit != nil {
		if err := m.StorageUnit.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("source" + "." + "storage_unit")
			}
			return err
		}
	}
	...
	if m.Links != nil {
		if err := m.Links.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("source" + "." + "snapshot" + "." + "_links")
			}
			return err
		}
	}
	...
	if m.Self != nil {
		if err := m.Self.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("source" + "." + "snapshot" + "." + "_links" + "." + "self")
			}
			return err
		}
	}
	...
	if m.Links != nil {
		if err := m.Links.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("source" + "." + "storage_unit" + "." + "_links")
			}
			return err
		}
	}
	...
	if m.Self != nil {
		if err := m.Self.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("source" + "." + "storage_unit" + "." + "_links" + "." + "self")
			}
			return err
		}
	}
