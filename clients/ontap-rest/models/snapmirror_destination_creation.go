...
type SnapmirrorDestinationCreation struct {
	...
	// snaplock
	Snaplock *SnapmirrorDestinationCreationInlineSnaplock `json:"snaplock,omitempty"`
...
func (m *SnapmirrorDestinationCreation) validateSnaplock(formats strfmt.Registry) error {
...
// SnapmirrorDestinationCreationInlineSnaplock snapmirror destination creation inline snaplock
//
// swagger:model snapmirror_destination_creation_inline_snaplock
type SnapmirrorDestinationCreationInlineSnaplock struct {

	// retention
	Retention *SnapmirrorDestinationCreationInlineSnaplockInlineRetention `json:"retention,omitempty"`
...
// Validate validates this snapmirror destination creation inline snaplock
func (m *SnapmirrorDestinationCreationInlineSnaplock) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *SnapmirrorDestinationCreationInlineSnaplock) validateRetention(formats strfmt.Registry) error {
...
var snapmirrorDestinationCreationInlineSnaplockTypeTypePropEnum []interface{}
...
func init() {
	...
	for _, v := range res {
		snapmirrorDestinationCreationInlineSnaplockTypeTypePropEnum = append(snapmirrorDestinationCreationInlineSnaplockTypeTypePropEnum, v)
	}
}

const (

	// SnapmirrorDestinationCreationInlineSnaplockTypeCompliance captures enum value "compliance"
	SnapmirrorDestinationCreationInlineSnaplockTypeCompliance string = "compliance"

	// SnapmirrorDestinationCreationInlineSnaplockTypeEnterprise captures enum value "enterprise"
	SnapmirrorDestinationCreationInlineSnaplockTypeEnterprise string = "enterprise"

	// SnapmirrorDestinationCreationInlineSnaplockTypeNonSnaplock captures enum value "non_snaplock"
	SnapmirrorDestinationCreationInlineSnaplockTypeNonSnaplock string = "non_snaplock"
)

// prop value enum
func (m *SnapmirrorDestinationCreationInlineSnaplock) validateTypeEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, snapmirrorDestinationCreationInlineSnaplockTypeTypePropEnum, true); err != nil {
		return err
	}
	return nil
}

func (m *SnapmirrorDestinationCreationInlineSnaplock) validateType(formats strfmt.Registry) error {
...
// ContextValidate validate this snapmirror destination creation inline snaplock based on the context it is used
func (m *SnapmirrorDestinationCreationInlineSnaplock) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
// MarshalBinary interface implementation
func (m *SnapmirrorDestinationCreationInlineSnaplock) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
	return swag.WriteJSON(m)
...
// UnmarshalBinary interface implementation
func (m *SnapmirrorDestinationCreationInlineSnaplock) UnmarshalBinary(b []byte) error {
	var res SnapmirrorDestinationCreationInlineSnaplock
	if err := swag.ReadJSON(b, &res); err != nil {
		return err
	}
	*m = res
...
// SnapmirrorDestinationCreationInlineSnaplockInlineRetention snapmirror destination creation inline snaplock inline retention
//
// swagger:model snapmirror_destination_creation_inline_snaplock_inline_retention
type SnapmirrorDestinationCreationInlineSnaplockInlineRetention struct {

	// Specifies the default retention period that is applied to snapshots while committing them to the locked state without an associated retention period. This property is only supported when the SnapLock type is specified.
	// Example: P30Y
	Default *string `json:"default,omitempty"`

	// Specifies the maximum allowed retention period for snapshots committed to the locked state on the volume. This property is only supported when the SnapLock type is specified.
	// Example: P30Y
	Maximum *string `json:"maximum,omitempty"`

	// Specifies the minimum allowed retention period for snapshots committed to the locked state on the volume. This property is only supported when the SnapLock type is specified.
	// Example: P30Y
	Minimum *string `json:"minimum,omitempty"`
}

// Validate validates this snapmirror destination creation inline snaplock inline retention
func (m *SnapmirrorDestinationCreationInlineSnaplockInlineRetention) Validate(formats strfmt.Registry) error {
	return nil
}

// ContextValidate validates this snapmirror destination creation inline snaplock inline retention based on context it is used
func (m *SnapmirrorDestinationCreationInlineSnaplockInlineRetention) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (m *SnapmirrorDestinationCreationInlineSnaplockInlineRetention) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
	return swag.WriteJSON(m)
...
// UnmarshalBinary interface implementation
func (m *SnapmirrorDestinationCreationInlineSnaplockInlineRetention) UnmarshalBinary(b []byte) error {
	var res SnapmirrorDestinationCreationInlineSnaplockInlineRetention
	if err := swag.ReadJSON(b, &res); err != nil {
		return err
	}
	*m = res
