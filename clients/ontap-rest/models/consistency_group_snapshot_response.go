...
func (m *ConsistencyGroupSnapshotResponseInlineRecordsInlineArrayItem) validateSvmDr(formats strfmt.Registry) error {
...
func (m *ConsistencyGroupSnapshotResponseInlineRecordsInlineArrayItem) contextValidateSize(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ConsistencyGroupSnapshotResponseInlineRecordsInlineArrayItem) contextValidateSvmDr(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ConsistencyGroupSnapshotResponseInlineRecordsInlineArrayItemInlineSvmDr) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ConsistencyGroupSnapshotResponseInlineRecordsInlineArrayItemInlineSvmDr) validateLabel(formats strfmt.Registry) error {
...
func (m *ConsistencyGroupSnapshotResponseInlineRecordsInlineArrayItemInlineSvmDr) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *ConsistencyGroupSnapshotResponseInlineRecordsInlineArrayItemInlineSvmDr) contextValidateLabel(ctx context.Context, formats strfmt.Registry) error {
...
// MarshalBinary interface implementation
func (m *ConsistencyGroupSnapshotResponseInlineRecordsInlineArrayItemInlineSvmDr) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
	return swag.WriteJSON(m)
...
// UnmarshalBinary interface implementation
func (m *ConsistencyGroupSnapshotResponseInlineRecordsInlineArrayItemInlineSvmDr) UnmarshalBinary(b []byte) error {
...
func (m *ConsistencyGroupSnapshotResponseInlineRecordsInlineArrayItemInlineSvmDrInlineLabel) Validate(formats strfmt.Registry) error {
	return nil
}
...
func (m *ConsistencyGroupSnapshotResponseInlineRecordsInlineArrayItemInlineSvmDrInlineLabel) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (m *ConsistencyGroupSnapshotResponseInlineRecordsInlineArrayItemInlineSvmDrInlineLabel) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
	return swag.WriteJSON(m)
...
// UnmarshalBinary interface implementation
func (m *ConsistencyGroupSnapshotResponseInlineRecordsInlineArrayItemInlineSvmDrInlineLabel) UnmarshalBinary(b []byte) error {
