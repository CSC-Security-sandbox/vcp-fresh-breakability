...
type ContainerResponseRecordsItems0VolumesItems0Flexcache struct {
	...
	// origins
	Origins []*FlexcacheRelationship `json:"origins"`
}
		...
		if m.Origins[i] != nil {
			if err := m.Origins[i].Validate(formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					...
					return ce.ValidateName("flexcache" + "." + "origins" + "." + strconv.Itoa(i))
				}
				return err
			}
		}
...
// ContainerResponseRecordsItems0VolumesItems0Qos QoS information
//
...
// ContainerResponseRecordsItems0VolumesItems0QosPolicy When "min_throughput_iops", "min_throughput_mbps", "max_throughput_iops" or "max_throughput_mbps" attributes are specified, the storage object is assigned to an auto-generated QoS policy group. If the attributes are later modified, the auto-generated QoS policy-group attributes are modified. Attributes can be removed by specifying "0" and policy group by specifying "none". Upon deletion of the storage object or if the attributes are removed, then the QoS policy-group is also removed.
//
...
type ContainerResponseRecordsItems0VolumesItems0QosPolicy struct {
	...
	// links
	Links *ContainerResponseRecordsItems0VolumesItems0QosPolicyLinks `json:"_links,omitempty"`
...
func (m *ContainerResponseRecordsItems0VolumesItems0QosPolicy) validateMaxThroughputIops(formats strfmt.Registry) error {
...
func (m *ContainerResponseRecordsItems0VolumesItems0QosPolicy) validateMaxThroughputMbps(formats strfmt.Registry) error {
...
func (m *ContainerResponseRecordsItems0VolumesItems0QosPolicy) validateMinThroughputIops(formats strfmt.Registry) error {
...
func (m *ContainerResponseRecordsItems0VolumesItems0QosPolicy) validateMinThroughputMbps(formats strfmt.Registry) error {
...
// ContainerResponseRecordsItems0VolumesItems0QosPolicyLinks container response records items0 volumes items0 qos policy links
//
// swagger:model ContainerResponseRecordsItems0VolumesItems0QosPolicyLinks
type ContainerResponseRecordsItems0VolumesItems0QosPolicyLinks struct {

	// self
	Self *Href `json:"self,omitempty"`
}

// Validate validates this container response records items0 volumes items0 qos policy links
func (m *ContainerResponseRecordsItems0VolumesItems0QosPolicyLinks) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ContainerResponseRecordsItems0VolumesItems0QosPolicyLinks) validateSelf(formats strfmt.Registry) error {
	if swag.IsZero(m.Self) { // not required
		return nil
	}
...
// ContextValidate validate this container response records items0 volumes items0 qos policy links based on the context it is used
func (m *ContainerResponseRecordsItems0VolumesItems0QosPolicyLinks) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *ContainerResponseRecordsItems0VolumesItems0QosPolicyLinks) contextValidateSelf(ctx context.Context, formats strfmt.Registry) error {
...
// MarshalBinary interface implementation
func (m *ContainerResponseRecordsItems0VolumesItems0QosPolicyLinks) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
	return swag.WriteJSON(m)
...
// UnmarshalBinary interface implementation
func (m *ContainerResponseRecordsItems0VolumesItems0QosPolicyLinks) UnmarshalBinary(b []byte) error {
	var res ContainerResponseRecordsItems0VolumesItems0QosPolicyLinks
	if err := swag.ReadJSON(b, &res); err != nil {
		return err
	}
	*m = res
...
type ContainerResponseRecordsItems0VolumesItems0S3Bucket struct {
	...
	// access policies
	AccessPolicies *ContainerResponseRecordsItems0VolumesItems0S3BucketAccessPolicies `json:"access_policies,omitempty"`
	...
	SnapshotPolicyReference *ContainerResponseRecordsItems0VolumesItems0S3BucketSnapshotPolicyReference `json:"snapshot_policy_reference,omitempty"`
}
...
func (m *ContainerResponseRecordsItems0VolumesItems0S3Bucket) Validate(formats strfmt.Registry) error {
	...
	if err := m.validateSnapshotPolicyReference(formats); err != nil {
		res = append(res, err)
	}
...
func (m *ContainerResponseRecordsItems0VolumesItems0S3Bucket) validateAccessPolicies(formats strfmt.Registry) error {
	if swag.IsZero(m.AccessPolicies) { // not required
		return nil
	}

	if m.AccessPolicies != nil {
		if err := m.AccessPolicies.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("s3_bucket" + "." + "access_policies")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("s3_bucket" + "." + "access_policies")
			}
			return err
		}
	}
...
func (m *ContainerResponseRecordsItems0VolumesItems0S3Bucket) validateSnapshotPolicyReference(formats strfmt.Registry) error {
	if swag.IsZero(m.SnapshotPolicyReference) { // not required
		return nil
	}

	if m.SnapshotPolicyReference != nil {
		if err := m.SnapshotPolicyReference.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("s3_bucket" + "." + "snapshot_policy_reference")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("s3_bucket" + "." + "snapshot_policy_reference")
			}
			return err
		}
	}
...
func (m *ContainerResponseRecordsItems0VolumesItems0S3Bucket) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	...
	if err := m.contextValidateSnapshotPolicyReference(ctx, formats); err != nil {
		res = append(res, err)
	}
...
func (m *ContainerResponseRecordsItems0VolumesItems0S3Bucket) contextValidateAccessPolicies(ctx context.Context, formats strfmt.Registry) error {

	if m.AccessPolicies != nil {
		if err := m.AccessPolicies.ContextValidate(ctx, formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("s3_bucket" + "." + "access_policies")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("s3_bucket" + "." + "access_policies")
...
func (m *ContainerResponseRecordsItems0VolumesItems0S3Bucket) contextValidateSnapshotPolicyReference(ctx context.Context, formats strfmt.Registry) error {

	if m.SnapshotPolicyReference != nil {
		if err := m.SnapshotPolicyReference.ContextValidate(ctx, formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("s3_bucket" + "." + "snapshot_policy_reference")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("s3_bucket" + "." + "snapshot_policy_reference")
...
// ContainerResponseRecordsItems0VolumesItems0S3BucketAccessPolicies A policy is an object associated with a bucket. It defines resource (bucket, folder, or object) permissions. These policies are evaluated when an S3 user makes a request by executing a specific command. The user must be part of the principal (user or group) specified in the policy. Permissions in the policies determine whether the request is allowed or denied.
//
// swagger:model ContainerResponseRecordsItems0VolumesItems0S3BucketAccessPolicies
type ContainerResponseRecordsItems0VolumesItems0S3BucketAccessPolicies struct {

	// Specifies the bucket access policy statement.
	// Max Items: 10
	// Min Items: 0
	Statements []*ContainerResponseRecordsItems0VolumesItems0S3BucketAccessPoliciesStatementsItems0 `json:"statements"`
}

// Validate validates this container response records items0 volumes items0 s3 bucket access policies
func (m *ContainerResponseRecordsItems0VolumesItems0S3BucketAccessPolicies) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ContainerResponseRecordsItems0VolumesItems0S3BucketAccessPolicies) validateStatements(formats strfmt.Registry) error {
	...
	if err := validate.MinItems("s3_bucket"+"."+"access_policies"+"."+"statements", "body", iStatementsSize, 0); err != nil {
		return err
	}

	if err := validate.MaxItems("s3_bucket"+"."+"access_policies"+"."+"statements", "body", iStatementsSize, 10); err != nil {
		return err
	}
	...
	for i := 0; i < len(m.Statements); i++ {
		...
		if m.Statements[i] != nil {
			if err := m.Statements[i].Validate(formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					return ve.ValidateName("s3_bucket" + "." + "access_policies" + "." + "statements" + "." + strconv.Itoa(i))
				} else if ce, ok := err.(*errors.CompositeError); ok {
					return ce.ValidateName("s3_bucket" + "." + "access_policies" + "." + "statements" + "." + strconv.Itoa(i))
				}
				return err
			}
		}
...
// ContextValidate validate this container response records items0 volumes items0 s3 bucket access policies based on the context it is used
func (m *ContainerResponseRecordsItems0VolumesItems0S3BucketAccessPolicies) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *ContainerResponseRecordsItems0VolumesItems0S3BucketAccessPolicies) contextValidateStatements(ctx context.Context, formats strfmt.Registry) error {
...
// MarshalBinary interface implementation
func (m *ContainerResponseRecordsItems0VolumesItems0S3BucketAccessPolicies) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
	return swag.WriteJSON(m)
...
// UnmarshalBinary interface implementation
func (m *ContainerResponseRecordsItems0VolumesItems0S3BucketAccessPolicies) UnmarshalBinary(b []byte) error {
	var res ContainerResponseRecordsItems0VolumesItems0S3BucketAccessPolicies
	if err := swag.ReadJSON(b, &res); err != nil {
		return err
	}
	*m = res
...
// ContainerResponseRecordsItems0VolumesItems0S3BucketAccessPoliciesStatementsItems0 Specifies information about a single access permission.
//
// swagger:model ContainerResponseRecordsItems0VolumesItems0S3BucketAccessPoliciesStatementsItems0
type ContainerResponseRecordsItems0VolumesItems0S3BucketAccessPoliciesStatementsItems0 struct {
...
// Validate validates this container response records items0 volumes items0 s3 bucket access policies statements items0
func (m *ContainerResponseRecordsItems0VolumesItems0S3BucketAccessPoliciesStatementsItems0) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ContainerResponseRecordsItems0VolumesItems0S3BucketAccessPoliciesStatementsItems0) validateConditions(formats strfmt.Registry) error {
...
var containerResponseRecordsItems0VolumesItems0S3BucketAccessPoliciesStatementsItems0TypeEffectPropEnum []interface{}
...
func init() {
	...
	for _, v := range res {
		containerResponseRecordsItems0VolumesItems0S3BucketAccessPoliciesStatementsItems0TypeEffectPropEnum = append(containerResponseRecordsItems0VolumesItems0S3BucketAccessPoliciesStatementsItems0TypeEffectPropEnum, v)
	}
}

const (

	// ContainerResponseRecordsItems0VolumesItems0S3BucketAccessPoliciesStatementsItems0EffectAllow captures enum value "allow"
	ContainerResponseRecordsItems0VolumesItems0S3BucketAccessPoliciesStatementsItems0EffectAllow string = "allow"

	// ContainerResponseRecordsItems0VolumesItems0S3BucketAccessPoliciesStatementsItems0EffectDeny captures enum value "deny"
	ContainerResponseRecordsItems0VolumesItems0S3BucketAccessPoliciesStatementsItems0EffectDeny string = "deny"
)

// prop value enum
func (m *ContainerResponseRecordsItems0VolumesItems0S3BucketAccessPoliciesStatementsItems0) validateEffectEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, containerResponseRecordsItems0VolumesItems0S3BucketAccessPoliciesStatementsItems0TypeEffectPropEnum, true); err != nil {
		return err
	}
	return nil
}

func (m *ContainerResponseRecordsItems0VolumesItems0S3BucketAccessPoliciesStatementsItems0) validateEffect(formats strfmt.Registry) error {
...
func (m *ContainerResponseRecordsItems0VolumesItems0S3BucketAccessPoliciesStatementsItems0) validateSid(formats strfmt.Registry) error {
...
// ContextValidate validate this container response records items0 volumes items0 s3 bucket access policies statements items0 based on the context it is used
func (m *ContainerResponseRecordsItems0VolumesItems0S3BucketAccessPoliciesStatementsItems0) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *ContainerResponseRecordsItems0VolumesItems0S3BucketAccessPoliciesStatementsItems0) contextValidateConditions(ctx context.Context, formats strfmt.Registry) error {
...
// MarshalBinary interface implementation
func (m *ContainerResponseRecordsItems0VolumesItems0S3BucketAccessPoliciesStatementsItems0) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
	return swag.WriteJSON(m)
...
// UnmarshalBinary interface implementation
func (m *ContainerResponseRecordsItems0VolumesItems0S3BucketAccessPoliciesStatementsItems0) UnmarshalBinary(b []byte) error {
	var res ContainerResponseRecordsItems0VolumesItems0S3BucketAccessPoliciesStatementsItems0
	if err := swag.ReadJSON(b, &res); err != nil {
		return err
	}
	*m = res
...
// ContainerResponseRecordsItems0VolumesItems0S3BucketSnapshotPolicyReference This is a reference to the snapshot policy.
//
// swagger:model ContainerResponseRecordsItems0VolumesItems0S3BucketSnapshotPolicyReference
type ContainerResponseRecordsItems0VolumesItems0S3BucketSnapshotPolicyReference struct {

	// links
	Links *ContainerResponseRecordsItems0VolumesItems0S3BucketSnapshotPolicyReferenceLinks `json:"_links,omitempty"`
...
// Validate validates this container response records items0 volumes items0 s3 bucket snapshot policy reference
func (m *ContainerResponseRecordsItems0VolumesItems0S3BucketSnapshotPolicyReference) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ContainerResponseRecordsItems0VolumesItems0S3BucketSnapshotPolicyReference) validateLinks(formats strfmt.Registry) error {
	if swag.IsZero(m.Links) { // not required
		return nil
	}
	...
	if m.Links != nil {
		if err := m.Links.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("s3_bucket" + "." + "snapshot_policy_reference" + "." + "_links")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("s3_bucket" + "." + "snapshot_policy_reference" + "." + "_links")
			}
			return err
		}
	}
...
// ContextValidate validate this container response records items0 volumes items0 s3 bucket snapshot policy reference based on the context it is used
func (m *ContainerResponseRecordsItems0VolumesItems0S3BucketSnapshotPolicyReference) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *ContainerResponseRecordsItems0VolumesItems0S3BucketSnapshotPolicyReference) contextValidateLinks(ctx context.Context, formats strfmt.Registry) error {
...
// MarshalBinary interface implementation
func (m *ContainerResponseRecordsItems0VolumesItems0S3BucketSnapshotPolicyReference) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
	return swag.WriteJSON(m)
...
// UnmarshalBinary interface implementation
func (m *ContainerResponseRecordsItems0VolumesItems0S3BucketSnapshotPolicyReference) UnmarshalBinary(b []byte) error {
	var res ContainerResponseRecordsItems0VolumesItems0S3BucketSnapshotPolicyReference
	if err := swag.ReadJSON(b, &res); err != nil {
		return err
	}
	*m = res
...
// ContainerResponseRecordsItems0VolumesItems0S3BucketSnapshotPolicyReferenceLinks container response records items0 volumes items0 s3 bucket snapshot policy reference links
//
// swagger:model ContainerResponseRecordsItems0VolumesItems0S3BucketSnapshotPolicyReferenceLinks
type ContainerResponseRecordsItems0VolumesItems0S3BucketSnapshotPolicyReferenceLinks struct {

	// self
	Self *Href `json:"self,omitempty"`
}

// Validate validates this container response records items0 volumes items0 s3 bucket snapshot policy reference links
func (m *ContainerResponseRecordsItems0VolumesItems0S3BucketSnapshotPolicyReferenceLinks) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ContainerResponseRecordsItems0VolumesItems0S3BucketSnapshotPolicyReferenceLinks) validateSelf(formats strfmt.Registry) error {
	if swag.IsZero(m.Self) { // not required
		return nil
	}
	...
	if m.Self != nil {
		if err := m.Self.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("s3_bucket" + "." + "snapshot_policy_reference" + "." + "_links" + "." + "self")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("s3_bucket" + "." + "snapshot_policy_reference" + "." + "_links" + "." + "self")
			}
			return err
		}
	}
...
// ContextValidate validate this container response records items0 volumes items0 s3 bucket snapshot policy reference links based on the context it is used
func (m *ContainerResponseRecordsItems0VolumesItems0S3BucketSnapshotPolicyReferenceLinks) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *ContainerResponseRecordsItems0VolumesItems0S3BucketSnapshotPolicyReferenceLinks) contextValidateSelf(ctx context.Context, formats strfmt.Registry) error {
...
// MarshalBinary interface implementation
func (m *ContainerResponseRecordsItems0VolumesItems0S3BucketSnapshotPolicyReferenceLinks) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
	return swag.WriteJSON(m)
...
// UnmarshalBinary interface implementation
func (m *ContainerResponseRecordsItems0VolumesItems0S3BucketSnapshotPolicyReferenceLinks) UnmarshalBinary(b []byte) error {
	var res ContainerResponseRecordsItems0VolumesItems0S3BucketSnapshotPolicyReferenceLinks
	if err := swag.ReadJSON(b, &res); err != nil {
		return err
	}
	*m = res
