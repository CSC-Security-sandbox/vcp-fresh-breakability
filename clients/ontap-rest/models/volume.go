...
// prop value enum
func (m *VolumeInlineTiering) validateStorageClassEnum(path, location string, value string) error {
...
func (m *VolumeInlineTiering) validateStorageClass(formats strfmt.Registry) error {
