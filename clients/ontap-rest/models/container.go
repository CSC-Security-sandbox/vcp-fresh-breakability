...
// ContainerInlineVolumesInlineArrayItemInlineQos QoS information
//
...
// ContainerInlineVolumesInlineArrayItemInlineQosInlinePolicy When "min_throughput_iops", "min_throughput_mbps", "max_throughput_iops" or "max_throughput_mbps" attributes are specified, the storage object is assigned to an auto-generated QoS policy group. If the attributes are later modified, the auto-generated QoS policy-group attributes are modified. Attributes can be removed by specifying "0" and policy group by specifying "none". Upon deletion of the storage object or if the attributes are removed, then the QoS policy-group is also removed.
//
...
type ContainerInlineVolumesInlineArrayItemInlineQosInlinePolicy struct {
	...
	// links
	Links *ContainerInlineVolumesInlineArrayItemInlineQosInlinePolicyInlineLinks `json:"_links,omitempty"`
...
func (m *ContainerInlineVolumesInlineArrayItemInlineQosInlinePolicy) validateMaxThroughputIops(formats strfmt.Registry) error {
...
func (m *ContainerInlineVolumesInlineArrayItemInlineQosInlinePolicy) validateMaxThroughputMbps(formats strfmt.Registry) error {
...
func (m *ContainerInlineVolumesInlineArrayItemInlineQosInlinePolicy) validateMinThroughputIops(formats strfmt.Registry) error {
...
func (m *ContainerInlineVolumesInlineArrayItemInlineQosInlinePolicy) validateMinThroughputMbps(formats strfmt.Registry) error {
...
// ContainerInlineVolumesInlineArrayItemInlineQosInlinePolicyInlineLinks container inline volumes inline array item inline qos inline policy inline links
//
// swagger:model container_inline_volumes_inline_array_item_inline_qos_inline_policy_inline__links
type ContainerInlineVolumesInlineArrayItemInlineQosInlinePolicyInlineLinks struct {

	// self
	Self *Href `json:"self,omitempty"`
}

// Validate validates this container inline volumes inline array item inline qos inline policy inline links
func (m *ContainerInlineVolumesInlineArrayItemInlineQosInlinePolicyInlineLinks) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ContainerInlineVolumesInlineArrayItemInlineQosInlinePolicyInlineLinks) validateSelf(formats strfmt.Registry) error {
	if swag.IsZero(m.Self) { // not required
		return nil
	}
...
// ContextValidate validate this container inline volumes inline array item inline qos inline policy inline links based on the context it is used
func (m *ContainerInlineVolumesInlineArrayItemInlineQosInlinePolicyInlineLinks) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *ContainerInlineVolumesInlineArrayItemInlineQosInlinePolicyInlineLinks) contextValidateSelf(ctx context.Context, formats strfmt.Registry) error {
...
// MarshalBinary interface implementation
func (m *ContainerInlineVolumesInlineArrayItemInlineQosInlinePolicyInlineLinks) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
	return swag.WriteJSON(m)
...
// UnmarshalBinary interface implementation
func (m *ContainerInlineVolumesInlineArrayItemInlineQosInlinePolicyInlineLinks) UnmarshalBinary(b []byte) error {
	var res ContainerInlineVolumesInlineArrayItemInlineQosInlinePolicyInlineLinks
	if err := swag.ReadJSON(b, &res); err != nil {
		return err
	}
	*m = res
...
type ContainerInlineVolumesInlineArrayItemInlineS3Bucket struct {
	...
	// access policies
	AccessPolicies *ContainerInlineVolumesInlineArrayItemInlineS3BucketInlineAccessPolicies `json:"access_policies,omitempty"`
	...
	SnapshotPolicyReference *ContainerInlineVolumesInlineArrayItemInlineS3BucketInlineSnapshotPolicyReference `json:"snapshot_policy_reference,omitempty"`
}
...
func (m *ContainerInlineVolumesInlineArrayItemInlineS3Bucket) validateAccessPolicies(formats strfmt.Registry) error {
...
func (m *ContainerInlineVolumesInlineArrayItemInlineS3Bucket) validateSnapshotPolicyReference(formats strfmt.Registry) error {
...
func (m *ContainerInlineVolumesInlineArrayItemInlineS3Bucket) contextValidateAccessPolicies(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ContainerInlineVolumesInlineArrayItemInlineS3Bucket) contextValidateSnapshotPolicyReference(ctx context.Context, formats strfmt.Registry) error {
...
// ContainerInlineVolumesInlineArrayItemInlineS3BucketInlineAccessPolicies A policy is an object associated with a bucket. It defines resource (bucket, folder, or object) permissions. These policies are evaluated when an S3 user makes a request by executing a specific command. The user must be part of the principal (user or group) specified in the policy. Permissions in the policies determine whether the request is allowed or denied.
//
// swagger:model container_inline_volumes_inline_array_item_inline_s3_bucket_inline_access_policies
type ContainerInlineVolumesInlineArrayItemInlineS3BucketInlineAccessPolicies struct {

	// Specifies the bucket access policy statement.
	// Max Items: 10
	// Min Items: 0
	Statements []*ContainerVolumesItems0S3BucketAccessPoliciesStatementsItems0 `json:"statements"`
}

// Validate validates this container inline volumes inline array item inline s3 bucket inline access policies
func (m *ContainerInlineVolumesInlineArrayItemInlineS3BucketInlineAccessPolicies) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ContainerInlineVolumesInlineArrayItemInlineS3BucketInlineAccessPolicies) validateStatements(formats strfmt.Registry) error {
...
// ContextValidate validate this container inline volumes inline array item inline s3 bucket inline access policies based on the context it is used
func (m *ContainerInlineVolumesInlineArrayItemInlineS3BucketInlineAccessPolicies) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *ContainerInlineVolumesInlineArrayItemInlineS3BucketInlineAccessPolicies) contextValidateStatements(ctx context.Context, formats strfmt.Registry) error {
...
// MarshalBinary interface implementation
func (m *ContainerInlineVolumesInlineArrayItemInlineS3BucketInlineAccessPolicies) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
	return swag.WriteJSON(m)
...
// UnmarshalBinary interface implementation
func (m *ContainerInlineVolumesInlineArrayItemInlineS3BucketInlineAccessPolicies) UnmarshalBinary(b []byte) error {
	var res ContainerInlineVolumesInlineArrayItemInlineS3BucketInlineAccessPolicies
	if err := swag.ReadJSON(b, &res); err != nil {
		return err
	}
	*m = res
...
// ContainerVolumesItems0S3BucketAccessPoliciesStatementsItems0 Specifies information about a single access permission.
//
// swagger:model ContainerVolumesItems0S3BucketAccessPoliciesStatementsItems0
type ContainerVolumesItems0S3BucketAccessPoliciesStatementsItems0 struct {
...
// Validate validates this container volumes items0 s3 bucket access policies statements items0
func (m *ContainerVolumesItems0S3BucketAccessPoliciesStatementsItems0) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ContainerVolumesItems0S3BucketAccessPoliciesStatementsItems0) validateConditions(formats strfmt.Registry) error {
...
var containerVolumesItems0S3BucketAccessPoliciesStatementsItems0TypeEffectPropEnum []interface{}
...
func init() {
	...
	for _, v := range res {
		containerVolumesItems0S3BucketAccessPoliciesStatementsItems0TypeEffectPropEnum = append(containerVolumesItems0S3BucketAccessPoliciesStatementsItems0TypeEffectPropEnum, v)
	}
}

const (

	// ContainerVolumesItems0S3BucketAccessPoliciesStatementsItems0EffectAllow captures enum value "allow"
	ContainerVolumesItems0S3BucketAccessPoliciesStatementsItems0EffectAllow string = "allow"

	// ContainerVolumesItems0S3BucketAccessPoliciesStatementsItems0EffectDeny captures enum value "deny"
	ContainerVolumesItems0S3BucketAccessPoliciesStatementsItems0EffectDeny string = "deny"
)

// prop value enum
func (m *ContainerVolumesItems0S3BucketAccessPoliciesStatementsItems0) validateEffectEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, containerVolumesItems0S3BucketAccessPoliciesStatementsItems0TypeEffectPropEnum, true); err != nil {
		return err
	}
	return nil
}

func (m *ContainerVolumesItems0S3BucketAccessPoliciesStatementsItems0) validateEffect(formats strfmt.Registry) error {
...
func (m *ContainerVolumesItems0S3BucketAccessPoliciesStatementsItems0) validateSid(formats strfmt.Registry) error {
...
// ContextValidate validate this container volumes items0 s3 bucket access policies statements items0 based on the context it is used
func (m *ContainerVolumesItems0S3BucketAccessPoliciesStatementsItems0) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *ContainerVolumesItems0S3BucketAccessPoliciesStatementsItems0) contextValidateConditions(ctx context.Context, formats strfmt.Registry) error {
...
// MarshalBinary interface implementation
func (m *ContainerVolumesItems0S3BucketAccessPoliciesStatementsItems0) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
	return swag.WriteJSON(m)
...
// UnmarshalBinary interface implementation
func (m *ContainerVolumesItems0S3BucketAccessPoliciesStatementsItems0) UnmarshalBinary(b []byte) error {
	var res ContainerVolumesItems0S3BucketAccessPoliciesStatementsItems0
	if err := swag.ReadJSON(b, &res); err != nil {
		return err
	}
	*m = res
...
// ContainerInlineVolumesInlineArrayItemInlineS3BucketInlineSnapshotPolicyReference This is a reference to the snapshot policy.
//
// swagger:model container_inline_volumes_inline_array_item_inline_s3_bucket_inline_snapshot_policy_reference
type ContainerInlineVolumesInlineArrayItemInlineS3BucketInlineSnapshotPolicyReference struct {

	// links
	Links *ContainerInlineVolumesInlineArrayItemInlineS3BucketInlineSnapshotPolicyReferenceInlineLinks `json:"_links,omitempty"`
...
// Validate validates this container inline volumes inline array item inline s3 bucket inline snapshot policy reference
func (m *ContainerInlineVolumesInlineArrayItemInlineS3BucketInlineSnapshotPolicyReference) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ContainerInlineVolumesInlineArrayItemInlineS3BucketInlineSnapshotPolicyReference) validateLinks(formats strfmt.Registry) error {
	if swag.IsZero(m.Links) { // not required
		return nil
	}
...
// ContextValidate validate this container inline volumes inline array item inline s3 bucket inline snapshot policy reference based on the context it is used
func (m *ContainerInlineVolumesInlineArrayItemInlineS3BucketInlineSnapshotPolicyReference) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *ContainerInlineVolumesInlineArrayItemInlineS3BucketInlineSnapshotPolicyReference) contextValidateLinks(ctx context.Context, formats strfmt.Registry) error {
...
// MarshalBinary interface implementation
func (m *ContainerInlineVolumesInlineArrayItemInlineS3BucketInlineSnapshotPolicyReference) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
	return swag.WriteJSON(m)
...
// UnmarshalBinary interface implementation
func (m *ContainerInlineVolumesInlineArrayItemInlineS3BucketInlineSnapshotPolicyReference) UnmarshalBinary(b []byte) error {
	var res ContainerInlineVolumesInlineArrayItemInlineS3BucketInlineSnapshotPolicyReference
	if err := swag.ReadJSON(b, &res); err != nil {
		return err
	}
	*m = res
...
// ContainerInlineVolumesInlineArrayItemInlineS3BucketInlineSnapshotPolicyReferenceInlineLinks container inline volumes inline array item inline s3 bucket inline snapshot policy reference inline links
//
// swagger:model container_inline_volumes_inline_array_item_inline_s3_bucket_inline_snapshot_policy_reference_inline__links
type ContainerInlineVolumesInlineArrayItemInlineS3BucketInlineSnapshotPolicyReferenceInlineLinks struct {

	// self
	Self *Href `json:"self,omitempty"`
}

// Validate validates this container inline volumes inline array item inline s3 bucket inline snapshot policy reference inline links
func (m *ContainerInlineVolumesInlineArrayItemInlineS3BucketInlineSnapshotPolicyReferenceInlineLinks) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ContainerInlineVolumesInlineArrayItemInlineS3BucketInlineSnapshotPolicyReferenceInlineLinks) validateSelf(formats strfmt.Registry) error {
	if swag.IsZero(m.Self) { // not required
		return nil
	}
...
// ContextValidate validate this container inline volumes inline array item inline s3 bucket inline snapshot policy reference inline links based on the context it is used
func (m *ContainerInlineVolumesInlineArrayItemInlineS3BucketInlineSnapshotPolicyReferenceInlineLinks) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *ContainerInlineVolumesInlineArrayItemInlineS3BucketInlineSnapshotPolicyReferenceInlineLinks) contextValidateSelf(ctx context.Context, formats strfmt.Registry) error {
...
// MarshalBinary interface implementation
func (m *ContainerInlineVolumesInlineArrayItemInlineS3BucketInlineSnapshotPolicyReferenceInlineLinks) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
	return swag.WriteJSON(m)
...
// UnmarshalBinary interface implementation
func (m *ContainerInlineVolumesInlineArrayItemInlineS3BucketInlineSnapshotPolicyReferenceInlineLinks) UnmarshalBinary(b []byte) error {
	var res ContainerInlineVolumesInlineArrayItemInlineS3BucketInlineSnapshotPolicyReferenceInlineLinks
	if err := swag.ReadJSON(b, &res); err != nil {
		return err
	}
	*m = res
