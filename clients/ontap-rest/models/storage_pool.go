		...
		if m.Disks[i] != nil {
			if err := m.Disks[i].Validate(formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					...
					return ce.ValidateName("capacity" + "." + "disks" + "." + strconv.Itoa(i))
				}
				return err
			}
		}
		...
		if m.SpareAllocationUnits[i] != nil {
			if err := m.SpareAllocationUnits[i].Validate(formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					...
					return ce.ValidateName("capacity" + "." + "spare_allocation_units" + "." + strconv.Itoa(i))
				}
				return err
			}
		}
		...
		if m.UsedAllocationUnits[i] != nil {
			if err := m.UsedAllocationUnits[i].Validate(formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					...
					return ce.ValidateName("capacity" + "." + "used_allocation_units" + "." + strconv.Itoa(i))
				}
				return err
			}
		}
	...
	if m.UnhealthyReason != nil {
		if err := m.UnhealthyReason.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("health" + "." + "unhealthy_reason")
			}
			return err
		}
	}
