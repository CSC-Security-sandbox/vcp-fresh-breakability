...
var accountAuthenticationMethodsItemsEnum []interface{}
...
func init() {
	...
	for _, v := range res {
		accountAuthenticationMethodsItemsEnum = append(accountAuthenticationMethodsItemsEnum, v)
	}
}

func (m *Account) validateAuthenticationMethodsItemsEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, accountAuthenticationMethodsItemsEnum, true); err != nil {
		return err
	}
	return nil
}

func (m *Account) validateAuthenticationMethods(formats strfmt.Registry) error {
