...
func (m *TopMetricsDirectoryInlineIops) contextValidateTotal(ctx context.Context, formats strfmt.Registry) error {
...
type TopMetricsDirectoryInlineThroughput struct {
	...
	// Average number of read and write bytes received, per second.
	// Example: 20
	// Read Only: true
	Total *int64 `json:"total,omitempty"`
...
func (m *TopMetricsDirectoryInlineThroughput) contextValidateTotal(ctx context.Context, formats strfmt.Registry) error {

	if err := validate.ReadOnly(ctx, "throughput"+"."+"total", "body", m.Total); err != nil {
		return err
	}
