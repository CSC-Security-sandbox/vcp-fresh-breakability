	...
	if m.ToBeApplied != nil {
		if err := m.ToBeApplied.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("to_be_applied")
			}
			return err
		}
	}
		...
		if m.AccessPolicies[i] != nil {
			if err := m.AccessPolicies[i].Validate(formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					...
					return ce.ValidateName("to_be_applied" + "." + "access_policies" + "." + strconv.Itoa(i))
				}
				return err
			}
		}
		...
		if m.AccessRules[i] != nil {
			if err := m.AccessRules[i].Validate(formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					...
					return ce.ValidateName("to_be_applied" + "." + "access_rules" + "." + strconv.Itoa(i))
				}
				return err
			}
		}
		...
		if m.Objects[i] != nil {
			if err := m.Objects[i].Validate(formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					...
					return ce.ValidateName("to_be_applied" + "." + "objects" + "." + strconv.Itoa(i))
				}
				return err
			}
		}
		...
		if m.RestrictedGroups[i] != nil {
			if err := m.RestrictedGroups[i].Validate(formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					...
					return ce.ValidateName("to_be_applied" + "." + "restricted_groups" + "." + strconv.Itoa(i))
				}
				return err
			}
		}
