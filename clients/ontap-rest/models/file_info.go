...
type FileInfo struct {
	...
	FileInfoInlineHoles []*FileHole `json:"holes,omitempty"`
...
func (m *FileInfo) Validate(formats strfmt.Registry) error {
	...
	if err := m.validateFileInfoInlineHoles(formats); err != nil {
		res = append(res, err)
	}
...
func (m *FileInfo) validateFileInfoInlineHoles(formats strfmt.Registry) error {
	if swag.IsZero(m.FileInfoInlineHoles) { // not required
		return nil
	}
	...
	for i := 0; i < len(m.FileInfoInlineHoles); i++ {
		...
		if m.FileInfoInlineHoles[i] != nil {
			if err := m.FileInfoInlineHoles[i].Validate(formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					return ve.ValidateName("holes" + "." + strconv.Itoa(i))
				} else if ce, ok := err.(*errors.CompositeError); ok {
					return ce.ValidateName("holes" + "." + strconv.Itoa(i))
				}
				return err
			}
		}
...
func (m *FileInfo) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	...
	if err := m.contextValidateFileInfoInlineHoles(ctx, formats); err != nil {
		res = append(res, err)
	}
...
func (m *FileInfo) contextValidateFileInfoInlineHoles(ctx context.Context, formats strfmt.Registry) error {
