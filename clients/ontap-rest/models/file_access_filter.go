...
// FileAccessFilter ONTAP allows the creation of filters for file access tracing for both CIFS and NFS. These filters have protocols, path, username, and client IP based on which file access operations are logged.
//
