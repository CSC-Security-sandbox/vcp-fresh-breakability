	...
	if m.ProtocolEndpoint != nil {
		if err := m.ProtocolEndpoint.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("protocol_endpoint")
			}
			return err
		}
	}
	...
	if m.Links != nil {
		if err := m.Links.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("protocol_endpoint" + "." + "_links")
			}
			return err
		}
	}
	...
	if m.Self != nil {
		if err := m.Self.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("protocol_endpoint" + "." + "_links" + "." + "self")
			}
			return err
		}
	}
	...
	if m.Links != nil {
		if err := m.Links.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("vvol" + "." + "_links")
			}
			return err
		}
	}
	...
	if m.Self != nil {
		if err := m.Self.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("vvol" + "." + "_links" + "." + "self")
			}
			return err
		}
	}
