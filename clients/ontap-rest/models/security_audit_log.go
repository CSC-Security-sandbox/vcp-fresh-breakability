...
type SecurityAuditLog struct {
	...
	// If present, the traceid that was included in the header of the request.
	// Read Only: true
...
func (m *SecurityAuditLog) contextValidateTraceid(ctx context.Context, formats strfmt.Registry) error {

	if err := validate.ReadOnly(ctx, "traceid", "body", m.Traceid); err != nil {
		return err
	}
