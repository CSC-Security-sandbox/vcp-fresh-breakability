...
type Lun struct {
	...
	// * `lun_maps`
	// * `comment`
	// <p>POST is asynchronous in these cases:
...
type LunInlineLocation struct {
	...
	// aggregate
	Aggregate *LunInlineLocationInlineAggregate `json:"aggregate,omitempty"`
...
func (m *LunInlineLocation) validateAggregate(formats strfmt.Registry) error {
	...
	if m.Aggregate != nil {
		if err := m.Aggregate.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("location" + "." + "aggregate")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("location" + "." + "aggregate")
			}
			return err
		}
	}
...
func (m *LunInlineLocation) contextValidateAggregate(ctx context.Context, formats strfmt.Registry) error {
...
// LunInlineLocationInlineAggregate Aggregate
//
// swagger:model lun_inline_location_inline_aggregate
type LunInlineLocationInlineAggregate struct {

	// links
	Links *LunInlineLocationInlineAggregateInlineLinks `json:"_links,omitempty"`
...
// Validate validates this lun inline location inline aggregate
func (m *LunInlineLocationInlineAggregate) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *LunInlineLocationInlineAggregate) validateLinks(formats strfmt.Registry) error {
	if swag.IsZero(m.Links) { // not required
		return nil
	}
	...
	if m.Links != nil {
		if err := m.Links.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("location" + "." + "aggregate" + "." + "_links")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("location" + "." + "aggregate" + "." + "_links")
			}
			return err
		}
	}
...
// ContextValidate validate this lun inline location inline aggregate based on the context it is used
func (m *LunInlineLocationInlineAggregate) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *LunInlineLocationInlineAggregate) contextValidateLinks(ctx context.Context, formats strfmt.Registry) error {
...
// MarshalBinary interface implementation
func (m *LunInlineLocationInlineAggregate) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
	return swag.WriteJSON(m)
...
// UnmarshalBinary interface implementation
func (m *LunInlineLocationInlineAggregate) UnmarshalBinary(b []byte) error {
	var res LunInlineLocationInlineAggregate
	if err := swag.ReadJSON(b, &res); err != nil {
		return err
	}
	*m = res
...
// LunInlineLocationInlineAggregateInlineLinks lun inline location inline aggregate inline links
//
// swagger:model lun_inline_location_inline_aggregate_inline__links
type LunInlineLocationInlineAggregateInlineLinks struct {

	// self
	Self *Href `json:"self,omitempty"`
}

// Validate validates this lun inline location inline aggregate inline links
func (m *LunInlineLocationInlineAggregateInlineLinks) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *LunInlineLocationInlineAggregateInlineLinks) validateSelf(formats strfmt.Registry) error {
	if swag.IsZero(m.Self) { // not required
		return nil
	}
	...
	if m.Self != nil {
		if err := m.Self.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("location" + "." + "aggregate" + "." + "_links" + "." + "self")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("location" + "." + "aggregate" + "." + "_links" + "." + "self")
			}
			return err
		}
	}
...
// ContextValidate validate this lun inline location inline aggregate inline links based on the context it is used
func (m *LunInlineLocationInlineAggregateInlineLinks) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *LunInlineLocationInlineAggregateInlineLinks) contextValidateSelf(ctx context.Context, formats strfmt.Registry) error {
...
// MarshalBinary interface implementation
func (m *LunInlineLocationInlineAggregateInlineLinks) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
	return swag.WriteJSON(m)
...
// UnmarshalBinary interface implementation
func (m *LunInlineLocationInlineAggregateInlineLinks) UnmarshalBinary(b []byte) error {
	var res LunInlineLocationInlineAggregateInlineLinks
	if err := swag.ReadJSON(b, &res); err != nil {
		return err
	}
	*m = res
