...
var (
    ...
    vsaImageName                                         = env.GetString("VSA_IMAGE_NAME", "x-9-18-1p1x5")
    mediatorImage                                        = env.GetString("VSA_MEDIATOR_IMAGE_NAME", "cvo-mediator-x-9-18-1p1x5")    
    vsaFilesImageName                                    = env.GetString("VSA_FILES_IMAGE_NAME", "x-9-18-1p1x5")
	filesMediatorImage                                   = env.GetString("VSA_FILES_MEDIATOR_IMAGE_NAME", "cvo-mediator-x-9-18-1p1x5")
