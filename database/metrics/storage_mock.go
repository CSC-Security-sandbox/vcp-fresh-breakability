...
func (_m *MockStorage) DeleteJobsOlderThan(ctx context.Context, olderThan time.Time) (int64, error) {
	ret := _m.Called(ctx, olderThan)
...
// MockStorage_DeleteJobsOlderThan_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'DeleteJobsOlderThan'
type MockStorage_DeleteJobsOlderThan_Call struct {
	*mock.Call
}
...
//   - ctx context.Context
//   - olderThan time.Time
func (_e *MockStorage_Expecter) DeleteJobsOlderThan(ctx interface{}, olderThan interface{}) *MockStorage_DeleteJobsOlderThan_Call {
	return &MockStorage_DeleteJobsOlderThan_Call{Call: _e.mock.On("DeleteJobsOlderThan", ctx, olderThan)}
}

func (_c *MockStorage_DeleteJobsOlderThan_Call) Run(run func(ctx context.Context, olderThan time.Time)) *MockStorage_DeleteJobsOlderThan_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(time.Time))
	})
	return _c
...
func (_c *MockStorage_DeleteJobsOlderThan_Call) Return(_a0 int64, _a1 error) *MockStorage_DeleteJobsOlderThan_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockStorage_DeleteJobsOlderThan_Call) RunAndReturn(run func(context.Context, time.Time) (int64, error)) *MockStorage_DeleteJobsOlderThan_Call {
	_c.Call.Return(run)
	return _c
}
...
// MockStorage_GetHydratedMetricsWithPagination_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'GetHydratedMetricsWithPagination'
type MockStorage_GetHydratedMetricsWithPagination_Call struct {
	*mock.Call
}
...
//   - conditions [][]interface{}
//   - pagination *utils.Pagination
func (_e *MockStorage_Expecter) GetHydratedMetricsWithPagination(ctx interface{}, conditions interface{}, pagination interface{}) *MockStorage_GetHydratedMetricsWithPagination_Call {
	return &MockStorage_GetHydratedMetricsWithPagination_Call{Call: _e.mock.On("GetHydratedMetricsWithPagination", ctx, conditions, pagination)}
}

func (_c *MockStorage_GetHydratedMetricsWithPagination_Call) Run(run func(ctx context.Context, conditions [][]interface{}, pagination *utils.Pagination)) *MockStorage_GetHydratedMetricsWithPagination_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].([][]interface{}), args[2].(*utils.Pagination))
	})
	return _c
...
func (_c *MockStorage_GetHydratedMetricsWithPagination_Call) Return(_a0 []datamodel.HydratedMetrics, _a1 error) *MockStorage_GetHydratedMetricsWithPagination_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockStorage_GetHydratedMetricsWithPagination_Call) RunAndReturn(run func(context.Context, [][]interface{}, *utils.Pagination) ([]datamodel.HydratedMetrics, error)) *MockStorage_GetHydratedMetricsWithPagination_Call {
	_c.Call.Return(run)
	return _c
}
