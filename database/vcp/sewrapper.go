...
func (re *retryEngine) ListPoolsWithFilterAndPaginationOrderedByUUID(ctx context.Context, filter *dbutils.Filter, pagination *dbutils.Pagination) ([]*datamodel.PoolView, error) {
	...
	err := retry.Do(func(attempt int) (bool, error) {
		var err error
		var0, err = re.dataStore.ListPoolsWithFilterAndPaginationOrderedByUUID(ctx, filter, pagination)
		if err != nil {
			re.logError("ListPoolsWithFilterAndPaginationOrderedByUUID", err)
			if !dbutils.IsTransientErr(err) {
				return false, err
			}
		}
...
func (re *retryEngine) ListAllTpProjects(ctx context.Context) ([]string, error) {
	var var0 []string
	err := retry.Do(func(attempt int) (bool, error) {
		var err error
		var0, err = re.dataStore.ListAllTpProjects(ctx)
		if err != nil {
			re.logError("ListAllTpProjects", err)
			if !dbutils.IsTransientErr(err) {
				return false, err
			}
		}
...
func (re *retryEngine) GetVolumesByVolumePerformanceGroupID(ctx context.Context, vpgID int64) ([]*datamodel.Volume, error) {
	...
	err := retry.Do(func(attempt int) (bool, error) {
		var err error
		var0, err = re.dataStore.GetVolumesByVolumePerformanceGroupID(ctx, vpgID)
		if err != nil {
			re.logError("GetVolumesByVolumePerformanceGroupID", err)
			if !dbutils.IsTransientErr(err) {
				return false, err
			}
		}
...
func (re *retryEngine) DereferenceVPGFromDeletedVolumes(ctx context.Context, vpgID int64) error {
	err := retry.Do(func(attempt int) (bool, error) {
		var err error
		err = re.dataStore.DereferenceVPGFromDeletedVolumes(ctx, vpgID)
		if err != nil {
			re.logError("DereferenceVPGFromDeletedVolumes", err)
			if !dbutils.IsTransientErr(err) {
				return false, err
			}
		}
...
func (re *retryEngine) HardDeleteVolumePerformanceGroup(ctx context.Context, vpg *datamodel.VolumePerformanceGroup) error {
	err := retry.Do(func(attempt int) (bool, error) {
		var err error
		err = re.dataStore.HardDeleteVolumePerformanceGroup(ctx, vpg)
		if err != nil {
			re.logError("HardDeleteVolumePerformanceGroup", err)
			if !dbutils.IsTransientErr(err) {
				return false, err
			}
		}
...
func (re *retryEngine) GetVolumePerformanceGroupByID(ctx context.Context, id int64) (*datamodel.VolumePerformanceGroup, error) {
	var var0 *datamodel.VolumePerformanceGroup
	err := retry.Do(func(attempt int) (bool, error) {
		var err error
		var0, err = re.dataStore.GetVolumePerformanceGroupByID(ctx, id)
		if err != nil {
			re.logError("GetVolumePerformanceGroupByID", err)
			if !dbutils.IsTransientErr(err) {
				return false, err
			}
		}
...
func (re *retryEngine) GetExpertModeVolumeByExternalUUID(ctx context.Context, volumeUUID string) (*datamodel.ExpertModeVolumes, error) {
	var var0 *datamodel.ExpertModeVolumes
	err := retry.Do(func(attempt int) (bool, error) {
		var err error
		var0, err = re.dataStore.GetExpertModeVolumeByExternalUUID(ctx, volumeUUID)
		if err != nil {
			re.logError("GetExpertModeVolumeByExternalUUID", err)
			if !dbutils.IsTransientErr(err) {
				return false, err
			}
		}
...
func (re *retryEngine) DeleteExpertModeVolume(ctx context.Context, volumeUUID string) error {
	err := retry.Do(func(attempt int) (bool, error) {
		var err error
		err = re.dataStore.DeleteExpertModeVolume(ctx, volumeUUID)
		if err != nil {
			re.logError("DeleteExpertModeVolume", err)
			if !dbutils.IsTransientErr(err) {
				return false, err
			}
		}
...
func (re *retryEngine) UpdateExpertModeVolumeDataProtection(ctx context.Context, expertModeVolume *datamodel.ExpertModeVolumes) error {
	err := retry.Do(func(attempt int) (bool, error) {
		var err error
		err = re.dataStore.UpdateExpertModeVolumeDataProtection(ctx, expertModeVolume)
		if err != nil {
			re.logError("UpdateExpertModeVolumeDataProtection", err)
			if !dbutils.IsTransientErr(err) {
				return false, err
			}
		}
...
func (re *retryEngine) GetEligibleExpertModeVolumes(ctx context.Context, conditions [][]interface{}, pagination *dbutils.Pagination) ([]*datamodel.ExpertModeVolumes, error) {
	...
	err := retry.Do(func(attempt int) (bool, error) {
		var err error
		var0, err = re.dataStore.GetEligibleExpertModeVolumes(ctx, conditions, pagination)
		if err != nil {
			re.logError("GetEligibleExpertModeVolumes", err)
			if !dbutils.IsTransientErr(err) {
				return false, err
			}
		}
