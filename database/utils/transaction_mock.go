...
func (_m *MockTransaction) GORM() *gorm.DB {
	ret := _m.Called()
...
// MockTransaction_GORM_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'GORM'
type MockTransaction_GORM_Call struct {
	*mock.Call
}

// GORM is a helper method to define mock.On call
func (_e *MockTransaction_Expecter) GORM() *MockTransaction_GORM_Call {
	return &MockTransaction_GORM_Call{Call: _e.mock.On("GORM")}
}

func (_c *MockTransaction_GORM_Call) Run(run func()) *MockTransaction_GORM_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run()
	})
	return _c
...
func (_c *MockTransaction_GORM_Call) Return(_a0 *gorm.DB) *MockTransaction_GORM_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockTransaction_GORM_Call) RunAndReturn(run func() *gorm.DB) *MockTransaction_GORM_Call {
	_c.Call.Return(run)
	return _c
}
