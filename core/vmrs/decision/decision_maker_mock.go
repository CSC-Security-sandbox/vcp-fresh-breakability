...
import (
	...
	vlm_config "netapp.com/vsa/lifecycle-manager/pkg/vlmconfig"
)
...
func (m *DecisionMakerMock) FindOptimalVMs(config *vmrs.VMRSConfig, customerRequest vmrs.CustomerRequestedPerformance, currentConfig *vlm_config.VLMConfig) (*vmrs.Decision, error) {
