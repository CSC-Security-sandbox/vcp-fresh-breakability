...
func (f *temporalCCFEPoolFetcher) FetchCCFEPools(ctx context.Context, projectID string, locations []string) (map[string][]resourcescope.CachedPool, error) {
	if f.client == nil {
	...
	var poolsByLocation map[string][]resourcescope.CachedPool
