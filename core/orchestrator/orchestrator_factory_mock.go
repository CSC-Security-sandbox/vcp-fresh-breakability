...
// DeleteReplication provides a mock function with given fields: ctx, params
func (_m *MockOrchestratorFactory) DeleteReplication(ctx context.Context, params *common.DeleteReplicationParams) (*models.VolumeReplication, string, error) {
	ret := _m.Called(ctx, params)
	...
	var r1 string
	var r2 error
	if rf, ok := ret.Get(0).(func(context.Context, *common.DeleteReplicationParams) (*models.VolumeReplication, string, error)); ok {
		return rf(ctx, params)
	}
	if rf, ok := ret.Get(0).(func(context.Context, *common.DeleteReplicationParams) *models.VolumeReplication); ok {
		r0 = rf(ctx, params)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*models.VolumeReplication)
	...
	if rf, ok := ret.Get(1).(func(context.Context, *common.DeleteReplicationParams) string); ok {
		r1 = rf(ctx, params)
	} else {
		r1 = ret.Get(1).(string)
	}

	if rf, ok := ret.Get(2).(func(context.Context, *common.DeleteReplicationParams) error); ok {
		r2 = rf(ctx, params)
	} else {
		r2 = ret.Error(2)
	}
...
func (_e *MockOrchestratorFactory_Expecter) DeleteReplication(ctx interface{}, params interface{}) *MockOrchestratorFactory_DeleteReplication_Call {
	return &MockOrchestratorFactory_DeleteReplication_Call{Call: _e.mock.On("DeleteReplication", ctx, params)}
}

func (_c *MockOrchestratorFactory_DeleteReplication_Call) Run(run func(ctx context.Context, params *common.DeleteReplicationParams)) *MockOrchestratorFactory_DeleteReplication_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(*common.DeleteReplicationParams))
	})
	return _c
}
...
func (_c *MockOrchestratorFactory_DeleteReplication_Call) RunAndReturn(run func(context.Context, *common.DeleteReplicationParams) (*models.VolumeReplication, string, error)) *MockOrchestratorFactory_DeleteReplication_Call {
	_c.Call.Return(run)
	return _c
}
