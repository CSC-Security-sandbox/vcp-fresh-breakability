...
func (o *Orchestrator) CreateJob(ctx context.Context, params *common.CreateJobParams) (*datamodel.Job, error) {
	if params == nil {
...
func (o *Orchestrator) UpdateJobStatus(ctx context.Context, jobID string, status string, trackingID int, errorDetails string) error {
...
func (o *Orchestrator) UpdateJobAttributes(ctx context.Context, jobID string, jobAttributes *datamodel.JobAttributes) error {
