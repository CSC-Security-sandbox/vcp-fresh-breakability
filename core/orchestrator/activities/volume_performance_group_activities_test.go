...
func TestRestoreAutoGeneratedVPG_CreateVPGInDBError_ReturnsError(t *testing.T) {
	...
	mockStorage.On("CreateVolumePerformanceGroup", mock.Anything, mock.MatchedBy(func(v *datamodel.VolumePerformanceGroup) bool {
		return v.OntapQosPolicyID == "policy-uuid"
	})).Return(nil, errors.New("create vpg failed"))
