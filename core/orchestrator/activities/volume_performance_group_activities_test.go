...
func TestCreateVPGInDB_Success(t *testing.T) {
	...
	mockStorage.On("CreateVolumePerformanceGroupWithCap", mock.Anything, vpg, mock.Anything).Return(expectedVPG, nil)
...
func TestCreateVPGInDB_Failure(t *testing.T) {
	...
	mockStorage.On("CreateVolumePerformanceGroupWithCap", mock.Anything, vpg, mock.Anything).Return(nil, expectedError)
...
func TestRestoreAutoGeneratedVPG_CreateVPGInDBError_ReturnsError(t *testing.T) {
	...
	vpg := &datamodel.VolumePerformanceGroup{
		...
		ThroughputMibps: 100, Iops: 200, AllocationType: models.AllocationTypeShared,
	}
	...
	}), mock.Anything).Return(nil, errors.New("create vpg failed"))
