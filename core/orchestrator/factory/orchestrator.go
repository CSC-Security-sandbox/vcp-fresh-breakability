...
type OrchestratorFactory interface {
	...
	GetNodesByPoolUUID(ctx context.Context, poolUUID string) ([]*datamodel.Node, error)
	...
	GetBackupsByUUIDs(ctx context.Context, backupUUIDs []string) ([]*datamodel.Backup, error)
	...
	UpdateRbacForPoolById(ctx context.Context, poolId string) (string, error)
