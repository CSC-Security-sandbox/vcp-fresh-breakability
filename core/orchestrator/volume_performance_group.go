...
func (o *Orchestrator) UpdateVolumePerformanceGroup(ctx context.Context, params *commonparams.UpdateVolumePerformanceGroupParams) (*models.VolumePerformanceGroup, string, error) {
	logger := util.GetLogger(ctx)
	se := o.storage
