...
func TestReplicationDeleteWorkflow(t *testing.T) {
	t.Run("TestReplicationDeleteWorkflow_Success", func(tt *testing.T) {
		...
		env.RegisterActivity(resumeReplicationActivity.UpdateReplicationRecordOnSource)
		env.RegisterActivity(resumeReplicationActivity.UpdateReplicationRecordOnDestination)
		...
		env.RegisterActivity(resumeReplicationActivity.UpdateReplicationOnDestinationToErrorState)
