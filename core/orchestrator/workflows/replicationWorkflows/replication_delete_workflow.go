...
func ReplicationDeleteWorkflow(ctx workflow.Context, params *commonparams.DeleteReplicationParams, event *replication.DeleteReplicationEvent) (*vsa.VolumeReplication, error) {
	...
	if err != nil {
		logger.Info("Delete Replication workflow run executed with error", "error", err)
	}
	return nil, err
}
...
func (wf *replicationDeleteWorkflow) Run(ctx workflow.Context, args ...interface{}) (interface{}, error) {
