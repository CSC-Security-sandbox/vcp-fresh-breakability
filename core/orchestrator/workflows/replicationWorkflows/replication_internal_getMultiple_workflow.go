...
func GetMultipleReplicationsInternalWorkflow(ctx workflow.Context, params *common.ReplicationInternalGetMultipleParams) error {
	...
	_, err = repWf.Run(ctx, params)
	if err != nil {
		logger.Info("Internal Volume Replication GetMultiple workflow run executed with error", "error", err)
	}
	return err
}
...
func (wf *replicationInternalGetMultipleWorkflow) Run(ctx workflow.Context, args ...interface{}) (interface{}, error) {
