...
func TestUpdatePoolWorkflow_QosTypeAutoToManual_RunsTransitionAndSucceeds(t *testing.T) {
	...
	env.OnActivity("GetPoolVolumesForQosTransition", mock.Anything, mock.Anything).Return([]*datamodel.Volume{}, nil)
	env.OnActivity("UpdatePoolFields", mock.Anything, mock.Anything, mock.Anything).Return(nil)
...
func TestUpdatePoolWorkflow_QosTypeAutoToManual_WithMultipleVolumes_Succeeds(t *testing.T) {
	...
	env.OnActivity("GetPoolVolumesForQosTransition", mock.Anything, mock.Anything).Return(volumes, nil)
...
// with 0 volumes: GetPoolVolumesForQosTransition empty, ListVolumePerformanceGroupsByPoolID empty, delete transition-named policy, Apply QPG to vserver, update pool.
...
// when the workflow fails after creating the converted VPG (e.g. GetPoolVolumesForQosTransition or first Assign fails),
...
func TestUpdatePoolWorkflow_QosTypeAutoToManual_FailAfterCreateVPG_RollbackReappliesQPG(t *testing.T) {
	...
	env.OnActivity("GetPoolVolumesForQosTransition", mock.Anything, mock.Anything).Return(nil, errors.New("get volumes failed"))
