...
func SetupTestDB() (*gorm.DB, error) {
	...
	err = db.AutoMigrate(&datamodel.Pool{}, &datamodel.Volume{}, &datamodel.VolumeReplication{}, &datamodel.Account{}, &datamodel.Svm{}, &datamodel.Node{}, &datamodel.Lif{}, &datamodel.Job{})
	if err != nil {
		return nil, err
	}
