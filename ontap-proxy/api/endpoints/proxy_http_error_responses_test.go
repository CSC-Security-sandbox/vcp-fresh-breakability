	...
	mappers := []wrappedMapper{
		{
			...
			call: func(ctx context.Context, err error) (any, bool) { r, ok := snaplockFileDeleteResFromProxyHTTP(ctx, err); return r, ok },
			explicitTypes: map[int]any{
		...
		},
		{
			...
			call: func(ctx context.Context, err error) (any, bool) { r, ok := v1PrivateCliResFromProxyHTTP(ctx, err); return r, ok },
			explicitTypes: map[int]any{
		...
		},
		{
			...
			call: func(ctx context.Context, err error) (any, bool) { r, ok := v1ListEventRetentionPoliciesResFromProxyHTTP(ctx, err); return r, ok },
			explicitTypes: map[int]any{
		...
		},
		{
			...
			call: func(ctx context.Context, err error) (any, bool) { r, ok := v1CreateEventRetentionPolicyResFromProxyHTTP(ctx, err); return r, ok },
			explicitTypes: map[int]any{
		...
		},
		{
			...
			call: func(ctx context.Context, err error) (any, bool) { r, ok := v1GetEventRetentionPolicyResFromProxyHTTP(ctx, err); return r, ok },
			explicitTypes: map[int]any{
		...
		},
		{
			...
			call: func(ctx context.Context, err error) (any, bool) { r, ok := v1UpdateEventRetentionPolicyResFromProxyHTTP(ctx, err); return r, ok },
			explicitTypes: map[int]any{
		...
		},
		{
			...
			call: func(ctx context.Context, err error) (any, bool) { r, ok := v1DeleteEventRetentionPolicyResFromProxyHTTP(ctx, err); return r, ok },
			explicitTypes: map[int]any{
		...
		},
		{
			...
			call: func(ctx context.Context, err error) (any, bool) { r, ok := v1ListEventRetentionOperationsResFromProxyHTTP(ctx, err); return r, ok },
			explicitTypes: map[int]any{
		...
		},
		{
			...
			call: func(ctx context.Context, err error) (any, bool) { r, ok := v1CreateEventRetentionOperationResFromProxyHTTP(ctx, err); return r, ok },
			explicitTypes: map[int]any{
		...
		},
		{
			...
			call: func(ctx context.Context, err error) (any, bool) { r, ok := v1GetEventRetentionOperationResFromProxyHTTP(ctx, err); return r, ok },
			explicitTypes: map[int]any{
		...
		},
		{
			...
			call: func(ctx context.Context, err error) (any, bool) { r, ok := v1AbortEventRetentionOperationResFromProxyHTTP(ctx, err); return r, ok },
			explicitTypes: map[int]any{
		...
		},
		{
			...
			call: func(ctx context.Context, err error) (any, bool) { r, ok := v1SnaplockLitigationBeginResFromProxyHTTP(ctx, err); return r, ok },
			explicitTypes: map[int]any{
		...
		},
		{
			...
			call: func(ctx context.Context, err error) (any, bool) { r, ok := v1SnaplockLitigationCollectionGetResFromProxyHTTP(ctx, err); return r, ok },
			explicitTypes: map[int]any{
		...
		},
		{
			...
			call: func(ctx context.Context, err error) (any, bool) { r, ok := v1SnaplockLitigationEndResFromProxyHTTP(ctx, err); return r, ok },
			explicitTypes: map[int]any{
		...
		},
		{
			...
			call: func(ctx context.Context, err error) (any, bool) { r, ok := v1SnaplockLitigationGetResFromProxyHTTP(ctx, err); return r, ok },
			explicitTypes: map[int]any{
		...
		},
		{
			...
			call: func(ctx context.Context, err error) (any, bool) { r, ok := v1SnaplockLitigationOperationCreateResFromProxyHTTP(ctx, err); return r, ok },
			explicitTypes: map[int]any{
		...
		},
		{
			...
			call: func(ctx context.Context, err error) (any, bool) { r, ok := v1SnaplockLitigationOperationGetResFromProxyHTTP(ctx, err); return r, ok },
			explicitTypes: map[int]any{
		...
		},
		{
			...
			call: func(ctx context.Context, err error) (any, bool) { r, ok := v1SnaplockLitigationOperationAbortResFromProxyHTTP(ctx, err); return r, ok },
			explicitTypes: map[int]any{
